...
/******************************************************************************/
/* Store procedure: rdt_NormalReceipt_Putaway                                 */
...
CREATE PROCEDURE [RDT].[rdt_NormalReceipt_Putaway]
   @nMobile       INT,           
   @nFunc         INT,           
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         SAVE TRAN rdt_NormalReceipt_Putaway -- For rollback or commit only our own transaction
   ...
   BEGIN
      ...
      COMMIT TRAN rdt_NormalReceipt_Putaway
   END
...
RollBackTran:
   ROLLBACK TRAN rdt_NormalReceipt_Putaway -- Only rollback change made here
Fail:
Quit:
