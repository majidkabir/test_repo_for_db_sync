...
/* Copyright      : LF                                                  */    
/*                                                                      */    
/* Purpose: IIC Replenishment Extended Update                           */    
/*                                                                      */    
/* Modifications log:                                                   */    
...
RollBackTran:  
   ROLLBACK TRAN rdt_895ExtUpdSP03 -- Only rollback change made here  
  
Quit:  
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started  
      COMMIT TRAN rdt_895ExtUpdSP03  
