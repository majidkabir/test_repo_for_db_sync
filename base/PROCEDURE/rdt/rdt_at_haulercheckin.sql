...
/***************************************************************************/              
/* Store procedure: rdt_AT_HaulerCheckIN                                   */              
/*                                                                         */              
/* Modifications log:                                                      */              
/*                                                                         */              
...
CREATE   PROC [RDT].[rdt_AT_HaulerCheckIN] (              
   @nMobile       INT,                  
   @nFunc         INT,                  
  ...
  DECLARE  @cGroup       NVARCHAR(20)
   ...
   BEGIN   
      ...
      BEGIN
         ...
         SET  @cOutField11= CASE WHEN @cOption = '1' THEN 'Check In' 
                                 WHEN @cOption = '9' THEN 'Check OUT' END
