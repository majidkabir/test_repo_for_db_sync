...
/************************************************************************/
/* Store procedure: rdt_PTLCart_Confirm_Load01_Lottable                 */
/* Copyright      : LF Logistics                                        */
/*                                                                      */
/* Date       Rev  Author      Purposes                                 */
/* 15-03-2022 1.0  Ung         WMS-18742 Created                        */
/************************************************************************/

CREATE PROC [RDT].[rdt_PTLCart_Confirm_Load01_Lottable] (
    @nMobile         INT
   ,@nFunc           INT
...
BEGIN
   ...
   -- Get session info
   SELECT @cMethod = V_String3 FROM rdt.rdtMobRec WITH (NOLOCK) WHERE Mobile = @nMobile

   -- Get storer config (some is method level config, setup at CodeLKUP.Notes)
   ...
   ***********************************************************************************************/
   ...
   BEGIN
      ...
      EXEC rdt.rdt_PTLCart_Confirm_Load01_LottableCursor @nMobile, @nFunc, @cLangCode, @nStep, @nInputKey, @cFacility, @cStorerKey, @cSQL, 'PTLTran', 
         @cLoadKey, @cPickConfirmStatus, @cDPLKey, @cLOC, @cSKU, @nQTY, @cPosition, @cLottableCode, 
      ...
      BEGIN
         ...
         BEGIN
            ...
            EXEC sp_ExecuteSQL @cSQL, @cSQLParam, 
               @cLoadKey, @cLOC, @cSKU, @cPickConfirmStatus, 
               @cLottable01, @cLottable02, @cLottable03, @dLottable04, @dLottable05,  
               @cLottable06, @cLottable07, @cLottable08, @cLottable09, @cLottable10,  
               @cLottable11, @cLottable12, @dLottable13, @dLottable14, @dLottable15, 
               @nQTY_PD OUTPUT
            ...
            EXEC rdt.rdt_PTLCart_Confirm_Load01_LottableCursor @nMobile, @nFunc, @cLangCode, @nStep, @nInputKey, @cFacility, @cStorerKey, @cSQL, 'LA', 
               @cLoadKey, @cPickConfirmStatus, @cDPLKey, @cLOC, @cSKU, @nQTY, @cPosition, @cLottableCode, 
               @cLottable01, @cLottable02, @cLottable03, @dLottable04, @dLottable05,
               @cLottable06, @cLottable07, @cLottable08, @cLottable09, @cLottable10,
               @cLottable11, @cLottable12, @dLottable13, @dLottable14, @dLottable15, 
