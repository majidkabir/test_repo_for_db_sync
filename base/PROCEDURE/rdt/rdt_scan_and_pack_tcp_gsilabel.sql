...
/************************************************************************/  
/* Store procedure: rdt_Scan_And_Pack_TCP_GSILabel                      */  
/* Copyright      : IDS                                                 */  
/*                                                                      */  
...
/* 22-Mar-2011 1.4  SHONG01 Created                                     */  
/*                          Added TCP Printing Features for Bartender   */  
/************************************************************************/  
  
CREATE PROC [RDT].[rdt_Scan_And_Pack_TCP_GSILabel] (
           @nSPID INT
          ,@cPrinterID NVARCHAR(50)
          ,@nErrNo  INT OUTPUT
          ,@cErrMsg NVARCHAR(20) 
           OUTPUT -- screen limitation, 20 char max
       ) AS  
BEGIN
    SET NOCOUNT ON  
    SET QUOTED_IDENTIFIER OFF  
    ...
    DECLARE @cLineText   NVARCHAR(1500)
