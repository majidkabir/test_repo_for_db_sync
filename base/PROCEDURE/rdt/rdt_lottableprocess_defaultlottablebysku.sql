...
/******************************************************************************/
/* Store procedure: rdt_LottableProcess_DefaultLottableBySKU                  */
/* Copyright      : LF Logistics                                              */
/*                                                                            */
/* Purpose: Show default lottable value by sku                                */
/*                                                                            */
/* Date         Author    Ver.  Purposes                                      */
/* 2021-10-26   James     1.0   WMS-17764. Created                            */
/******************************************************************************/

CREATE PROCEDURE [RDT].[rdt_LottableProcess_DefaultLottableBySKU]
    @nMobile          INT
   ,@nFunc            INT
