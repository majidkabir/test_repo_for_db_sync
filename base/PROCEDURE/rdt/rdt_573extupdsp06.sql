...
/************************************************************************/
/* Store procedure: rdt_573ExtUpdSP06                                   */
...
CREATE PROC [RDT].[rdt_573ExtUpdSP06] (
   @nMobile       INT,
   @nFunc         INT,
...
RollBackTran:
   ROLLBACK TRAN rdt_573ExtUpdSP06 -- Only rollback change made here
Quit:
