...
/***************************************************************************/
/* Store procedure: rdt_EcomReturn_Confirm                                 */
/* Copyright      : LF Logistics                                           */
/*                                                                         */
/* Date       Rev  Author  Purposes                                        */
/* 2019-11-14 1.0  James   WMS-10952. Created                              */
/* 2020-06-17 1.1  Ung     WMS-13555 Revise ReceiptConfirm_SP              */
/* 2020-11-24 1.2  Ung     WMS-14691 Add serial no                         */
/* 2021-07-12 1.3  Ung     WMS-17458 Default ConditionCode                 */
/***************************************************************************/

CREATE PROC [RDT].[rdt_EcomReturn_Confirm](
   @nFunc          INT,
   @nMobile        INT,
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         SET @cSQL = 'EXEC rdt.' + RTRIM( @cRcptConfirmSP) +
            ...
            ' @cConditionCode, @cSubreasonCode, @cSerialNo, @nSerialQTY, @tConfirmVar, ' + 
   ...
   ***********************************************************************************************/
   ...
   BEGIN TRAN    
   SAVE TRAN rdt_EcomReturn_Confirm  
...
RollBackTran:          
   ROLLBACK TRAN rdt_EcomReturn_Confirm -- Only rollback change made here          
Quit:          
