...
/************************************************************************/
/* Store procedure: rdt_PTLStation_Confirm_OrderSKU_Light               */
...
CREATE PROC [RDT].[rdt_PTLStation_Confirm_OrderSKU_Light] (
    @nMobile      INT
   ,@nFunc        INT
            ...
            BEGIN
               ...
               BEGIN -- Have balance, need to split
                  ...
                  SELECT 
                     ...
                     IPAddress, DeviceID, DevicePosition, Status, LightUp, LightMode, LightSequence, PTLType, SourceKey, DropID, CaseID, RefPTLKey, 
                     Storerkey, OrderKey, ConsigneeKey, SKU, LOC, LOT, UOM, Remarks, Func, GroupKey, 'rdt_PTLStation_Confirm_OrderSKU_Light', ArchiveCop
                  FROM PTL.PTLTran WITH (NOLOCK) 
         			WHERE PTLKey = @nPTLKey			            
                  IF @@ERROR <> 0
                  BEGIN
