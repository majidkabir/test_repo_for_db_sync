...
/************************************************************************/
/* Store procedure: rdt_1819ExtScnRC                                    */
/* Copyright      :  Maersk                                             */
/*                                                                      */
...
CREATE   PROC [rdt].[rdt_1819ExtScnRC] (
   @nMobile          INT,           
   @nFunc            INT,           
...
BEGIN
   ...
   SAVE TRAN rdt_1819ExtScnRC -- For rollback or commit only our own transaction
...
TRANS_FAIL:
   ROLLBACK TRAN rdt_1819ExtScnRC -- Only rollback change made here
Quit:
