...
/******************************************************************************/
/* Store procedure: rdt_523ExtPA42                                            */
/* Copyright: LF Logistics                                                    */
/*                                                                            */
/* Date        Rev  Author    Purposes                                        */
/* 2021-08-02  1.0  James     WMS-17630. Created (dup rdt_523ExtPA36)         */
/******************************************************************************/

CREATE PROC [RDT].[rdt_523ExtPA42] (
   @nMobile          INT,
   @nFunc            INT,
...
BEGIN
   ...
   SAVE TRAN rdt_523ExtPA42 -- For rollback or commit only our own transaction
   ...
   BEGIN
      ...
      COMMIT TRAN rdt_523ExtPA42 -- Only commit change made here
   END
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_523ExtPA42 -- Only rollback change made here
Quit:
