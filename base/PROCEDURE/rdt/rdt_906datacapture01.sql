...
/************************************************************************/
/* Store procedure: rdt_906DataCapture01                                */
...
CREATE PROCEDURE [RDT].[rdt_906DataCapture01] (  
   @nMobile       INT,
   @nFunc         INT, 
   ...
   BEGIN
      SET @nErrNo = 136851
      SET @cErrMsg = rdt.rdtgetmessage( @nErrNo, @cLangCode, 'DSP') --SKU NotIn Ord
      GOTO Quit
   END
   ...
   BEGIN
      SET @nErrNo = 136852
      SET @cErrMsg = rdt.rdtgetmessage( @nErrNo, @cLangCode, 'DSP') --Batch NotInOrd
   ...
   BEGIN TRAN
   SAVE TRAN rdt_906DataCapture01
   ...
   COMMIT TRAN rdt_906DataCapture01
...
RollBackTran:
      ROLLBACK TRAN rdt_906DataCapture01
Quit:
