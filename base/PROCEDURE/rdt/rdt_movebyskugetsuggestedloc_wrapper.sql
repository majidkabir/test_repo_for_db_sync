...
GO
/************************************************************************/
/* Store procedure: RDT_MoveBySKUGetSuggestedLoc_Wrapper                */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 10-Jun-2014 1.1  James       Revamp error msg                        */
/************************************************************************/

CREATE PROC [RDT].[RDT_MoveBySKUGetSuggestedLoc_Wrapper] (
	@n_Mobile				INT, 
   @n_Func					INT,
...
BEGIN
   ...
   BEGIN
	   ...
	   SET @cSQLStatement = N'EXEC RDT.' + RTrim(@c_SPName) + 
			 ...
			 ' @c_Storerkey,        @c_SKU,              @c_ReceiptKey,  '                    +
			 ' @c_FromLoc,          @c_ToLoc, '                                              +
			 ' @c_FromID,           @c_ToID,             @n_QtyReceived, '                    + 
