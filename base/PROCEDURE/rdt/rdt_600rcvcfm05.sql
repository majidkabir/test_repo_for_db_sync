...
/******************************************************************************/
/* Store procedure: rdt_600RcvCfm05                                           */
/* Copyright: LF Logistics                                                    */
/*                                                                            */
/* Purpose: Finalize by line after receive                                    */
/*                                                                            */
/* Date        Author    Ver.  Purposes                                       */
/* 18-Mar-2019 James     1.0   WMS-6623 Created                               */
/* 19-11-2020  YeeKung   1.1   WMS-15597 Add SerialNo(yeekung01)              */
/******************************************************************************/

CREATE PROC [RDT].[rdt_600RcvCfm05] (
   @nFunc          INT,           
   @nMobile        INT,           
...
BEGIN
   ...
   SAVE TRAN rdt_600RcvCfm05 -- For rollback or commit only our own transaction
