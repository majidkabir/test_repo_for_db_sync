...
/************************************************************************/
/* Store procedure: rdt_PTLStation_CreateTask_ToteIDSKU02               */
/* Copyright      : LFLogistics                                         */
/*                                                                      */
/* Date       Rev Author      Purposes                                  */
/* 02-01-2018 1.0 ChewKP      WMS-3487 Created                          */
/************************************************************************/

CREATE PROC [RDT].[rdt_PTLStation_CreateTask_ToteIDSKU02] (
    @nMobile      INT
   ,@nFunc        INT
      ...
      BEGIN
         ...
         BEGIN
            ...
            VALUES (
               ...
               @cOrderKey, @cStorerKey, @cScanSKU, @nPDQTY, 0,  @cScanID, @nFunc, @nRowRef, 'rdt_PTLStation_CreateTask_ToteIDSKU02')
            IF @@ERROR <> 0
            BEGIN
               SET @nErrNo = 111653
