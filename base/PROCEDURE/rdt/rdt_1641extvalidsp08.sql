...
/******************************************************************************/              
/* Store procedure: rdt_1641ExtValidSP08                                      */              
/* Purpose: Validate Pallet DropID                                            */              
/*                                                                            */              
/* Modifications log:                                                         */              
/*                                                                            */              
/* Date       Rev  Author   Purposes                                          */              
/* 2019-08-21 1.0  James    WMS-9792 Created                                  */              
/* 2020-04-22 1.1  YeeKung  WMS-13004 Add validate fro liquid item(yeekung01) */           
/* 2020-07-05 1.2  YeeKung  INC1194731 Performace Tune (yeekung02)            */        
/* 2020-07-09 1.3  YeeKung  WMS14187 Check deliverymode(yeekung03)            */       
/* 2020-09-02 1.4  YeeKung  WMS15054 Add PBEL          (yeekung04)            */   
/* 2021-05-24 1.5  YeeKung  WMS-17053 Add codelkup in delivery mode (yeekung05)*/    
/******************************************************************************/              
              
CREATE PROC [RDT].[rdt_1641ExtValidSP08] (              
   @nMobile      INT,              
   @nFunc        INT,              
