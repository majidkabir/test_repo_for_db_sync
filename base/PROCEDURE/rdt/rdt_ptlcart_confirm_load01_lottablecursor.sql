...
/******************************************************************************/
/* Store procedure: rdt_PTLCart_Confirm_Load01_LottableCursor                 */
/* Copyright      : LF Logistics                                              */
/*                                                                            */
/* Purpose: Open PickDetail / PTLTran / TaskDetail cursor,                    */
/*          with optional lottables filter                                    */
/*                                                                            */
/* Date       Rev  Author      Purposes                                       */
/* 15-03-2022 1.0  Ung         WMS-18742 Created                              */
/******************************************************************************/

CREATE PROC [RDT].[rdt_PTLCart_Confirm_Load01_LottableCursor] (
    @nMobile         INT
   ,@nFunc           INT
...
BEGIN
   ...
   EXEC sp_ExecuteSQL @cSQL, @cSQLParam, 
      @cLoadKey, @cPickConfirmStatus, @cStorerKey, @cDPLKey, @cLOC, @cSKU, @nQTY, @cPosition, @cLottableCode, 
      @cLottable01, @cLottable02, @cLottable03, @dLottable04, @dLottable05,
      @cLottable06, @cLottable07, @cLottable08, @cLottable09, @cLottable10,
      @cLottable11, @cLottable12, @dLottable13, @dLottable14, @dLottable15, 
      @curCursor OUTPUT
