...
/************************************************************************/
/* Store procedure: rdt_ClusterPickCfm10                                */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 10-Jul-2018 1.0  James       WMS5199 Created                         */
/************************************************************************/

CREATE PROC [RDT].[rdt_ClusterPickCfm10] (
   @nMobile                   INT, 
   @nFunc                     INT, 
...
SET CONCAT_NULL_YIELDS_NULL OFF
   ...
   BEGIN TRAN
   SAVE TRAN rdt_ClusterPickCfm10
...
*/
   ...
   RollBackTran:
      ROLLBACK TRAN rdt_ClusterPickCfm10

   Quit:
      WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started
         COMMIT TRAN rdt_ClusterPickCfm10
