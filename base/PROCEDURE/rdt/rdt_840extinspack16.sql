...
/************************************************************************/
/* Stored Procedure: rdt_840ExtInsPack16                                */
/*                                                                      */
/* Purpose: rdt_840ExtInsPackLV>rdt_840ExtInsPack16                     */
...
/* 2021-04-26   yeekung   1.0   WMS16717- Created                       */
/************************************************************************/

CREATE PROC [RDT].[rdt_840ExtInsPack16] (
   @nMobile                   INT, 
   @nFunc                     INT, 
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         VALUES
            ...
            '', 'rdt.' + sUser_sName(), GETDATE(), 'rdt.' + sUser_sName(), GETDATE(), @cCurLabelNo)
   ...
   RollBackTran:  
         ROLLBACK TRAN rdt_840ExtInsPack16  
   Quit:  
