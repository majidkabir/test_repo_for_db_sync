...
GO
/************************************************************************/
/* Store procedure: RDT.RDT_SortAndPackGetCtnType_Wrapper               */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 27-Mar-2013 1.0  James       Created                                 */
/* 10-Jun-2014 1.1  James       Revamp error msg (james01)              */
/************************************************************************/

CREATE PROC [RDT].[RDT_SortAndPackGetCtnType_Wrapper] (
	@n_Mobile				INT, 
   @n_Func					INT,
   ...
   @c_SKU               NVARCHAR( 20),
   @c_ConsigneeKey      NVARCHAR( 15)   OUTPUT,
...
BEGIN
   ...
   BEGIN
	   ...
	   SET @cSQLStatement = N'EXEC RDT.' + RTrim(@c_SPName) + 
			 ...
			 ' @c_PackByType,       @c_Type,             @c_LoadKey, '                       +
			 ' @c_Storerkey,        @c_SKU, '                                                +
			 ' @c_ConsigneeKey   OUTPUT, @c_OrderKey     OUTPUT, '                           + 
