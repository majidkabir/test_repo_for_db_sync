...
/************************************************************************/
/* Store procedure: rdt_Pick_Cfm_DSG_RW                                 */
...
CREATE PROCEDURE [RDT].[rdt_Pick_Cfm_DSG_RW] (
   @nMobile       INT,
   @nFunc         INT,
...
*/
   ...
   ***********************************************************************************************/
   ...
   SAVE TRAN rdt_Pick_Cfm_DSG_RW  -- For rollback or commit only our own transaction
...
select * from @tActPD
   ...
   ***********************************************************************************************/
   ...
   COMMIT TRAN rdt_Pick_Cfm_DSG_RW
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_Pick_Cfm_DSG_RW
Fail:
Quit:
