...
/************************************************************************/
/* Store procedure: rdt_1766ExtUpd02                                    */
/* Purpose: Reverse the locked task status for CC task                  */
/*          using Loc.Floor (instead of Loc.Aisle)                      */
/*                                                                      */
/* Modifications log:                                                   */
/*                                                                      */
/* Date       Rev  Author     Purposes                                  */
/* 2023-10-24 1.0  James      WMS-23941. Created                        */
/************************************************************************/

CREATE   PROC [RDT].[rdt_1766ExtUpd02] (
   @nMobile     INT,
   @nFunc       INT, 
...
AS
   ...
   SAVE TRAN rdt_1766ExtUpd02 -- For rollback or commit only our own transaction  
   ...
   BEGIN
      ...
      BEGIN
		 ...
		 IF ISNULL(@cExcludeQtyPicked,'') = ''
			SET @cExcludeQtyPicked = 'Y'
   ...
   RollBackTran:  
         ROLLBACK TRAN rdt_1766ExtUpd02  
