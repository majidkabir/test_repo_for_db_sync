...
/************************************************************************/      
/* Store procedure: rdt_839GetTaskSP11                                  */   
/* Copyright      : Maersk                                              */   
/*                                                                      */
/* Purpose: Order by Sku, logicallocation, loc,                         */      
/*                                                                      */      
/* Modifications log:                                                   */      
/*                                                                      */      
/* Date       Rev  Author     Purposes                                  */      
/* 2023-12-06 1.0  Tony       WMS-24315 Created copy from standard logic*/
/************************************************************************/      
      
CREATE   PROC [RDT].[rdt_839GetTaskSP11] (      
  @nMobile          INT,                
  @nFunc            INT,                
   ...
   BEGIN
      ...
      BEGIN
         IF @cPickZone = ''
            ...
            GROUP BY PD.SKU,LOC.LogicalLocation, LOC.LOC, PD.StorerKey
            ORDER BY PD.SKU
                  ,CASE WHEN (LOC.LogicalLocation = @cCurrLogicalLOC AND LOC.LOC > @cCurrLOC) THEN 0 ELSE 1 END 
                  ,CASE WHEN (LOC.LogicalLocation > @cCurrLogicalLOC) THEN 0 ELSE 1 END 
                  ,LOC.LogicalLocation, LOC.LOC, PD.StorerKey
         ELSE
            SELECT TOP 1
               @cSuggLOC = LOC.LOC,
               @cSuggSKU = PD.SKU,
