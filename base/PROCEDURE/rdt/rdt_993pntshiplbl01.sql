...
/******************************************************************************/
/* Store procedure: rdt_993PntShipLbl01                                       */
/* Copyright      : Maersk                                                    */
/*                                                                            */
/* Date       Rev  Author     Purposes                                        */
/* 2024-11-01 1.1  JACKC      FCR-946 Created. Copied from rdt_838PntShipLbl04*/
/* 2024-12-10 1.2.0 NLT013    FCR-1659 Be able to print label for MPOC        */
/******************************************************************************/

CREATE   PROC rdt.rdt_993PntShipLbl01 (
   @nMobile          INT,
   @nFunc            INT,
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            --Check if the carton is a MPOC carton
