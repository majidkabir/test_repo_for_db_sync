...
/***************************************************************************/
/* Store procedure: rdt_656ClosePallet01                                   */
/* Copyright      : Maersk                                                 */
/*                                                                         */
/* Date        Rev  Author    Purposes                                     */
/* 27-04-2023  1.0  Ung       WMS-22246 Based on rdt_TM_Replen_ClosePallet */
/*                            Process FP like PP, carton level             */
/***************************************************************************/

CREATE   PROC [RDT].[rdt_656ClosePallet01] (
   @nMobile        INT,
   @nFunc          INT,
...
BEGIN
   ...
   ***********************************************************************************************/
   ...
   SAVE TRAN rdt_656ClosePallet01 -- For rollback or commit only our own transaction
   ...
   BEGIN
      ...
      BEGIN
         ...
         EXECUTE rdt.rdt_Move
            ...
            @cSourceType = 'rdt_656ClosePallet01',
...
END
   ...
   COMMIT TRAN rdt_656ClosePallet01 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_656ClosePallet01 -- Only rollback change made here
Fail:
Quit:
