...
/************************************************************************/
/* Store procedure: rdt_511ExtUpd08                                     */
/* Purpose: Trigger receiving out interface                             */
/*                                                                      */
/* Modifications log:                                                   */
/*                                                                      */
/* Date       Rev  Author     Purposes                                  */
/* 2022-06-07 1.0  James      WMS-19665. Created                        */
/************************************************************************/

CREATE PROC [RDT].[rdt_511ExtUpd08] (
   @nMobile        INT,
   @nFunc          INT,
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            SET @nErrNo = 0
            SET @cCommand = N'EXEC [CNDTSITF].[dbo].[isp6374P_WOL_CN_Columbia_CS_REC_OUT_Export] ' +
               N' @c_DataStream = ''6374'' ' +
               ...
               N' , @n_Err = 0 '+
               N' , @c_ErrMsg = ''''' +
               N' , @c_TransmitLogKey = ''' + @cTransmitLogKey + '''' +
               N' , @c_ToId = ''' + @cFromID + ''''
