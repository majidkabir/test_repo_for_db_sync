...
/************************************************************************/    
/* Store procedure: rdt_842ExtUpdSP07                                   */    
/* Copyright      : LF                                                  */    
/*                                                                      */    
/* Purpose: THG DTC Logic                                               */    
/*                                                                      */    
/* Modifications log:                                                   */    
/* Date        Rev  Author   Purposes                                   */    
/* 2019-04-17  1.0  James    WMS-8717 Created                           */    
/* 2020-06-17  1.1  James    WMS-13504 Printing process fix (james01)   */  
/* 2020-12-02  1.2  LZG      INC1367573 - Set @cWinPrinterName (ZG01)   */
/* 2021-04-16  1.1  James    WMS-16024 Standarized use of TrackingNo    */
/*                           (james02)                                  */
/************************************************************************/    
    
CREATE PROC [RDT].[rdt_842ExtUpdSP07] (    
   @nMobile        INT,                
   @nFunc          INT,                
...
BEGIN    
   ...
   DECLARE  @fCartonWeight       FLOAT  
           ...
           ,@cOrderKey4Printing  NVARCHAR( 10)            
   ...
   BEGIN    
      ...
      ****************************/    
      ...
      SET @cOrderKey4Printing = @cOrderKey  
      ...
      BEGIN  
         ...
         */  
         SELECT @cShipperKey = ShipperKey,  
                ...
                @cExternOrderKey = ExternOrderKey  
         FROM dbo.Orders WITH (NOLOCK)  
         WHERE OrderKey = @cOrderKey4Printing  
         ...
         BEGIN  
            ...
            BEGIN  
               ...
               BEGIN      
                  ...
                  SET @cFileName = @cFilePrefix + RTRIM( @cOrderKey4Printing) + '.pdf'       
               ...
               BEGIN  
                  ...
                  INSERT INTO @tDatawindow (Variable, Value) VALUES ( '@cOrderKey', @cOrderKey4Printing)   
            ...
            BEGIN  
               ...
               INSERT INTO @tSHIPLabel (Variable, Value) VALUES ( '@cOrderKey', @cOrderKey4Printing)   
   ...
   RollBackTran:        
      ROLLBACK TRAN rdt_842ExtUpdSP07 -- Only rollback change made here        
        
   Quit:        
      WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started        
         COMMIT TRAN rdt_842ExtUpdSP07        
