...
/************************************************************************/      
/* Store procedure: rdt_1764CreateTask02                                */      
/* Copyright      : IDS                                                 */      
/*                                                                      */      
...
/* 09-Aug-2018 1.0  ChewKP    WMS-6178 Created                          */      
/* 12-Mar-2019 1.1  Ung       WMS-7764 Add RPT task                     */      
/* 26-Mar-2019 1.2  Ung       WMS-7764 Add DYNPPICK                     */      
/************************************************************************/      
      
CREATE PROC [RDT].[rdt_1764CreateTask02] (      
   @nMobile        INT,      
   @nFunc          INT,      
...
BEGIN      
   ...
   SELECT TOP 1       
      ...
      @cSourceType     = 'rdt_1764CreateTask02'      
   ...
   SAVE TRAN rdt_1764CreateTask02 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN rdt_1764CreateTask02 -- Only commit change made here      
   GOTO Quit      
      
RollBackTran:      
     
   ROLLBACK TRAN rdt_1764CreateTask02 -- Only rollback change made here      
Fail:      
Quit:      
