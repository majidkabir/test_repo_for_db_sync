...
GO
/************************************************************************/  
/* Store procedure: rdt_841ExtUpdSP20                                   */  
/* Copyright      : LF                                                  */  
/*                                                                      */  
...
CREATE   PROC [RDT].[rdt_841ExtUpdSP20] (  
   @nMobile       INT,  
   @nFunc         INT,  
...
BEGIN  
         ...
         BEGIN  
            ...
            END
               ...
               BEGIN  
                  ...
                  SELECT @cLabelPrinter=@cLabelPrinter
                  FROM rdt.RDTMOBREC (NOLOCK)
                  WHERE mobile=@nMobile

                  SELECT @cLoadKey= CASE WHEN isnull(@cLoadKey,'')='' THEN loadkey ELSE @cLoadKey END
   ...
   --      AND LabelNo = @cLabelNo  
      ...
      BEGIN  
         ...
         --VALUES ( 'rdt_841ExtUpdSP20', GetDate() , '1' , @cOrderKey, @cOrderType )  
         ...
         BEGIN  
            ...
            --INSERT INTO TRACEINFO (TraceName, TimeIn, Step1 , Step2, Step3 )  
            --VALUES ( 'rdt_841ExtUpdSP20', GetDate() , '1.1' , @cOrderKey, @cSOStatus )  
   ...
   --         BEGIN  
               ...
               --VALUES ( 'rdt_841ExtUpdSP20', GetDate() , '1.2' , @cOrderKey, @cSOStatus, @cStorerKey )  
   ...
   --         BEGIN  
   --            INSERT INTO TRACEINFO (TraceName, TimeIn, Step1 , Step2, Step3, Step4 )  
   --            VALUES ( 'rdt_841ExtUpdSP20', GetDate() , '1.3' , @cOrderKey, @cSOStatus, @cStorerKey )  
   --         END  
         END  
...
RollBackTran:        
   ROLLBACK TRAN rdt_841ExtUpdSP20 -- Only rollback change made here        
        
Quit:        
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started        
      COMMIT TRAN rdt_841ExtUpdSP20        
