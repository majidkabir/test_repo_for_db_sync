...
/************************************************************************/    
/* Store procedure: rdt_1651ExtInfo01                                   */    
/* Copyright      : IDS                                                 */    
/*                                                                      */    
...
/* 2018-07-20 1.0  James    WMS-4673-Created                            */    
/************************************************************************/    
    
CREATE PROCEDURE [RDT].[rdt_1651ExtInfo01]    
   @nMobile                   INT,           
   @nFunc                     INT,           
...
BEGIN    
   ...
   BEGIN
      ...
      BEGIN
         ...
         WHERE ContainerKey = @cContainerKey
         AND   [Status] = '5' -- Pallet verified only status = '5'
