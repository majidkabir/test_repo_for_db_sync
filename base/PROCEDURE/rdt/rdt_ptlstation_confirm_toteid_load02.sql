...
/************************************************************************/
/* Store procedure: rdt_PTLStation_Confirm_ToteID_Load02                */
...
CREATE PROC [RDT].[rdt_PTLStation_Confirm_ToteID_Load02] (
    @nMobile      INT
   ,@nFunc        INT
            ...
            BEGIN
               ...
               BEGIN -- Have balance, need to split
                  ...
                  SELECT 
                     ...
                     IPAddress, DeviceID, DevicePosition, Status, LightUp, LightMode, LightSequence, PTLType, SourceKey, DropID, CaseID, RefPTLKey, 
                     Storerkey, OrderKey, SKU, LOC, LOT, UOM, Remarks, Func, GroupKey, 'rdt_PTLStation_Confirm_ToteID_Load02', ArchiveCop
                  FROM PTL.PTLTran WITH (NOLOCK) 
         			WHERE PTLKey = @nPTLKey			            
                  IF @@ERROR <> 0
                  BEGIN
