...
GO
/************************************************************************/  
/* Store procedure: rdt_511ExtUpd07                                     */  
/* Purpose: Validate UCC                                                */  
/*                                                                      */  
/* Modifications log:                                                   */  
/*                                                                      */  
/* Date       Rev  Author     Purposes                                  */  
/* 2022-02-21 1.0  yeekung   WMS-18906. Created                        */ 
/************************************************************************/  
  
CREATE PROC [RDT].[rdt_511ExtUpd07] (  
   @nMobile        INT, 
   @nFunc          INT, 
...
BEGIN
   ...
   BEGIN  
      ...
      BEGIN
         ...
         BEGIN
            SET @nErrNo = 0
            EXEC [CNDTSITF].[dbo].[isp6068P_WOL_AEOQHW_CN_REC_Export] 
                  @c_DataStream = '6068'
