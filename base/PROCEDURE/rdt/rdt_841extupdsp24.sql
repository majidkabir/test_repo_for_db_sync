...
/************************************************************************/          
/* Store procedure: rdt_841ExtUpdSP24                                   */          
/* Copyright      : LF                                                  */          
/*                                                                      */          
...
/* 2021-01-10  1.0  Chermaine WMS-18680 Created (dup rdt_841ExtUpdSP09) */          
/* 2022-06-07  1.1  James     Add VariableTable Param (james01)         */
/************************************************************************/          
        
CREATE PROC [RDT].[rdt_841ExtUpdSP24] (          
   @nMobile     INT,          
   @nFunc       INT,          
...
--          
               ...
               SELECT @cTrackNo = TrackingNo -- (james03)  
...
RollBackTran:                
   ROLLBACK TRAN rdt_841ExtUpdSP24 -- Only rollback change made here                
                
Quit:                
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started                
      COMMIT TRAN rdt_841ExtUpdSP24                
