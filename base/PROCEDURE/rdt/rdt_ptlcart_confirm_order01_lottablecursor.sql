...
/******************************************************************************/
/* Store procedure: rdt_PTLCart_Confirm_Order01_LottableCursor                */
...
CREATE PROC [RDT].[rdt_PTLCart_Confirm_Order01_LottableCursor] (
    @nMobile         INT
   ,@nFunc           INT
...
BEGIN
   ...
   EXEC sp_ExecuteSQL @cSQL, @cSQLParam, 
      @cOrderKey, @cPickConfirmStatus, @cStorerKey, @cDPLKey, @cLOC, @cSKU, @nQTY, @cPosition, @cLottableCode, 
      @cLottable01, @cLottable02, @cLottable03, @dLottable04, @dLottable05,
      @cLottable06, @cLottable07, @cLottable08, @cLottable09, @cLottable10,
      @cLottable11, @cLottable12, @dLottable13, @dLottable14, @dLottable15, 
      @curCursor OUTPUT
