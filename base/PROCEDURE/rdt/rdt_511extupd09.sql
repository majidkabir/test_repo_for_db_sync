...
/************************************************************************/
/* Store procedure: rdt_511ExtUpd09                                     */
/* Purpose: Trigger receiving out interface                             */
/*                                                                      */
/* Modifications log:                                                   */
/*                                                                      */
/* Date       Rev  Author     Purposes                                  */
/* 2022-06-07 1.0  James      WMS-19800/19824. Created                  */
/************************************************************************/

CREATE PROC [RDT].[rdt_511ExtUpd09] (
   @nMobile        INT,
   @nFunc          INT,
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            SET @nErrNo = 0
            SET @cCommand = N'EXEC [CNDTSITF].[dbo].[isp6380P_WOL_STUSSY_CN_REC_Export] ' +
               N' @c_DataStream = ''6380'' ' +
