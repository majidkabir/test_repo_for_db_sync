...
/******************************************************************************/
/* Store procedure: rdt_513ExtUpdSP03                                         */
...
CREATE PROCEDURE [RDT].[rdt_513ExtUpdSP03]
    @nMobile         INT 
   ,@nFunc           INT 
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            -- Booked elsewhere like RDT piece receiving
            IF @cSuggestedLOC <> '' 
            BEGIN
               -- Move to different LOC/ID (both LOTxLOCxID and RFPutaway need to unlock)
               IF (@cSuggestedLOC <> @cToLOC) OR (@cFromID <> @cToID)
               BEGIN
               ...
               BEGIN
                  ...
                  SAVE TRAN rdt_513ExtUpdSP03 -- For rollback or commit only our own transaction
...
RollBackTran:
   ROLLBACK TRAN rdt_513ExtUpdSP03 -- Only rollback change made here
Quit:
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started
      COMMIT TRAN rdt_513ExtUpdSP03
