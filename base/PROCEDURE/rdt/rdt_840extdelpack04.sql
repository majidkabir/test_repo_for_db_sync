...
/************************************************************************/
/* Store procedure: rdt_840ExtDelPack04                                 */
/* Purpose: Clear pickdetail.caseid for M&M Korea                       */
/*          Clear carton track data with archivecop = null. Trigger will*/
/*          block if cartontrack.labelno <> '' (assigned to orders)     */
/*                                                                      */
/* Modifications log:                                                   */
/*                                                                      */
/* Date       Rev  Author     Purposes                                  */
/* 2018-11-16 1.0  James      WMS6891. Created                          */
/* 2021-04-16 1.1  James      WMS-16024 Standarized use of TrackingNo   */
/*                            (james01)                                 */
/************************************************************************/

CREATE PROC [RDT].[rdt_840ExtDelPack04] (
   @nMobile     INT,
   @nFunc       INT, 
...
AS
   ...
   BEGIN
      ...
      AND   KeyName = @cStorerkey   -- (james01)
      AND   CarrierRef2 = 'GET'
   ...
   RollBackTran:  
         ROLLBACK TRAN rdt_840ExtDelPack04  
   Quit:  
      WHILE @@TRANCOUNT > @nTranCount  
         COMMIT TRAN rdt_840ExtDelPack04
