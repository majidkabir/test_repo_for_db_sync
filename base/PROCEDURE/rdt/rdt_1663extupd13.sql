...
/******************************************************************************/
/* Store procedure: rdt_1663ExtUpd13                                          */
/* Copyright      : LF Logistics                                              */
/*                                                                            */
/* Date       Rev  Author   Purposes                                          */
/* 2023-09-22 1.0  yeekung  WMS-23692. Created                                */
/******************************************************************************/

CREATE   PROC [RDT].[rdt_1663ExtUpd13](
   @nMobile       INT,
   @nFunc         INT,
...
BEGIN
   ...
   SAVE TRAN rdt_1663ExtUpd13 -- For rollback or commit only our own transaction
...
RollBackTran:
   ROLLBACK TRAN rdt_1663ExtUpd13
Quit:
