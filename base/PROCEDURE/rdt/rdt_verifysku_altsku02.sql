...
/************************************************************************/
/* Store procedure: rdt_VerifySKU_AltSKU02                              */
/* Copyright      : LF Logistics                                        */
/*                :Copy from rdt_VerifySKU_AltSKU add sscc feature      */
/*                 checking                                             */
/*                                                                      */
/* Date        Rev  Author       Purposes                               */
/* 18-02-2021  1.0  YeeKung      WMS-16381 CREATED                      */
/************************************************************************/
            
CREATE PROCEDURE [RDT].[rdt_VerifySKU_AltSKU02]
   @nMobile     INT,
   @nFunc       INT,
...
BEGIN
   ...
   ***********************************************************************************************/
   ...
   BEGIN
      ...
      -- Check not setup
      IF @cSUSR4  IN( 'Y','SSCC') AND @cAltSKU <> ''
