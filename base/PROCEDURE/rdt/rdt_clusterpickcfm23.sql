...
CREATE   PROC [RDT].[rdt_ClusterPickCfm23] (  
   @nMobile                   INT,  
   @nFunc                     INT,  
         ...
         BEGIN  
            ...
            BEGIN  
               ...
               VALUES  
                  ...
                  @cPickDetailKey, 'rdt.' + sUser_sName(), GETDATE(), 'rdt.' + sUser_sName(), GETDATE(), @cDropID, @cRefno02)  
