...
/******************************************************************************/
/* Store procedure: rdt_1819ExtPASP26                                         */
/* Copyright: LF Logistics                                                    */
/*                                                                            */
/* Date         Rev  Author   Purposes                                        */
/* 08-May-2020  1.0  Ung      WMS-13243 Add HostWHCode (rdt_1819ExtPASP14)    */
/******************************************************************************/

CREATE PROC [RDT].[rdt_1819ExtPASP26] (
   @nMobile          INT,
   @nFunc            INT,
...
BEGIN
   ...
   WHERE LOC.Facility = @cFacility
      AND ISNULL( HostWhcode, '') = @cHostWhcode
   ...
   BEGIN
      ...
      COMMIT TRAN rdt_1819ExtPASP26 -- Only commit change made here
   END

   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_1819ExtPASP26 -- Only rollback change made here
Quit:
