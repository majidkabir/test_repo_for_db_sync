...
GO
/***************************************************************************/    
/* Store procedure: rdt_593Print13                                         */    
/*                                                                         */    
/* Modifications log:                                                      */    
/*                                                                         */    
/* Date       Rev  Author   Purposes                                       */    
/* 2017-08-28 1.0  ChewKP   WMS-2776 Created                               */  
/***************************************************************************/    
    
CREATE PROC [RDT].[rdt_593Print13] (    
   @nMobile    INT,    
   @nFunc      INT,    
   @nStep      INT,    
...
--      SET @cTargetDB   = ''
      ...
      INSERT INTO @tOutBoundLis (Variable, Value) VALUES ( '@cPickSlipNo',  @cPickSlipNo)
      INSERT INTO @tOutBoundLis (Variable, Value) VALUES ( '@nCartonStart', @nCartonStart)
      INSERT INTO @tOutBoundLis (Variable, Value) VALUES ( '@nCartonEnd',   @nCartonEnd)
                        

      -- Print label
      EXEC RDT.rdt_Print @nMobile, @nFunc, @cLangCode, 0, 1, '', @cStorerKey, @cLabelPrinter, '', 
         'UCCLABEL01', -- Report type
...
--RollBackTran:      
--   ROLLBACK TRAN rdt_593Print13 -- Only rollback change made here      
--   EXEC rdt.rdtSetFocusField @nMobile, @nFocusParam

 
Quit:      
   --WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started      
   --   COMMIT TRAN rdt_593Print13    
   EXEC rdt.rdtSetFocusField @nMobile, @nFocusParam 
