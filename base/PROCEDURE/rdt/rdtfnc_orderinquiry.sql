...
GO
/*****************************************************************************/
/*Store procedure: rdtfnc_OrderInquiry                                       */
/*Copyright      : IDS                                                       */
/*                                                                           */
/*Purpose: SOS#337052 - Order Inquiry                                        */
/*                                                                           */
/*Modifications log:                                                         */
/*                                                                           */
/*Date       Rev  Author   Purposes                                          */
/*2015-03-27 1.0  ChewKP   Created                                           */
/*2016-09-30 1.1  Ung      Performance tuning                                */
/*2018-10-08 1.2  TungGH   Performance                                       */
/*****************************************************************************/
CREATE PROC [RDT].[rdtfnc_OrderInquiry](
   @nMobile    INT,
   @nErrNo     INT  OUTPUT,
...
IF @nFunc = 596
BEGIN
   IF @nStep = 0 GOTO Step_0   -- Menu. Func = 596
   IF @nStep = 1 GOTO Step_1   -- Scn = 4120  OrderKey
   IF @nStep = 2 GOTO Step_2   -- Scn = 4121  Information
...
/********************************************************************************
Step 0. Called from menu (func = 596)
********************************************************************************/
Step_0:
BEGIN
   -- Set the entry point
...
BEGIN
 ...
 BEGIN
      -- Screen mapping
      SET @cOrderKey = ISNULL(@cInField01,'') 
      ...
      ****************************/
      ...
      BEGIN
         SET @nErrNo = 93302
         SET @cErrMsg = rdt.rdtgetmessage( @nErrNo, @cLangCode, 'DSP') --OrderKeyNotExist
         GOTO Step_1_Fail
      END
      ...
      BEGIN
         ...
         BEGIN
            ...
            SET @cSQL = 'EXEC rdt.' + RTRIM(@cExtendedInfoSP) +
               ' @nMobile, @nFunc, @cLangCode, @nStep, @cStorerKey, @cOrderKey, ' + 
