...
/************************************************************************/  
/* Store procedure: rdt_840GenLabelNo02                                 */  
...
/* 2018-11-27 1.0  James      WMS7082. Created                          */  
/* 2019-03-11 1.1  James      Customer orders don't use counter from    */  
/*                            codelkup (james01)                        */  
/* 2019-06-17 1.2  Shong      Capture EditDate for nCounter             */  
/* 2020-06-04 1.3  James      Fix param seq wrongly put (james02)       */  
/************************************************************************/  
  
CREATE PROC [RDT].[rdt_840GenLabelNo02] (  
   @nMobile     INT,  
   @nFunc       INT,   
