...
/************************************************************************/          
/* Store procedure: rdt_841ExtUpdSP17                                   */          
/* Copyright      : LF                                                  */          
/*                                                                      */          
/* Purpose: rdt_841ExtUpdSPLV->rdt_841ExtUpdSP17                        */          
/*                                                                      */          
/* Modifications log:                                                   */          
/* Date        Rev  Author   Purposes                                   */          
/* 2021-04-26  1.0  yeekung   WMS-16718 Created                         */
/* 2021-07-27  1.1  Chermain WMS-17410 Add VariableTable Param (cc01)   */
/************************************************************************/          
        
CREATE PROC [RDT].[rdt_841ExtUpdSP17] (          
   @nMobile       INT,  
   @nFunc         INT,  
               ...
               BEGIN --(cc01)        
                -- Common params ofr printing        
                  ...
                  BEGIN          
                     ...
                     INSERT INTO @tSHIPPLABEL (Variable, Value) VALUES ( '@nFromCartonNo',    '1')        
                     INSERT INTO @tSHIPPLABEL (Variable, Value) VALUES ( '@nToCartonNo',    '1')            
                             
                     --INSERT INTO TraceInfo (TraceName,col1,Col2,Col3,Col4)        
                     --VALUES('ccDTC',@cStorerKey,@cPickSlipNo,@cDropID,@nCartonNo)        
...
RollBackTran:                
   ROLLBACK TRAN rdt_841ExtUpdSPLV -- Only rollback change made here                
                
Quit:                
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started                
      COMMIT TRAN rdt_841ExtUpdSPLV                
