...
/************************************************************************/
/* Store procedure: rdt_803MatrixSP07                                   */
/* Copyright      : LF Logistics                                        */
/*                                                                      */
/* Date       Rev  Author   Purposes                                    */
/* 2021-09-24 1.0  James    WMS-18005. Created                          */
/************************************************************************/

CREATE   PROC [RDT].[rdt_803MatrixSP07] (
    @nMobile    INT
   ,@nFunc      INT
...
BEGIN
   ...
   BEGIN
      ...
      JOIN dbo.Orders O WITH (NOLOCK) ON ( O.OrderKey = L.OrderKey)  
      ...
      SET @cResult10 = 'QTY: ' + CAST( @nPickedQty AS NVARCHAR( 5))+ '/' + CAST( @nPickQty AS NVARCHAR( 5))
   END
   ELSE
   BEGIN
      SET @nStart = 1
