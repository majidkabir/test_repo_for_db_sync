...
/************************************************************************/
/* Store procedure: rdt_1812GetTask01                                   */
...
/* 17-Dec-2011 1.0  Ung       SOS327467 Created                         */
/* 10-Apr-2015 1.1  Ung       SOS338354 Support UserKeyOverRide         */
/* 12-Jun-2015 1.2  Ung       SOS343926 Add GroupKey                    */
/************************************************************************/

CREATE PROC [RDT].[rdt_1812GetTask01] (
   @nMobile          INT,
   @nFunc            INT,
