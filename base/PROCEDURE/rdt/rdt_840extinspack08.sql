...
GO
/************************************************************************/
/* Stored Procedure: rdt_840ExtInsPack08                                */
/*                                                                      */
...
/* 2020-03-19   James     1.0   WMS-12366 Created                       */
/* 2020-12-04   LZG       1.1   INC1366461 - Fixed NULL CaseID          */
/*                              exception (ZG01)                        */
...
CREATE PROC [RDT].[rdt_840ExtInsPack08] (
   @nMobile                   INT, 
   @nFunc                     INT, 
...
BEGIN
   ...
   IF EXISTS (SELECT 1 FROM dbo.PackDetail WITH (NOLOCK)
               ...
               AND SKU = @cSKU)   -- can scan many sku into 1 carton
   BEGIN
      SELECT TOP 1 @cCurLabelNo = LabelNo FROM dbo.PackDetail WITH (NOLOCK)   -- ZG01
         WHERE StorerKey = @cStorerKey  
         AND PickSlipNo = @cPickSlipNo  
         AND CartonNo = @nCartonNo  
   ...
   GOTO Commit_rdt_840ExtInsPack08
   
   RollBackTran:  
         ROLLBACK TRAN rdt_840ExtInsPack08  
   Commit_rdt_840ExtInsPack08:  
