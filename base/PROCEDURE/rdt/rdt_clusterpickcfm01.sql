...
/************************************************************************/
/* Store procedure: rdt_ClusterPickCfm01                                */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 29-Jun-2015 1.0  James       SOS342111 Created                       */
/* 02-Dec-2015 1.1  Leong       SOS356989 - Insert with AddWho column.  */
/* 27-Oct-2016 1.2  James       Perf tuning                             */
/* 29-Nov-2019 1.3  James       Perf tuning (james01)                   */
/************************************************************************/

CREATE PROC [RDT].[rdt_ClusterPickCfm01] (
   @nMobile                   INT,
   @nFunc                     INT,
...
BEGIN
   ...
   BEGIN TRAN
   SAVE TRAN rdt_ClusterPickCfm01
   ...
   RollBackTran:
      ROLLBACK TRAN rdt_ClusterPickCfm01

   Quit:
      WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started
         COMMIT TRAN rdt_ClusterPickCfm01
