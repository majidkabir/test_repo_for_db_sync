...
/******************************************************************************/
/* Store procedure: rdt_PTLCart_Assign_PickslipPosTote_Lottable               */
/* Copyright      : LFLogistics                                               */
/*                                                                            */
/* Date       Rev  Author   Purposes                                          */
/* 15-03-2018 1.0  Ung      WMS-4247 Created                                  */
/* 19-11-2018 1.1  James    WMS-6854 Check custom pickcfm status (james01)    */
/* 15-04-2019 1.2  James    WMS-8585 Add scan in pickslip (james02)           */
/* 04-07-2019 1.3  James    WMS-8585 Add check pending replenishment (james03)*/
/* 06-08-2019 1.4  James    WMS-9983 Add filter loc type (james04)            */
/* 04-10-2019 1.5  James    WMS-10764 Add custom pickkslip retrival (james05) */
/******************************************************************************/

CREATE PROC [RDT].[rdt_PTLCart_Assign_PickslipPosTote_Lottable] (
   @nMobile          INT, 
   @nFunc            INT, 
...
BEGIN
   ...
   ***********************************************************************************************/
   ...
   BEGIN
      ...
      EXEC sp_ExecuteSQL @cSQL, @cSQLParam, 
         @curPD OUTPUT, @nFunc, @cStorerKey, @cPickSlipNo, @cOrderKey, @cLoadKey, @cPickZone, @cFilterLocType, @cPickConfirmStatus
         ...
         BEGIN
            SET @cSQL = 
               ...
               ' SELECT ' + 
                  ...
                  ' @cDPLKey, '''', @cPickSlipNo, @cStorerKey, @cSKU, @cLOC, ISNULL( SUM( PD.QTY), 0), 0, ' + @cGroupBy + 
               CASE 
