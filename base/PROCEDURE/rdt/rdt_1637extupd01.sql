...
/************************************************************************/
/* Store procedure: rdt_1637ExtUpd01                                    */
...
/* 2017-09-21 1.1  James      WMS2990-Add update based on UDF (james01) */  
/*                            Extend PalletKey to 30 chars              */  
/* 2019-09-19 1.2  James      WMS-10587 Change update externcontainerkey*/
/*                            to UserDefine02 (james02)                 */
/************************************************************************/

CREATE PROC [RDT].[rdt_1637ExtUpd01] (
   @nMobile                   INT,           
   @nFunc                     INT,           
...
AS
   ...
   RollBackTran:  
         ROLLBACK TRAN rdt_1637ExtUpd01  
   Quit:  
