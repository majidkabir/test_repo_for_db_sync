...
/************************************************************************/  
/* Store procedure: rdt_NIKE_GETTASK_02                                 */  
/* Copyright      : IDS                                                 */  
/*                                                                      */  
/* Purpose: Get next SKU to Pick                                        */  
/*          ORDER seq as below                                          */  
/*          LOC.LogicalLoc, PickDetail.Loc, PickDetail.OrderKey,        */
/*          SKU.Style, SKU.Color, SKU.BUSR6 (Nike size sequence no.)    */
/*                                                                      */
...
/* 30-May-2016 1.1  James       SOS364904 - Add sort by lot (james01)   */  
/************************************************************************/  

CREATE PROC [RDT].[rdt_NIKE_GETTASK_02] (  
   @n_Mobile                  INT, 
   @n_Func                    INT, 
...
SET CONCAT_NULL_YIELDS_NULL OFF  
   ...
   ORDER BY L.LogicalLocation, PD.LOC, PD.OrderKey, SKU.Style, SKU.Color, SKU.BUSR6, PD.LOT  -- (james01)
