...
/************************************************************************/
/* Store procedure: rdt_808MatrixSP05                                   */
...
BEGIN
   ...
   SELECT @cMethod = V_String3 FROM RDT.rdtmobrec (Nolock) where mobile=@nMobile
