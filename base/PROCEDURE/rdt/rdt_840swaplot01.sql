...
/************************************************************************/
/* Store procedure: rdt_840SwapLot01                                    */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 04-12-2018  1.0  James       WMS-7147. Created                       */
/************************************************************************/

CREATE PROC [RDT].[rdt_840SwapLot01] (
   @n_Mobile         INT, 
...
BEGIN
   ...
   SAVE TRAN rdt_840SwapLot01 -- For rollback or commit only our own transaction  
   ...
   COMMIT TRAN rdt_840SwapLot01
   GOTO Quit
   
   RollBackTran:  
      ROLLBACK TRAN rdt_840SwapLot01  
