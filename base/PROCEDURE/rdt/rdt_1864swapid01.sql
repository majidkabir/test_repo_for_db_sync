...
/******************************************************************************/
/* Store procedure: rdt_1864SwapID01                                          */
/* Copyright      : Maersk                                                    */
/*                                                                            */
/* Modifications log:                                                         */
/*                                                                            */
...
CREATE   PROCEDURE [RDT].[rdt_1864SwapID01] (
   @nMobile       INT,
   @nFunc         INT,
...
*/
   ...
   SAVE TRAN rdt_1864SwapID01 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN rdt_1864SwapID01
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_1864SwapID01
Quit:
