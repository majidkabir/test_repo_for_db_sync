...
/************************************************************************/
/* Store procedure: rdt_728GetNextRec02                                 */
/*                                                                      */
...
CREATE PROC [RDT].[rdt_728GetNextRec02] (
   @nMobile          INT,
   @nFunc            INT, 
   ...
   BEGIN
      ...
      IF @nLoop = 1
         SET @cDisplay01 = LEFT( CAST( @cLLI_LOC AS NVARCHAR( 10)) + SPACE( 10), 10) + 
                           LEFT( CAST( @nLLI_Qty AS NVARCHAR( 5)) + SPACE( 5), 5) + ' ' +
                           LEFT( CAST( @nLLI_Avl AS NVARCHAR( 5)) + SPACE( 5), 5) 
