...
GO
/************************************************************************/
/* Stored Procedure: rdt_840ExtInsPack07                                */
/*                                                                      */
...
/* 2020-03-19   LZG       1.1   INC1082261 - Fixed print by CartonNo    */
/*                              instead of all cartons everytime (ZG01) */
...
CREATE PROC [RDT].[rdt_840ExtInsPack07] (
   @nMobile                   INT, 
   @nFunc                     INT, 
...
BEGIN
   ...
   RollBackTran:  
         ROLLBACK TRAN rdt_840ExtInsPack07  
   Quit:  
