...
/************************************************************************/  
/* Store procedure: rdt_Pick_Cfm_UNI01                                  */  
/* Copyright      : IDS                                                 */  
/*                                                                      */  
...
/* 2013-02-21 1.0  James    SOS270234 - Not auto unallocate when short  */
/*                          pick (james02)                              */
/* 2013-05-22 1.1  James    Cater all pickslip type (james03)           */
/* 2014-04-17 1.2  James    Revamp error no (james04)                   */
/* 2017-07-25 1.3  TLTING   missing NOLOCK                              */
/************************************************************************/  
  
CREATE  PROCEDURE [RDT].[rdt_Pick_Cfm_UNI01] (  
   @nMobile       INT,   
   @nFunc         INT, 
...
SET CONCAT_NULL_YIELDS_NULL OFF  
   ...
   DECLARE @cOrderKey      NVARCHAR(10)   
          ...
          ,@cPH_OrderKey   NVARCHAR( 10)  -- (james03)
          ,@cPH_LoadKey    NVARCHAR( 10)  -- (james03)
...
--  goto fail
   ...
   */  
   ...
   BEGIN  
      ...
      FROM dbo.UCC UCC  
         INNER JOIN RDT.RDTTempUCC T WITH (NOLOCK) ON (UCC.UCCNo = T.UCCNo)  
