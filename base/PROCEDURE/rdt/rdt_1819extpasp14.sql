...
/************************************************************************/
/* Store procedure: rdt_1819ExtPASP14                                   */
...
CREATE PROC [RDT].[rdt_1819ExtPASP14] (
   @nMobile          INT,
   @nFunc            INT,
...
BEGIN
   ...
   BEGIN
      ...
      COMMIT TRAN rdt_1819ExtPASP14 -- Only commit change made here
   END

   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_1819ExtPASP14 -- Only rollback change made here
Quit:
