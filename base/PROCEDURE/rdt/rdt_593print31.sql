...
GO
/***************************************************************************/          
/* Store procedure: rdt_593Print31                                         */          
/*                                                                         */          
/* Modifications log:                                                      */          
/*                                                                         */          
...
CREATE PROC [RDT].[rdt_593Print31] (          
   @nMobile    INT,          
   @nFunc      INT,          
   @nStep      INT,          
...
AS          
   ...
   BEGIN            
      SET @nErrNo = 164403            
      SET @cErrMsg = rdt.rdtgetmessage(@nErrNo ,@cLangCode ,'DSP') --'GenLblSPNoFound'            
      GOTO Quit            
   END       
...
--               END      
               ...
               BEGIN  
                  ...
                  VALUES  
                  (@cPickSlipNo, @nCartonNo, 'CARTON', 0, 0, '')  
...
--      AND StorerKey = @cStorerKey      
      ...
      --         AND StorerKey = @cStorerKey        
               ...
               BEGIN        
                  SET @nErrNo = 164417          
                  SET @cErrMsg = rdt.rdtgetmessage( @nErrNo, @cLangCode, 'DSP') --TemplateNoFound            
                  GOTO Quit            
               END        
...
RollBackTran:            
   ROLLBACK TRAN rdt_593Print31 -- Only rollback change made here            
   EXEC rdt.rdtSetFocusField @nMobile, @nFocusParam      
      
       
Quit:            
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started            
      COMMIT TRAN rdt_593Print31          
   EXEC rdt.rdtSetFocusField @nMobile, @nFocusParam       
