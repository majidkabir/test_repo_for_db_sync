...
/************************************************************************/
/* Store procedure: rdt_838PackCfmSP05                                  */
/* Copyright      : LF Logistics                                        */
/*                                                                      */
/* Date       Rev  Author      Purposes                                 */
/* 2022-11-03 1.0  yeekung    WMS-21057. Created                       */
/************************************************************************/

CREATE   PROC [RDT].[rdt_838PackCfmSP05] (
    @nMobile      INT
   ,@nFunc        INT
...
BEGIN
   ...
   SAVE TRAN rdt_838PackCfmSP05 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN rdt_838PackCfmSP05
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_838PackCfmSP05 -- Only rollback change made here
Quit:
