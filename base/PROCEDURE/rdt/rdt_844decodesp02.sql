...
/************************************************************************/  
/* Store procedure: rdt_844DecodeSP02                                   */  
/* Purpose: Check if user login with printer                            */  
/*                                                                      */  
/* Modifications log:                                                   */  
/*                                                                      */  
/* Date       Rev  Author    Purposes                                   */  
/* 2022-11-15 1.0  yeekung    WMS-20944 Created                         */  																	   
/************************************************************************/  
  
CREATE   PROC [RDT].[rdt_844DecodeSP02] (  
   @nMobile      INT,
   @nFunc        INT,
...
BEGIN
   ...
   IF LEN(@cBarcode)> 14 and substring(@cBarcode,1,2) ='01'
   BEGIN
      SET @cSKU= SUBSTRING(@cBarcode,3,14)
      SET @cBarcode= SUBSTRING(@cBarcode,3,14)
   END
