...
GO
/************************************************************************/
/* Store procedure: rdt_955DropIDDecod01                                */
/* Copyright      : LFLogistics                                         */
/*                                                                      */
/* Purpose: Decode dropid                                               */
/*                                                                      */
/* Date        Rev  Author      Purposes                                */
/* 11-10-2017  1.0  James       WMS3294.Created                         */
/************************************************************************/

CREATE PROCEDURE [RDT].[rdt_955DropIDDecod01]
   @nMobile          INT,
   @nFunc            INT, 
      ...
      BEGIN
         ...
         BEGIN
            ...
            */
            ...
            SET @nErrNo = 0
            SET @cErrMsg1 = SUBSTRING( rdt.rdtgetmessage( 116452, @cLangCode, 'DSP'), 7, 14)
            SET @cErrMsg2 = SUBSTRING( rdt.rdtgetmessage( 116453, @cLangCode, 'DSP'), 7, 14)
            SET @cErrMsg3 = ''
            SET @cErrMsg4 = ''
            SET @cErrMsg5 = ''
