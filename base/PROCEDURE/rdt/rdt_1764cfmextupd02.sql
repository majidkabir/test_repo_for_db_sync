...
/************************************************************************/
/* Store procedure: rdt_1764CfmExtUpd02                                 */
/* Purpose: 1. Stamp TaskDetail.CaseID as UCCNo                         */
/*          2. Stamp PickDetail.DropID as UCCNo                         */
/*                                                                      */
/* Date         Author    Ver.  Purposes                                */
/* 2017-10-25   Ung       1.0   WMS-3133 Created                        */
/************************************************************************/

CREATE PROCEDURE [RDT].[rdt_1764CfmExtUpd02]
    @nMobile            INT 
   ,@nFunc              INT 
...
BEGIN
   ...
   COMMIT TRAN rdt_1764CfmExtUpd02 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_1764CfmExtUpd02 -- Only rollback change made here
Fail:
Quit:
