...
/***************************************************************************/
/* Store procedure: rdt_608RcvCfm02                                        */
...
CREATE PROC [RDT].[rdt_608RcvCfm02](
    @nFunc          INT,              
    @nMobile        INT,              
...
BEGIN
   ...
   SAVE TRAN rdt_608RcvCfm02 -- For rollback or commit only our own transaction
