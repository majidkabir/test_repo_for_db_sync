...
/************************************************************************/  
/* Store procedure: rdt_SortAndPack_Confirm                             */  
/* Copyright: IDS                                                       */  
...
/* 2012-11-29 1.1  James    SOS262231 Insert Packinfo (james01)         */
/* 2012-12-24 1.2  James    Don't pack confirm if SOStatus = 'HOLD'     */
/*                          (james02)                                   */
/* 2013-10-18 1.3  James    SOS287522-Exclude qty from manually created */
/*                          orderline (james03)                         */
/* 2020-06-09 1.4  Ung      WMS-13538 Add PickStatus                    */
/* 2021-04-19 1.5  Chermain WMS-16851 Add Channel_ID when split         */
/*                          pickDetail (cc01)                           */
/************************************************************************/  
  
CREATE PROCEDURE [RDT].[rdt_SortAndPack_Confirm]  
   @nMobile       INT,  
   @nFunc         INT,  
   ...
   @cCartonType   NVARCHAR( 10),     -- (james01)
   @nErrNo        INT  OUTPUT,  
