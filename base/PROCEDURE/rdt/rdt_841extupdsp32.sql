...
/************************************************************************/              
/* Store procedure: rdt_841ExtUpdSP32                                   */              
/* Copyright      : LF                                                  */              
/*                                                                      */              
...
/* 2022-01-05  1.0  yeekung   WMS-21447 Created                         */              
/************************************************************************/              
            
CREATE   PROC [RDT].[rdt_841ExtUpdSP32] (              
   @nMobile     INT,              
   @nFunc       INT,              
...
BEGIN              
   ...
   IF @nStep = 2              
   BEGIN              
      SET @cGenLabelNoSP = rdt.RDTGetConfig( @nFunc, 'GenLabelNoSP', @cStorerkey)              
            ...
            BEGIN              
               ...
               BEGIN              
                  ...
                  VALUES              
                     ...
                     @cLabelNo, @cUCCNo, @cTrackNo, sUser_sName(), GETDATE(), sUser_sName(), GETDATE(),@cUCCNo)              
...
RollBackTran:                    
   ROLLBACK TRAN rdt_841ExtUpdSP32 -- Only rollback change made here                    
                    
Quit:                    
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started                    
      COMMIT TRAN rdt_841ExtUpdSP32                    
END 
