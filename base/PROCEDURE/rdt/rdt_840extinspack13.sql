...
GO
 ...
 /************************************************************************/
 /* Stored Procedure: rdt_840ExtInsPack13                                */
 /*                                                                      */
 ...
 /* 2021-01-04   James     1.0   WMS15988 - Created                      */
 ...
 CREATE PROC [RDT].[rdt_840ExtInsPack13] (
    @nMobile                   INT, 
    @nFunc                     INT, 
 ...
 BEGIN
    ...
    BEGIN
       ...
       BEGIN
          ...
          VALUES
             ...
             'rdt.' + sUser_sName(), GETDATE(), 'rdt.' + sUser_sName(), GETDATE(), @cDropID)
    ...
    RollBackTran:  
         ROLLBACK TRAN rdt_840ExtInsPack13  
   Quit:  
