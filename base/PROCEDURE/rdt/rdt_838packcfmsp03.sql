...
/************************************************************************/
/* Store procedure: rdt_838PackCfmSP03                                  */
...
CREATE PROC [RDT].[rdt_838PackCfmSP03] (
    @nMobile      INT
   ,@nFunc        INT
...
BEGIN
   ...
   SAVE TRAN rdt_838PackCfmSP03 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN rdt_838PackCfmSP03
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_838PackCfmSP03 -- Only rollback change made here
Quit:
