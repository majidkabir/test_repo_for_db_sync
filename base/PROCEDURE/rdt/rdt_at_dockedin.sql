...
/***************************************************************************/              
/* Store procedure: rdt_AT_DockedIn                                        */              
/*                                                                         */              
/* Modifications log:                                                      */              
/*                                                                         */              
...
CREATE   PROC [RDT].[rdt_AT_DockedIn] (              
   @nMobile       INT,                  
   @nFunc         INT,                  
...
AS              
   ...
   BEGIN   
      ...
      BEGIN
         ...
         SET  @cOutField11= CASE WHEN @cActivityStatus = '1' THEN 'Dock In' 
                                 WHEN @cActivityStatus = '9' THEN 'Dock OUT' END
