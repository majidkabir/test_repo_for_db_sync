...
GO
/************************************************************************/  
/* Store procedure: rdt_842ExtUpdSP05                                   */  
/* Copyright      : LF                                                  */  
/*                                                                      */  
...
/* 2018-11-28  1.0  James    WMS-7126 Created                           */  
/* 2020-06-05  1.1  James    WMS-13504 Cater multiple printing process  */
/*                           process (james01)                          */
/* 2021-04-16  1.1  James    WMS-16024 Standarized use of TrackingNo    */
/*                           (james02)                                  */
/************************************************************************/  
  
CREATE PROC [RDT].[rdt_842ExtUpdSP05] (  
   @nMobile        INT,              
   @nFunc          INT,              
...
BEGIN  
      ...
      ****************************/        
      ...
      BEGIN
         ...
         IF EXISTS ( SELECT 1 FROM dbo.Orders WITH (NOLOCK)         
                     WHERE StorerKey = @cStorerKey      
                     AND OrderKey = @cOrderKey       
                     --AND ISNULL(UserDefine04,'')  = '' )  -- (james02)    
   ...
   RollBackTran:      
      ROLLBACK TRAN rdt_842ExtUpdSP05 -- Only rollback change made here      
