...
/******************************************************************************/
/* Store procedure: rdt_593CartonLBL01                                        */
/*                                                                            */
/* Modifications log:                                                         */
/*                                                                            */
/* Date       Rev  Author     Purposes                                        */
/* 2017-04-14 1.0  Ung        WMS-1612 Created                                */
/******************************************************************************/

CREATE PROC [RDT].[rdt_593CartonLBL01] (
   @nMobile    INT,
   @nFunc      INT,
   @nStep      INT,
...
AS
   ...
   -- Pack carton
   EXEC rdt.rdt_593CartonLBL01_Confirm @nMobile, @nFunc, @cLangCode, @cStorerKey, @cFacility, @cOrderKey, @cDropID, 
      @cPickSlipNo OUTPUT, 
      @nCartonNo   OUTPUT, 
      @nErrNo      OUTPUT, 
      @cErrMsg     OUTPUT
