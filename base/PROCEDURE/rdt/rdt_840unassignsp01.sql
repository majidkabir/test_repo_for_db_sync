...
/************************************************************************/
/* Store procedure: rdt_840UnassignSP01                                 */
...
CREATE PROC [RDT].[rdt_840UnassignSP01] (
    @nMobile    INT
   ,@nFunc      INT
...
BEGIN
   ...
   SAVE TRAN rdt_840UnassignSP01 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN rdt_840UnassignSP01
   GOTO Quit
   
RollBackTran:
   ROLLBACK TRAN rdt_840UnassignSP01 -- Only rollback change made here
Quit:
