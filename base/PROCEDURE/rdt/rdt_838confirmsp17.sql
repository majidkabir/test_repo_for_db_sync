...
/******************************************************************************/
/* Store procedure: rdt_838ConfirmSP17                                        */
/* Copyright      : LF Logistics                                              */
/*                                                                            */
/* Date       Rev  Author      Purposes                                       */
/* 23-06-2023 1 1.0  yeekung   WMS-22763 created                              */
/******************************************************************************/

CREATE   PROC [RDT].[rdt_838ConfirmSP17] (
    @nMobile         INT
   ,@nFunc           INT
...
BEGIN
   ...
   SAVE TRAN rdt_838ConfirmSP17 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN rdt_838ConfirmSP17
   GOTO Quit

RollBackTran:
BEGIN
   ROLLBACK TRAN rdt_838ConfirmSP17 -- Only rollback change made here
   IF @cNewCarton = 'Y'
   BEGIN
      SET @nCartonNo = 0
      SET @cLabelNo = ''
