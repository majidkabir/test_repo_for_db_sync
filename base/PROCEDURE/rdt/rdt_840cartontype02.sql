...
GO
/************************************************************************/
/* Store procedure: rdt_840CartonType02                                 */
...
/* 2018-11-03  1.0  James      WMS-7181. Created                        */
/* 2019-09-07  1.1  James      Change Long -> UDF01 (james01)           */
/************************************************************************/

CREATE PROC [RDT].[rdt_840CartonType02] (
   @nMobile          INT,
   @nFunc            INT,
...
AS
   ...
   IF @nStep = 3
   BEGIN
      -- If it is not Move type order then no need input carton type
