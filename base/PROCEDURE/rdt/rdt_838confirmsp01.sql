...
/************************************************************************/
/* Store procedure: rdt_838ConfirmSP01                                  */
/* Copyright      : LF Logistics                                        */
/*                                                                      */
/* Date       Rev  Author      Purposes                                 */
/* 24-05-2017 1.0  Ung         WMS-1919 Created                         */
/* 04-04-2019 1.1  Ung         WMS-8134 Add PackData1..3 parameter      */
/* 30-08-2021 1.2  Chermaine   WMS-17786 Add EventLog (cc01)            */  
/************************************************************************/

CREATE PROC [RDT].[rdt_838ConfirmSP01] (
    @nMobile         INT
   ,@nFunc           INT
...
BEGIN
   ...
   SAVE TRAN rdt_838ConfirmSP01 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN rdt_838ConfirmSP01
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_838ConfirmSP01 -- Only rollback change made here
Quit:
