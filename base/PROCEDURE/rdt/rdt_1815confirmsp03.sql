...
/******************************************************************************/    
/* Store procedure: rdt_1815ConfirmSP03                                       */    
/* Copyright      : LF Logistics                                              */    
/*                                                                            */    
/* Date         Author    Ver.  Purposes                                      */    
/* 2022-01-27   YeeKung   1.0   WMS-18765 Created                             */     
/******************************************************************************/    
    
CREATE PROCEDURE [RDT].[rdt_1815ConfirmSP03]    
   @nMobile          INT,                    
   @nFunc            INT,                    
...
BEGIN    
   ...
   SAVE TRAN rdt_1815ConfirmSP03 -- For rollback or commit only our own transaction    
   ...
   EXECUTE rdt.rdt_Move  
      ...
      @cSourceType = 'rdt_1815ConfirmSP03',   
   ...
   BEGIN  
      ...
      SELECT @c_TaskDetailKey, 'PA1', @cStorerkey, '', '', 0, 0, 0, '',     
         toloc, toid, Finalloc, toid, 'rdt_1815ConfirmSP03',SourceKey, Priority, SourcePriority,    
   ...
   COMMIT TRAN rdt_1815ConfirmSP03 -- Only commit change made here    
   GOTO Quit    
    
RollBackTran:    
   ROLLBACK TRAN rdt_1815ConfirmSP03 -- Only rollback change made here    
Quit:    
