...
/************************************************************************/
/* Store procedure: rdt_TM_CasePick_GetNextTask                         */
/* Copyright      : IDS                                                 */
/*                                                                      */
/* Purpose: Get next full case pick task (only for partial pallet)      */
/*                                                                      */
/* Modifications log:                                                   */
/*                                                                      */
/* Date        Rev  Author    Purposes                                  */
/* 21-Oct-2011 1.0  Ung       SOS327467 Created                         */
/************************************************************************/

CREATE PROC [RDT].[rdt_TM_CasePick_GetNextTask] (
   @nMobile          INT,
   @nFunc            INT,
