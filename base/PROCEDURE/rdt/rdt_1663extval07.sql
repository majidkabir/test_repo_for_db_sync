...
GO
/******************************************************************************/
/* Store procedure: rdt_1663ExtVal07                                          */
...
CREATE PROC [RDT].[rdt_1663ExtVal07](
   @nMobile       INT,
   @nFunc         INT,
         ...
         BEGIN
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  JOIN @tOrders O ON CT.LabelNo = O.OrderKey AND CT.CarrierName = O.ShipperKey
                  WHERE CT.TrackingNo LIKE '%-%'   -- exclude original tracking no which doesn't have '-'
                  AND   NOT EXISTS (
                  ...
                  SET @cErrMsg1 = rdt.rdtGetMessage( 137901, @cLangCode, 'DSP') --Not All Ctn Scanned
                  SET @cErrMsg2 = ''
                  SET @cErrMsg3 = rdt.rdtGetMessage( 137902, @cLangCode, 'DSP') --Top 5 Order With
                  SET @cErrMsg4 = rdt.rdtGetMessage( 137903, @cLangCode, 'DSP') --Missing Carton
