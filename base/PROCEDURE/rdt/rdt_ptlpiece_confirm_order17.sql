...
/************************************************************************/  
/* Store procedure: rdt_PTLPiece_Confirm_Order17                        */  
...
CREATE   PROC [RDT].[rdt_PTLPiece_Confirm_Order17] (  
    @nMobile      INT  
   ,@nFunc        INT  
...
BEGIN  
   ...
   --error lightposition
   SET @cErrlightPos = rdt.RDTGetConfig( @nFunc, 'ErrLgtPos', @cStorerKey) -- (cc01)  
