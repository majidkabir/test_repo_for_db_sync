...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         SET @nErrNo = 167351
         SET @cErrMsg = rdt.rdtgetmessage( @nErrNo, @cLangCode, 'DSP') --Gift sku req
         SET @cOutField02 = @cUserDefine08
         EXEC rdt.rdtSetFocusField @nMobile, 4
         GOTO Quit
      END

      IF @cDtlData2 NOT IN ( @cUserDefine08, @cUserDefine09)
      BEGIN
         SET @nErrNo = 167352
         SET @cErrMsg = rdt.rdtgetmessage( @nErrNo, @cLangCode, 'DSP') --Inv Gift SKU
         SET @cOutField02 = @cUserDefine08
         EXEC rdt.rdtSetFocusField @nMobile, 4
         GOTO Quit
      END
      ...
      BEGIN
         SET @nErrNo = 167353
         SET @cErrMsg = rdt.rdtgetmessage( @nErrNo, @cLangCode, 'DSP') --Inv Grade
         SET @cOutField02 = @cUserDefine08
