...
/************************************************************************/
/* Store procedure: rdt_TN_Mbol_LEVIS                                   */
/* Copyright      : MAERSK                                              */
/*                                                                      */
...
/* 2024-06-14  1.0  Dennis   FCR-396                                    */
/************************************************************************/

CREATE   PROC [RDT].[rdt_TN_Mbol_LEVIS] (
   @nMobile        INT,
   @nFunc          INT,
...
BEGIN
   ...
   ***********************************************************************************************/
   ...
   BEGIN
      ...
      VALUES
         (@cPalletKey, '0', @cLabelNo, @cStorerKey, @cSKU, 'HM-QI', 0, '0', @cOrderKey, @cTrackNo,@cLane)
      IF @@ERROR <> 0
      BEGIN
         SET @nErrNo = 191304
   ...
   BEGIN
      ...
      BEGIN
         ...
         INSERT INTO dbo.MBOL (MBOLKey, ExternMBOLKey, Facility, Status) VALUES (@cMBOLKey, @cLane, @cFacility, '0')
         IF @@ERROR <> 0
         BEGIN
            SET @nErrNo = 191306
