...
/************************************************************************/    
/* Store procedure: rdt_608ExtInfo07                                    */    
/* Copyright      : LF                                                  */    
/*                                                                      */    
...
/* 2020-01-03  1.0  James    WMS-11635. Created                         */
/* 2022-09-08  1.1  Ung      WMS-20348 Expand RefNo to 60 chars         */
/************************************************************************/    

CREATE   PROC [RDT].[rdt_608ExtInfo07] (    
  @nMobile       INT,           
  @nFunc         INT,           
...
BEGIN    
   ...
   BEGIN
      ...
      BEGIN
         ...
         SET @cExtendedInfo = STR( @fUnitPrice, 4, 3) + '/' + SUBSTRING( @cNotes, 1, 15)
      END
   END
