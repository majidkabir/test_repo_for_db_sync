...
/************************************************************************/
/* Store procedure: rdt_841ExtUpdSP07                                   */
/* Copyright      : LF                                                  */
/*                                                                      */
...
/* 2019-01-10  1.0  ChewKP   WMS-7607 Created                           */
/* 2019-06-04  1.1  Ung      Performance tuning                         */
/* 2019-09-24  1.2  James    WMS-10648 Filter SOStatus PENDCANC(james01)*/
/* 2019-11-07  1.3  Ung      LWP-23 Performance tuning                  */
/* 2020-01-03  1.4  James    WMS-11634 Stamp packdetail.labelno to      */
/*                           pickdetail.dropid (james02)                */
/* 2020-05-19  1.5 YeeKung   WMS-13131 Add Cartontype param(yeekung01)  */ 
...
RollBackTran:
   ROLLBACK TRAN rdt_841ExtUpdSP07 -- Only rollback change made here
Quit:
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started
      COMMIT TRAN rdt_841ExtUpdSP07
END
