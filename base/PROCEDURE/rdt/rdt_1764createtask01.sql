...
/************************************************************************/
/* Store procedure: rdt_1764CreateTask01                               */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 09-Aug-2018 1.0  ChewKP    WMS-5178 Created                          */
/************************************************************************/

CREATE PROC [RDT].[rdt_1764CreateTask01] (
   @nMobile        INT,
   @nFunc          INT,
...
--      @cSourceType     = 'rdt_1764CreateTask01'
...
--   SAVE TRAN rdt_1764CreateTask01 -- For rollback or commit only our own transaction
--
...
--               
--               SET @cNewTaskDetailKey = ''
--               FETCH NEXT FROM @curRPTLog INTO @cStorerKey, @cSKU, @cLOT, @nQTY, @cFinalLOC, @cFinalID, @cCaseID, @cOrgTaskKey
--            END
--         END
--         ELSE
--         BEGIN
...
--   END
--
--   COMMIT TRAN rdt_1764CreateTask01 -- Only commit change made here
--   GOTO Quit
--
--RollBackTran:
--   ROLLBACK TRAN rdt_1764CreateTask01 -- Only rollback change made here
--Fail:
--Quit:
