...
/************************************************************************/
/* Store procedure: rdt_PTLCart_Confirm_BatchPos                        */
/* Copyright      : LF Logistics                                        */
/*                                                                      */
/* Purpose: Confirm base on batch, position                             */
/*                                                                      */
/* Date       Rev  Author      Purposes                                 */
/* 29-03-2019 1.0  Ung         WMS-8024 Created                         */
/************************************************************************/

CREATE PROC [RDT].[rdt_PTLCart_Confirm_BatchPos] (
    @nMobile    INT
   ,@nFunc      INT
   ...
   ***********************************************************************************************/
   ...
   BEGIN
      ...
      BEGIN
         ...
         SAVE TRAN rdt_PTLCart_Confirm_BatchPos -- For rollback or commit only our own transaction
         ...
         -- Commit order level
         COMMIT TRAN rdt_PTLCart_Confirm_BatchPos
...
RollBackTran:
   ROLLBACK TRAN rdt_PTLCart_Confirm_BatchPos -- Only rollback change made here
Quit:
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started
      COMMIT TRAN
END
