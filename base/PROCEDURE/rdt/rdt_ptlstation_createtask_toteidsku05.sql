...
/************************************************************************/
/* Store procedure: rdt_PTLStation_CreateTask_ToteIDSKU05               */
...
CREATE PROC [RDT].[rdt_PTLStation_CreateTask_ToteIDSKU05] (
    @nMobile      INT
   ,@nFunc        INT
   ...
   SET @curPD = CURSOR LOCAL FAST_FORWARD READ_ONLY FOR
      SELECT PD.OrderKey, SUM( PD.QTY)
         ...
         WHERE LOC.Facility = @cFacility
            ...
            AND O.Status <> 'CANC' 
            AND O.SOStatus <> 'CANC'
         GROUP BY PD.OrderKey, PD.ID, PD.SKU
   OPEN @curPD
      ...
      BEGIN
         ...
         BEGIN
            ...
            VALUES (
               ...
               @cOrderKey, @cStorerKey, @cScanSKU, @nPDQty, 0,  @cScanID, @nFunc, @nRowRef, 'rdt_PTLStation_CreateTask_ToteIDSKU05')
            IF @@ERROR <> 0
            BEGIN
               SET @nErrNo = 146753
