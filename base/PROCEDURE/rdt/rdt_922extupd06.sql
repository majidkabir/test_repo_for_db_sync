...
/***************************************************************************************************/
/* Store procedure: rdt_922ExtUpd06                                                                */
/* Copyright      : Maersk                                                                         */
/*                                                                                                 */
...
CREATE   PROC rdt.rdt_922ExtUpd06 (
   @nMobile     INT,
   @nFunc       INT,
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               SAVE TRAN rdt_922ExtUpd06 -- For rollback or commit only our own transaction
               ...
               ***********************************************************************************************/
               ...
               COMMIT TRAN rdt_922ExtUpd06 -- Only commit change made here
            END
         END
      END
   END
...
RollBackTran:
   ROLLBACK TRAN rdt_922ExtUpd06 -- Only rollback change made here
Quit:
