...
/************************************************************************/      
/* Store procedure: rdt_840ExtUpd28                                     */      
/* Purpose: 1. update tracking no to packinfo.trackingno                */  
/*          2. EXEC isp_AssignPackLabelToOrderByLoad                    */      
/*                                                                      */
/* Modifications log:                                                   */      
/*                                                                      */      
/* Date       Rev  Author     Purposes                                  */      
/* 2023-06-05 1.0  ZQ         WMS-22756 Combine rdt_840ExtUpd08         */
/*                            and rdt_840ExtUpd02                       */      
/************************************************************************/      
      
CREATE   PROC [RDT].[rdt_840ExtUpd28] (      
   @nMobile     INT,      
   @nFunc       INT,       
...
AS      
   ...
   BEGIN      
      ...
      BEGIN      
         ...
         SAVE TRAN rdt_840ExtUpd28 -- For rollback or commit only our own transaction      
         ...
         COMMIT TRAN rdt_840ExtUpd28      
      
         GOTO Commit_Tran      
      
         RollBackTran:      
            ROLLBACK TRAN rdt_840ExtUpd28 -- Only rollback change made here      
         Commit_Tran:      
