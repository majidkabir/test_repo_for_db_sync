...
/************************************************************************/
/* Store procedure: rdt_513ExtVal03                                     */
/* Copyright: LF Logistics                                              */
/*                                                                      */
/* Date       Rev  Author     Purposes                                  */
/* 2017-02-17 1.0  Ung        WMS-961 Created                           */
/************************************************************************/

CREATE PROC [RDT].[rdt_513ExtVal03] (
   @nMobile         INT,          
   @nFunc           INT,          
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            EXEC rdt.rdtInsertMsgQueue @nMobile, @nErrNo OUTPUT, @cErrMsg OUTPUT, '106251 ', @cErrMsg
            GOTO Quit
         END
      END
   END
