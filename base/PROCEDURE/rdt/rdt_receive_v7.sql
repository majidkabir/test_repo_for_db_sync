...
/******************************************************************************/  
/* Store procedure: rdt_Receive_V7                                            */  
...
/*            1.1  FKLim/Vicky Added New Coding                               */  
/* 2007-09-20 1.2  Shong       SOS# 87068 Comment TrafficCop                  */  
/* 2008-07-16 1.3  Leong       SOS# 111756 - check over receive for           */  
/*                                           Trade Return                     */  
/* 2008-07-28 1.4  Leong       SOS# 112522 - update ReceiptDetail for         */  
/*                             doctype = 'R'                                  */  
/* 2008-09-22 1.5  Vicky       SOS#105011 - Skip prompting error msg of       */  
/*                             duplicate UCC if configkey                     */  
/*                             "SkipCheckMultiUCC" = 1 (Vicky02)              */  
/*                             - Add in POKey filtering when update UCC       */  
/* 2008-11-24 1.6  Vicky       Bug Fix on @@ROWCOUNT- replace with            */  
/*                             @nCnt of @tRD (Vicky03)                        */  
/* 2008-12-01 1.7  Vicky       SOS#105011 - Add configkey                     */  
/*                             "IncludePOKeyFilter" to allow filtering        */  
/*                             by POKey (Vicky04)                             */  
/* 2009-12-17 1.8  Leong       SOS#129347-Insert POKey to ReceiptDetail       */  
/* 2010-12-22 1.9  ChewKP      SOS#199529-Fixes & Enhancement(ChewKP01)       */  
/* 2011-11-23 2.0  Ung         SOS#230666                                     */  
/*                             Implement storer config SkipLottable0X         */  
/* 2012-07-13 2.1  Leong       SOS# 249945 - Bug Fix on UCC.ReceiptLineNumber.*/  
/* 2013-01-04 2.2  ChewKP      SOS# 266264 - Receive to Matching line when    */  
/*                             RDT.Storerconfig 'OverReceiptToMatchLine' is   */  
/*                             turn on (ChewKP02)                             */  
/* 2013-04-11 2.3  James       SOS275027 - Bypass ASNStatus checking (james02)*/  
/* 2012-09-12 2.4  Ung         SOS255639 Add ClosePallet                      */  
/*                             Add UCC receive on multi ReceiptDetail lines   */  
/*                             Add UCCWithMultiSKU                            */  
/* 2013-06-11 2.5  Ung         SOS279908 Add ReceiptDetailFilterSP            */  
/*                             Remove check Receipt.Status for RDT finalize   */  
/* 2014-02-26 2.6  Ung         SOS301005                                      */  
/*                             Add custom sorting in ReceiptDetailFilterSP    */  
/*                             Add custom SP in DuplicateFromMatchValue       */  
/* 2015-02-04 2.7  ChewKP      SQL 2012 Fixes (ChewKP03)                      */  
/* 2015-06-08 2.8  Ung         SOS343433 Update new ReceiptLineNumber in @tRD */  
/* 2015-06-12 2.9  Ung         SOS342914 Call ispFinalizeReceipt              */  
/* 2014-12-01 3.0  Ung         SOS317571 Add lottable06-15                    */  
/*                             Remove SkipLottable0X                 */  
/*                             Fix receive to line already finalized          */  
/* 2015-09-08 3.1  Ung         SOS352968 Fix LottableCode without StorerKey   */  
/* 2016-02-01 3.2  Ung         SOS362783 Fix insert duplicate PKReceiptDetail */  
/* 2016-01-29 3.3  Ung         SOS362473 Remove RDT_NotFinalizeReceiptDetail  */  
/*                             Add FinalizeReceiptDetail (by Func ID)         */  
/* 2016-04-28 3.4  Ung         SOS368437 Fix SUSR4 is decimal                 */  
/* 2016-06-02 3.5  Leong       IN00061158 - Extend column size.               */  
/* 2017-06-22 3.6  Ung         WMS-2230 Add sub reason                        */  
/* 2017-07-13 3.7  Ung         Performance tuning                             */  
/* 2018-01-26 3.8  James       WMS3756 Change DisAllowDuplicateIdsOnRFRcpt    */  
/*                             to RDT config CheckIDInUse (james03)           */  
/* 2018-03-06 3.9  ChewKP      WMS-3872 Add Channel colum (cheWKP04)          */  
/* 2019-03-21 4.0  Ung         INC0560080 Add RowVer for concurrent receive   */  
/*                             Missing (NOLOCK)                               */  
/* 2019-05-27 4.1  James       WMS-9128 Add ASNStatus 1 (james04)             */  
/* 2019-09-19 4.2  James       WMS-10122 Add serial no feature (james05)      */    
/* 2019-10-08 4.3  Ung         WMS-10743 DuplicateFromMatchValue copy lottable*/  
/* 2019-10-29 4.4  Ung         INC0908347 Fix over receive offset not reduce  */  
/* 2019-10-08 4.5  Ung         WMS-10643 Allow_OverReceipt by DocType         */    
/* 2019-10-17 4.6  YeeKung     WMS-10667 byPassTolerance by DocType (yeekung01)*/    
/* 2020-04-09 4.7  Ung         LWP-96 Performance tuning                      */  
/* 2020-02-03 4.8  Chermaine   WMS-16136 passIn facility on nspGetRight       */  
...
IF PATINDEX( '%ORDER BY%', @cCustomSQL) = 0  
   ...
   --NICK
   DECLARE @NICKMSG NVARCHAR(4000)
   SET @NICKMSG = CONCAT_WS(',', 'rdt_Receive_V7', @cCustomSQL )
...
ELSE  
BEGIN  
   COMMIT TRAN rdt_Receive_V7 -- Only commit change made in here  
   GOTO Quit  
END  
  
RollBackTran:  
   ROLLBACK TRAN rdt_Receive_V7  
Fail:  
Quit:  
