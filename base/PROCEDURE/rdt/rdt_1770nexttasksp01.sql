...
/************************************************************************/
/* Store procedure: rdt_1770NextTaskSP01                                */
/* Copyright      : LFLogistics                                         */
/*                                                                      */
/* Purpose: Generate next task, if current task is transit              */
/*                                                                      */
/* Date       Rev  Author     Purposes                                  */
/* 15-11-2017 1.0  Ung        WMS-3007 Created                          */
/************************************************************************/

CREATE PROC [RDT].[rdt_1770NextTaskSP01] (
   @nMobile        INT,
   @nFunc          INT,
...
BEGIN
   ...
   SELECT TOP 1 
      ...
      @cSourceType     = 'rdt_1770NextTaskSP01'
   ...
   SAVE TRAN rdt_1770NextTaskSP01 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN rdt_1770NextTaskSP01 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_1770NextTaskSP01 -- Only rollback change made here
Fail:
Quit:
