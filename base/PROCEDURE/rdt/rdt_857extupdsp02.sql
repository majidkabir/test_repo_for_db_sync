...
GO
/************************************************************************/
/* Store procedure: rdt_857ExtUpdSP02                                   */
/* Copyright      : LF                                                  */
/*                                                                      */
...
/* 2018-04-19  1.0  ChewKP   WMS-4700 Created                           */
/* 2019-01-02  1.1  Leong    INC0527496 - Bug Fix.                      */
/************************************************************************/

CREATE PROC [RDT].[rdt_857ExtUpdSP02] (
   @nMobile        INT,
   @nFunc          INT,
...
--            END
   ...
   RollBackTran:
   ROLLBACK TRAN rdt_857ExtUpdSP02

   Quit:
   WHILE @@TRANCOUNT>@nTranCount -- Commit until the level we started
          COMMIT TRAN rdt_857ExtUpdSP02
