...
GO
/************************************************************************/
/* Store procedure: rdt_ClusterPickCfm04                                */
/* Copyright      : IDS                                                 */
/*                                                                      */
/* Purpose: Comfirm Pick & Insert packdetail                            */
/*          with Labelno=Dropid (enhancement)                           */
/*                                                                      */
...
/* 16-Nov-2015 1.0  James       SOS354305 - Created                     */
/* 23-Feb-2017 1.1  James       Perfomance tuning (james01)             */
/* 14-Apr-2017 1.2  James       WMS1626-Stamp pickdetail.caseid(james02)*/
/************************************************************************/

CREATE PROC [RDT].[rdt_ClusterPickCfm04] (
   @nMobile                   INT,           
   @nFunc                     INT,           
