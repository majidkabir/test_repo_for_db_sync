...
/******************************************************************************/
/* Store procedure: rdt_807ExtPA03                                            */
/*                                                                            */
/* Modifications log:                                                         */
/*                                                                            */
...
CREATE PROC [RDT].[rdt_807ExtPA03] (
   @nMobile          INT,
   @nFunc            INT,
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            SAVE TRAN rdt_807ExtPA03 -- For rollback or commit only our own transaction
            ...
            COMMIT TRAN rdt_807ExtPA03 -- Only commit change made here
         END
...
RollBackTran:
   ROLLBACK TRAN rdt_807ExtPA03 -- Only rollback change made here
Quit:
