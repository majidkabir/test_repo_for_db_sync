...
/************************************************************************/              
/* Store procedure: rdt_841ExtUpdSP09                                   */              
/* Copyright      : LF                                                  */              
/*                                                                      */              
...
/* 2019-04-01  1.0  ChewKP   WMS-8418 Created                           */              
/* 2019-07-06  1.1  Chermaine WMS-13977 Change printing method (cc01)   */      
/* 2020-05-19  1.2  YeeKung  WMS-13131 Add Cartontype param(yeekung01)  */              
/* 2020-09-10  1.3  James    WMS-14657 Add filter pick status 3(james01)*/      
/* 2020-10-23  1.4  YeeKung  Fix Pack QTY more than pick qty (yeekung01)*/      
/* 2021-04-01  1.5  YeeKung  WMS-16718 Add serialno and serialqty       */      
/*                           Params (yeekung02)                         */      
/* 2021-04-16  1.6  James    WMS-16024 Standarized use of TrackingNo    */      
/*                           (james02)                                  */      
/* 2021-04-01  1.7  YeeKung  WMS-16718 Add serialno and serialqty       */
/*                           Params (yeekung02)                         */
/* 2021-07-27  1.8  Chermain WMS-17410 Add VariableTable Param (cc01)   */
/************************************************************************/              
            
CREATE   PROC [RDT].[rdt_841ExtUpdSP09] (              
   @nMobile     INT,              
   @nFunc       INT,              
...
--         --VALUES ( 'rdt_841ExtUpdSP09', GetDate() , '1' , @cOrderKey, @cOrderType )              
--              
--         -- Build PrintJob for RDT Spooler --              
--         IF @cOrderType = 'TMALL'              
--         BEGIN              
...
--              
--            --INSERT INTO TRACEINFO (TraceName, TimeIn, Step1 , Step2, Step3 )              
--            --VALUES ( 'rdt_841ExtUpdSP09', GetDate() , '1.1' , @cOrderKey, @cSOStatus )              
--              
--   -- P01)              
--   --         IF EXISTS ( SELECT 1 FROM dbo.Orders WITH (NOLOCK)              
--   --                     WHERE OrderKey = @cOrderKey              
...
--               --VALUES ( 'rdt_841ExtUpdSP09', GetDate() , '1.2' , @cOrderKey, @cSOStatus, @cStorerKey )              
--              
--               UPDATE dbo.Orders WITH (ROWLOCK)              
--                  SET SOStatus= '0',             
--                      TrafficCop = NULL,             
--                      EditWho    = SUSER_SNAME(),             
--                      EditDate   = GETDATE()         --               WHERE OrderKey = @cPrevOrderkey              
--               AND StorerKey = @cStorerKey              
--              
--               IF  @@ERROR <> 0              
--               BEGIN              
...
--   --            VALUES ( 'rdt_841ExtUpdSP09', GetDate() , '1.3' , @cOrderKey, @cSOStatus, @cStorerKey )              
--   --         END              
--         END              
--              
--         IF EXISTS ( SELECT 1 FROM dbo.CodeLkup WITH (NOLOCK)              
...
RollBackTran:                    
   ROLLBACK TRAN rdt_841ExtUpdSP09 -- Only rollback change made here                    
                    
Quit:                    
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started                    
      COMMIT TRAN rdt_841ExtUpdSP09                    
