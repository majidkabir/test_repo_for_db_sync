...
/************************************************************************/    
/* Store procedure: rdt_PTLPiece_Confirm_Batch                          */    
...
CREATE PROC [RDT].[rdt_PTLPiece_Confirm_Batch] (    
    @nMobile      INT    
   ,@nFunc        INT    
...
BEGIN    
   ...
   SET @cOrderKey = ''    
   SELECT TOP 1     
     @cReceiptkey=L.UserDefine03   
     ,@nQty=l.UserDefine02  
   FROM rdt.rdtPTLPieceLog L WITH (NOLOCK)     
      JOIN receipt R WITH (NOLOCK) ON (R.UserDefine10 = L.BatchKey)    
