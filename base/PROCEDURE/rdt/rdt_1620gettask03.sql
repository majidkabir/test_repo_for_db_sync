...
/************************************************************************/  
/* Store procedure: rdt_1620GETTASK03                                   */  
/* Copyright      : IDS                                                 */  
/*                                                                      */  
...
CREATE PROC [RDT].[rdt_1620GETTASK03] (  
   @n_Mobile                  INT, 
   @n_Func                    INT, 
...
SET CONCAT_NULL_YIELDS_NULL OFF  
   ...
   DECLARE @cPrefUOM    NVARCHAR( 10)

   SELECT @cPrefUOM = V_UOM FROM RDT.RDTMOBREC WITH (NOLOCK) WHERE Mobile = @n_Mobile
