...
/******************************************************************************/
/* Store procedure: rdt_1764SwapUCC01                                         */
/* Copyright      : IDS                                                       */
/*                                                                            */
...
/* 29-11-2018  1.0  Ung         INC0486759 Split from ispCarterRPFDecode      */
/* 19-02-2019  1.1  James       WMS-8040 Add custom checking condition        */
/*                              on swap ucc (james01)                         */
/* 10-10-2019  1.2  Ung         WMS-10858 Fix swap UCC not update RFPutaway   */
/* 19-10-2019  1.3  Ung         WMS-10858 Fix swap UCC not update LOTxLOCxID  */
/******************************************************************************/

CREATE PROCEDURE [RDT].[rdt_1764SwapUCC01]
   @nMobile          INT,
   @nFunc            INT,
...
CommitTran:
   ...
   COMMIT TRAN rdt_1764SwapUCC01
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_1764SwapUCC01
Fail:
   SET @nUCCQTY = 0 
Quit:
