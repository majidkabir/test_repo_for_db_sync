...
/*********************************************************************************/
/* Store procedure: rdt_600ExtScnJCB                                             */
/* Copyright      : Maersk                                                       */
/* Customer       : JCB                                                          */
/* Remarks        : Create base on rdt_600ExtScn01                               */
/*                                                                               */
/*                                                                               */
/* Date       Rev  Author   Purposes                                             */
/* 2025-02-26 1.0  PPA374   UWP-30939 ID having multiple Lottable03 validation   */
/*********************************************************************************/

CREATE     PROC [RDT].[rdt_600ExtScnJCB] (
   @nMobile      INT,           
   @nFunc        INT,           
