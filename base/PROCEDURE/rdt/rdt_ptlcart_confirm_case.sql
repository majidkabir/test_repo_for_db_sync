...
/************************************************************************/
/* Store procedure: rdt_PTLCart_Confirm_Case                            */
...
/* 04-12-2018 1.1  Ung         WMS-6818 Fix short pick                  */
/* 26-05-2018 1.2  Ung         Change to PTL.Schema                     */
/* 15-04-2019 1.3  ChewKP      WMS-8593 Add EventLog (ChewKP01)         */
/************************************************************************/

CREATE PROC [RDT].[rdt_PTLCart_Confirm_Case] (
    @nMobile    INT
   ,@nFunc      INT
   ...
   ***********************************************************************************************/
   ...
   BEGIN
      ...
      BEGIN
         ...
         SAVE TRAN rdt_PTLCart_Confirm_Case -- For rollback or commit only our own transaction
         ...
         -- Commit order level
         COMMIT TRAN rdt_PTLCart_Confirm_Case
...
RollBackTran:
   ROLLBACK TRAN rdt_PTLCart_Confirm_Case -- Only rollback change made here
Quit:
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started
      COMMIT TRAN
END
