...
/**************************************************************************/
/* Store procedure: rdt_600ExtScn03_NICK                                       */
...
/* 2025-02-11 1.5.0  NLT013   FCR-1952 Execute function for ShelfLife calculation   */
/**************************************************************************/

CREATE PROC [RDT].[rdt_600ExtScn03_NICK] (
   @nMobile      INT,           
   @nFunc        INT,           
...
BEGIN
   ...
   DECLARE @NICKMSG NVARCHAR(200)
	--rdt_600ExtScn03-1,@cLottable07 :AAC,@cRectype :IBD,@cLottable12 :,@dLottable04 :2028-11-20 00:00:00.000,@dLottable13 :
    SET @NICKMSG = CONCAT_WS(',', 'rdt_600ExtScn03-1', '@cLottable07 :' + @cLottable07,
		'@cRectype :' + ISNULL(@cRectype, ''),
		'@cStorerKey :' + @cStorerKey,
						'@cSKU :' + @cSKU,
			'@cLottable12 :' + ISNULL(@cLottable12, ''),
			'@dLottable04 :' + CONVERT(NVARCHAR(30), @dLottable04,121),
						'@dLottable13 :' + CONVERT(NVARCHAR(30), @dLottable13,121)
			)
                  ...
                  BEGIN
                     SELECT @cLottable07 = [dbo].[fnc_CalcShelfLifeBUD]  (@cStorerKey, @cSKU, @dLottable04, @dLottable13)

					 --rdt_600ExtScn03-2,@cLottable07 :,@cStorerKey :NKST,@cSKU :NNFG004,@dLottable04 :2028-11-20 00:00:00.000,@dLottable13 :
					 SET @NICKMSG = CONCAT_WS(',', 'rdt_600ExtScn03-2', '@cLottable07 :' + @cLottable07,
						'@cStorerKey :' + @cStorerKey,
						'@cSKU :' + @cSKU,
						'@dLottable04 :' + CONVERT(NVARCHAR(30), @dLottable04,121),
						'@dLottable13 :' + CONVERT(NVARCHAR(30), @dLottable13,121)
               ...
               END
               SET @cLottable06 = IIF ( @cLottable07 <> 'ML13', '1', '0' )
