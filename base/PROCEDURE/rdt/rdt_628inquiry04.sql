...
/************************************************************************/    
/* Store procedure: rdt_628Inquiry04                                    */    
/* Copyright      : IDS                                                 */    
/*                                                                      */    
...
/* 2019-08-30 1.0  James    WMS-10415. Created                          */
/************************************************************************/    
    
CREATE PROCEDURE [RDT].[rdt_628Inquiry04] (    
   @nMobile         INT,
   @nFunc           INT,
   ...
   SELECT @cExecStatements = @cExecStatements + 
      ...
      ' AND   1 = CASE WHEN LLI.PendingMoveIN > 0 THEN 1
                  WHEN LLI.PendingMoveIN = 0 AND 
                      (LLI.QTY <> 0 OR LLI.QtyAllocated <> 0 OR LLI.QtyPicked <> 0 OR LLI.QtyExpected <> 0) THEN 1
             ELSE 0 END ' 
