...
/************************************************************************/
/* Store procedure: rdt_1812SwapID02                                    */
...
/************************************************************************/
CREATE PROCEDURE [RDT].[rdt_1812SwapID02]
   @nMobile           INT,
   @nFunc             INT,
   ...
   */
   ...
   BEGIN
      ...
      SET
         ...
         EditWho = SUSER_SNAME(), 
         TrafficCop = NULL
      WHERE TaskDetailKey = @cOtherPickDetailKey
         AND Status = '0'
...
CommitTran:
   COMMIT TRAN rdt_1812SwapID02
   GOTO Quit
RollBackTran:
      ROLLBACK TRAN rdt_1812SwapID02
Quit:
