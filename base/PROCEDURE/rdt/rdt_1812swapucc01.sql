...
/******************************************************************************/
/* Store procedure: rdt_1812SwapUCC01                                         */
/* Copyright      : IDS                                                       */
/*                                                                            */
/* Date        Rev  Author      Purposes                                      */
/* 27-02-2019  1.0  Ung         WMS-8058 Created                              */
/******************************************************************************/

CREATE PROCEDURE [RDT].[rdt_1812SwapUCC01]
   @nMobile          INT,
   @nFunc            INT,
...
*/
   ...
   COMMIT TRAN rdt_1812SwapUCC01
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_1812SwapUCC01
Fail:
   SET @nUCCQTY = 0 
Quit:
