...
/* 18-Sep-2018 1.0  ZhengGang   INC0387458 Duplicate from old version   */
/*                              rdt_ClusterPickCfm02 for storer 4CARE.  */
/************************************************************************/

CREATE PROC [RDT].[rdt_ClusterPickCfm11] (
   @nMobile                   INT,
   @nFunc                     INT,
...
--   ('cfm', getdate(), @cStorerKey, @cOrderKey, @cSKU, @cLOT, @cLOC, @cUserName, @cPutAwayZone, @cPickZone)
