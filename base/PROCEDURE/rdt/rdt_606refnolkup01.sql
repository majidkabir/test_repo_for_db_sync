...
/******************************************************************************/
/* Store procedure: rdt_606RefNoLKUP01                                        */
/* Copyright      : LF Logistics                                              */
/*                                                                            */
/* Purpose: Extended putaway                                                  */
/*                                                                            */
/* Date        Author   Ver.  Purposes                                        */
/* 2020-04-13  James    1.0   WMS-12749 Created                               */
/******************************************************************************/

CREATE PROCEDURE [RDT].[rdt_606RefNoLKUP01]
   @nMobile      INT,
   @nFunc        INT,
...
BEGIN
   ...
   OPEN @curColumn
   FETCH NEXT FROM @curColumn INTO @cColumnName, @cUDF02
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF @cUDF02 <> ''
            SET @cUDF02 = REPLACE( @cUDF02, '@cRefNo', @cColumnName)
...
RollBackTran:  
   ROLLBACK TRAN rdt_606RefNoLKUP01 
Fail:  
Quit:  
