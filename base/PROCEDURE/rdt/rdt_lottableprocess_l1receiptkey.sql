...
/******************************************************************************/
/* Store procedure: rdt_LottableProcess_L1ReceiptKey                          */
/* Copyright      : LF Logistics                                              */
/*                                                                            */
/* Purpose: Use L11 to track trade return ASN                                 */
/*                                                                            */
/* Date        Author    Ver.  Purposes                                       */
/* 28-08-2018  Ung       1.0   WMS-5956 Created                               */
/******************************************************************************/

CREATE PROCEDURE [RDT].[rdt_LottableProcess_L1ReceiptKey]
    @nMobile          INT
   ,@nFunc            INT
