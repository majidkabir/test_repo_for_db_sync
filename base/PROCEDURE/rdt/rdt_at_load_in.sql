...
/***************************************************************************/              
/* Store procedure: rdt_AT_Load_IN                                          */              
/*                                                                         */              
/* Modifications log:                                                      */              
/*                                                                         */              
...
CREATE PROC [RDT].[rdt_AT_Load_IN] (              
   @nMobile       INT,                  
   @nFunc         INT,                  
      ...
      BEGIN
         ...
         BEGIN
            ...
            SET drivername=@cInput01,
                  ...
                  status = @cNewStatus,
                  signintime =  CASE WHEN @cActivityStatus='1' then getdate() else signintime end,
                  unloadtime = CASE WHEN @cActivityStatus='9' then getdate() else unloadtime end
            WHERE BOOKINGNO=@cRefNo1
