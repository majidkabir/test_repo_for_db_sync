...
GO
/************************************************************************/
/* Store procedure: rdt_PickSuggLoc01                                   */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 08-03-2013  1.0  James       SOS276108 Created                       */
/* 20-07-2016  1.1  James       IN00099973 Bug fix (james01)            */
/* 09-07-2021  1.2  Chermaine   WMS-17140 Add fn1854 (cc01)             */
/************************************************************************/

CREATE PROC [RDT].[rdt_PickSuggLoc01] (
   @nMobile                   INT,
   @nFunc                     INT, 
...
BEGIN
   ...
   SET @cPickType =   
      CASE @nFunc  
         ...
         WHEN 1854 THEN 'P' --Pallet_v7  --(cc01)
      END  
