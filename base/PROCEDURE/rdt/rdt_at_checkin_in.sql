...
CREATE PROC [RDT].[rdt_AT_CheckIN_IN] (              
   @nMobile       INT,                  
   @nFunc         INT,                  
...
AS              
   ...
   DECLARE @cDoorBooking NVARCHAR(20),
           ...
           @cApptNO      NVARCHAR(20),
           @cHauler      NVARCHAR(20),
           @cBookingDate DATETIME,
           @cLoadingBay  NVARCHAR(20),
           @cCarPlate    NVARCHAR(20),
           @cDriverName  NVARCHAR(20),
   ...
   BEGIN 
      ...
      BEGIN
         ...
         SELECT   @cOutField01 = 'Appt No:',
                  @cOutField02 = bookingno,
                  @cOutField03 = 'Driver Name:',
                  @cOutField04 =  DriverName,
                  @cOutField05 = 'License No:',
                  @cOutField06 = userdefine01
         FROM Booking_IN (NOLOCK)
         WHERE bookingno=@cRefNo1
      ...
      BEGIN
         ...
         BEGIN
            ...
            SET drivername=@cInput01,
                  userdefine01=@cInput02,
                  status = @cNewStatus,
                  arrivedtime = CASE WHEN @cActivityStatus='1' then getdate() else arrivedtime end,
                  departtime = CASE WHEN @cActivityStatus='9' then getdate() else departtime end
            WHERE BOOKINGNO=@cRefNo1
            ...
            Values(@cRefNo1,'I',GETDATE(),GETDATE(),GETDATE(),@cLong,@cInput01,@cInput02,@cEventCode,@cActivityStatus)
            ...
            BEGIN
               ...
               Values(@cRefNo1,'I',GETDATE(),@cUserName,@cInput01,@cInput02)
