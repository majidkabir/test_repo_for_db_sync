...
/************************************************************************/
/* Stored Procedure: rdt_840ExtInsPack09                                */
/*                                                                      */
...
/* 2020-03-27   James     1.0   WMS12654 - Created                      */
...
CREATE PROC [RDT].[rdt_840ExtInsPack09] (
   @nMobile                   INT, 
   @nFunc                     INT, 
...
BEGIN
   ...
   RollBackTran:  
         ROLLBACK TRAN rdt_840ExtInsPack09  
   Quit:  
