...
/************************************************************************/  
/* Store procedure: rdt_TM_Assist_ClusterPick_MatrixV2                  */  
/* Copyright      : Maersk                                              */  
/*                                                                      */  
...
CREATE   PROC [RDT].[rdt_TM_Assist_ClusterPick_MatrixV2] (  
   @nMobile        INT,  
   @nFunc          INT,  
   ...
   BEGIN  
      ...
      BEGIN  
         SET @cSQL = 'EXEC rdt.' + RTRIM( @cMatrixSP) +  
            ...
            ' @cFacility, @cStorerKey, @cPickZone, @cCartID, @cMethod, @cGroupKey, ' +   
