...
/***************************************************************************/
/* Store procedure: rdt_EcomReturn_CaptureDetailInfo                       */
/* Copyright      : LF Logistics                                           */
/*                                                                         */
/* Date       Rev  Author  Purposes                                        */
/* 2021-05-04 1.0  James   WMS-16735. Created                              */
/***************************************************************************/

CREATE PROC [RDT].[rdt_EcomReturn_CaptureDetailInfo](
   @nMobile      INT,           
   @nFunc        INT,           
...
BEGIN
   ...
   DECLARE @cCaptureReceiptDetailInfoSP NVARCHAR(30)
   ...
   ***********************************************************************************************/
   ...
   BEGIN
      IF EXISTS( SELECT 1 FROM dbo.sysobjects WHERE name = @cCaptureReceiptDetailInfoSP AND type = 'P')
      BEGIN
         SET @cSQL = 'EXEC rdt.' + RTRIM( @cCaptureReceiptDetailInfoSP) +
