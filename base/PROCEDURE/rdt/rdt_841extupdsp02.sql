...
/************************************************************************/      
/* Store procedure: rdt_841ExtUpdSP02                                   */      
/* Copyright      : LF                                                  */      
/*                                                                      */      
...
/* 2015-04-01  1.0  ChewKP   SOS#336932 Created                         */      
/* 2015-08-10  1.1  ChewKP   SOS#349748 - Allow Pickdetail.Status = '3' */        
/*                           for DTC (ChewKP01)                         */           
/* 2015-08-24  1.2  Ung      SOS350720 Add BackendPickConfirm           */      
/* 2015-10-30  1.3  ChewKP   Performance Tuning (ChewKP02)              */    
/* 2016-10-10  1.4  ChewKP   Performance Tuning (ChewKP03)              */    
/* 2016-10-25  1.5  Ung      Performance Tuning                         */    
/* 2016-11-11  1.6  Ung      Bypass print if printer is PDF             */    
/* 2017-10-17  1.7  JyhBin   Bypass print if printer is not blank       */    
/* 2017-10-26  1.8  ChewKP   Swap printing sequence with Pack confirm   */    
/*                           (ChewKP05)                                 */    
/* 2020-05-18  1.9  James    WMS-13201 Add invoice printing (james01)   */   
/* 2020-05-19  2.0  YeeKung  WMS-13131 Add Cartontype param(yeekung01)  */   
/* 2020-09-05  2.1  James    WMS-15010 Add AutoMBOLPack (james02)       */  
/* 2021-02-01  2.2  James    WMS-16272 Add prompt on SUSR3 (james03)    */  
/* 2021-04-16  2.3  James    WMS-16024 Standarized use of TrackingNo    */  
/*                           (james04)                                  */  
/* 2021-04-01  2.4  YeeKung  WMS-16718 Add serialno and serialqty       */
/*                           Params (yeekung02)                         */
/* 2021-07-27  2.5  Chermain WMS-17410 Add VariableTable Param (cc01)   */
/************************************************************************/      
    
CREATE   PROC [RDT].[rdt_841ExtUpdSP02] (      
   @nMobile     INT,      
   @nFunc       INT,      
...
BEGIN      
 ...
 @cPaperPrinter,      
      ...
      BEGIN  
         SET @cErrMsg01 = ''  
         SET @cErrMsg01 = rdt.rdtgetmessage( 93390, @cLangCode, 'DSP') -- PLS USE BOX  
      ...
      BEGIN  
         SET @cErrMsg01 = ''  
         SET @cErrMsg01 = rdt.rdtgetmessage( 93391, @cLangCode, 'DSP') -- PLS USE GWP  
   ...
   --      AND LabelNo = @cLabelNo      
      ...
      BEGIN      
         ...
         --VALUES ( 'rdt_841ExtUpdSP02', GetDate() , '1' , @cOrderKey, @cOrderType )      
         ...
         BEGIN      
            ...
            --INSERT INTO TRACEINFO (TraceName, TimeIn, Step1 , Step2, Step3 )      
            --VALUES ( 'rdt_841ExtUpdSP02', GetDate() , '1.1' , @cOrderKey, @cSOStatus )      
   ...
   --         BEGIN      
               ...
               --VALUES ( 'rdt_841ExtUpdSP02', GetDate() , '1.2' , @cOrderKey, @cSOStatus, @cStorerKey )      
   ...
   --         BEGIN      
   --            INSERT INTO TRACEINFO (TraceName, TimeIn, Step1 , Step2, Step3, Step4 )      
   --            VALUES ( 'rdt_841ExtUpdSP02', GetDate() , '1.3' , @cOrderKey, @cSOStatus, @cStorerKey )      
   --         END      
         END      
...
RollBackTran:            
   ROLLBACK TRAN rdt_841ExtUpdSP02 -- Only rollback change made here            
            
Quit:            
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started            
      COMMIT TRAN rdt_841ExtUpdSP02            
