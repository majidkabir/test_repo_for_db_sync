...
GO
/************************************************************************/  
/* Store procedure: rdt_842ExtUpdSP06                                   */  
/* Copyright      : LF                                                  */  
/*                                                                      */  
...
/* 2018-11-29  1.0  ChewKP   WMS-7133 Created                           */
/* 2019-07-25  1.1  James    WMS-9955 Add print multi label (james01)   */
...
/*                           (james03)                                  */
/* 2021-09-24  1.5  James    WMS-17965 Add short pick check (james04)   */
/************************************************************************/  
  
CREATE PROC [RDT].[rdt_842ExtUpdSP06] (  
   @nMobile        INT,              
   @nFunc          INT,              
...
RollBackTran:      
   ROLLBACK TRAN rdt_842ExtUpdSP06 -- Only rollback change made here      
      
Quit:      
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started      
      COMMIT TRAN rdt_842ExtUpdSP06      
