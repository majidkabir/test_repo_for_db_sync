...
/************************************************************************/
/* Store procedure: rdt_843ConfirmSP01                                  */
/* Copyright      : LF Logistics                                        */
/*                                                                      */
/* Date       Rev  Author      Purposes                                 */
/* 29-06-2021 1.0  Chermaine   WMS-17288 Created                        */
/************************************************************************/

CREATE PROC [RDT].[rdt_843ConfirmSP01] (
    @nMobile         INT
   ,@nFunc           INT
...
BEGIN
   ...
   SAVE TRAN rdt_843ConfirmSP01 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN rdt_843ConfirmSP01
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_843ConfirmSP01 -- Only rollback change made here
Quit:
