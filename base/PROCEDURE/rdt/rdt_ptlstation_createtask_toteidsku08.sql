...
/************************************************************************/  
/* Store procedure: rdt_PTLStation_CreateTask_ToteIDSKU08               */  
...
CREATE   PROC [RDT].[rdt_PTLStation_CreateTask_ToteIDSKU08] (  
    @nMobile      INT  
   ,@nFunc        INT  
      ...
      BEGIN  
         ...
         BEGIN  
            ...
            INSERT INTO PTL.PTLTran (  
               ...
               OrderKey, StorerKey, SKU, ExpectedQTY, QTY, DropID, Func, GroupKey, SourceType,Facility)  
            VALUES (  
               @cIPAddress, @cPosition, @cStation, 'STATION',  
               @cOrderKey, @cStorerKey, @cScanSKU, @nPDQTY, 0,  @cScanID, @nFunc, @nRowRef, 'rdt_PTLStation_CreateTask_ToteIDSKU08',@cFacility)  
            IF @@ERROR <> 0  
            BEGIN  
               SET @nErrNo = 222703  
