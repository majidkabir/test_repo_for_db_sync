...
/************************************************************************/
/* Store procedure: rdt_835ExtPack02                                    */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/*                              (james02)                               */  
/* 07-07-2021  1.3  James       WMS-17450 Modify packinfo (james03)     */
/************************************************************************/

CREATE PROC [RDT].[rdt_835ExtPack02] (
   @nMobile       INT,
   @nFunc         INT,
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         SELECT 
            @nCartonWeight = ISNULL( SUM( CAST( Userdefined02 AS float)), 0)
