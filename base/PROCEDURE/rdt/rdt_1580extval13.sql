...
GO
/******************************************************************************/
/* Store procedure: rdt_1580ExtVal13                                          */
...
/* 23-04-2019  1.1  Ung         WMS-8718 Add Lottable03 (base on ExtVal12)    */
/******************************************************************************/
CREATE PROCEDURE [RDT].[rdt_1580ExtVal13]
    @nMobile      INT
   ,@nFunc        INT
   ,@nStep        INT
   ,@nInputKey    INT
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            SET @nErrNo = 137955
            SET @cErrMsg = rdt.rdtgetmessage( @nErrNo, @cLangCode, 'DSP') --Need Lottable3
            GOTO Quit
         END
