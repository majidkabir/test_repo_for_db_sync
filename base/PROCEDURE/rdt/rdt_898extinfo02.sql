...
/************************************************************************/
/* Store procedure: rdt_898ExtInfo02                                    */
...
CREATE PROCEDURE [RDT].[rdt_898ExtInfo02]
    @nMobile       INT
   ,@nFunc         INT
      ...
      BEGIN
         ...
         BEGIN
            ...
            FROM UCC WITH (NOLOCK) 
               JOIN ReceiptDetail RD WITH (NOLOCK) ON (RD.POKey = UCC.SourceKey AND RD.StorerKey = UCC.StorerKey AND RD.SKU = UCC.SKU)
