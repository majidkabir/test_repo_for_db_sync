...
/************************************************************************/
/* Store procedure: rdtHnMSwapLot03                                     */
/* Copyright      : IDS                                                 */
/*                                                                      */
/* Purpose: H&M KR swap lot logic                                       */
/*                                                                      */
...
/* 10-Jun-2016 1.0  James       SOS368195 Created                       */
/* 16-Apr-2021 1.1  James       WMS-16024 Standarized use of TrackingNo */
/*                              (james01)                               */
/************************************************************************/

CREATE PROC [RDT].[rdtHnMSwapLot03] (
   @n_Mobile         INT, 
...
BEGIN
   ...
   SAVE TRAN rdtHnMSwapLot03 -- For rollback or commit only our own transaction  
   ...
   BEGIN
      ...
      -- 1st carton also no tracking# or is orders with multi carton
      IF @n_CartonNo > 1 OR ISNULL( @c_TrackNo, '') = ''
      BEGIN
   ...
   COMMIT TRAN rdtHnMSwapLot03
   GOTO Quit
   
   RollBackTran:  
      ROLLBACK TRAN rdtHnMSwapLot03  
