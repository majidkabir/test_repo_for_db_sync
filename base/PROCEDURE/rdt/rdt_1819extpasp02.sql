...
/************************************************************************/
/* Store procedure: rdt_1819ExtPASP02                                   */
/*                                                                      */
/* Modifications log:                                                   */
/*                                                                      */
/* Date        Rev  Author   Purposes                                   */
/* 13-07-2015  1.0  Ung      SOS346283. Created                         */
/* 03-09-2020  1.1  James    WMS-14953 Add Short to codelkup when       */
/*                           getting suggested locaisle PnD (james01)   */
/************************************************************************/

CREATE PROC [RDT].[rdt_1819ExtPASP02] (
   @nMobile          INT,
   @nFunc            INT,
...
BEGIN
   ...
   BEGIN
      ...
      SAVE TRAN rdt_1819ExtPASP02 -- For rollback or commit only our own transaction
      ...
      COMMIT TRAN rdt_1819ExtPASP02 -- Only commit change made here
   END

   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_1819ExtPASP02 -- Only rollback change made here
Fail:
Quit:
