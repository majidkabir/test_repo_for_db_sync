...
/************************************************************************/  
/* Store procedure: rdt_ClusterPickCfm20                                */  
/* Copyright      : IDS                                                 */  
/*                                                                      */  
...
/* 2021-09-28  1.0  James       WMS17916. Created                       */  
/************************************************************************/  
  
CREATE PROC [RDT].[rdt_ClusterPickCfm20] (  
   @nMobile                   INT,  
   @nFunc                     INT,  
...
BEGIN  
   ...
   BEGIN TRAN  
   SAVE TRAN rdt_ClusterPickCfm20  
   ...
   RollBackTran:  
      ROLLBACK TRAN rdt_ClusterPickCfm20  
  
   Quit:  
      WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started  
         COMMIT TRAN rdt_ClusterPickCfm20  
