...
/************************************************************************/    
/* Store procedure: rdt841HnMSwapLot02                                  */    
/* Copyright      : IDS                                                 */    
/*                                                                      */    
...
CREATE PROC [RDT].[rdt841HnMSwapLot02] (    
   @n_Mobile         INT,     
...
BEGIN    
  ...
  /*  
   ...
   SAVE TRAN rdt841HnMSwapLot02 -- For rollback or commit only our own transaction      
  /*  
   IF @n_SwapLot = 0    
   BEGIN    
...
*/    
   ...
   COMMIT TRAN rdt841HnMSwapLot02    
   GOTO Quit    
       
   RollBackTran:      
      ROLLBACK TRAN rdt841HnMSwapLot02      
