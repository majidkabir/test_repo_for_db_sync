...
/************************************************************************/
/* Store procedure: rdt_1819ExtPASP29                                   */
/*                                                                      */
/* Purpose: Use strategy defined in codelkup to get suggested loc       */
/*          Check Loc.MaxSKU                                            */
/*                                                                      */
/* Called from: rdt_PutawayByID_GetSuggestLOC                           */
/*                                                                      */
/* Date         Rev  Author   Purposes                                  */
/* 2020-04-24   1.0  James    WMS-13070. Created                        */
/************************************************************************/
  
CREATE PROC [RDT].[rdt_1819ExtPASP29] (  
   @nMobile          INT,  
   @nFunc            INT,  
...
BEGIN  
   ...
   SAVE TRAN rdt_1819ExtPASP29 -- For rollback or commit only our own transaction  
   ...
   BEGIN  
      ...
      COMMIT TRAN rdt_1819ExtPASP29 -- Only commit change made here  
   END  
   ELSE
   BEGIN  
...
RollBackTran:  
   ROLLBACK TRAN rdt_1819ExtPASP29 -- Only rollback change made here  
Quit:  
