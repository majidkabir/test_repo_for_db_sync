...
/******************************************************************************/
/* Store procedure: rdt_1764ExtUpd18                                          */
/* Purpose: TM Replen From, Extended Update for HK ANF                        */
/*                                                                            */
/* Modifications log:                                                         */
/*                                                                            */
/* Date         Author    Ver.  Purposes                                      */
/* 2023-09-22   yeekung   1.0   WMS-22639. Created                            */
/******************************************************************************/

CREATE   PROCEDURE [RDT].[rdt_1764ExtUpd18]
    @nMobile         INT
   ,@nFunc           INT
...
BEGIN
   ...
   BEGIN
     ...
     BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  WHERE storerKey = @cStorerKey   
                  AND listName = 'WSAGVLog'  
                  AND code = @nFunc  

                  SET @cKey1 = RIGHT(@cCaseID,10)
         ...
         COMMIT TRAN rdt_1764ExtUpd18 -- Only commit change made here
      END
   END
...
RollBackTran:
   ROLLBACK TRAN rdt_1764ExtUpd18 -- Only rollback change made here
Fail:
Quit:
