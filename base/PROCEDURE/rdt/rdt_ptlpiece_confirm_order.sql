...
/************************************************************************/  
/* Store procedure: rdt_PTLPiece_Confirm_Order                          */  
...
/* 31-10-2016 1.1  Ung         Add PackTask.EditDate, EditWho           */  
/* 04-05-2017 1.2  Ung         WMS-1856 Add Orders sequence             */  
/* 17-12-2018 1.3  ChewKP      WMS-7091 Add EventLog (ChewKP01)         */  
/* 20-05-2020 1.4  Ung         WMS-13431 Add UpdateDropID               */  
/* 13-08-2020 1.5  Chermaine   WMS-14683 Add PrintLabelSP (cc01)        */  
/* 19-11-2020 1.6  CheeMun     INC1356666 - Insert PickDetail.Channel_ID*/ 
/************************************************************************/  
  
CREATE PROC [RDT].[rdt_PTLPiece_Confirm_Order] (  
    @nMobile      INT  
   ,@nFunc        INT  
