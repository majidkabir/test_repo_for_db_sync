...
/************************************************************************/
/* Store procedure: rdt_1819ExtPASP11                                   */
/*                                                                      */
/* Modifications log:                                                   */
/*                                                                      */
...
CREATE PROC [RDT].[rdt_1819ExtPASP11] (
   @nMobile          INT,
   @nFunc            INT,
...
BEGIN
   ...
   SAVE TRAN rdt_1819ExtPASP11 -- For rollback or commit only our own transaction
   ...
   SELECT TOP 1 @cLOT = LOT, @cSKU = SKU
...
RollBackTran:
   ROLLBACK TRAN rdt_1819ExtPASP11 -- Only rollback change made here
Quit:
