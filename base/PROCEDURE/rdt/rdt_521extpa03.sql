...
/************************************************************************/
/* Store procedure: rdt_521ExtPA03                                      */
/*                                                                      */
...
/* 16-Feb-2017  1.0  James    WMS1862. Created                          */
/************************************************************************/

CREATE PROC [RDT].[rdt_521ExtPA03] (
   @nMobile          INT, 
   @nFunc            INT, 
...
BEGIN
   ...
   SAVE TRAN rdt_521ExtPA03 -- For rollback or commit only our own transaction
...
RollBackTran:
   ROLLBACK TRAN rdt_521ExtPA03 -- Only rollback change made here
Quit:
