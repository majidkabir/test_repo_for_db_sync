...
/************************************************************************/
/* Store procedure: rdt_CPVMultiSKUExtLOT                               */
/* Copyright      : LF                                                  */
/*                                                                      */
/* Purpose: Prompt multi SKU that share same barcode for selection      */
/*                                                                      */
/* Date        Rev  Author      Purposes                                */
/* 16-10-2018  1.0  Ung         WMS-6632 Created                        */
/* 26-04-2019  1.1  James       Clear variable                          */
/* 26-07-2021  1.2  Chermaine   WMS-17552 Add busr10 (cc01)             */
/************************************************************************/

CREATE PROCEDURE [RDT].[rdt_CPVMultiSKUExtLOT]
   @nMobile    INT, 
   @nFunc      INT, 
