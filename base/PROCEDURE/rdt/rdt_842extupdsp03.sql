...
/************************************************************************/  
/* Store procedure: rdt_842ExtUpdSP03                                   */  
/* Copyright      : LF                                                  */  
/*                                                                      */  
...
/* 2018-11-08  1.1  James    Add filter storerkey when retrieve report  */  
/*                           type from codelkup (james01)               */
/* 2020-06-05  1.2  James    WMS-13504 Printing process fix (james02)   */
/* 2021-04-16  1.3  James    WMS-16024 Standarized use of TrackingNo    */
/*                           (james01)                                  */
/************************************************************************/  
  
CREATE PROC [RDT].[rdt_842ExtUpdSP03] (  
   @nMobile        INT,              
   @nFunc          INT,              
...
BEGIN  
   ...
   RollBackTran:      
      ROLLBACK TRAN rdt_842ExtUpdSP03 -- Only rollback change made here      
      
   Quit:      
      WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started      
         COMMIT TRAN rdt_842ExtUpdSP03      
