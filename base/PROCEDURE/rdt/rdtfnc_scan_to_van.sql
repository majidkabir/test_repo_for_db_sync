...
/*****************************************************************************/
/* Store procedure: rdtfnc_Scan_To_Van                                       */
/* Copyright      : IDS                                                      */
/*                                                                           */
/* Purpose: SOS#151573                                                       */
...
/* 2018-11-14 1.2  Gan      Performance tuning                               */
/*****************************************************************************/
CREATE PROC [RDT].[rdtfnc_Scan_To_Van](
   @nMobile    INT,
   @nErrNo     INT  OUTPUT,
...
IF @nFunc = 1634
BEGIN
   IF @nStep = 0 GOTO Step_0   -- Menu. Func = 1634
   IF @nStep = 1 GOTO Step_1   -- Scn = 2160   TRLR ID
   IF @nStep = 2 GOTO Step_2   -- Scn = 2161   TRLR ID, Store#
   IF @nStep = 3 GOTO Step_3   -- Scn = 2162   TRLR ID, Store#, Tote#, ToteCnt
END
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
--         SET @nErrNo = 68266
--         SET @cErrMsg = rdt.rdtgetmessage( 68266, @cLangCode, 'DSP') --TRLR req
--         GOTO Step_1_Fail  
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
--         SET @nErrNo = 68267
--         SET @cErrMsg = rdt.rdtgetmessage( 68267, @cLangCode, 'DSP') --Store# req
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
--         SET @nErrNo = 68268
--         SET @cErrMsg = rdt.rdtgetmessage( 68268, @cLangCode, 'DSP') --Tote# req
--         EXEC rdt.rdtSetFocusField @nMobile, 3
--         GOTO Step_3_Fail  

         SELECT @nToteCnt = COUNT(ToteNo) 
         ...
         SET @cOutField02 = @cStoreNo
         SET @cOutField03 = ''
         SET @cOutField04 = CASE WHEN @nToteCnt = 0 THEN '' ELSE RTRIM(@cToteCnt) + ' TOTES FOR TRLR' END
         SET @cToteNo = ''
         EXEC rdt.rdtSetFocusField @nMobile, 3
         GOTO Quit
      END 
      ...
      BEGIN
--         SET @nErrNo = 68274
--         SET @cErrMsg = rdt.rdtgetmessage( 68274, @cLangCode, 'DSP') --ToteNotNum
--         EXEC rdt.rdtSetFocusField @nMobile, 3
--         GOTO Step_3_Fail  
      ...
      BEGIN
--         SET @nErrNo = 68269
--         SET @cErrMsg = rdt.rdtgetmessage( 68269, @cLangCode, 'DSP') --Invalid Tote#
--         GOTO Step_3_Fail    
      ...
      IF @cActStoreNo <> @cStoreNo
      BEGIN
--         SET @nErrNo = 68270
--         SET @cErrMsg = rdt.rdtgetmessage( 68270, @cLangCode, 'DSP') --ToteNotForStore
--         GOTO Step_3_Fail  
      ...
      BEGIN
--         SET @nErrNo = 68272
--         SET @cErrMsg = rdt.rdtgetmessage( 68272, @cLangCode, 'DSP') --Already Loaded
--         GOTO Step_3_Fail    
      ...
      BEGIN
--         SET @nErrNo = 68271
--         SET @cErrMsg = rdt.rdtgetmessage( 68271, @cLangCode, 'DSP') --Tote Marshalled
--         GOTO Step_3_Fail    
...
--
--        SET @nErrNo = 68273
--        SET @cErrMsg = rdt.rdtgetmessage( 68273, @cLangCode, 'DSP') --'UpdateFail'
--        GOTO Step_3_Fail
