...
/************************************************************************/    
/* Store procedure: rdt_841ExtUpdSP30                                   */    
/* Copyright      : LF                                                  */    
/*                                                                      */    
...
CREATE   PROC [RDT].[rdt_841ExtUpdSP30] (    
   @nMobile       INT,  
   @nFunc         INT,  
...
BEGIN    
   ...
   --         WHERE PH.Orderkey = @cOrderkey    
            ...
            ****************************/    
            ...
            BEGIN    
               INSERT INTO dbo.PackInfo(PickslipNo, CartonNo, CartonType, Refno, AddWho, AddDate, EditWho, EditDate,trackingno)    
               SELECT DISTINCT PD.PickSlipNo, PD.CartonNo, @cDropIDType, RefNo, sUser_sName(), GETDATE(), sUser_sName(), GETDATE(),@cTrackNo    
   ...
   --      AND LabelNo = @cLabelNo    
      ...
      BEGIN    
         ...
         --VALUES ( 'rdt_841ExtUpdSP30', GetDate() , '1' , @cOrderKey, @cOrderType )    
         ...
         BEGIN    
            ...
            --INSERT INTO TRACEINFO (TraceName, TimeIn, Step1 , Step2, Step3 )    
            --VALUES ( 'rdt_841ExtUpdSP30', GetDate() , '1.1' , @cOrderKey, @cSOStatus )    
   ...
   --         BEGIN    
               ...
               --VALUES ( 'rdt_841ExtUpdSP30', GetDate() , '1.2' , @cOrderKey, @cSOStatus, @cStorerKey )    
   ...
   --         BEGIN    
   --            INSERT INTO TRACEINFO (TraceName, TimeIn, Step1 , Step2, Step3, Step4 )    
   --            VALUES ( 'rdt_841ExtUpdSP30', GetDate() , '1.3' , @cOrderKey, @cSOStatus, @cStorerKey )    
   --         END    
         END    
   ...
   BEGIN
      ...
      BEGIN
         ...
         SET @nTotalWeight=@nTotalWeight+@nWeight
      END
...
RollBackTran:          
   ROLLBACK TRAN rdt_841ExtUpdSP30 -- Only rollback change made here          
          
Quit:          
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started          
      COMMIT TRAN rdt_841ExtUpdSP30        
