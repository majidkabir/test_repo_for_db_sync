...
/************************************************************************/          
/* Store procedure: rdt_841ExtUpdSP36                                   */          
/* Copyright      : LF                                                  */          
/*                                                                      */          
...
/* 2023-08-10  1.0  James     WMS-23227 Created (dup rdt_841ExtUpdSP24) */          
/************************************************************************/          
        
CREATE   PROC [RDT].[rdt_841ExtUpdSP36] (          
   @nMobile             INT,          
   @nFunc               INT,          
...
RollBackTran:                
   ROLLBACK TRAN rdt_841ExtUpdSP36 -- Only rollback change made here                
                
Quit:                
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started                
      COMMIT TRAN rdt_841ExtUpdSP36                
