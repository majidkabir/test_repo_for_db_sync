...
/************************************************************************/
/* Store procedure: rdt_841RefNoInsLog03                                */
/* Copyright      : LF                                                  */
/*                                                                      */
...
/* 2023-06-09  1.0  yeekung  WMS-22755. Created                         */
/************************************************************************/

CREATE   PROC [RDT].[rdt_841RefNoInsLog03] (
   @nMobile        INT,
   @nFunc          INT,
   ...
   BEGIN
      ...
      BEGIN
         ...
         WHERE PK.PickSlipNo = @cRefNo
            ...
            AND O.Type IN (SELECT code FROM CODELKUP (NOLOCK) WHERE LISTNAME ='DOCTYPE' AND storerkey = @cStorerKey)
