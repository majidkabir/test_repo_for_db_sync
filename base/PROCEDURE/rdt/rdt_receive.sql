...
/* 2016-07-26 3.0  Ung         IN00098355 Fix receive on finalized line       */
/* 2016-10-17 3.1  Ung         Performance tuning                             */
/* 2017-05-04 3.2  Ung         WMS-1817 Add serial no                         */
/* 2017-07-13 3.3  Ung         Performance tuning                             */
/* 2018-08-06 3.4  Ung         WMS-5722 Add bulk serial no                    */
/* 2019-03-21 3.5  Ung         WMS-3872 Add Channel colum                     */
/* 2019-03-21 3.6  Ung         INC0560080 Add RowVer for concurrent receive   */
/*                             Missing (NOLOCK)                               */
/* 2019-05-27 3.9  James       WMS-9128 Add ASNStatus 1 (james03)             */
/* 2019-07-18 4.0  KimMun      INC0780531 - Change @cReceiptLineNumber 		   */
/*                             to @cReceiptLineNumberOutput (KM01)            */
/* 2019-10-08 4.1  Ung         WMS-10643 Allow_OverReceipt by DocType         */
/* 2020-05-12 4.2  James       WMS-12984 Skip tolerance check if it is a new  */
/*                             sku (james04)                                  */
/* 2020-04-09 4.3  Ung         LWP-96 Performance tuning                      */
/* 2020-09-29 4.1  LZG         INC1294700 - Order by RowRef to fix wrong      */
...
CREATE   PROCEDURE [RDT].[rdt_Receive] (
   @nFunc          INT,
   @nMobile        INT,
