...
GO
/************************************************************************/
/* Store procedure: rdt_GetTransitLoc                                   */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 30-08-2013  1.1  Shong     Change Select for Empty PND Location      */
/* 16-07-2014  1.2  Leong     SOS# 316284 - Prevent NULL value.         */
/************************************************************************/

CREATE PROC [RDT].[rdt_GetTransitLoc] (
