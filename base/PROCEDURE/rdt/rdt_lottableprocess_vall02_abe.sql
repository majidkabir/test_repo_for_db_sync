...
/******************************************************************************/
/* Store procedure: rdt_LottableProcess_ValL02_ABE                            */
...
BEGIN
   ...
   BEGIN
      IF @nLottableNo = 2 
      BEGIN
         IF EXISTS(SELECT 1 FROM dbo.ReceiptDetail WITH(NOLOCK) WHERE storerkey = @cStorerKey AND lottable02 = @cLottable02Value)
         BEGIN
            SET @nErrNo = 234101
