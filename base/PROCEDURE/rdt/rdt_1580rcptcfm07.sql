...
/***************************************************************************/
/* Store procedure: rdt_1580RcptCfm07                                      */
/* Copyright      : LF Logistics                                           */
/*                                                                         */
/* Date       Rev  Author  Purposes                                        */
/* 2018-03-06 1.0  ChewKP  WMS-4126 Created                                */
/***************************************************************************/
CREATE PROC [RDT].[rdt_1580RcptCfm07](
   @nFunc          INT,
   @nMobile        INT,
...
BEGIN
   ...
   BEGIN
      ...
      INSERT INTO @tConsigneeList (ConsigneeKey, Priority, OrderKey, SKU, OpenQty, Qty, QtyReceived)
      SELECT S.StorerKey , ISNULL(S.SUSR5 ,'99' ) , O.OrderKey, OD.SKU, SUM(OD.OpenQty), SUM(OD.OpenQty - OD.QtyAllocated - OD.QtyPicked) , 0 
      ...
      AND OD.SKU = @cSKUCode
      GROUP BY S.StorerKey , ISNULL(S.SUSR5 ,'99' ) , O.OrderKey, OD.SKU--, OD.OpenQty-- ,OD.QtyAllocated 
      ...
      BEGIN
         ...
         VALUES( 'rdt_1580RcptCfm07', GetDate() ,'D1', @cLoadKey, @cTConsigneeKey, @cTOderKey, @cTSKU, @nTOpenQty, @nTQty, @nTQtyReceived, '', '')
      ...
      BEGIN
         ...
         INSERT INTO TRACEINFO ( TraceName, TimeIn, Step1, Step2, Step3, Step4, Step5, Col1, Col2, Col3, Col4, Col5 )
         VALUES( 'rdt_1580RcptCfm07', GetDate() ,'D2', @cLoadKey, @cTConsigneeKey, @cTOderKey, @cTSKU, @nTOpenQty, @nTQty, @nTQtyReceived, @cLottable08, @cLottable09)
      ...
      BEGIN
         ...
         BEGIN
            ...
            INSERT INTO TRACEINFO ( TraceName, TimeIn, Step1, Step2, Step3, Step4, Step5, Col1, Col2, Col3, Col4, Col5 )
            VALUES( 'rdt_1580RcptCfm07', GetDate() ,'D3', @cLoadKey, @nCurrentRow, @nCounter, @cSKUCode, @cLastAssignConsignee, @cLastAssignOrderKey, '', @cLottable08, @cLottable09)
         ...
         BEGIN
            ...
            INSERT INTO TRACEINFO ( TraceName, TimeIn, Step1, Step2, Step3, Step4, Step5, Col1, Col2, Col3, Col4, Col5 )
            VALUES( 'rdt_1580RcptCfm07', GetDate() ,'D4', @cLoadKey, @nCurrentRow, @nCounter, @cSKUCode, @cLastAssignConsignee, @cLastAssignOrderKey, '', @cLottable08, @cLottable09)
            ...
            BEGIN
               ...
               INSERT INTO TRACEINFO ( TraceName, TimeIn, Step1, Step2, Step3, Step4, Step5, Col1, Col2, Col3, Col4, Col5 )
               VALUES( 'rdt_1580RcptCfm07', GetDate() ,'D5', @cLoadKey, @nCurrentRow, @nCounter, @cSKUCode, @cLastAssignConsignee, @cLastAssignOrderKey, '', @cLottable08, @cLottable09)
