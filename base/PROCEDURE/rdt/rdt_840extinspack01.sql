...
GO
/************************************************************************/
/* Stored Procedure: rdt_840ExtInsPack01                                */
/*                                                                      */
...
/* 2016-02-29   James     1.0   SOS362968 - Created                     */
...
CREATE PROC [RDT].[rdt_840ExtInsPack01] (
   @nMobile                   INT, 
   @nFunc                     INT, 
...
BEGIN
   ...
   RollBackTran:  
         ROLLBACK TRAN rdt_840ExtInsPack01  
   Quit:  
