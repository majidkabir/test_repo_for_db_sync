...
GO
/****************************************************************************/  
/* Store procedure: rdt_1864ConfirmSP01                                     */  
/* Copyright      : Maersk                                                  */    
/* Client         : PMI                                                     */    
...
/* 2025-02-26   NLT013    1.0.0   UWP-30204 Created                         */  
/****************************************************************************/  

CREATE   PROCEDURE [RDT].[rdt_1864ConfirmSP01]  
   @nMobile       INT,            
   @nFunc         INT,          
...
BEGIN  
   ...
   SAVE TRAN rdt_1864ConfirmSP01 -- For rollback or commit only our own transaction
   ...
   BEGIN
      ...
      EXECUTE rdt.rdt_Move
         ...
         @cSourceType    = 'rdt_1864ConfirmSP01',
   ...
   COMMIT TRAN rdt_1864ConfirmSP01
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_1864ConfirmSP01
Quit:
