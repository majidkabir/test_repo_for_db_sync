...
/******************************************************************************/
/* Store procedure: rdt_PTLCart_Assign_Totes02                                */
/* Copyright      : LFLogistics                                               */
/*                                                                            */
/* Purpose : Get OrderKey from TaskDetail                                     */
/*                                                                            */
/* Date       Rev  Author   Purposes                                          */
/* 18-02-2019 1.0  Ung      WMS-7995 Created                                  */
/* 23-07-2019 1.1  Ung      WMS-9587 Stamp TaskDetail.StartTime               */
/******************************************************************************/

CREATE PROC [RDT].[rdt_PTLCart_Assign_Totes02] (
   @nMobile          INT, 
   @nFunc            INT, 
...
BEGIN
   ...
   ***********************************************************************************************/
   ...
   BEGIN
      ...
      BEGIN
         BEGIN TRAN
         SAVE TRAN rdt_PTLCart_Assign_Totes02
         ...
         COMMIT TRAN rdt_PTLCart_Assign_Totes02
		END
...
RollBackTran:
   ROLLBACK TRAN rdt_PTLCart_Assign_Totes02
Quit:
