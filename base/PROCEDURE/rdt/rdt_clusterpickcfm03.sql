...
GO
/************************************************************************/
/* Store procedure: rdt_ClusterPickCfm03                                */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 22-Sep-2015 1.0  James       SOS352683 Created                       */
/* 26-Oct-2016 1.1  James       Perf tuning (james01)                   */
/************************************************************************/

CREATE PROC [RDT].[rdt_ClusterPickCfm03] (
   @nMobile                   INT,           
   @nFunc                     INT,           
