...
/******************************************************************************/
/* Store procedure: rdt_803MatrixSP08                                         */
/* Copyright      : LF Logistics                                              */
/*                                                                            */
/* Date       Rev  Author   Purposes                                          */
/* 01-03-2022 1.0  yeekung  WMS-17331 Created                                 */
/* 31-05-2022 1.1  Ung      WMS-19619 Change back to DeviceProfile.LogicalName*/
/******************************************************************************/
CREATE   PROC [RDT].[rdt_803MatrixSP08] (
    @nMobile    INT
   ,@nFunc      INT
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF @i = 8  SET @cResult08 = @cResult ELSE           IF @i = 9  SET @cResult09 = @cResult ELSE
