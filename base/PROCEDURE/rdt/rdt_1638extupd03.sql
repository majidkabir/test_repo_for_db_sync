...
/************************************************************************/
/* Store procedure: rdt_1638ExtUpd03                                    */
/* Copyright: LFLogistics                                               */
/*                                                                      */
/* Date        Rev  Author   Purposes                                   */
/* 2021-01-13  1.0  James    WMS-15914. Created                         */
/************************************************************************/

CREATE PROC [RDT].[rdt_1638ExtUpd03] (
   @nMobile      INT,           
   @nFunc        INT,           
   @nStep        INT,
   @nAfterStep   INT,        
...
RollBackTran:
   ROLLBACK TRAN rdt_1638ExtUpd03 -- Only rollback change made here
Quit:
