...
/******************************************************************************/
/* Store procedure: rdt_1764CreateTask04                                      */
/* Copyright      : LF Logistics                                              */
/*                                                                            */
/* Date        Rev  Author    Purposes                                        */
/* 13-08-2019  1.0  Ung       WMS-10166 Created (from rdt_1764CreateTask02)   */
/******************************************************************************/

CREATE PROC [RDT].[rdt_1764CreateTask04] (
   @nMobile        INT,
   @nFunc          INT,
...
BEGIN
   ...
   SELECT TOP 1
      ...
      @cSourceType     = 'rdt_1764CreateTask04'
   ...
   SAVE TRAN rdt_1764CreateTask04 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN rdt_1764CreateTask04 -- Only commit change made here
   GOTO Quit

RollBackTran:

   ROLLBACK TRAN rdt_1764CreateTask04 -- Only rollback change made here
Fail:
Quit:
