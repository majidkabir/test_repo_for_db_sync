...
/******************************************************************************/
/* Store procedure: rdt_805TerminateSP01                                      */
/* Copyright      : LF Logistics                                              */
/*                                                                            */
/* Purpose: Close working batch                                               */
/*                                                                            */
/* Date       Rev Author      Purposes                                        */
/* 03-01-2018 1.0 ChewKP      WMS-3487 Created                                */
/******************************************************************************/

CREATE PROC [RDT].[rdt_805TerminateSP01] (
    @nMobile      INT
   ,@nFunc        INT
...
BEGIN
   ...
   SAVE TRAN rdt_805TerminateSP01 -- For rollback or commit only our own transaction
...
RollBackTran:
   ROLLBACK TRAN rdt_805TerminateSP01 -- Only rollback change made here
Quit:
