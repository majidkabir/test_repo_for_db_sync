...
/************************************************************************/
/* Store procedure: rdt_1819ExtUpd03                                    */
/* Copyright      : LF Logistics                                        */
/*                                                                      */
/* Purpose: Generate PA1 task                                           */
/*                                                                      */
/* Date         Author    Ver.  Purposes                                */
/* 2016-02-02   Ung       1.0   SOS360340 Created                       */
/************************************************************************/

CREATE PROCEDURE [RDT].[rdt_1819ExtUpd03]
   @nMobile         INT,
   @nFunc           INT,
...
BEGIN
   ...
   SAVE TRAN rdt_1819ExtUpd03 -- For rollback or commit only our own transaction
               ...
               BEGIN
                  ...
                  BEGIN
                     ...
                     VALUES (
                        ...
                        'PP', @cStorerKey, '', 0, 'rdt_1819ExtUpd03', '9', '9', NULL)
                     IF @@ERROR <> 0
                     BEGIN
                        SET @nErrNo = 59852
                  ...
                  VALUES (
                     ...
                     'PP', @cStorerKey, 'Dummy task for', 'PAType=61 to work', 'rdt_1819ExtUpd03', '9', '9', NULL)
                  IF @@ERROR <> 0
                  BEGIN
                     SET @nErrNo = 59852
                     SET @cErrMsg = rdt.rdtgetmessage( @nErrNo, @cLangCode, 'DSP') -- InsTaskDetFail
   ...
   COMMIT TRAN rdt_1819ExtUpd03 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_1819ExtUpd03 -- Only rollback change made here
Fail:
Quit:
