...
/******************************************************************************/
/* Store procedure: rdt_1764ExtUpd11                                          */
/* Purpose: TM Replen From, Extended Update for HK ANF                        */
/*                                                                            */
/* Modifications log:                                                         */
/*                                                                            */
/* Date         Author    Ver.  Purposes                                      */
/* 2019-06-28   Ung       1.0   WMS-9505 Created (split from rdtANFRPFExtUpd) */
/******************************************************************************/

CREATE PROCEDURE [RDT].[rdt_1764ExtUpd11]
    @nMobile         INT
   ,@nFunc           INT
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            COMMIT TRAN rdt_1764ExtUpd11 -- Only commit change made here
         END
      END
...
RollBackTran:
   ROLLBACK TRAN rdt_1764ExtUpd11 -- Only rollback change made here
Fail:
Quit:
