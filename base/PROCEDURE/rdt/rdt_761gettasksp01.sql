...
GO
/************************************************************************/  
/* Store procedure: rdt_761GetTaskSP01                                  */  
/* Copyright      : LF                                                  */  
/*                                                                      */  
/* Purpose:                                                             */  
/*                                                                      */  
...
CREATE PROC [RDT].[rdt_761GetTaskSP01] (  
   @nMobile        INT,                
   @nFunc          INT,                
...
RollBackTran:
   ROLLBACK TRAN rdt_761GetTaskSP01 -- Only rollback change made here

Quit:
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started
      COMMIT TRAN rdt_761GetTaskSP01
