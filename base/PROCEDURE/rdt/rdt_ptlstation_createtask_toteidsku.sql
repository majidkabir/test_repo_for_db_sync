...
/************************************************************************/
/* Store procedure: rdt_PTLStation_CreateTask_ToteIDSKU                 */
...
CREATE PROC [RDT].[rdt_PTLStation_CreateTask_ToteIDSKU] (
    @nMobile      INT
   ,@nFunc        INT
      ...
      BEGIN
         ...
         BEGIN
            ...
            VALUES (
               ...
               @cOrderKey, @cStorerKey, @cScanSKU, @nPDQTY, 0,  @cScanID, @nFunc, @nRowRef, 'rdt_PTLStation_CreateTask_ToteIDSKU')
            IF @@ERROR <> 0
            BEGIN
               SET @nErrNo = 111653
