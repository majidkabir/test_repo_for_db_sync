...
/************************************************************************/  
/* Store procedure: rdt_1638ExtVal17                                    */  
...
CREATE   PROC [RDT].[rdt_1638ExtVal17] (  
   @nMobile      INT,             
   @nFunc        INT,             
   @nStep        INT,  
   @nInputKey    INT,             
      ...
      BEGIN  
         ...
         BEGIN  
           ...
           BEGIN  
               ...
               IF NOT EXISTS ( SELECT 1 FROM @tLoad WHERE LoadKey = @cLoadKey)  
               BEGIN  
                  ...
                  INSERT INTO @tLoad (LoadKey) VALUES ( @cLoadKey)  
               END  
