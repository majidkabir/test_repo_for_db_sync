...
GO
/************************************************************************/
/* Store procedure: rdt_973DefToTote01                                  */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
CREATE PROC [RDT].[rdt_973DefToTote01] (
   @nMobile         INT,           
   @nFunc           INT,           
...
BEGIN
   ...
   RollBackTran:
      ROLLBACK TRAN rdt_973DefToTote01

   Quit:
      WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started
         COMMIT TRAN rdt_973DefToTote01
   ...
   BEGIN
      ...
      SET @cErrMsg1 = rdt.rdtgetmessage( 102852, @cLangCode, 'DSP') --Not within
      SET @cErrMsg2 = rdt.rdtgetmessage( 102853, @cLangCode, 'DSP') --Default sack#
      SET @cErrMsg3 = rdt.rdtgetmessage( 102854, @cLangCode, 'DSP') --Range          
