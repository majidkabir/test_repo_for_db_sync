...
/******************************************************************************/
/* Store procedure: rdt_LottableProcess_MNCDefaultLottable                    */
/* Copyright      : LF Logistics                                              */
/*                                                                            */
/* Purpose: Dynamic lottable                                                  */
/*                                                                            */
/* Date         Author    Ver.  Purposes                                      */
/* 22-03-2023   yeekung   1.0   WMS-21965 Created                             */
/******************************************************************************/

CREATE   PROCEDURE [RDT].[rdt_LottableProcess_MNCDefaultLottable]
    @nMobile          INT
   ,@nFunc            INT
...
BEGIN
  ...
  --    IF @nLottableNo = 7  SET @cLottable07 = @cRDLottable07
   ...
   ELSE
   BEGIN
      IF @cLottable03 NOT IN ('WH','Disposal','MPB')
      BEGIN
         SET @nErrNo = 198101
         SET @cErrMsg = rdt.rdtgetmessage( @nErrNo, @cLangCode, 'DSP') -- InvalidLot03
      END
   END
END
