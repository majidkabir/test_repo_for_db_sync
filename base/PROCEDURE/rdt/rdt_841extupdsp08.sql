...
GO
/************************************************************************/      
/* Store procedure: rdt_841ExtUpdSP08                                   */      
/* Copyright      : LF                                                  */      
/*                                                                      */      
...
/* 2019-03-18  1.0  ChewKP   WMS-8321 Created                           */  
...
CREATE PROC [RDT].[rdt_841ExtUpdSP08] (      
   @nMobile       INT,  
   @nFunc         INT,  
...
--                      @cLabelNo        
   ...
   --      AND LabelNo = @cLabelNo      
      ...
      BEGIN      
        ...
        ' , @cLabelNo              ' +      
         ...
         --VALUES ( 'rdt_841ExtUpdSP08', GetDate() , '1' , @cOrderKey, @cOrderType )      
      ...
      @cOrderKey      
         ...
         BEGIN      
            ...
            --INSERT INTO TRACEINFO (TraceName, TimeIn, Step1 , Step2, Step3 )      
            --VALUES ( 'rdt_841ExtUpdSP08', GetDate() , '1.1' , @cOrderKey, @cSOStatus )      
   ...
   --         BEGIN      
               ...
               --VALUES ( 'rdt_841ExtUpdSP08', GetDate() , '1.2' , @cOrderKey, @cSOStatus, @cStorerKey )      
   ...
   --         BEGIN      
   --            INSERT INTO TRACEINFO (TraceName, TimeIn, Step1 , Step2, Step3, Step4 )      
   --            VALUES ( 'rdt_841ExtUpdSP08', GetDate() , '1.3' , @cOrderKey, @cSOStatus, @cStorerKey )      
   --         END      
         END      
...
RollBackTran:            
   ROLLBACK TRAN rdt_841ExtUpdSP08 -- Only rollback change made here            
            
Quit:            
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started            
      COMMIT TRAN rdt_841ExtUpdSP08            
