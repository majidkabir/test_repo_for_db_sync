...
/************************************************************************/
/* Store procedure: rdt_TM_PalletPick_CreateNextTask                    */
...
BEGIN
   ...
   SELECT TOP 1 
      ...
      @cSourceType     = 'rdt_TM_PalletPick_CreateNextTask'
   ...
   ***********************************************************************************************/
   ...
   SAVE TRAN rdt_TM_PalletPick_CreateNextTask -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN rdt_TM_PalletPick_CreateNextTask -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_TM_PalletPick_CreateNextTask -- Only rollback change made here
Fail:
Quit:
