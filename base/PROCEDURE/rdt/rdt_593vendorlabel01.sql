...
CREATE   PROC [RDT].[rdt_593VendorLabel01] (
   @nMobile    INT,
   @nFunc      INT,
   @nStep      INT,
...
AS
   ...
   BEGIN
      DECLARE CUR_VENDORLABEL_REPRINT CURSOR LOCAL FAST_FORWARD READ_ONLY FOR
   ...
   OPEN CUR_VENDORLABEL_REPRINT 
   FETCH NEXT FROM CUR_VENDORLABEL_REPRINT INTO @cCustLabelDataDesc, @cCustLabelName, @cCustLblPrintSequence, @cCustomCode
