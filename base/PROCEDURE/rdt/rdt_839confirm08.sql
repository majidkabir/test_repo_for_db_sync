...
BEGIN    
   ...
   SAVE TRAN rdt_839Confirm08 -- For rollback or commit only our own transaction   
   ...
   BEGIN
      ...
      BEGIN      
         ...
         JOIN WAVE WD (NOLOCK) ON PD.WaveKey=WD.WaveKey  
         WHERE PD.PickSlipNo = @cPickSlipNo  
           AND PD.Storerkey = @cStorerKey 
           AND userdefine01 IN ( 'PTS-SENT','PTS')
...
RollBackTran:    
   ROLLBACK TRAN rdt_839Confirm08 -- Only rollback change made here    
Quit:    
