...
/************************************************************************/
/* Store procedure: rdt_1820ExtUpd02                                    */
...
CREATE PROC [RDT].[rdt_1820ExtUpd02] (
   @nMobile          INT, 
   @nFunc            INT, 
   @nStep            INT, 
   @nInputKey        INT, 
