...
/******************************************************************************/    
/* Store procedure: rdt_638RefNoLKUP02                                        */    
   ...
   BEGIN    
      ...
      BEGIN    
         ...
         BEGIN     
            ...
            SAVE TRAN rdt_638RefNoLKUP02 -- For rollback or commit only our own transaction    
       
            -- Copy Orders to Receipt    
            INSERT INTO Receipt    
               (ReceiptKey, Facility, StorerKey, ExternReceiptKey, WarehouseReference,userdefine01,RecType,receiptgroup,doctype,ASNReason )    
            SELECT     
               @cNewReceiptKey, @cFacility, @cStorerKey, externorderkey,externorderkey,'DO'+externorderkey,'GRN','ECOM','R','12'  
...
RollBackTran:      
   ROLLBACK TRAN rdt_638RefNoLKUP02     
Fail:      
Quit:      
