...
/************************************************************************/
/* Store procedure: rdt_Putaway_GetSuggestLOC                           */
/*                                                                      */
/* Modifications log:                                                   */
/*                                                                      */
/* Date        Rev  Author   Purposes                                   */
/* 2024-11-18  1.0  JCH507   FCR-1025.Created for Granite               */
/************************************************************************/

CREATE PROC [rdt].[rdt_Putaway_GetSuggestLOC] (
   @nMobile          INT,
   @nFunc            INT,
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         SAVE TRAN rdt_Putaway_GetSuggestLOC -- For rollback or commit only our own transaction
         ...
         COMMIT TRAN rdt_Putaway_GetSuggestLOC -- Only commit change made here
      END
   END
   GOTO Quit

   RollBackTran:
   ROLLBACK TRAN rdt_Putaway_GetSuggestLOC -- Only rollback change made here
   Quit:
