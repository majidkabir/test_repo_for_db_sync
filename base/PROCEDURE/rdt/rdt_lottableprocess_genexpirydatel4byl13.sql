...
/************************************************************************/
/* Store procedure: rdt_LottableProcess_GenExpiryDateL4ByL13            */
/* Copyright      : LF                                                  */
/*                                                                      */
/* Purpose: Key in L13 (Production date) and populate L4 (Expiry date)  */
/*                                                                      */
/* Date        Rev  Author      Purposes                                */
/* 09-04-2019  1.0  James       WMS8582. Created                        */
/************************************************************************/

CREATE PROCEDURE [RDT].[rdt_LottableProcess_GenExpiryDateL4ByL13]
    @nMobile          INT
   ,@nFunc            INT
...
BEGIN
   ...
   -- Add shelf life
   IF @nShelfLife > 0
      SET @dLottable04 = DATEADD( dd, @nShelfLife, @dLottable13)
   
   SET @dLottable04 = CONVERT( DATETIME, @dLottable04, 101) --MM/DD/YYYY
