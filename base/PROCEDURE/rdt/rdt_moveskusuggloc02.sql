...
/************************************************************************/
/* Store procedure: rdt_MoveSKUSuggLoc02                                */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 16-08-2013  1.0  James       SOS286394 - Created                     */
/* 05-01-2014  1.1  Ung         SOS328774 Change param                  */
/* 23-04-2015  1.2  Ung         SOS337296 Add PABookingKey              */
/************************************************************************/

CREATE PROC [RDT].[rdt_MoveSKUSuggLoc02] (
   @nMobile       INT,
   @nFunc         INT,
