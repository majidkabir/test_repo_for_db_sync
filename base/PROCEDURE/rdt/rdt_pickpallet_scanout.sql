...
/************************************************************************/
/* Store procedure: rdt_PickPallet_ScanOut                              */
/* Copyright      : Maersk                                              */
/*                                                                      */
...
CREATE   PROC rdt.rdt_PickPallet_ScanOut (
    @nMobile      INT
   ,@nFunc        INT
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN TRAN
         SAVE TRAN rdt_PickPallet_ScanOut -- For rollback or commit only our own transaction
         ...
         COMMIT TRAN rdt_PickPallet_ScanOut
...
RollBackTran:
   ROLLBACK TRAN rdt_PickPallet_ScanOut -- Only rollback change made here
Quit:
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started
      COMMIT TRAN
END
