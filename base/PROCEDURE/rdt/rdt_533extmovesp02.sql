...
/************************************************************************/
/* Store procedure: rdt_533ExtMoveSP02                                  */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 2020-08-21 1.0  James    WMS-14608 - Created                         */
/************************************************************************/

CREATE PROC [RDT].[rdt_533ExtMoveSP02] (
   @nMobile      INT,
   @nFunc        INT, 
...
--------------------------------------------------------------------------------------------------*/  
   ...
   BEGIN            
      ...
      BEGIN    
         ...
         EXECUTE rdt.rdt_Move        
            ...
            @cSourceType = 'rdt_533ExtMoveSP02',        
   ...
   COMMIT TRAN rdt_533ExtMoveSP02 -- Only commit change made in rdt_533ExtMoveSP02  
   GOTO Quit  
  
   RollBackTran:  
      ROLLBACK TRAN rdt_533ExtMoveSP02 -- Only rollback change made in rdt_533ExtMoveSP02  
   Quit:  
