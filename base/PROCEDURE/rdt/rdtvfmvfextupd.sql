...
/************************************************************************/
/* Store procedure: rdtVFMVFExtUpd                                      */
/* Purpose: Send command to Junheinrich WCS direct carton to location   */
/*                                                                      */
/* Modifications log:                                                   */
/*                                                                      */
/* Date         Author    Ver.  Purposes                                */
/* 2014-05-08   Ung       1.0   SOS309193 Created                       */
/************************************************************************/

CREATE PROCEDURE [RDT].[rdtVFMVFExtUpd]
    @nMobile         INT 
   ,@nFunc           INT 
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            COMMIT TRAN rdtVFMVFExtUpd -- Only commit change made here        
         END
...
RollBackTran:
   ROLLBACK TRAN rdtVFMVFExtUpd -- Only rollback change made here
Fail:
Quit:
