...
/************************************************************************/    
/* Store procedure: rdt_841ExtUpdSP10                                   */    
/* Copyright      : LF                                                  */    
/*                                                                      */    
...
/* 2019-08-16  1.0  James    WMS-9981 Modified from rdt_841ExtUpdSP02   */
/* 2019-12-23  1.1  LZG      INC0979460 - Removed DropID condition(ZG01)*/ 
/* 2020-05-19  1.2  YeeKung  WMS-13131 Add Cartontype param(yeekung01)  */
/* 2020-09-29  1.3  YeeKung  Fix Deadlock (yeekung02)                   */ 
/* 2020-12-17  1.4  James    WMS-15901-Add PackList reporttype (james01)*/ 
...
--               AND    Status = '5'    
   ...
   --      AND LabelNo = @cLabelNo    
      ...
      BEGIN    
         ...
         --VALUES ( 'rdt_841ExtUpdSP10', GetDate() , '1' , @cOrderKey, @cOrderType )    
         ...
         BEGIN    
            ...
            --INSERT INTO TRACEINFO (TraceName, TimeIn, Step1 , Step2, Step3 )    
            --VALUES ( 'rdt_841ExtUpdSP10', GetDate() , '1.1' , @cOrderKey, @cSOStatus )    
   ...
   --         BEGIN    
               ...
               --VALUES ( 'rdt_841ExtUpdSP10', GetDate() , '1.2' , @cOrderKey, @cSOStatus, @cStorerKey )    
   ...
   --         BEGIN    
   --            INSERT INTO TRACEINFO (TraceName, TimeIn, Step1 , Step2, Step3, Step4 )    
   --            VALUES ( 'rdt_841ExtUpdSP10', GetDate() , '1.3' , @cOrderKey, @cSOStatus, @cStorerKey )    
   --         END    
         END    
...
RollBackTran:          
   ROLLBACK TRAN rdt_841ExtUpdSP10 -- Only rollback change made here          
          
Quit:          
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started          
      COMMIT TRAN rdt_841ExtUpdSP10        
