...
/******************************************************************************/
/* Store procedure: rdt_1764SwapUCC07                                         */
/* Copyright      : LF Logistics                                              */
/*                                                                            */
/* Date       Rev  Author    Purposes                                         */
/* 05-07-2021 1.0  Chermaine WMS-17383 Created (based on rdt_1764SwapUCC02)   */
/* 05-09-2023 1.1  James     WMS-23224 Prevent double scan UCC (james01)      */
/******************************************************************************/

CREATE   PROCEDURE [RDT].[rdt_1764SwapUCC07]
   @nMobile          INT,
   @nFunc            INT,
...
CommitTran:
   ...
   COMMIT TRAN rdt_1764SwapUCC07
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_1764SwapUCC07
Fail:
   SET @nUCCQTY = 0
Quit:
