...
/************************************************************************/      
/* Store procedure: rdt_1768ExtCfm03                                    */      
/* Copyright      : LF                                                  */      
/*                                                                      */      
...
/* 2021-04-26  1.0  James    WMS-16634. Created                         */  
/************************************************************************/      
  
CREATE PROC [RDT].[rdt_1768ExtCfm03] (      
   @nMobile         INT,  
   @nFunc           INT,  
...
BEGIN  
   ...
   RollBackTran:  
      ROLLBACK TRAN rdt_1768ExtCfm03  
  
   Quit:  
   WHILE @@TRANCOUNT>@nTranCount -- Commit until the level we started  
      COMMIT TRAN rdt_1768ExtCfm03  
END  
