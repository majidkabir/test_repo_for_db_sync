...
CREATE   PROC [RDT].[rdt_957Confirm02] (
    @nMobile      INT
   ,@nFunc        INT
...
*/
   ...
   SAVE TRAN rdt_957Confirm02 -- For rollback or commit only our own transaction
...
RollBackTran:
   ROLLBACK TRAN rdt_957Confirm02 -- Only rollback change made here
Quit:
