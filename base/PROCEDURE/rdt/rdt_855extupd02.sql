...
/***************************************************************************/
/* Store procedure: rdt_855ExtUpd02                                        */
/*                                                                         */
...
/* 29-Mar-2019 1.2  James       WMS-8002 Add TaskDetailKey param (james01) */
/* 06-Jul-2021 1.3  YeeKung     WMS-17278 Add Reasonkey (yeekung01)        */
/***************************************************************************/

CREATE PROC [RDT].[rdt_855ExtUpd02] (
   @nMobile      INT, 
   @nFunc        INT, 
...
BEGIN
   ...
   SAVE TRAN rdt_855ExtUpd02 -- For rollback or commit only our own transaction
