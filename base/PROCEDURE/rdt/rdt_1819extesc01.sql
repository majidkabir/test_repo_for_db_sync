...
/************************************************************************/
/* Store procedure:    rdt_1819ExtEsc01                                 */
...
CREATE PROCEDURE rdt.rdt_1819ExtEsc01
   @nMobile         INT,          
   @nFunc           INT,          
...
BEGIN
   ...
   SAVE TRAN rdt_1819ExtEsc01 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN rdt_1819ExtEsc01

   GOTO Quit

RollBackTran:
   ROLLBACK TRAN rdt_1819ExtEsc01 -- Only rollback change made here
Fail:
Quit:
