...
GO
/************************************************************************/
/* Store procedure: rdt_ClusterPickCfm12                                */
/* Copyright      : IDS                                                 */
/*                                                                      */
/* Purpose: Comfirm Pick with PickDetail.                               */
/*          Order.Type = B2C Update Status = '3'                        */
/*          Order.Type = B2B Update Status = '5'                        */
/*                                                                      */
...
/*192-Nov-2018 1.0  James       WMS6887.Created                         */
/* 21-Mar-2019 1.1  James       INC0631789. Bug fix                     */
/************************************************************************/

CREATE PROC [RDT].[rdt_ClusterPickCfm12] (
   @nMobile                   INT,           
   @nFunc                     INT,           
...
BEGIN
   ...
   SELECT @cPickCfmStatus = Short
   FROM dbo.CODELKUP WITH (NOLOCK)
   WHERE ListName = 'ORDPCKSTAT'
   AND   Code = @cOrderType
