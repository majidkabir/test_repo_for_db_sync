...
/***************************************************************************/
/* Store procedure: rdt_1580ExtInfo02                                      */
/* Copyright      : LFLogistics                                            */
/*                                                                         */
/* Purpose: Display Count                                                  */
/*                                                                         */
/* Date       Rev  Author     Purposes                                     */
/* 2021-01-27 1.0  Chermaine  WMS-15775 Created                            */
/* 2022-05-19 1.1  Ung        WMS-19667 Migrate to new ExtendedInfoSP      */
/***************************************************************************/

CREATE   PROCEDURE [RDT].[rdt_1580ExtInfo02] (
    @nMobile         INT
   ,@nFunc           INT
...
BEGIN
   ...
   BEGIN
      ...
      SET @cExtendedInfo = 'TOTAL: ' + RIGHT(Replicate(' ',4) + CAST(@nBeforeReceivedQty As VARCHAR(4)), 4)  + ' / ' + RIGHT(Replicate(' ',4) + CAST(@nQtyExpected As VARCHAR(4)), 4)  
   END
