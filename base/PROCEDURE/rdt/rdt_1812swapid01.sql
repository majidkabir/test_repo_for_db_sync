...
/************************************************************************/
/* Store procedure: rdt_1812SwapID01                                    */
...
CREATE PROCEDURE [RDT].[rdt_1812SwapID01]
   @nMobile           INT,
   @nFunc             INT,
...
CommitTran:
   COMMIT TRAN rdt_1812SwapID01
   GOTO Quit

RollBackTran:
      ROLLBACK TRAN rdt_1812SwapID01
Quit:
