...
/************************************************************************/
/* Store procedure: rdt_838RepackSPVLT                                  */
...
CREATE     PROC [RDT].[rdt_838RepackVLT] (
@nMobile      INT
,@nFunc        INT
...
BEGIN
   ...
   ***********************************************************************************************/
   ...
   SELECT TOP 1 @cFirstLine = LabelLine
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               WHILE @@FETCH_STATUS = 0
               BEGIN
                  DELETE PackSerialNo WHERE PackSerialNoKey = @nPackSerialNoKey and StorerKey = @cStorerKey
                  SET @nErrNo = @@ERROR 
                  IF @nErrNo <> 0
                  BEGIN
