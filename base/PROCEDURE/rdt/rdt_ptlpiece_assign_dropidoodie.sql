...
/******************************************************************************/
/* Store procedure: rdt_PTLPiece_Assign_DropIDOodie                           */
/* Copyright      : LFLogistics                                               */
/*                                                                            */
/* Date       Rev  Author   Purposes                                          */
/* 2023-05-09 1.0  James    Temp requested by AU Oodie                        */
/******************************************************************************/

CREATE   PROC [RDT].[rdt_PTLPiece_Assign_DropIDOodie] (
   @nMobile          INT,
   @nFunc            INT,
...
BEGIN
   ...
   BEGIN TRAN
   SAVE TRAN rdt_PTLPiece_Assign_DropIDOodie
...
RollBackTran:
      ROLLBACK TRAN rdt_PTLPiece_Assign_DropIDOodie
