...
/************************************************************************/
/* Store procedure: rdt_1638ExtVal07                                    */
...
/*	2020-03-19  1.0  James    WMS-12460. Created                         */
/************************************************************************/

CREATE PROC [RDT].[rdt_1638ExtVal07] (
   @nMobile      INT,           
   @nFunc        INT,           
   @nStep        INT,
   @nInputKey    INT,           
      ...
      BEGIN  
         ...
         BEGIN  
            ...
            BEGIN  
               ...
               SELECT TOP 1 @cOrderGroup = OrderGroup FROM Orders WITH (NOLOCK) WHERE LoadKey = @cLoadKey ORDER BY 1  
