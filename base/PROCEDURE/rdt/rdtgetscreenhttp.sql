...
/************************************************************************/
/* Store Procedure: rdtGetScreen                                        */
/* Copyright      : Maersk                                              */
/*                                                                      */
/* Purpose: Loop screen objects to build XML                            */
/*                                                                      */
/* Date        Rev  Author    Purposes                                  */
/* 2023-09-26  1.0  JLC042    Created base on rdtGetScreen 2015-10-02   */
/************************************************************************/

CREATE   PROC [RDT].[rdtGetScreenHttp] (
   @nMobile INT,
...
AS
   ...
   BEGIN
      ...
      BEGIN
         ...
         EXEC RDT.rdtScr2XMLHttp @nMobile, @cLangCode, NULL, '1', 'Screen not setup:', @cXML OUTPUT
         EXEC RDT.rdtScr2XMLHttp @nMobile, @cLangCode, NULL, '2', @cScn, @cXML OUTPUT
         EXEC RDT.rdtScr2XMLHttp @nMobile, @cLangCode, NULL, '4', 'Try ESC to go back', @cXML OUTPUT
         GOTO Quit
      END
   END
   ...
   BEGIN
      -- Build XML
      EXEC RDT.rdtScr2XMLHttp @nMobile, @cLangCode, @nScnKey, 0, '', @cXML OUTPUT
