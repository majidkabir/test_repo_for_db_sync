...
GO
/************************************************************************/
/* Store procedure: rdtGetTaskInLOCMHD01                                */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 2016-05-04 1.1  Leong    IN00032602 - Reassign sku descr variable.   */
/************************************************************************/

CREATE PROCEDURE [RDT].[rdtGetTaskInLOCMHD01] (
   @n_Mobile        INT,
   @n_Func          INT,
...
--   ('MHD2', GETDATE(), @c_SKU, @c_UOM, @c_Lottable1, @c_Lottable2, @c_Lottable3)
...
SET @c_SKUDescr  = @cSKUDescr -- IN00032602
