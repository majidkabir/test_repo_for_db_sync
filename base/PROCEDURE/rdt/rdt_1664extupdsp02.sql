...
/******************************************************************************/  
/* Store procedure: rdt_1664ExtUpdSP02                                        */    
/* Copyright      : LF                                                        */    
/*                                                                            */    
...
/* 2015-04-22  1.0  ChewKP   SOS#339560 Created                               */    
/* 2018-03-16  1.1  Ung      WMS-3774 Change CartonDescription to Barcode     */
/******************************************************************************/    
    
CREATE PROC [RDT].[rdt_1664ExtUpdSP02] (    
   @nMobile     INT,    
   @nFunc       INT,    
...
BEGIN     
   ...
   BEGIN  
         ...
         BEGIN    
            ...
            WHERE (CartonType = @cCartonType OR Barcode = @cCartonType)
            ...
            SET @nTotalCartonWeight = @nTotalCartonWeight + ((ISNULL(@nCartonCount,0) + @nCountCartonType) * ISNULL(@nCartonWeight,0)) -- @nTotalCartonWeight + (ISNULL(@nCartonCount,0) * ISNULL(@nCartonWeight,0))
...
RollBackTran:  
   ROLLBACK TRAN rdt_1664ExtUpdSP02 -- Only rollback change made here  
  
Quit:  
   WHILE @@TRANCOUNT > @nTranCount -- Commit until the level we started  
      COMMIT TRAN rdt_1664ExtUpdSP02  
