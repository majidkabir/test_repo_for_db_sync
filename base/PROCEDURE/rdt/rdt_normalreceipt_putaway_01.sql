...
/******************************************************************************/
/* Store procedure: rdt_NormalReceipt_Putaway_01                              */
/* Copyright      : Maersk                                                    */
/*                                                                            */
...
CREATE   PROCEDURE rdt.rdt_NormalReceipt_Putaway_01
   @nMobile       INT,           
   @nFunc         INT,           
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         SAVE TRAN rdt_NormalReceipt_Putaway_01 -- For rollback or commit only our own transaction
         ...
         COMMIT TRAN rdt_NormalReceipt_Putaway_01 -- Only commit change made here
      END
   END
   ...
   BEGIN
      ...
      COMMIT TRAN rdt_NormalReceipt_Putaway_01
   END
...
RollBackTran:
   ROLLBACK TRAN rdt_NormalReceipt_Putaway_01 -- Only rollback change made here
Fail:
Quit:
