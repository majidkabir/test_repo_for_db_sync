...
/* 22-Oct-2021  1.2  yeekung  WMS-17797 add for cainian print(yeekung01)*/       
/* 11-Jan-2023  1.3  James    WMS-21458 Add PDF print (james01)         */
/************************************************************************/      
      ...
      BEGIN        
         ...
         BEGIN  
            ...
            IF CHARINDEX( 'SEND2PRINTER', @cPrintFilePath) > 0      
               SET @cPrintCommand = '"' + @cPrintFilePath + '" "' + @cWorkingFilePath + '\' + @cFileName + '" "33" "0" "' + @cWinPrinterName + '"'    
