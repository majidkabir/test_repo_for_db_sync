...
/*************************************************************************/  
/* Stored Procedure: lsp_PrePrint_PLIST_WAVE_001                         */  
/* Creation Date: 03-May-2023                                            */  
/* Copyright: LFL                                                        */  
/* Written by: WLChooi                                                   */  
/*                                                                       */  
/* Purpose: WMS-22367 - Print Report by Orders.Type                      */
/*                                                                       */  
/* Called By:                                                            */  
/*                                                                       */  
/*                                                                       */  
...
/* 03-May-2023 WLChooi  1.0   DevOps Script Combine                      */
/*************************************************************************/   
CREATE   PROCEDURE [WM].[lsp_PrePrint_PLIST_WAVE_001]  
...
BEGIN  
   ...
   BEGIN CATCH
      SET @n_Continue = 3
      SET @c_ErrMsg = ERROR_MESSAGE() + '. (lsp_PrePrint_PLIST_WAVE_001)'
      GOTO EXIT_SP
   END CATCH
   ...
   BEGIN
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'lsp_PrePrint_PLIST_WAVE_001'
   END
   ELSE
   BEGIN
      SET @b_Success = 1
