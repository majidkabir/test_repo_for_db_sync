...
/*************************************************************************/  
/* Stored Procedure: lsp_WAVE_PLIST_WAVE_Print_Pre_Std                   */  
/* Creation Date: 14-Jul-2023                                            */  
/* Copyright: MAERSK                                                     */  
/* Written by: WLChooi                                                   */  
/*                                                                       */  
/* Purpose: WMS-22860 - Call ispExportAllocatedOrd by Wave               */
/*                                                                       */  
...
/*************************************************************************/   
CREATE   PROCEDURE [WM].[lsp_WAVE_PLIST_WAVE_Print_Pre_Std]  
...
BEGIN  
   ...
   BEGIN CATCH
      SET @n_Continue = 3
      SET @c_ErrMsg = ERROR_MESSAGE() + '. (lsp_WAVE_PLIST_WAVE_Print_Pre_Std)'
      GOTO EXIT_SP
   END CATCH
   ...
   BEGIN
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'lsp_WAVE_PLIST_WAVE_Print_Pre_Std'
   END
   ELSE
   BEGIN
      SET @b_Success = 1
