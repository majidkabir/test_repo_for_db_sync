...
/*************************************************************************/  
/* Stored Procedure: lsp_PrePrint_PLIST_WAVE_JET                         */  
/* Creation Date: 02-Jun-2022                                            */  
/* Copyright: LFL                                                        */  
/* Written by: WLChooi                                                   */  
/*                                                                       */  
/* Purpose: WMS-19758 - [TW] JET Pick Slip CR - PrePrint Process         */
/*                                                                       */  
/* Called By:                                                            */  
/*                                                                       */  
/*                                                                       */  
...
/* 02-Jun-2022 WLChooi  1.0   DevOps Script Combine                      */
/*************************************************************************/   
CREATE PROCEDURE [WM].[lsp_PrePrint_PLIST_WAVE_JET]  
...
BEGIN  
   ...
   BEGIN CATCH
      SET @n_Continue = 3
      SET @c_ErrMsg = ERROR_MESSAGE() + '. (lsp_PrePrint_PLIST_WAVE_JET)'
      GOTO EXIT_SP
   END CATCH
   ...
   BEGIN
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'lsp_PrePrint_PLIST_WAVE_JET'
   END
   ELSE
   BEGIN
      SET @b_Success = 1
