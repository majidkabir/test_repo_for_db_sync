...
GO
/************************************************************************/                                                                                  
/* Store Procedure: lsp_WaveMBolDetail_Delete                           */                                                                                  
...
BEGIN                                                                                                                                                        
   ...
   DECLARE  @n_StartTCnt      INT = @@TRANCOUNT  
         ...
         ,  @c_SourceType     NVARCHAR(50)   = 'lsp_WaveMBolDetail_Delete'
...
EXIT_SP:
   ...
   BEGIN
      ...
      END
      SET @n_WarningNo = 0
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'lsp_WaveMBolDetail_Delete'
   END
   ELSE
   BEGIN
      SET @b_Success = 1
