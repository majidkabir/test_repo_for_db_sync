...
GO
/*************************************************************************/  
/* Stored Procedure: lsp_RCMConfigSP_PO_Wrapper                          */  
...
BEGIN  
   ...
   BEGIN TRY
      ...
      BEGIN CATCH
         ...
         SET @c_errmsg = 'NSQL' +CONVERT(CHAR(6),@n_err) + ': Error Executing PO''s RCMConfig Custom SP' + @c_RCMConfigSP + '. (lsp_RCMConfigSP_PO_Wrapper)'
   ...
   BEGIN
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'lsp_RCMConfigSP_PO_Wrapper'
   END
   ELSE
   BEGIN
      SET @b_Success = 1
