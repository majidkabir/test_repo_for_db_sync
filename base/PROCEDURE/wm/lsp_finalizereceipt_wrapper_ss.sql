...
CREATE         PROCEDURE [WM].[lsp_FinalizeReceipt_Wrapper_SS]
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               BEGIN
			      print(@c_POKey)
				  print(@c_ExternReceiptkey)
				  print(@c_ExternLineNo)
				  print(@n_TolPct)
				  
				   print (@n_QtyReceived + @n_SumBeforeReceivedQty + @n_SumFreeGoodQtyReceived)
				   print(@n_QtyOrdered * (1 + (CONVERT(FLOAT, @n_TolPct) * 0.01)))
