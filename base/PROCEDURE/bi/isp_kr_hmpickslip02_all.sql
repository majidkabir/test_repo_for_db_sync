...
/******************************************************************************/        
/* Store Procedure: isp_kr_hmpickslip02_All https://jiralfl.atlassian.net/browse/WMS-19743  */        
...
/* 30-Mar-2022  Jeffrey   1.2   Printing All Items in loadkeys                */
/******************************************************************************/        
       
CREATE   PROC [BI].[isp_kr_hmpickslip02_All]   
...
BEGIN        
   ...
   BEGIN  
      ...
      BEGIN  
		 ...
		 JOIN KRWMS..SKU		 e WITH (NOLOCK) on e.Sku = b.Sku --Jeffrey Shin 210930
