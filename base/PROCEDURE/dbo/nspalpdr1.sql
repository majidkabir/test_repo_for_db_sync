...
GO
/************************************************************************/    
/* Stored Procedure: nspALPDR1                                          */    
/* Creation Date: 25-MAR-2019                                           */    
/* Copyright: LFL                                                       */    
/* Written by:                                                          */    
/*                                                                      */    
/* Purpose: WMS-8341 CN Pandora Allocation (B2C)                        */
/*          Allocate from pick (uom6) with overallocation (non-fastpick)*/
   ...
   BEGIN
      ...
      BEGIN
         SELECT TOP 1 @c_Doctype = O.DocType,
                      @c_OrderType = O.Type,
                      @c_Consigneekey = O.Consigneekey --NJOW02
         FROM ORDERS O (NOLOCK)
