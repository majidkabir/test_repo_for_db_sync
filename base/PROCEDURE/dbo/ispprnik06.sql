    ...
    --BEGIN      
      ...
      BEGIN      
         ...
         BEGIN       
            ...
            BEGIN      
               SET @n_CTNCount = @n_CTNNeeded                END       
            ELSE      
            BEGIN      
               ...
               END --CS01a      
                  ...
                  BEGIN      
                     ...
                     SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0))         
                                            + ': Get PickDetailKey Failed. (ispPRNIK06)'      
                     GOTO QUIT_SP      
                  END      
                  ELSE      
                  BEGIN      
                     ...
                     BEGIN      
                        ...
                        SET @n_Err = 61020      
                        SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0))       
                                       + ': Insert PickDetail Failed. (ispPRNIK06)'      
                        GOTO QUIT_SP      
                     END      
...
QUIT_SP:      
   ...
   IF OBJECT_ID('tempdb..#UCCxLOTxLOCxID','u') IS NOT NULL            DROP TABLE #UCCxLOTxLOCxID;      
   ...
   BEGIN        
      ...
      BEGIN        
         ...
         END        
      END        
      EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'ispPRNIK06'        
