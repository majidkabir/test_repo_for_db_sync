...
/************************************************************************/
/* Stored Proc: isp_ReceiptPreTallySheet14                              */
/* Creation Date: 07-JUL-2022                                           */
/* Copyright: LF Logistics                                              */
/* Written by:MINGLE                                                    */
/*                                                                      */
/* Purpose: WMS-19944 ID-CR-adidas-PreTallySheet Report                 */
/*        :                                                             */
/* Called By: r_receipt_pre_tallysheet14                                */
/*          :                                                           */
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 7.0                                                         */
...
/* 07-JUL-2022  MINGLE    1.0 Devops Scripts combine                    */
/************************************************************************/

CREATE PROC [dbo].[isp_ReceiptPreTallySheet14]
 ...
 GROUP BY receiptkey,PalletPosition,sku
  ...
  --DROP TABLE #ITEMCLASS2
   ...
   BEGIN
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'isp_ReceiptPreTallySheet14'
