...
/************************************************************************/
/* Store Procedure: ispShippingManifest_WTCTH_Summ                      */
...
/*          - Summary Report                                            */
/*                                                                      */
/* Called By: r_dw_shippingmanifest_wtcth_summ                          */
/*                                                                      */
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 5.4                                                         */
...
CREATE PROC [dbo].[ispShippingManifest_WTCTH_Summ] (
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               @@error, 
               @c_errmsg,
               'ispShippingManifest_WTCPH_Det_Summ'
...
/* 1) Insert OrderQTY for all                     */
   ...
   INNER JOIN @tResult_CT t ON (A.ConsigneeKey = t.ConsigneeKey AND A.SKU = t.SKU)
