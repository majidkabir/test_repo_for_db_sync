...
/************************************************************************/
/* Stored Procedure: nsp_ReplenishmentRpt_PC07                          */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
...
/************************************************************************/
CREATE PROC  [dbo].[nsp_ReplenishmentRpt_PC07] 
                  ...
                  BEGIN
                     ...
                     BEGIN
                        ...
                        BEGIN
                           ...
                           FROM #lotxlocxid LOTxLOCxID (NOLOCK)  
                           ...
                           WHERE LOTxLOCxID.LOT > @c_fromlot2
                              ...
                              AND DATEDIFF(dd, getdate(), lottable04) >= CASE WHEN ISNUMERIC(Sku.busr6) = 1 THEN 
                                                                                 CAST(SKU.busr6 as int)
                                                                               ELSE 0
                                                                           END 
                              AND LOT.STATUS = 'OK' 
                              AND LOC.Facility = @c_Zone01
                    ...
                    /* CREATE PROC  nsp_ReplenishmentRpt_PC07 
  @c_zone01           NVARCHAR(10) 
 ,@c_zone02           NVARCHAR(10) 
 ,@c_zone03           NVARCHAR(10) 
 ,@c_zone04           NVARCHAR(10) 
 ...
 -- End Insert Replenishment
   ...
   --(Wan01) - END
      ...
      BEGIN             
         ...
         LOTATTRIBUTE.LOTTABLE04, PACK.Pallet
         FROM  REPLENISHMENT R, SKU (NOLOCK), LOC (NOLOCK), LOTATTRIBUTE (NOLOCK),  
         ...
         and  r.confirmed = 'N'
         AND  LOTATTRIBUTE.LOT = R.LOT
         AND  LOC.Facility = @c_zone01 -- SOS29696
