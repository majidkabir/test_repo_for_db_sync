...
GO
/************************************************************************/    
/* Store Procedure:  nspConsoPickList05                             */    
/* Creation Date:                                           */    
/* Copyright: IDS                                                       */    
/* Written by:                                                */    
/*                                                                      */    
/* Purpose:  ALTER  Consolidated Pickslip for IDSTW       */    
/*                                                                      */    
...
/* Return Status:  None                                                 */    
/*                                                                      */    
/* Usage:  Used for report dw = r_dw_consolidated_pick05_4            */    
/*                                                                      */    
/* Local Variables:                                                     */    
/*                                                                      */    
/* Called By:                                                */    
...
/* 03-Jan-2005  MaryVong  Do Auto Scan-in when only 1 storer found  */    
/*          and configkey is setup         */    
/*          (SOS30692)           */    
/*                          */    
/* 17-Jun-2005  Shong   Ver. Performance Patching                       */    
/* 27-Jul-2010  GTGoh   1.0  SOS#180982 - Add Expiry Date Column (GOH01)*/    
/* 17-Jun-2013  NJOW01  2.0  277602 - Add putawayzone                   */    
/* 22-Aug-2016  CSCHONG 3.0  374710 - add sorting (CS01)                */  
/* 10-Nov-2017  JHTAN   3.1  INC0036616 - LogicalLocation sorting error */   
/*                                        (JH01)                        */    
/************************************************************************/    
    
CREATE PROC [dbo].[nspConsoPickList05] (    
...
BEGIN    
 ...
 BEGIN    
   SELECT LoadPlanDetail.LoadKey,       
       ...
       PACK.CaseCnt,      
       PACK.PackKey,     
       LOTATTRIBUTE.Lottable04,     --GOH01         
       LOC.Putawayzone, --NJOW01    
   ...
   JOIN PICKHEADER (NOLOCK) ON ( PICKHEADER.ExternOrderKey = LoadPlan.LoadKey ) AND    
                         ( PICKHEADER.Zone = '7' )                             
   JOIN LOTATTRIBUTE (NOLOCK) ON ( LOTATTRIBUTE.Storerkey = PICKDETAIL.Storerkey --GOH01    
          AND LOTATTRIBUTE.SKU = PICKDETAIL.SKU   --GOH01    
          AND LOTATTRIBUTE.Lot = PICKDETAIL.Lot)  --GOH01    
   JOIN LOC (NOLOCK) ON PICKDETAIL.LOC = LOC.Loc --NJOW01           
