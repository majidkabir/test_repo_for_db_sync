...
BEGIN
   ...
   SAVE TRAN nspTTMFCP7 -- For rollback or commit only our own transaction
   ...
   BEGIN
      ...
      -- No check transitloc as LIT advise 
      -- only 2nd phase of this project will use 2 steps pick here
   ...
   COMMIT TRAN nspTTMFCP7 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN nspTTMFCP7 -- Only rollback change made here
Fail:
Quit:
