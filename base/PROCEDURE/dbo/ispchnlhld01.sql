...
BEGIN  
   ...
   BEGIN
         ...
         SELECT @c_ErrMsg = 'NSQL' + CONVERT(CHAR(5), @n_Err) +
                            ...
                            ': Channel Attribute Configuration Not Found! (ispCHNLHLD01)'
         GOTO QUIT_SP
   END       
   ...
   AND LOC.LocationFlag = @c_Channel ' +
...
QUIT_SP:
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE dbo.nsp_LogError @n_Err, @c_Errmsg, 'ispCHNLHLD01'		
