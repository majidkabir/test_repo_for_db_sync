...
/***************************************************************************/    
CREATE proc [dbo].[isp_monthly_by_bizgroup](
...
set @d_start_date = convert(datetime,'01/01/' + convert(char(4), datepart(year, @c_datemin)))
...
and d.orderdate >= @c_datemin
and d.orderdate < dateadd(day,1,@c_datemax) 
