...
/***************************************************************************/  
/* Stored Proc : isp_GetPickSlipOrders93_1                                 */  
/* Creation Date:                                                          */  
/* Copyright: IDS                                                          */  
/* Written by:                                                             */  
/*                                                                         */  
/* Purpose: Pick Slip for TRIPLE (POSM Orders)                             */  
/*                                                                         */  
/*                                                                         */  
/* Usage:                                                                  */  
/*                                                                         */  
/* Local Variables:                                                        */  
/*                                                                         */  
/* Called By: r_dw_print_pickorder93_1                                     */  
/*                                                                         */  
/* PVCS Version: 1.0                                                       */  
/*                                                                         */  
/* Version: 5.4                                                            */  
...
CREATE PROC [dbo].[isp_GetPickSlipOrders93_1] (@c_loadkey NVARCHAR(10), @c_Status NVARCHAR(30) )  
AS  
BEGIN  
   SET NOCOUNT ON  
   SET ANSI_NULLS OFF  
   ...
   -- AND Long      = 'r_dw_print_pickorder93'  
...
QUIT_SP:
   ...
   BEGIN  
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'isp_GetPickSlipOrders93_1'  
