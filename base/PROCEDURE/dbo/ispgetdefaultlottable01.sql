...
/************************************************************************/  
/* Store procedure: ispGetDefaultLottable01                             */  
/* Copyright: IDS                                                       */  
/* Purpose: Get top 1 lottable01 from the ASN                           */  
/*                                                                      */  
/* Modifications log:                                                   */  
/*                                                                      */  
/* Date         Author    Ver.  Purposes                                */  
/* 2014-03-18   James     1.0   Created                                 */  
/* 2014-05-21   TKLIM     1.1   Added Lottables 06-15                   */
/* 2015-02-05   CSCHONG   1.2   Add new input parameter (CS01)          */
/************************************************************************/  
  
CREATE PROCEDURE [dbo].[ispGetDefaultLottable01]  
...
BEGIN  
   ...
   -- Note: Assume all lottable01 is same within 1 receiptkey
   DECLARE @cReceiptKey    NVARCHAR( 10)

   SET @cReceiptKey = ISNULL( @c_Sourcekey, '')
