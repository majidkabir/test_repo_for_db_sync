...
/************************************************************************/              
/* Store procedure: isp_WSITF_GeekPlusRBT_Order_Inbound_Order           */              
...
/************************************************************************/    
CREATE PROC [dbo].[isp_WSITF_GeekPlusRBT_Order_Inbound_Order](
     @b_Debug                 INT
...
BEGIN
   ...
   SET @c_Application                     = 'GEEK+_ORDER_RESPONSE_IN_ORDERTYPE'
      ...
      BEGIN
         ...
         BEGIN
            ...
            SET @c_ErrMsg = 'FAILD TO UPDATE PickDetail.QTY and PickDetail.DropId and PickDetail.Status'
                           + '. (isp_WSITF_GeekPlusRBT_Order_Inbound_Order)'    
         GOTO QUIT                                                                                          
         END  --IF @@ERROR <> 0
      END
