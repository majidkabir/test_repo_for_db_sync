...
GO
/************************************************************************/  
/* Trigger:  ispJACKWLottable04                                         */  
/* Copyright: IDS                                                       */  
/*                                                                      */  
/* Purpose:  SOS#315958 Default lottable04 with GETDATE()               */  
/*                                                                      */  
/*                                                                      */  
/* PVCS Version: 1.1                                                    */  
/*                                                                      */  
...
CREATE PROCEDURE [dbo].[ispJACKWLottable04]  
...
BEGIN  
   ...
   SET @dt_Lottable04 = CONVERT(char(10),GETDATE(),103)
