...
GO
/************************************************************************/    
/* Stored Procedure: isp_Packing_List_37                                */    
...
/*                                                                      */    
/*                                                                      */    
/* Called By: report dw = r_dw_Packing_List_37                          */    
/*                                                                      */    
/* PVCS Version: 1.1                                                    */    
/*                                                                      */    
/* Version: 5.4                                                         */    
...
/* 07-DEC-2022  MINGLE    2.7   WMS-21246 - Add notes2 (ML01)         */    
/************************************************************************/    
   ...
   CREATE TABLE #TEMP_PackList37    
         (  Rowid            INT IDENTITY(1,1),    
            ...
            ShowRemark       NVARCHAR(1)   NULL,                            --WL03  
				OHNOtes2         NVARCHAR(4000) NULL,									 --ML01  
         )    
        ...
        SELECT  DISTINCT ORDERS.OrderKey,    
          ...
          ELSE ISNULL(S.B_Company,'') END AS IDS_Company,  
            ...
            /*CS07 END*/   
                   ...
                   CASE WHEN ORDERS.Ordergroup = 'S01' THEN     
                      ...
                      CASE WHEN ORDERS.Ordergroup = 'S01' THEN     
                          CASE WHEN ORDERS.c_country = 'HK'  THEN ISNULL(MWRHK.Address3,'')    
                           ...
                           WHEN ORDERS.c_country = 'AU'  THEN ISNULL(MWRAU.Address3,'')                               WHEN ORDERS.c_country = 'NZ'  THEN ISNULL(MWRNZ.Address3,'')    
                           ELSE '' END    
                ...
                --WL03 END  
					 --,ORDERS.Notes2 --ML01  
					 ,REPLACE(TRIM(ISNULL(ORDERS.Notes2, '')), ', ', ', ' + CHAR(13)) --ML01  
              FROM MBOL WITH (NOLOCK)    
      ...
      FETCH FROM CS_ORDERS_INFO INTO @c_OrderKey, @c_MBOLKey, @c_pmtterm, @c_ExtPOKey,    
                                 ...
                                 @c_ShowRemark,@c_OHNOtes2   --WL03 --ML01  
