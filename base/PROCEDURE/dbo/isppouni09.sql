...
BEGIN  
   ...
   BEGIN        
      ...
      SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0)) +         
                      ': Update PickDetail Failed. (ispPOUNI09)'        
      GOTO Quit        
   END  
   ...
   SELECT PD.PickDetailKey, PD.OrderKey, PD.OrderLineNumber, PD.StorerKey,     
          PD.SKU, PD.UOM, PD.Qty, PD.PackKey    
   FROM dbo.PickDetail PD WITH (NOLOCK)        
   ...
   BEGIN        
      ...
      BEGIN    
         ...
         BEGIN    
            ...
            SET UOM = @c_UOM, UOMQty = @n_PDQty / @n_PackSize, Qty = @n_PDQty, TrafficCop = NULL        
       ...
       SET @n_PDQty = @n_PackSize * @n_UOMQty    
               ...
               BEGIN            
                  ...
                  SET @n_Err = 14007        
                  SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0)) +          
                                  ': Unable to retrieve new PickdetailKey. (ispPOUNI09)'          
                  GOTO Quit         
               END          
               ...
               BEGIN            
                  ...
                  SET @n_Err = 14008       
                  SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0)) +          
                                  ': Insert Pickdetail Failed. (ispPOUNI09)'          
                  GOTO Quit         
               END    
            END    
            ELSE    
            BEGIN    
               ...
               BEGIN    
                  ...
                  BEGIN    
                     ...
                     SET @n_Err = 14010    
                     SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0)) +    
                                     ': Delete Pickdetail Failed. (ispPOUNI09)'    
                     GOTO Quit         
                  END    
               ...
               BEGIN    
                  ...
                  UPDATE PickDetail WITH (ROWLOCK)        
                  SET UOM = '6', UOMQty = @n_PDQty, Qty = @n_PDQty, TrafficCop = NULL        
                  WHERE PickDetailKey = @c_PickDetailKey  
                  AND AddWho = 'rajans'
   ...
   BEGIN      
      ...
      BEGIN            
         ...
         BEGIN                
            ...
            SET @n_Err = 14002            
            SET @c_Errmsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0)) +               
                           ': Unable to retrieve new CaseID. (ispPOUNI09)'             
            GOTO Quit             
         END             
...
QUIT:      
   ...
   BEGIN      
      ...
      BEGIN      
         ...
         END      
      END      
      EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'ispPOUNI09'      
