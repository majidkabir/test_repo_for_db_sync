...
/************************************************************************/
/* Store Procedure:  isp_UCC_Carton_Label_92                            */
/* Creation Date: 23-Dec-2019                                           */
/* Copyright: LFL                                                       */
/* Written by: WLChooi                                                  */
/*                                                                      */
/* Purpose:  WMS-11393 - [CN] Pandora_ECOM_Carton Label_Enhancement_CR  */ 
/*                                                                      */
/*                                                                      */
...
CREATE PROC [dbo].[isp_UCC_Carton_Label_92] (
...
BEGIN
   ...
   IF @c_Type = 'MAIN'
   BEGIN
      SELECT TOP 1 @c_StorerKey, @c_PickSlipNo, @c_StartCartonNo, @c_EndCartonNo, ISNULL(Salesman,'') AS Salesman
      FROM ORDERS (NOLOCK)
