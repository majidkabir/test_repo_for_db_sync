...
GO
/***************************************************************************/
/* Stored Proc : nsp_GetPickSlipOrders03g                                  */
/* Creation Date: 28-05-2019                                               */
/* Copyright: IDS                                                          */
/* Written by: WLCHOOI                                                     */
/*                                                                         */
/* Purpose: Modified from nsp_GetPickSlipOrders03e                         */
/*                                                                         */
/* Usage:                                                                  */
/*                                                                         */
/* Local Variables:                                                        */
/*                                                                         */
/* Called By: r_dw_print_pickorder03g                                      */
/*                                                                         */
/* PVCS Version: 1.0                                                       */
/*                                                                         */
/* Version: 5.4                                                            */
...
CREATE PROC [dbo].[nsp_GetPickSlipOrders03g]
(
...
BEGIN TRAN
   ...
   LEFT JOIN CODELKUP WITH (NOLOCK) ON ( CODELKUP.ListName = 'REPORTCFG' )
                                    ...
                                    AND( CODELKUP.Long = 'r_dw_print_pickorder03g')
