...
/************************************************************************/
/* Stored Proc: isp_packing_list_101_JD                                 */
/* Creation Date: 22-Apr-2022                                           */
/* Copyright: LF Logistics                                              */
/* Written by: WLChooi                                                  */
/*                                                                      */
/* Purpose: WMS-19525 CN_Converse_PackList_JD                           */
/*        : Copy from isp_packing_list_101_ByteDance and modify         */
/*                                                                      */
/* Called By: r_dw_packing_list_101_JD                                  */
/*          :                                                           */
/* GitLab Version: 1.1                                                  */
/*                                                                      */
/* Version: 7.0                                                         */
...
/* 22-Apr-2022 WLChooi  1.0   Devops Scripts Combine                    */
/* 14-Jul-2022 WLChooi  1.1   WMS-20244 Modify SKU Logic (WL01)         */
/************************************************************************/
CREATE PROC [dbo].[isp_packing_list_101_JD]
...
BEGIN
   ...
   SELECT  SortBy = ROW_NUMBER() OVER ( ORDER BY ISNULL(PH.PickSlipNo,'')
         ...
         , OH.Loadkey
         , OH.Orderkey
         , OHUDF03 = N'CONVERSE官方旗舰店'
         , ExternOrderkey = ISNULL(RTRIM(UPPER(OH.ExternOrderkey)),'')
         , SSUSR5  = ISNULL(RTRIM(SKU.SUSR5),'')
