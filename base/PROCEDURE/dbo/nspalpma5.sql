...
GO
/************************************************************************/    
/* Stored Procedure: nspALPMA5                                          */    
/* Creation Date: 10-JAN-2020                                           */    
/* Copyright: LFL                                                       */    
/* Written by:                                                          */    
/*                                                                      */    
/* Purpose: WMS-11530 CN PUMA Allocation                                */
/*         	Piece from pick overallocation(sku with pick) uom 7         */
/*         	Piece from all loc (sku without pick) uom 6                 */
/*          SkipPreallocation = '1'                                     */
/*                                                                      */
/* Called By: Wave                                                      */    
/*                                                                      */    
...
BEGIN    
   ...
   SET @c_SQL = N'   
      ...
      CASE WHEN @c_UOM = '7' THEN 
             ' ORDER BY CASE WHEN SL.LocationType = ''PICK'' THEN 1 ELSE 2 END, LOC.LocationRoom, LA.Lottable05, LOC.LogicalLocation, LOC.LOC ' 
          ELSE
