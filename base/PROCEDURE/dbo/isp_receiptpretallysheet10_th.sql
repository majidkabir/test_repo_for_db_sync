...
/************************************************************************/
/* Stored Proc: isp_ReceiptPreTallySheet10_th                           */
/* Creation Date: 09-MAY-2023                                           */
/* Copyright: LF Logistics                                              */
/* Written by:CSCHONG                                                   */
/*                                                                      */
/* Purpose: WMS-22457 - TH-CR-adidas-Pre-TallySheet Report              */
/*        :                                                             */
/* Called By: r_receipt_pre_tallysheet10_th                             */
/*          :                                                           */
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 7.0                                                         */
...
/* 09-MAY-2023  CSCHONG   1.0 Devops Scripts combine                    */
/* 31-MAY-2023  CSCHONG   1.1 Merge latest datawindow                   */
/************************************************************************/

CREATE   PROC [dbo].[isp_ReceiptPreTallySheet10_th]
...
BEGIN
   ...
   SELECT RECEIPT.RECEIPTKEY,
          ...
          PalletPosition = CASE WHEN  UCC.Userdefined08 ='' OR ( UCC.Userdefined08 ='HV' AND UCC.Userdefined06 = '1' 
                                                                 AND UCC.Userdefined07 ='1' AND UCC.Userdefined09 = '1') THEN 'QC-FM'  
                                WHEN  UCC.Userdefined08 ='' OR ( UCC.Userdefined08 ='HV' AND UCC.Userdefined07 ='1' AND UCC.Userdefined09 = '1') THEN 'QC-M'   
                                WHEN  UCC.Userdefined08 ='' OR ( UCC.Userdefined08 ='HV' AND UCC.Userdefined06 ='1' AND UCC.Userdefined07 = '1') THEN 'F-M'                              
 ...
 GROUP BY receiptkey,PalletPosition,sku
  ...
  --DROP TABLE #ITEMCLASS2
   ...
   BEGIN
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'isp_ReceiptPreTallySheet10_th'
