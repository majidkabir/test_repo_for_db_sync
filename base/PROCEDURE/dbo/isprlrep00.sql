...
GO
/************************************************************************/      
/* Stored Procedure: ispRLREP00                                         */      
/* Creation Date: 12/07/2017                                            */      
/* Copyright: LFL                                                       */      
/* Written by:                                                          */      
/*                                                                      */      
/* Purpose: WMS-2324 Standard Release replenishment task(RPF) from      */
...
RETURN_SP:
    ...
    BEGIN  
       ...
       BEGIN  
          ...
          END  
       END  
       execute nsp_logerror @n_err, @c_errmsg, "ispRLREP00"  
