...
/************************************************************************/
/* Trigger: nsp_GetPickSlipOrders04a                             	      */
/* Creation Date: 27-Jul-2004                                           */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
/* Purpose: Pickslip for IDSPH - Loreal										   */
/*          Notes: Duplicate from nsp_GetPickSlipOrders04 and modified  */
/*                                                                      */
...
/* 07-Jul-2005  MaryVong	   SOS37766 Add new fields for Loreal -      */
/*                            CustomerBarcode and Sku Tag               */
/* 22-Jun-2006  UngDH         SOS52808 - All pick list must sort by     */
/*                            LogicalLocation                           */
/* 26-Nov-2013  TLTING     Change user_name() to SUSER_SNAME()          */
/************************************************************************/

CREATE PROC [dbo].[nsp_GetPickSlipOrders04a] (@c_loadkey NVARCHAR(10))
AS
BEGIN
   SET NOCOUNT ON 
   SET QUOTED_IDENTIFIER OFF 
