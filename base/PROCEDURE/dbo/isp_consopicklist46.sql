...
/************************************************************************/
/* Stored Procedure: isp_ConsoPickList46                                */
/* Creation Date: 01-Oct-2020                                           */
/* Copyright: LFL                                                       */
/* Written by: WLChooi                                                  */
/*                                                                      */
/* Purpose: WMS-15339 - [CN] - SKE_PrintPickSlips_CR                    */   
/*                                                                      */
/* Called By: r_dw_consolidated_pick46                                  */
/*                                                                      */
/* GitLab Version: 1.0                                                  */
/*                                                                      */
/* Version: 6.0                                                         */
...
CREATE PROC [dbo].[isp_ConsoPickList46] (
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         SET @n_continue = 3
         SET @n_err = 65005
         SET @c_errmsg='NSQL'+CONVERT(char(5),@n_err)+': Get Pickslipno Failed. (isp_ConsoPickList46)'
      END
      
      INSERT INTO #TMP_CONSO46
      (
         Loadkey,
         Pickslipno,
         Facility,
...
QUIT_SP:
   IF OBJECT_ID('tempdb..#TMP_CONSO46') IS NOT NULL
      DROP TABLE #TMP_CONSO46
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, 'isp_ConsoPickList46'
