...
/*          Copy from isp_BT_Bartender_Shipper_Label_SCSmartLogis             */              
/*                                                                            */               
/* Modifications log:                                                         */               
/*                                                                            */               
/* Date       Rev  Author     Purposes                                        */    
/* 2023-06-08 1.0  CSCHONG    Devops Scripts Combine & WMS-22702 (Created)    */           
/******************************************************************************/              
                
CREATE   PROC [dbo].[isp_BT_Bartender_Shipper_Label_SCSmartLogis]                     
...
BEGIN                    
  ...
  DECLARE  @d_Trace_StartTime   DATETIME, 
   ...
   SET @c_SQLJOIN = +' SELECT DISTINCT F.DESCR,F.Address1,F.Address2,F.Address3,F.Address4,'   --5
                    ...
                    +' LEFT JOIN STORER ST WITH (NOLOCK) ON ST.Storerkey = ORD.C_contact2 AND ST.ConsigneeFor = ORD.Storerkey AND ST.Type = ''2'' '
