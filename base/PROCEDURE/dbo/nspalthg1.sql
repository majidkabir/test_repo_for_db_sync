...
GO
/************************************************************************/    
/* Stored Procedure: nspALTHG1                                          */    
/* Creation Date: 28-AUG-2019                                           */    
/* Copyright: LFL                                                       */    
/* Written by:                                                          */    
/*                                                                      */    
/* Purpose: WMS-10428 THGSG Allocation                                  */
/*         	Piece from pick then bulk - UOM 6                           */
/*          SkipPreallocation = '1'                                     */
/*                                                                      */
/* Called By: Wave                                                      */    
/*                                                                      */    
...
BEGIN    
   ...
   BEGIN
      ...
      SELECT @c_SpecialHandling = O.SpecialHandling
      FROM ORDERS O (NOLOCK)
   ...
   SET @c_SQL = N'   
      ...
      CASE WHEN @c_SpecialHandling = 'X' THEN ' AND Loc.PickZone LIKE ''PBO%'' '
           ELSE ' AND Loc.PickZone NOT LIKE ''PBO%'' ' END +      --CS01
      ...
      ' ORDER BY CASE WHEN LOC.LocationType = ''PICK'' THEN 1 ELSE 2 END, LA.Lottable04, LA.Lottable05, LA.Lot, LOC.LogicalLocation, LOC.Loc'
