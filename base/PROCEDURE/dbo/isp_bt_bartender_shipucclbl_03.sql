...
/******************************************************************************/                   
/* Copyright: LFL                                                             */                   
/* Purpose: isp_BT_Bartender_SHIPUCCLBL_03                                    */                   
/*                                                                            */                   
/* Modifications log:                                                         */                   
/*                                                                            */                   
...
BEGIN                        
 ...
 --  SET ANSI_WARNINGS OFF                    --CS01             
   ...
   ELSE
   BEGIN
      SET @c_TableLinkage = 'JOIN ORDERS ORD (NOLOCK) ON PH.Orderkey = ORD.Orderkey '
   END
         
   SET @c_SQLJOIN = N' SELECT DISTINCT ORD.Consigneekey, ISNULL(ST.SUSR2,''''), ISNULL(ST.B_City,''''), '
                  +  ' ISNULL(ST.Address3,''''), PD.LabelNo, ' + CHAR(13) --5
                  +  ' ISNULL(CL.UDF02,''''), '''', '''', '''', '''', ' + CHAR(13) --10
                  +  ' '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', ' + CHAR(13) --20
                  +  ' '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', ' + CHAR(13) --30
                  +  ' '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', ' + CHAR(13) --40
                  +  ' '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', ' + CHAR(13) --50
...
EXIT_SP:      
   ...
   EXEC isp_InsertTraceInfo     
      ...
      @c_TraceName = 'isp_BT_Bartender_SHIPUCCLBL_03',    
