...
CREATE PROC [dbo].[nspPRCDC1R]
 ...
 BEGIN -- MAIN
  ...
  -- print '@c_CustSubCode' + @c_CustSubCode + ' @c_Lottable03 ' + @c_Lottable03 + ' @c_OrderKey=' + @c_OrderKey
...
--	          " AND LOC.Loc NOT IN ('CDC-OVFLOW','MOVFLW-LO','STAGEU') " + 
	          @c_LimitString + " " +   
