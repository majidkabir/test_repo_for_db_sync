...
GO
/************************************************************************/    
   /* Stored Procedure: isp_CommecialInvoice_03                            */    
   /* Creation Date: 03-May-2017                                           */    
   /* Copyright: IDS                                                       */    
   /* Written by: CSCHONG                                                  */    
   /*                                                                      */    
   /* Purpose:MS-1745 - SG Logitech Shipping Invoice Report                */    
   /*                                                                      */    
   /*                                                                      */    
   /* Called By: report dw = r_dw_commercialinvoice_03                     */    
   /*                                                                      */    
   /* PVCS Version: 1.6                                                    */    
   /*                                                                      */    
   /* Version: 5.4                                                         */    
   ...
   CREATE PROC [dbo].[isp_CommecialInvoice_03] (    
   ...
   BEGIN    
     ...
     -- SET ANSI_WARNINGS OFF    
      ...
      DECLARE @n_rowid      INT,    
          ...
          ,@c_OrderKey_Inv  NVARCHAR(10)    --(Wan01) 
      ...
      CREATE TABLE #TEMP_CommINV03    
            (  Rowid            INT IDENTITY(1,1),    
               ...
               ODUDF05          NVARCHAR(50) NULL,       --CS01, G01, WL04    
            ...
            ,  OrderKey_Inv     NVARCHAR(10)  NULL       --(Wan01)      
   ...
   ,  OrderKey_Inv     NVARCHAR(10)                     --(Wan01)       
      )    
      ...
      SELECT  MBOL.Mbolkey AS MBOLKEY,    
             ...
             --WL04 START 
             --WL02 START    
             CASE WHEN ORDERS.C_COUNTRY IN ('IN','KR') THEN REPLACE(ISNULL(SKUINFO.EXTENDEDFIELD05,''),'/','/ ') --G01
      ...
      BEGIN       
         ...
         BEGIN                                                             --(Wan01)    
            ...
            WHERE MBOLKey=@c_getmbolkey AND OrderKey=@c_OrderKey_Inv       --(Wan01)            
         END                                                               --(Wan01)    
         ELSE                                                              --(Wan01)    
         BEGIN    
