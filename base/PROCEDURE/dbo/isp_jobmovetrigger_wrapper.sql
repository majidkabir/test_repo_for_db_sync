...
/************************************************************************/  
/* Stored Procedure: isp_JobMoveTrigger_Wrapper                         */  
...
/* Purpose:                                                             */
/*                                                                      */  
/* Called By: WorkOrderJobMove insert/update/delete trigger             */    
/*            Stored proc naming: ispJMVxx                              */
/*                                                                      */  
/* PVCS Version: 1.0                                                    */  
/*                                                                      */  
/* Version: 5.4                                                         */  
...
CREATE PROCEDURE [dbo].[isp_JobMoveTrigger_Wrapper]  
...
BEGIN  
   ...
   SET @c_SQL        = ''
   SET @c_Storerkey  = ''
   SET @c_configkey = 'JobMoveTrigger_SP'
...
QUIT_SP:
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, 'isp_JobMoveTrigger_Wrapper'
