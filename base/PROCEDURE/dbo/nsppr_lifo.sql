...
/************************************************************************/
/* Stored Procedure: nspPR_LIFO                                         */
/* Creation Date: 12-July-2018                                          */
/* Copyright: LFL                                                       */
/* Written by:                                                          */
/*                                                                      */
/* Purpose: PreAllocateStrategy : WMS-5718 Last In First Out            */
/*                                                                      */
...
BEGIN
   ...
   BEGIN
      ...
      ORDER BY Lotattribute.Lottable05 DESC, Lot.Lot DESC
   END
   ELSE
   BEGIN
      /* Get Storer Minimum Shelf Life */
