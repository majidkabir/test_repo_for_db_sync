...
/******************************************************************************/                 
/* Copyright: IDS                                                             */                 
/* Purpose: isp_Bartender_Pallet_Putaway_Label                                */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
/* Date       Rev  Author     Purposes                                        */                 
/* 2014-04-01 1.0  CSCHONG    Created (SOS306942)                             */   
/* 2017-01-24 1.1  TLTING01   SET ANSI NULLS Option                           */        
/* 2017-10-24 1.4  CSCHONG    Remove FULL JOIN (CS04)                         */   
/* 2019-05-10 1.5  WLCHOOI    Add ReceiptDetail.Lottable01 (WL01)             */      
/******************************************************************************/                
                  
CREATE PROC [dbo].[isp_Bartender_Pallet_Putaway_Label]                      
...
/*   SET @d_Trace_EndTime = GETDATE()  
   ...
   EXEC isp_InsertTraceInfo   
      ...
      @c_TraceName = 'isp_Bartender_Pallet_Putaway_Label',  
