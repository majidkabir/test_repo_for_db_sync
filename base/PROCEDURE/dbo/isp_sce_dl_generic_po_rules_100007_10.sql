...
GO
/************************************************************************/
/* Store Procedure:  isp_SCE_DL_GENERIC_PO_RULES_100007_10              */
...
CREATE PROCEDURE [dbo].[isp_SCE_DL_GENERIC_PO_RULES_100007_10] (
   @b_Debug       INT            = 0
 , @n_BatchNo     INT            = 0
 , @n_Flag        INT            = 0
...
BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               SET @c_ErrMsg = 'NSQL' + CONVERT(CHAR(5), ISNULL(@n_ErrNo, 0))
                               + ': Update record fail. (isp_SCE_DL_GENERIC_PO_RULES_100007_10)';
               ROLLBACK;
         ...
         BEGIN
            ...
            BEGIN
               ...
               SET @n_ErrNo = 68001;
               SET @c_ErrMsg = 'NSQL' + CONVERT(CHAR(5), ISNULL(@n_ErrNo, 0))
                               + ': Update record to SCE_DL_PO_STG fail. (isp_SCE_DL_GENERIC_PO_RULES_100007_10)';
               ROLLBACK;
               GOTO STEP_999_EXIT_SP;
            END;
            COMMIT;
   ...
   IF @b_Debug = 1
   BEGIN
      SELECT '<<SUB-SP-RULES>> - [isp_SCE_DL_GENERIC_PO_RULES_100007_10] EXIT... ErrMsg : ' + ISNULL(RTRIM(@c_ErrMsg), '');
   END;
