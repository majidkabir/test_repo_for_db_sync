...
/***************************************************************************/
/* Store Procedure:  nspPRTW06                                             */
/* Purpose:  Taiwan Standard PreAllocation Strategy                        */
/*                                                                         */
...
/* 04-Jun-2007  SHONG     SOS#60580 - If Consignee Min ShelfLife is not    */
/*                        define, then use SKU.SUSR2 (MinOutGoingShelfLife)*/
/*                                                                         */
/***************************************************************************/

 

CREATE PROC  [dbo].[nspPRTW06]
