...
/************************************************************************/
/* Store Procedure: isp_Print_SSCC_CartonLabel_04_uf           		      */
...
CREATE   PROC [dbo].[isp_Print_SSCC_CartonLabel_04_uf] ( 
...
BEGIN
   ...
   DECLARE @tTempResult TABLE (
         ...
         BillTo_Addr4            NVARCHAR( 45) NULL,  --NJOW01
         BillTo_City             NVARCHAR( 45) NULL,  --NJOW01
         ...
         BillTo_Label            NVARCHAR( 22) NULL,  -- include brackets 
         BillTo_Barcode          NVARCHAR( 22) NULL,  -- exclude brackets
   ...
   DECLARE 
      ...
      @cBillTo_Addr4            NVARCHAR( 45), --NJOW01
      @cBillTo_City             NVARCHAR( 45), --NJOW01
      ...
      @cColor                   NVARCHAR( 3),
      @cSize                    NVARCHAR( 3),
      @cBillTo_Label            NVARCHAR( 22),
      @cBillTo_Barcode          NVARCHAR( 22),
      ...
      @cShort                   int --Added by HFLiew on 12 Mac 2008 for SOS98666 to enable the digits dynamic value
   ...
   BEGIN
      ...
      SELECT 
         ...
         @cBillTo_Addr4      = BillTo.Address4,  --NJOW01
         @cBillTo_City       = BillTo.City,  --NJOW01
      ...
      INNER JOIN STORER DivCode (NOLOCK) ON (OH.OrderGroup = DivCode.StorerKey)
      INNER JOIN STORER BillTo (NOLOCK) ON (OH.Consigneekey = BillTo.StorerKey)
      INNER JOIN STORER ShipTo (NOLOCK) ON (OH.MarkForkey = ShipTo.StorerKey)
...
-- End of statement-------------------------------------------------------------------------------------- 
      ...
      SET @curLABEL = CURSOR LOCAL FAST_FORWARD READ_ONLY FOR
   	...
   	BEGIN
         ...
         SELECT @cBillTo_Label = '(421)036' +
                  ...
                  '(90)' + dbo.fnc_RTrim(dbo.fnc_LTrim(@cOrdUserDefine03))
      ...
      SET
         ...
         BillTo_Addr4       = @cBillTo_Addr4,  --NJOW01
         BillTo_City        = @cBillTo_City,  --NJOW01
