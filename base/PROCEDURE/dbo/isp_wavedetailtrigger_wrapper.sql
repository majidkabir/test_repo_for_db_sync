...
GO
/************************************************************************/  
/* Stored Procedure: isp_WaveDetailTrigger_Wrapper                      */  
/* Creation Date: 20-OCT-2022                                           */  
/* Copyright: LFL                                                       */  
/* Written by:                                                          */  
/*                                                                      */  
/* Purpose:  WMS-21042-Call wavedetail custom stored proc               */
/*                                                                      */  
/* Called By: Wavedetail insert/update/delete trigger                   */    
/*            Stored proc naming: ispWVDxx                              */
/*                                                                      */  
/* PVCS Version: 1.0                                                    */  
/*                                                                      */  
/* Version: 7.0                                                         */  
...
/* 20-OCT-2022  NJOW     1.0  DEVOPS Combine Script                     */
/************************************************************************/  

CREATE PROCEDURE [dbo].[isp_WaveDetailTrigger_Wrapper]  
...
BEGIN  
   ...
   BEGIN   	  
      ...
      BEGIN        	  
         ...
         EXECUTE dbo.isp_WaveDetailTrigger_Wrapper ----->wrapper for current table trigger
   ...
   */
   ...
   SET @c_SQL        = ''
   SET @c_Storerkey  = ''
   SET @c_configkey = 'WaveDetailTrigger_SP'
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, 'isp_WaveDetailTrigger_Wrapper'
