...
/************************************************************************/    
/* Stored Procedure: ispBackendAssignTrackingNo                         */    
...
/************************************************************************/    
CREATE PROC [dbo].[ispBackendAssignTrackingNo]  
...
BEGIN      
   ...
   AND   O.UserDefine04 = '' 
   AND   O.[Status] < '5'         -- O.[Status] = '0'  --tlting1
  ...
  -- AND   O.SOStatus = '0'
   ...
   ORDER BY o.Status desc, O.OrderKey    --tlting1
...
EXIT_SP:  
   ...
   BEGIN      
      ...
      BEGIN      
         ...
         END      
      END      
      EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'ispBackendAssignTrackingNo'      
