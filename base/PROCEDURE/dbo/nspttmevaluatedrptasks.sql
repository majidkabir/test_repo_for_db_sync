...
GO
/************************************************************************/
/* Stored Procedure: nspTTMEvaluateDRPTasks                             */
...
/* 23-Jul-2010  1.0   AQSKC      Update EditDate and EditWho (Kc01)     */
/************************************************************************/

CREATE PROC    [dbo].[nspTTMEvaluateDRPTasks]
    ...
    BEGIN
        ...
        BEGIN
            ...
            SELECT @c_errmsg = "NSQL"+CONVERT(CHAR(5) ,@n_err)+
                   ": Execute Of Move Tasks Pick Code Failed. (nspTTMEvaluateDRPTasks)" 
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                ...
                END
            END
            EXECUTE nsp_logerror @n_err, @c_errmsg, 'nspTTMEvaluateDRPTasks'
