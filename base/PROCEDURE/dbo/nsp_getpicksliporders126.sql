...
/************************************************************************/
/* Store Procedure:  nsp_GetPickSlipOrders126                           */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by: Mingle                                                   */
/*                                                                      */
...
/* Return Status:  None                                                 */
/*                                                                      */
/* Usage:  Used for report dw = r_dw_print_pickorder126                 */
/*                                                                      */
/* Local Variables:                                                     */
/*                                                                      */
/* Called By:                                                           */
...
CREATE PROC [dbo].[nsp_GetPickSlipOrders126] (@c_loadkey NVARCHAR(10))
AS
BEGIN
   SET NOCOUNT ON 
   SET ANSI_NULLS OFF 
   ...
   GROUP BY PickDetail.sku,       PickDetail.loc,    PickDetail.qty,  PACK.Qty,
   ...
   FETCH NEXT FROM pick_cur INTO @c_sku, @c_loc, @n_Qty, @n_uom3, @c_storerkey,
      @c_orderkey,  @c_UOM, @c_logicalloc, @c_lot, @c_ID,@c_Lottable12,@c_Lottable03
