...
/* Purpose: UWP-12623                                                   */
/*                                                                      */
/* Called By: RPT_ASN_TALLYSHT_042                                      */
/*                                                                      */
/* GitLab Version: 1.0                                                  */
/*                                                                      */
/* Version: 1.0                                                         */
...
/* 05-Jan-2023 Sean Deng 1.0   UWP-12623 - Add Two New Fields           */
/************************************************************************/

CREATE PROC [dbo].[isp_RPT_ASN_TALLYSHT_042]
(
...
BEGIN
   ...
   SELECT RECEIPT.ReceiptKey
		...
		, CaseExpected = CONVERT(DEC(10,1),(RECEIPTDETAIL.QtyExpected / PACK.CaseCnt))
        , RECEIPTDETAIL.BeforeReceivedQty
		, CaseReceived = CONVERT(DEC(10,1),(RECEIPTDETAIL.BeforeReceivedQty / PACK.CaseCnt))
        , (USER_NAME()) username
        , PACK.PackUOM1
