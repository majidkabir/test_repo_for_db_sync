...
/************************************************************************/
/* Trigger: ispMBBT01                                                   */
/* Creation Date: 10-Jul-2020                                           */
/* Copyright: LF Logistics                                              */
/* Written by: WLChooi                                                  */
/*                                                                      */
/* Purpose: WMS-13954 - Decide to print Bartender depends on Doctype    */
/*        :                                                             */
/* Called By: isp_MBOL_Bartender_Print                                  */
/*          :                                                           */
/*                                                                      */
/* GitLab Version: 1.0                                                  */
/*                                                                      */
...
CREATE PROCEDURE [dbo].[ispMBBT01]
...
BEGIN  
   ...
   SELECT @c_DocType = MAX(ORDERS.DocType)
...
QUIT_SP:
   ...
   BEGIN
      SET @b_success = 0
      EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'ispMBBT01'  
