...
GO
/************************************************************************/  
/* Stored Proc: isp_packing_list_51                                     */  
/* Creation Date: 21-MAY-2018                                           */  
/* Copyright: LF Logistics                                              */  
/* Written by: Wan                                                      */  
/*                                                                      */  
/* Purpose: WMS-5633 - [CN] Converse Ecom_Packing List                  */  
/*        :                                                             */  
/* Called By: r_dw_packing_list_51                                      */  
/*          :                                                           */  
/* PVCS Version: 1.0                                                    */  
/*                                                                      */  
/* Version: 7.0                                                         */  
...
/* 2019-08-02  WLChooi  1.1   WMS-10034 - Add Orderkey and TrackingNo   */  
/*                                        (WL01)                        */  
/* 2020-05-04  WLChooi  1.2   WMS-13220 - Add AddDate and SKUSize (WL02)*/  
/* 2021-04-09 CSCHONG   1.3   WMS-16024 PB-Standardize TrackingNo (CS01)*/  
/************************************************************************/  
CREATE PROC [dbo].[isp_packing_list_51]  
...
BEGIN  
   ...
   SELECT  SortBy = ROW_NUMBER() OVER ( ORDER BY PH.PickSlipNo  
         ...
         , Shipperkey= ISNULL(RTRIM(OH.Shipperkey),'') --+ N'速递'  --WL02  
