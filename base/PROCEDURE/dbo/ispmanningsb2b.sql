...
/************************************************************************/
CREATE   PROC [dbo].[ispManningsB2B]
...
BEGIN
   ...
   BEGIN
      ...
      SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0))  
                    ...
                    + '. Must Be MANB2B or MANB2C or MANLQ (ispManningsB2B)'   --WL01
      GOTO QUIT_SP
   END

   --This Main Pickcode only proceed MANB2B
   IF @c_WaveType NOT IN ('MANB2B')
   BEGIN
      GOTO QUIT_SP
   END
   ...
   BEGIN
      ...
      SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0))  
                    ...
                    + '. Allocation is not allowed (ispManningsB2B)'
      GOTO QUIT_SP
   END
   ...
   SET @c_SQLParms  = N' @c_Facility           NVARCHAR(5)'  
    ...
    EXEC sp_ExecuteSQL  @c_SQL
      ...
      BEGIN
         ...
         BEGIN
            PRINT '-----------------------------------'+ CHAR(13) +
                  'Main PICKCOde: ispManningsB2B'+ CHAR(13) +
                  'SKU: ' + @c_SKU + CHAR(13) +
         ...
         EXEC ispManningsLoadFP2   --//Pallet @Pallet LOC
           @c_WaveKey          = @c_WaveKey         
         ...
         END
          ...
          EXEC ispManningsLoadFC2   --//CASE @Case & @Pallet Loc, UOM = '2'
           @c_WaveKey          = @c_WaveKey         
         , @c_WaveType         = @c_WaveType  
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
         ...
         EXEC ispManningsConsoFP6  --//Pallet @Pallet LOC
           @c_WaveKey          = @c_WaveKey         
         , @c_WaveType         = @c_WaveType   
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
         ...
         EXEC ispManningsConsoFC6  --//CASE @Case & @Pallet Loc, UOM = '6'
           @c_WaveKey          = @c_WaveKey         
         , @c_WaveType         = @c_WaveType   
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
         ...
         EXEC ispManningsConsoFQ7  --//Loose Qty @DPP Loc, UOM = '7', Get DPP <= @n_QtyLeftToFullfill   --(Wan01)
           @c_WaveKey          = @c_WaveKey 
         , @c_WaveType         = @c_WaveType                      
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
         ...
         EXEC ispManningsConsoLC7  --//Loose Qty @Case & @Pallet Loc, UOM = '7'
           @c_WaveKey          = @c_WaveKey 
         , @c_WaveType         = @c_WaveType                    
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
         ...
         EXEC ispManningsConsoLQ7  --//Loose Qty @DPP Loc, UOM = '7', Get DPP >= 0 
           @c_WaveKey          = @c_WaveKey 
         , @c_WaveType         = @c_WaveType                      
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
      ...
      --IF @n_QtyLeftToFullfill > 0
      --BEGIN
      --   EXEC ispManningsConsoLQ7  --//Loose Qty @AVG Loc, UOM = '7'
      --     @c_WaveKey          = @c_WaveKey 
      --   , @c_WaveType         = 'ManningsB2B_AGV'  -- to get from AVG                       
      --   , @c_Facility         = @c_Facility         
      --   , @c_Storerkey        = @c_Storerkey        
      --   , @c_Sku              = @c_Sku              
      --   , @c_Lottable01       = @c_Lottable01       
...
QUIT_SP:
   ...
   BEGIN
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'ispManningsB2B'
