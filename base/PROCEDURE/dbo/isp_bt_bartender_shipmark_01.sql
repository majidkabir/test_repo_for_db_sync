...
/******************************************************************************/
/* Copyright: IDS                                                             */
/* Purpose: isp_BT_Bartender_SHIPMARK_01                                      */
/*                                                                            */
/* Modifications log:                                                         */
/*                                                                            */
...
CREATE PROC [dbo].[isp_BT_Bartender_SHIPMARK_01]
   ...
   SET @c_Trace_ModuleName = ''
    ...
    CREATE TABLE [#Result] (
      ...
      (
          ...
          LEFT JOIN CARTONIZATION CT WITH (NOLOCK) ON CT.CartonType = PIF.CartonType AND CT.CartonizationGroup = ST.CartonGroup
