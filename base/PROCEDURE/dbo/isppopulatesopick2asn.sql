...
/************************************************************************/
/* Stored Procedure: ispPopulateSOPick2ASN                              */
/* Creation Date: 09-08-2010                                            */
/* Copyright: IDS                                                       */
/* Written by: Vanessa                                                  */
/*                                                                      */
/* Purpose: New Populate Order and PickDetail for E1 CN SOS182963       */
/*          (Refered ispPopulateTSO2ASN)                                */
/*                                                                      */
/* Called By: Exceed Populate Order Pick Detail                         */
/*                                                                      */
/* PVCS Version: 1.3                                                    */
/*                                                                      */
/* Version: 5.4                                                         */
...
/************************************************************************/
CREATE PROCEDURE [dbo].[ispPopulateSOPick2ASN] 
...
--            AND  PODETAIL.ExternLineNo = @c_ExternOrderLine -- Remark by June 8.May.02
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  --        @c_ExternPOLine '@c_ExternPOLine', @c_OrderLine '@c_OrderLine', @c_SKU '@c_SKU' 
   ...
   --                             @d_Lottable04,    @d_Lottable05,    @n_QtyReceived,
   --                             @c_POLine
                  ...
                  INSERT INTO RECEIPTDETAIL (ReceiptKey,          ReceiptLineNumber,   ExternReceiptKey, 
                                             ...
                                             BeforeReceivedQty,   POLineNumber,        ToId)
                              VALUES        (@c_ReceiptKey,       @c_ReceiptLine,      @c_ExternReceiptKey,
                                             @c_ExternPOLine,     @c_StorerKey,        @c_SKU,
                                             @c_POKey,            ISNULL(@n_ExpectedQty,0),   0,
                                             @c_UOM,              @c_Packkey,          @c_LOC,
                                             @c_Lottable01,       @c_Lottable02,       @c_Lottable03, @d_Lottable04, @d_Lottable05,    
                                             @c_Lottable06,       @c_Lottable07,       @c_Lottable08, @c_Lottable09, @c_Lottable10, 
                                             @c_Lottable11,       @c_Lottable12,       @d_Lottable13, @d_Lottable14, @d_Lottable15,
                                             @n_QtyReceived,      @c_POLine,           @c_ID)  
