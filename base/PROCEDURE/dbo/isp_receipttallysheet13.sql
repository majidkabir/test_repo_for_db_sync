...
/***************************************************************************/  
/* Store Procedure: isp_ReceiptTallySheet13                                */  
/* Creation Date: 14-MAR-2014                                              */  
/* Copyright: LF                                                           */  
/* Written by: YTWan                                                       */  
/*                                                                         */  
/* Purpose:  SOS#306085 -  CR for Tally Sheet                              */  
/*                                                                         */  
/* Called By: PB: r_receipt_tallysheet13                                   */  
/*                                                                         */  
/* PVCS Version: 1.1                                                       */  
/*                                                                         */  
/* Version: 5.4                                                            */  
...
/* 27-Jun-2014  NJOW01    1.0   314037-add toid                            */  
/* 12-Feb-2018  SPChin    1.1   INC0128600 - Add Filter By Storerkey       */  
/***************************************************************************/  
CREATE PROC [dbo].[isp_ReceiptTallySheet13]  
...
BEGIN   
   ...
   AND   Long     = 'r_receipt_tallysheet13'  
