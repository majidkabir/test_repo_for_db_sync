...
/******************************************************************************/                 
/* Copyright: IDS                                                             */                 
/* Purpose: isp_Bartender_TH_STORELBL_GetParm                                 */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
...
CREATE PROC [dbo].[isp_Bartender_TH_STORELBL_GetParm]                      
(  @parm01            NVARCHAR(250),              
   @parm02            NVARCHAR(250),              
   @parm03            NVARCHAR(250),              
   @parm04            NVARCHAR(250),              
...
BEGIN                      
  ...
  DECLARE @d_Trace_StartTime   DATETIME,   
   ...
   SET @c_Trace_ModuleName = ''  
    ...
    SET @c_SQLJOIN = ' SELECT DISTINCT PARM1=RH.Receiptkey,PARM2=RD.SKU,PARM3=RD.lottable08,PARM4=RD.Lottable09,PARM5=RD.Toid,' + CHAR(13) +
                     ...
                     ' AND RD.SKU = @Parm02 AND RD.lottable08 = @Parm03' +
                     ' AND RD.Lottable09= @Parm04 ' +
                     ' AND RD.toid = @Parm05 '
