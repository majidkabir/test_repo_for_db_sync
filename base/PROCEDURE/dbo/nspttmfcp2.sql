...
/* 2017-04-26  Ung       1.0  WMS-1768 Created                                */
/******************************************************************************/
CREATE PROC [dbo].[nspTTMFCP2]
...
BEGIN
   ...
   SAVE TRAN nspTTMFCP2 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN nspTTMFCP2 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN nspTTMFCP2 -- Only rollback change made here
Fail:
Quit:
