    ...
    BEGIN  
        ...
        BEGIN  
            ...
            SELECT @c_errmsg = 'NSQL'+CONVERT(CHAR(5) ,@n_err)+  
                   ': Update to TaskDetail table failed. (nspTTMRT01)'+' ( '+  
    ...
    BEGIN  
        ...
        BEGIN  
            ...
            BEGIN  
                ...
                BEGIN  
                    ...
                    SELECT @c_errmsg = 'NSQL'+CONVERT(CHAR(5) ,@n_err)+  
                           ': Could not Open Cursor_Eval02. (nspTTMRT01)'+' ( '   
                          +' SQLSvr MESSAGE='+RTRIM(@c_errmsg)   
                          +' ) '  
                END  
                ELSE  
        ...
        BEGIN  
            ...
            BEGIN  
                ...
                BEGIN  
                    ...
                    SELECT @c_errmsg = CONVERT(CHAR(250) ,@n_err)  
                          ,@n_err = 81204 -- Should Be Set To The SQL Errmessage but I don't know how to do so.  
                    SELECT @c_errmsg = 'NSQL'+CONVERT(CHAR(5) ,@n_err)+': UPDATE TaskDetail Failed. (nspTTMRT01)'+' ( '   
                          + ' SQLSvr MESSAGE='+RTRIM(@c_errmsg)+' ) '  
                END
                ...
                WHERE TD.Storerkey = @c_StorerKey  
                  ...
                  AND TD.[Status]  = '3'  
                  AND TD.FromID    = @c_id
                ORDER BY ToLoc.LogicalLocation
            END  
     ...
     BEGIN  
         ...
         BEGIN  
             ...
             END  
         END  
         EXECUTE nsp_logerror @n_err, @c_errmsg, 'nspTTMRT01'  
