      ...
      IF @n_continue IN(1,2)
        ...
        BEGIN
           ...
           SET @c_SQL = N'SET @CUR_INV = CURSOR FAST_FORWARD READ_ONLY FOR
            ...
            ' GROUP BY lli.Loc, loc.LogicalLocation, LLI.ID
              ORDER BY MIN(la.Lottable05), loc.LogicalLocation, lli.Loc
                      ,CASE WHEN SUM(LLI.QTY - LLI.QTYALLOCATED - LLI.QTYPICKED - LLI.QtyReplen) <= @n_QtyLeftToFulfill
                            THEN 0
                            ELSE 5
                            END; OPEN @CUR_INV'
           ...
           SET @c_SQLParm = N'@c_StorerKey NVARCHAR(15), @c_SKU NVARCHAR(20), @c_Facility NVARCHAR(5)'
                          ...
                          +' ,@n_QtyLeftToFulfill INT, @CUR_INV CURSOR OUTPUT'
                    ...
                    BEGIN
                       ...
                       BEGIN
                          ...
                          BEGIN
                             ...
                             SET @c_errmsg='NSQL'+CONVERT(NVARCHAR(5),@n_err)+': Insert Pickdetail Failed. (ispPRJCB05)'
...
QUIT:
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'ispPRJCB05'
