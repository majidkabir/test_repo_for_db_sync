...
CREATE PROC    [dbo].[nsp_ReplenishmentRpt_RF_GL]
   ...
   SET CONCAT_NULL_YIELDS_NULL OFF
       ...
       BEGIN
          ...
          BEGIN
             ...
             WHERE SKUxLOC.StorerKey = 'GL'
             AND   SKUxLOC.LOC = LOC.LOC
             AND   LOC.putawayzone in (@c_zone01, @c_zone02, @c_zone03, @c_zone04, @c_zone05, @c_zone06, @c_zone07, @c_zone08, @c_zone09, @c_zone10, @c_zone11, @c_zone12)
             AND   LOC.Locationflag <> "DAMAGE"
             AND   LOC.Locationflag <> "HOLD"
             AND   (skuxloc.locationtype = "PICK" or skuxloc.locationtype = "CASE")
             AND   replenishmentseverity > 0
             AND   skuxloc.qty - skuxloc.qtypicked - SKUxLOC.QtyPickInProcess < skuxloc.QtyLocationMinimum --skuxloc.qtylocationlimit
          END
 			 -- Added By SHONG
 			 -- Date: 16th JUL 2001
