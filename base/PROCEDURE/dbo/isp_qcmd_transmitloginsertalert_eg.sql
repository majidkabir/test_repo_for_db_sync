...
GO
/*************************************************************************/
/* Stored Procedure: isp_QCmd_TransmitLogInsertAlert_EG                 */
...
CREATE PROCEDURE [dbo].[isp_QCmd_TransmitLogInsertAlert_EG]
...
BEGIN
   ...
   (TableName, StorerKey, Transmitlogkey)    --, MbolKey
   SELECT T3.Tablename    
        , T3.Key3    --, T3.key1
        , T3.Transmitlogkey    
   ...
   BEGIN    
      IF @b_debug = 1                                                         
      BEGIN                                                                                                                  
         PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: Nothing to Process (#QCmd_Transmitlog3_Seq)..'                                                                     
      END     
   ...
   BEGIN    
      ...
      IF @b_Debug = 1    
      BEGIN    
         PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: *** @c_TableName=' + @c_TableName    
         PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @c_StorerKey=' + @c_StorerKey
         --PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @c_MbolKey=' + @c_MbolKey    
         PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @c_TransmitLogKey=' + @c_TransmitLogKey    
      END    
      ...
      BEGIN    
         IF @b_Debug = 1    
         BEGIN    
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @c_APP_DB_Name=' + @c_APP_DB_Name    
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @c_ExecStatements=' + @c_ExecStatements    
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @c_DataStream=' + @c_DataStream    
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @n_ThreadPerAcct=' + CAST(CAST(@n_ThreadPerAcct AS INT)AS NVARCHAR)    
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @n_ThreadPerStream=' + CAST(CAST(@n_ThreadPerStream AS INT)AS NVARCHAR)    
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @n_MilisecondDelay=' + CAST(CAST(@n_MilisecondDelay AS INT)AS NVARCHAR)    
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @c_Port=' + @c_Port     
         END    
         ...
         --   IF @b_Debug = 1    
         --   BEGIN    
         --      PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: Exceeed Port Limit. Port : ' + @c_Port    
         --   END    
         --   BREAK    
         --END    
         ...
         BEGIN    
            IF @b_Debug = 1    
            BEGIN    
               PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: Record exists in TCPSOCKET_QueueTask, @c_TransmitLogKey=' + @c_TransmitLogKey    
            END    
         ...
         SET @c_ExecStatements = @c_ExecStatements     
                               + ',@c_ParamVal10=' + QUOTENAME(@c_TransmitLogKey, '''')
    
            IF @b_Debug = 1    
            BEGIN    
               PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @c_CmdType=' + @c_CmdType    
               PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @c_ExecStatements=' + @c_ExecStatements    
            END    
            ...
            BEGIN CATCH    
               ...
               IF @b_Debug = 1    
               BEGIN    
                  PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: @c_ErrMsg=' + @c_ErrMsg    
               END     
            END CATCH       
            ...
            --   IF @b_Debug = 1    
            --   BEGIN    
            --      PRINT '[isp_QCmd_TransmitLogInsertAlert_EG]: BREAK For RecCount exceeed Port Limit. Port : ' + @c_Port    
            --   END    
            --   BREAK    
            --END    
