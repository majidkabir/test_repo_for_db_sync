...
/************************************************************************/              
/* Store procedure: isp_WSITF_GeekPlusRBT_Order_Inbound_Load            */              
...
/************************************************************************/    
CREATE PROC [dbo].[isp_WSITF_GeekPlusRBT_Order_Inbound_Load](
     @b_Debug                 INT
      ...
      BEGIN
         ...
         BEGIN
            ...
            SET @c_ErrMsg = 'FAILD TO UPDATE PickDetail.QTY and PickDetail.DropId and PickDetail.Status'
                           + '. (isp_WSITF_GeekPlusRBT_Order_Inbound_Load)'    
         GOTO QUIT                                                                                          
         END  --IF @@ERROR <> 0
      END
