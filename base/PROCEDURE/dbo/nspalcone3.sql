...
GO
/*************************************************************************/
/* Stored Procedure: nspALCONE3                                          */
/* Creation Date: 07-FEB-2023                                            */
/* Copyright: LFL                                                        */
/* Written by:                                                           */
/*                                                                       */
/* Purpose: WMS-21653/21789 - CN Converse ECOM Allocation from bulk or   */
/*          overallocate pick from bulk.                                 */
/*                                                                       */
/* Called By:                                                            */
/*                                                                       */
/* PVCS Version: 1.0                                                     */
...
BEGIN    
   ...
   SET @c_SortBy = 'ORDER BY LOC.LogicalLocation, LOC.Loc, LA.Lottable05, LOTxLOCxID.Lot'
   ...
   SET @c_SQL = N'      
      ...
      'GROUP BY LOTxLOCxID.LOT, LOTxLOCxID.LOC, LOTxLOCxID.ID, LOC.LogicalLocation, LOC.LOC, LA.Lottable05 ' +    
      @c_SortBy
