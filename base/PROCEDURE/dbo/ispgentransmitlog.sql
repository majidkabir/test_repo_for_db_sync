...
GO
/************************************************************************/
/* Store Procedure:  ispGenTransmitLog                                  */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
...
/* 09-Jun-2005  YokeBeen  Extended the length of the parameter -        */
...
CREATE PROC   [dbo].[ispGenTransmitLog]
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, "ispGenTransmitLog"
