...
/************************************************************************/  
/* Stored Procedure: isp_GetKIOSKASRSPKTask_b                           */  
...
/*                                                                      */  
/* Called By: r_dw_kiosk_asrspk_b_form                                  */  
/*                                                                      */  
/* PVCS Version: 1.2                                                    */  
/*                                                                      */  
/* Version: 7.0                                                         */  
...
/* 03-JAN-2019  Wan03   1.2   WMS-7286 - PRHK-GTM Picking For COPACK Sku*/ 
/************************************************************************/   
CREATE PROC [dbo].[isp_GetKIOSKASRSPKTask_b]
...
,  Remarks             NVARCHAR(80)  NOT NULL DEFAULT ('')  --(Wan02)
   ...
   ,RemainingQtyInCS= 0
   ,RemainingQtyInEA= 0
   ,TASKDETAIL.Status--PICKDETAIL.Status
   ,@c_JobStatus
