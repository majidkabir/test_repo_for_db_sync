...
GO
/************************************************************************/
/* Store procedure: ispMCLLblNoDecode01                                 */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 29-11-2013  1.0  James       SOS295953 Created                       */
/************************************************************************/

CREATE PROCEDURE [dbo].[ispMCLLblNoDecode01]
...
BEGIN
   ...
   SET @c_Length = rdt.RDTGetConfig( @nFunc, 'ALLOWABLEBARCODELEN', @c_Storerkey)
   ...
   IF @n_LblLength > @n_Length
      SET @c_ErrMsg = 'Invalid SKU'   --Return Error
   ELSE
      SET @c_oFieled01 = @c_LabelNo -- Return
