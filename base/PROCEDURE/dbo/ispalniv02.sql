...
GO
/************************************************************************/    
/* Stored Procedure: ispALNIV02                                         */    
/* Creation Date: 02-JUNE-2014                                          */    
/* Copyright: LF                                                        */    
/* Written by:                                                          */    
/*                                                                      */    
/* Purpose: 312318 - Allocate case from level 1 case bulk               */
/*                                                                      */
/*                                                                      */    
/* Called By:                                                           */    
/*                                                                      */    
...
BEGIN    
   ...
   SET @c_SQL = N'   
      ...
      AND ISNULL(LOC.LocLevel,1) IN (0,1)
      ...
      CASE WHEN @n_StorerMinShelfLife <> 0 THEN ' AND DateAdd(Day, @n_StorerMinShelfLife, LA.Lottable04) > GetDate() ' ELSE ' ' + CHAR(13) END + CHAR(13) + --(Wan01)
