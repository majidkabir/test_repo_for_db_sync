...
CREATE PROC [dbo].[isp_DPC_DestroyJunctionBox]
(
...
BEGIN
   ...
   SET @c_DSPMessage = 'DESTROY_JUNCTION_BOX<TAB>' + @c_DeviceIP 
...
EXIT_SP:
   ...
   BEGIN  
      ...
      BEGIN  
         ROLLBACK TRAN  
         EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'isp_DPC_DestroyJunctionBox'  
