...
GO
/************************************************************************/  
/* Store Procedure: nsp_GetPickSlipOrders01                             */  
/* Creation Date:                                                       */  
/* Copyright: IDS                                                       */  
/* Written by:                                                          */  
/*                                                                      */  
...
/* 14-JUN-2023  KuanYee   1.6   INC2098409-Substring Lottable01,02,03   */  
/************************************************************************/  
 ...
 BEGIN  
   ...
   INSERT INTO #TEMP_PICK  
         (PickSlipNo,          LoadKey,          OrderKey,         ConsigneeKey,  
          ...
          Lottable03,               Lottable01,       Altsku) --NJOW01  
   ...
   SELECT DISTINCT  
         ...
         SUBSTRING(LotAttribute.Lottable03, 1, 18), -- Added By SHONG On 2nd Mar 2004 (SOS#20463)  --KY01
         SUBSTRING(LotAttribute.Lottable01, 1, 18), -- NJOW01                                      --KY01
