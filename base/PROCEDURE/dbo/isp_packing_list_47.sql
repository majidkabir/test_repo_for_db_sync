...
GO
/************************************************************************/
/* Stored Proc: isp_packing_list_47                                     */
/* Creation Date: 21-MAY-2018                                           */
/* Copyright: LF Logistics                                              */
/* Written by: Wan                                                      */
/*                                                                      */
/* Purpose: WMS-4995 - [CN] COSTCO_Ecom_PackingList                     */
/*        :                                                             */
/* Called By:                                                           */
/*          :                                                           */
/* PVCS Version: 1.0                                                    */
...
/*16-JUL-2019  WLCHOOI  1.1   WMS-9848 - Use Codelkup to store hardcoded*/
/*                                       text (WL01)                    */
/************************************************************************/
CREATE PROC [dbo].[isp_packing_list_47]
...
BEGIN
   ...
   DECLARE  
         ...
         , @c_Datawindow      NVARCHAR(100) = 'r_dw_packing_list_47'
