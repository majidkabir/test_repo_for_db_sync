...
/************************************************************************/
/* Stored Proc: isp_ReceiptPreTallySheet10                              */
/* Creation Date: 17-JUN-2021                                           */
/* Copyright: LF Logistics                                              */
/* Written by:CSCHONG                                                   */
/*                                                                      */
/* Purpose: WMS-17201 - [RG]-adidas-New-PreTallySheet Report            */
/*        :                                                             */
/* Called By: r_receipt_pre_tallysheet10                                */
/*          :                                                           */
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 7.0                                                         */
...
CREATE   PROC [dbo].[isp_ReceiptPreTallySheet10]
 ...
 GROUP BY receiptkey,PalletPosition,sku
  ...
  --DROP TABLE #ITEMCLASS2
   ...
   BEGIN
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'isp_ReceiptPreTallySheet10'
