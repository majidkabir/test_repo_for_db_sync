...
/************************************************************************/      
/* Stored Procedure: nspALBBG01                                         */      
/* Creation Date: 26-Apr-2019                                           */      
/* Copyright: LFL                                                       */      
/* Written by:                                                          */      
/*                                                                      */      
/* Purpose: WMS-8759 CN Boardriders – Allocation Strategy               */  
/*                                                                      */  
/* Called By: Wave                                                      */      
/*                                                                      */      
/* PVCS Version: 1.0                                                    */      
...
BEGIN      
   ...
   SET @c_ExtraCondition = ' AND UCC.Qty > 0 AND SL.LocationType NOT IN (''PICK'',''CASE'') ' + CHAR(13) +
                           ' AND LOC.LocationType = ''OTHER'' AND LOC.LocationFlag <> ''HOLD'' AND LOC.Status = ''OK'' ' + CHAR(13) + 
                           ' AND ID.Status = ''OK'' AND LOT.Status = ''OK'' '

   SET @c_SortingCondition = ' ORDER BY LA.Lottable05, QTYAVAILABLE, LOC.LogicalLocation, LOC.Loc '
   ...
   BEGIN  
      ...
      --SELECT TOP 1 @d_OrderDate = O.Orderdate  
      --FROM ORDERS O (NOLOCK)  
