...
GO
/************************************************************************/
/* Store procedure: isp1580LblNoDecode02                                */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 17-07-2018  1.0  James       Created                                 */
/************************************************************************/

CREATE PROCEDURE [dbo].[isp1580LblNoDecode02]
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            SET @c_oFieled09 = CASE WHEN @cDocType = 'A' THEN 'QI' ELSE 'RET' END
         END
      END
   END
