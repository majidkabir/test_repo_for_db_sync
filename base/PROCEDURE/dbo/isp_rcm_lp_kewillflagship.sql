...
/* Written by:                                                          */
/*                                                                      */
/* Purpose: 361046-Load Plan RCM trigger kewill flagship 020 interface  */
/*                                                                      */
...
CREATE PROCEDURE [dbo].[isp_RCM_LP_KewillFlagship]
   ...
   IF @n_continue=3  -- Error Occured - Process And Return
	 ...
	 ELSE
	    BEGIN
	       ...
	       END
	    END
  	  execute nsp_logerror @n_err, @c_errmsg, 'isp_RCM_LP_KewillFlagship'
