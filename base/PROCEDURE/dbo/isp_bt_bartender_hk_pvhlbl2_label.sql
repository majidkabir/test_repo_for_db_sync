...
/* 11-JAN-2019    1.0  CSCHONG    WMS-7583 Created                            */       
/******************************************************************************/              
                
CREATE PROC [dbo].[isp_BT_Bartender_HK_PVHLBL2_label]                     
...
BEGIN                    
  ...
  DECLARE @d_Trace_StartTime   DATETIME, 
   ...
   SET @c_Trace_ModuleName = ''
    ...
    where orderkey in (
    select orderkey from pickdetail WITH (NOLOCK)  
	WHERE storerkey = @c_Sparm1 and sku = @c_Sparm3 and Dropid = @c_Sparm2)
...
EXIT_SP:  
   ...
   EXEC isp_InsertTraceInfo 
      ...
      @c_TraceName = 'isp_BT_Bartender_HK_PVHLBL2_label',
