...
/************************************************************************/  
/* S Proc: nspConsolidatedPickList04                                    */  
/* Creation Date:                                                       */  
/* Copyright: IDS                                                       */  
/* Written by:                                                          */  
/*                                                                      */  
...
/* 1-Mar-2005   Shong         Add UNLOCK                                */  
/* 13-Jan-2012  TLTING   1.1  Commit transaction                        */
/*                                                                      */  
/************************************************************************/  
  
CREATE PROC [dbo].[nspConsolidatedPickList04] (  
 ...
 -- Modified by YokeBeen on 15-Apr-2004 (SOS#22066) - (YokeBeen01)  
 -- Expand the Length of Sku Description to max.  
 -- 13-Jul-2004 YTWan SOS#24811: Expand the Length of ExternOrderkey.  
  
 -- Modified by YokeBeen on 28-Jul-2004 (SOS#24811) - (YokeBeen02)  
 -- Update blank values for the rest of the Orders.  
  
 -- Modified by MaryVong on 06Sept04 (SOS26757)  
 -- Set Printed Flag (allow for reprint)  
...
--  if @c_debug = '1'  
--  begin  
--   print 'Open Cursor #1-2...'  
--   select * from #SKUGroup   
--   print 'End Open Cursor #1-2...'  
--  end  
...
-- Move it to bottom, update the descr after updating empty Orderkey1  
 ...
 /* Start Modification */  
    ...
    JOIN   PickHeader (NOLOCK) ON (PickHeader.ExternOrderKey = LoadPlanDetail.LoadKey AND      
                                   PickHeader.Zone = '7')  
...
-- (YokeBeen02) - End.  
   ...
   EXEC ispInsertOriginAllocQty @a_s_LoadKey, NULL  
