...
/* Written by: CSCHONG                                                  */
/*                                                                      */
/* Purpose: WMS-22764 [CN]Lacoste B2B Carton Label modification         */
/*        :                                                             */
/* Called By:                                                           */
/*          :                                                           */
/*        :                                                             */
...
CREATE   PROCEDURE [dbo].[ispPKBT16]
...
END
   ...
   BEGIN
      SET @b_success = 0
      EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'ispPKBT16'
