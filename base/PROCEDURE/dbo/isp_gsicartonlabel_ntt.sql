...
GO
/*********************************************************************************/        
/* Stored Procedure: isp_GSICartonLabel_NTT (NoTempTable)                        */        
...
/*                                       to Char(10)                             */        
/*                                  #3 - Extended from Char(5) to Char(20)       */        
...
/* 26-Nov-2008    Adrian      1.4   Changed PackType to Char(18) to match        */        
/*                                  actual field - (AAY006)                      */       
...
/*                                  Removed Char(5) restriction on field 41      */        
/*                                  --AAY0023 #2                                 */        
...
/* 19-Apr-2011    Adrian      1.20  Increaseed Consignee SKU field char(20)      */        
...
/*********************************************************************************/        
CREATE PROC [dbo].[isp_GSICartonLabel_NTT] (        
...
--NJOW03        
   ...
   SET @c_Date = RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(MONTH, GETDATE()))), 2) + '/'        
               + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(DAY, GETDATE()))), 2) + '/'        
               + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(YEAR, GETDATE()))), 2) + '/'        
        
   SET @c_Time = RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(HOUR, GETDATE()))), 2) + ':'        
               + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(MINUTE, GETDATE()))), 2) + ':'        
               + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(SECOND, GETDATE()))), 2) + ':'        
        
   SET @c_DateTime = RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(YEAR, GETDATE()))), 4)        
                   + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(MONTH, GETDATE()))), 2)        
                   + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(DAY, GETDATE()))), 2)        
                   + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(HOUR, GETDATE()))), 2)        
                   + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(MINUTE, GETDATE()))), 2)        
                   + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(SECOND, GETDATE()))), 2)        
...
/*      CREATE TABLE #TempGSICartonLabel_XML        
   ...
   DECLARE
     ...
     @c_Buying_Store NVARCHAR(15),                          -- #38  B_BillToKey --AAY0019 from 6 to 15 NVARCHAR   
...
--                 Buying_Store NVARCHAR(15) default '',                          -- #38  B_BillToKey --AAY0019 from 6 to 15 NVARCHAR        
...
--                 Line_Item2_01_Reserve01 NVARCHAR(30) default '',               -- #379        
...
--                 Line_Item2_02_Reserve01 NVARCHAR(30) default '',               -- #392        
...
--                 Line_Item2_03_Reserve01 NVARCHAR(30) default '',               -- #405        
...
--                 Line_Item2_04_Reserve01 NVARCHAR(30) default '',               -- #418        
...
--                 Line_Item2_05_Reserve01 NVARCHAR(30) default '',               -- #431        
...
--                 Line_Item2_06_Reserve01 NVARCHAR(30) default '',               -- #444        
...
--                 Line_Item2_07_Reserve01 NVARCHAR(30) default '',               -- #457        
...
--                 Line_Item2_08_Reserve01 NVARCHAR(30) default '',               -- #470        
...
--                 Line_Item2_09_Reserve01 NVARCHAR(30) default '',               -- #483        
...
--                 Line_Item2_10_Reserve01 NVARCHAR(30) default '',               -- #496        
...
--                 Line_Item2_11_Reserve01 NVARCHAR(30) default '',               -- #509        
...
--                 Line_Item2_12_Reserve01 NVARCHAR(30) default '',               -- #522        
...
--                 Line_Item2_13_Reserve01 NVARCHAR(30) default '',               -- #535        
...
--                 Line_Item2_14_Reserve01 NVARCHAR(30) default '',               -- #548        
...
--                 Line_Item2_15_Reserve01 NVARCHAR(30) default '',               -- #561        
...
--                 Line_Item2_16_Reserve01 NVARCHAR(30) default '',               -- #574        
...
--                 Line_Item2_17_Reserve01 NVARCHAR(30) default '',               -- #587        
...
--                 Line_Item2_18_Reserve01 NVARCHAR(30) default '',               -- #600        
...
--                 Line_Item2_19_Reserve01 NVARCHAR(30) default '',               -- #613        
...
--                 Line_Item2_20_Reserve01 NVARCHAR(30) default '',               -- #626        
...
--                 Line_Item2_21_Reserve01 NVARCHAR(30) default '',               -- #639        
...
--                 Line_Item2_22_Reserve01 NVARCHAR(30) default '',               -- #652        
...
--                 Line_Item2_23_Reserve01 NVARCHAR(30) default '',               -- #665        
...
--                 Line_Item2_24_Reserve01 NVARCHAR(30) default '',               -- #678        
...
--                 Line_Item2_25_Reserve01 NVARCHAR(30) default '',               -- #691        
...
--                 Line_Item2_26_Reserve01 NVARCHAR(30) default '',               -- #704        
...
--                 Line_Item2_27_Reserve01 NVARCHAR(30) default '',               -- #717        
...
--                 Line_Item2_28_Reserve01 NVARCHAR(30) default '',               -- #730        
...
--                 Line_Item2_29_Reserve01 NVARCHAR(30) default '',               -- #743        
...
--                 Line_Item2_30_Reserve01 NVARCHAR(30) default '',               -- #756        
...
--                 Line_Item2_31_Reserve01 NVARCHAR(30) default '',               -- #769        
...
--                 Line_Item2_32_Reserve01 NVARCHAR(30) default '',               -- #782        
...
--                 Line_Item2_33_Reserve01 NVARCHAR(30) default '',               -- #795        
...
--                 Line_Item2_34_Reserve01 NVARCHAR(30) default '',               -- #808        
...
--                 Line_Item2_35_Reserve01 NVARCHAR(30) default '',               -- #821        
...
--                 Line_Item2_36_Reserve01 NVARCHAR(30) default '',               -- #834        
...
--                 Line_Item2_37_Reserve01 NVARCHAR(30) default '',               -- #847        
...
--                 Line_Item2_38_Reserve01 NVARCHAR(30) default '',               -- #860        
...
--                 Line_Item2_39_Reserve01 NVARCHAR(30) default '',               -- #873        
...
--                 Line_Item2_40_Reserve01 NVARCHAR(30) default '',               -- #886        
...
--                 Line_Item2_41_Reserve01 NVARCHAR(30) default '',               -- #899        
...
--                 Line_Item2_42_Reserve01 NVARCHAR(30) default '',               -- #912        
...
--                 Line_Item2_43_Reserve01 NVARCHAR(30) default '',               -- #925        
...
--                 Line_Item2_44_Reserve01 NVARCHAR(30) default '',               -- #938        
...
--                 Line_Item2_45_Reserve01 NVARCHAR(30) default '',               -- #951        
...
--                 Line_Item2_46_Reserve01 NVARCHAR(30) default '',               -- #964        
...
--                 Line_Item2_47_Reserve01 NVARCHAR(30) default '',               -- #977        
...
--                 Line_Item2_48_Reserve01 NVARCHAR(30) default '',               -- #990        
...
--                 Line_Item2_49_Reserve01 NVARCHAR(30) default '',               -- #1003        
...
--                 Line_Item2_50_Reserve01 NVARCHAR(30) default '',               -- #1016        
...
/*********************************************/        
   ...
   SELECT  TOP 1 
           ...
           @c_Product_Group                        = '',        
           @c_PickUp_Date                          = RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(MONTH, MBOL.USERDEFINE07))), 2) + '/'    --AAY0021        
                                                     + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(DAY, MBOL.USERDEFINE07))), 2) + '/'    --AAY0021        
                                                     + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(YEAR, MBOL.USERDEFINE07))), 2) + ' '        
                                                     + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(HOUR, MBOL.USERDEFINE07))), 2) + ':'        
                                                     + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(MINUTE, MBOL.USERDEFINE07))), 2),      --AAY0021        
           ...
           @c_Julian_Day                           = CASE ISNULL(RTRIM(MBOL.USERDEFINE07),'')                                          --AAY0023 #5        
                                                     ...
                                                     END,                                                                              -- AAY0023 #5        
           @c_Order_Start_Date                     = RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(MONTH, ORDERS.OrderDate))), 2) + '/'        
                                                     + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(DAY, ORDERS.OrderDate))), 2) + '/'        
                                                     + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(YEAR, ORDERS.OrderDate))), 2),        
           @c_Order_Completion_Date                = RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(MONTH, ORDERS.DeliveryDate))), 2) + '/'        
                                                     + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(DAY, ORDERS.DeliveryDate))), 2) + '/'        
                                                     + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(YEAR, ORDERS.DeliveryDate))), 2),
           ...
           @c_File_Create_Date                     = RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(MONTH, GETDATE()))), 2) + '/'        
                                                     + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(DAY, GETDATE()))), 2) + '/'        
                                                     + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(YEAR, GETDATE()))), 2),               -- @c_Date        
           @c_File_Create_Time                     = RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(HOUR, GETDATE()))), 2) + ':'        
                                                     + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(MINUTE, GETDATE()))), 2) + ':'        
                                                     + RIGHT(RTRIM('0' + CONVERT(NVARCHAR, DATEPART(SECOND, GETDATE()))), 2),             -- @c_Time        
...
--        WHERE Sequential_Carton_Number = @n_CartonNoParm   
      ...
      DECLARE GSI_Rec_Cur CURSOR LOCAL FAST_FORWARD READ_ONLY FOR
       SELECT LEFT(ISNULL(RTRIM(PACKREC.CartonType),''), 8), 
              RIGHT(ISNULL(RTRIM(CONVERT(NVARCHAR, PACKREC.TotQty)),0), 5),
              RIGHT(ISNULL(RTRIM(CONVERT(NVARCHAR, PACKREC.CartonNo)),0), 5),
              RIGHT(ISNULL(RTRIM(CONVERT(NVARCHAR, PACKREC.TotCarton)),0), 4),
              LEFT(ISNULL(RTRIM(PACKREC.UPC),''), 20),
              LEFT(ISNULL(RTRIM(PACKREC.LabelNo),''), 19), 
              LEFT(ISNULL(RTRIM(PACKREC.LabelNo),''), 20), 
              ISNULL(RIGHT(RTRIM(CONVERT(NVARCHAR, PACKREC.TTLCnts)), 6),'0'),  -- Total_Cartons_In_Shipment  SHONG01  
              ISNULL(LEFT(LTRIM(CONVERT(NVARCHAR, PACKREC.TotCtnWeight)), 5),'0'), 
...
--                                    @c_BuyerPO, @c_ExternOrderKey, @c_CartonNo
   ...
   BEGIN        
      ...
      SET @c_SerialSCCwCD = ISNULL(RTRIM(@c_SerialSCCwoCD),'') + CONVERT(NVARCHAR(1), ISNULL(RTRIM(@n_CheckDigit),0))        
...
--         SET @c_Pack_Qty               = @c_PkQtyScl    
      ...
      BEGIN        
         ...
         BEGIN           
            DECLARE GSI_Sku_Cur CURSOR LOCAL FAST_FORWARD READ_ONLY FOR        
             SELECT DISTINCT SKU.Style, SKU.Color, SKU.Measurement, SKU.[Size], PACKDETAIL.Qty,        
                    CASE WHEN ISNULL(ODREF.ComponentSKU,'') <> '' THEN ODREF.ComponentSKU ELSE SKU.Sku END,             --NJOW05        
                    ORDERDETAIL.RetailSKU,                                                                              --SOS# 193703        
                    ISNULL(ODREF.RetailSKU,'') AS RetailComponentSKU, ISNULL(BM.Qty,0) AS RetailComponentQty,           --NJOW05        
               ...
               LEFT JOIN BILLOFMATERIAL BM (NOLOCK) ON (ODREF.ParentSKU = BM.Sku AND ODREF.ComponentSKU = BM.ComponentSKU AND ODREF.Storerkey = BM.Storerkey)        
      ...
      OPEN GSI_Sku_Cur        
      FETCH NEXT FROM GSI_Sku_Cur INTO @c_Style, @c_Color, @c_Measurement, @c_Size, @c_Pack_Qty, @c_Sku , @c_RSku,        
                                       @c_RetailComponentSKU, @c_RetailComponentQty, @c_CompStyle, @c_CompColor, @c_CompMeasurement, @c_CompSize  --NJOW05        
      ...
      BEGIN        
         ...
         BEGIN        
            ...
            END -- IF @n_licnt > 36        
         END
         FETCH NEXT FROM GSI_Sku_Cur INTO @c_Style, @c_Color, @c_Measurement, @c_Size, @c_Pack_Qty, @c_Sku , @c_RSku, --AAY0020        
                                          @c_RetailComponentSKU, @c_RetailComponentQty, @c_CompStyle, @c_CompColor, @c_CompMeasurement, @c_CompSize  --NJOW05        
...
/*********************************************/        
   ...
   END        
        ...
        SET  @c_FullLineText = 
            ...
            +',"' + @c_Buying_Store                          + '"' -- #38  B_BillToKey --AAY0019 from 6 to 15 NVARCHAR        
            +',"' + @c_Blank11                               + '"' -- #39        
            +',"' + @c_Blank12                               + '"' -- #40        
