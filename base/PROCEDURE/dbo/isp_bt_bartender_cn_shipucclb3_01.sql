...
/******************************************************************************/                   
/* Copyright: LFL                                                             */                   
/* Purpose: isp_BT_Bartender_CN_SHIPUCCLB3_01                                 */              
/*                                                                            */                   
/* Modifications log:                                                         */                   
/*                                                                            */                   
...
CREATE PROC [dbo].[isp_BT_Bartender_CN_SHIPUCCLB3_01]                        
...
BEGIN                        
   ...
   SELECT TOP 1 @c_GetOrderkey = ORDERS.Orderkey, 
                @c_Col01       = LTRIM(RTRIM(ISNULL(ORDERS.C_City,''))),
                @c_Col02       = ORDERS.Loadkey,
                @c_Col03       = ORDERS.Consigneekey,
                @c_Col04       = LTRIM(RTRIM(ISNULL(ORDERS.C_Company,''))),
   ...
   SET @c_SQLJOIN = N' SELECT DISTINCT @c_Col01,@c_Col02,@c_Col03,@c_Col04,PD.CartonNo,'   + CHAR(13) +   --5   
                    +' SUM(PD.Qty),PD.LabelNo,CONVERT(CHAR(10), GETDATE(), 126),'''','''', '   + CHAR(13) +   --10     
                    +' '''','''','''','''','''','''','''','''','''','''', '   + CHAR(13) +   --20     
                    +' '''','''','''','''','''','''','''','''','''','''', '   + CHAR(13) +   --30     
                    +' '''','''','''','''','''','''','''','''','''','''', '   + CHAR(13) +   --40     
                    +' '''','''','''','''','''','''','''','''','''','''', '   + CHAR(13) +   --50           
                    ...
                    +' GROUP BY PD.CartonNo, PD.LabelNo'
