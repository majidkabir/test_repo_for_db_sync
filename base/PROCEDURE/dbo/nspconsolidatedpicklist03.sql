...
GO
/************************************************************************/
/* Stored Procedure: nspConsolidatedPickList03                                         */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
...
/****** Object:  Stored Procedure dbo.nspConsolidatedPickList03    Script Date: 3/11/99 6:24:26 PM ******/
CREATE PROC [dbo].[nspConsolidatedPickList03](
   ...
   ELSE
      ...
      BEGIN
         ...
         BEGIN TRAN
            ...
            VALUES
            (@c_pickheaderkey, @a_s_LoadKey,     "0",      "8",  "")
            SELECT @n_err = @@ERROR
            IF @n_err <> 0
            BEGIN
               IF @@TRANCOUNT >= 1
      ...
      ELSE
         ...
         --ORDER BY LOC.LogicalLocation, PICKDETAIL.LOC, ORDERDETAIL.OrderKey, ORDERDETAIL.SKU
