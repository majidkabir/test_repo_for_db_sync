...
SET @c_SQLJOIN = +' SELECT DISTINCT OH.ORDERKEY,OH.EXTERNORDERKEY,OH.BUYERPO,OH.C_CONTACT1,OH.C_CONTACT2,OH.C_COMPANY,OH.C_PHONE1 ' + CHAR(13) --7  
  ...
  --SET @c_SQL = @c_SQL + @c_SQLJOIN       
   ...
   SELECT DISTINCT TOP 6 PAD.Pickslipno, PAD.Labelno, PAD.LabelLine, PAD.SKU, LTRIM(RTRIM(S.descr)), CAST(PAD.QTY AS NVARCHAR)   --CS01
   ...
   EXIT_SP:        
      ...
      EXEC isp_InsertTraceInfo       
         ...
         @c_TraceName = 'isp_BT_SHIPLBL_KR_LOTTE',      
