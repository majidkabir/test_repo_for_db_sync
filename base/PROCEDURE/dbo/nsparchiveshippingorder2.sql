...
CREATE   PROC [dbo].[nspArchiveShippingOrder2]  
...
BEGIN -- main  
   ...
   BEGIN -- 3  
      ...
      BEGIN  
         ...
         SELECT @local_c_errmsg =  
            ...
            ' sqlsvr message = ' + dbo.fnc_LTrim(dbo.fnc_RTrim(@local_c_errmsg)) + ')' + ' (nspArchiveShippingOrder2)'  
      END  
      ...
      EXECUTE dbo.nspLogAlert  
               @c_modulename   = 'nspArchiveShippingOrder2',  
  ...
  IF @b_debug = 1  
      ...
      IF (@b_debug=1)  
      BEGIN  
         PRINT 'WhereClause...' + @c_WhereClause  
      END  
      ...
      FETCH NEXT FROM C_Orderkey INTO @cOrderKey, @c_StorerKey -- kocy01  add @c_StorerKey  
      ...
      BEGIN  
         ...
         BEGIN  
            ...
            BEGIN  
               ...
               SELECT @local_c_errmsg = convert(char(5),@local_n_err)  
               SELECT @local_c_errmsg =  
               ': UPDATE of archivecop failed - OrderDetail. (nspArchiveShippingOrder2) ' + ' ( ' +  
            ...
            BEGIN  
               ...
               BEGIN  
                  ...
                  SELECT @local_c_errmsg = convert(char(5),@local_n_err)  
                  SELECT @local_c_errmsg =  
                  ': UPDATE of archivecop failed - OrderDetailRef. (nspArchiveShippingOrder2) ' + ' ( ' +  
                  ' sqlsvr message = ' + dbo.fnc_LTrim(dbo.fnc_RTrim(@local_c_errmsg)) + ')'  
                  ROLLBACK TRAN  
               END  
               ELSE  
  ...
  AND NOT EXISTS ( SELECT 1 FROM dbo.CODELKUP CL (NOLOCK)  
            ...
            BEGIN  
               ...
               BEGIN  
                  ...
                  BEGIN  
                     ...
                     SELECT @local_c_errmsg = convert(char(5),@local_n_err)  
                     SELECT @local_c_errmsg =  
                     ': UPDATE of archivecop failed - PickDetail. (nspArchiveShippingOrder2) ' + ' ( ' +  
                     ' sqlsvr message = ' + dbo.fnc_LTrim(dbo.fnc_RTrim(@local_c_errmsg)) + ')'  
                     ROLLBACK TRAN  
                  END  
                  ELSE  
                  ...
                  BEGIN  
                     ...
                     BEGIN  
                        ...
                        BEGIN  
                           ...
                           SELECT @local_c_errmsg = convert(char(5),@local_n_err)  
                           SELECT @local_c_errmsg =  
                           ': UPDATE of archivecop failed - refkeylookup. (nspArchiveShippingOrder2) ' + ' ( ' +  
                           ' sqlsvr message = ' + dbo.fnc_LTrim(dbo.fnc_RTrim(@local_c_errmsg)) + ')'  
                           ROLLBACK TRAN  
                        END  
                        ELSE  
         ...
         BEGIN  
            ...
            SELECT @local_c_errmsg = convert(char(5),@local_n_err)  
            SELECT @local_c_errmsg =  
            ': UPDATE of archivecop failed - Orders. (nspArchiveShippingOrder2) ' + ' ( ' +  
            ' sqlsvr message = ' + dbo.fnc_LTrim(dbo.fnc_RTrim(@local_c_errmsg)) + ')'  
            ROLLBACK TRAN  
         END  
         ELSE  
         ...
         BEGIN  
            ...
            SELECT @local_c_errmsg = convert(char(5),@local_n_err)  
            SELECT @local_c_errmsg =  
            ': UPDATE of archivecop failed - OrderInfo. (nspArchiveShippingOrder2) ' + ' ( ' +  
            ' sqlsvr message = ' + dbo.fnc_LTrim(dbo.fnc_RTrim(@local_c_errmsg)) + ')'  
            ROLLBACK TRAN  
         END  
         ELSE  
         ...
         BEGIN  
            ...
            BEGIN                       
               ...
               BEGIN  
                  ...
                  SELECT @local_c_errmsg = CONVERT(CHAR(5) ,@local_n_err)   
                  SELECT @local_c_errmsg =   
                        ': update of archivecop failed - CartonTrack. (nspArchiveShippingOrder2) '   
                        +' ( '+  
      ...
      BEGIN  
         ...
         BEGIN  
            ...
            SELECT @local_c_errmsg = convert(char(5),@local_n_err)  
            SELECT @local_c_errmsg =  
            ': archiving of wave failed - (nspArchiveShippingOrder2) ' + ' ( ' +  
            ' sqlsvr message = ' + dbo.fnc_LTrim(dbo.fnc_RTrim(@local_c_errmsg)) + ')'  
         END  
      END  
      ...
      BEGIN  
         ...
         BEGIN  
            ...
            SELECT @local_c_errmsg = convert(char(5),@local_n_err)  
            SELECT @local_c_errmsg =  
            ': archiving of load failed - (nspArchiveShippingOrder2) ' + ' ( ' +  
            ' sqlsvr message = ' + dbo.fnc_LTrim(dbo.fnc_RTrim(@local_c_errmsg)) + ')'  
         END  
      END  
      ...
      BEGIN  
         ...
         BEGIN  
            ...
            SELECT @local_c_errmsg = convert(char(5),@local_n_err)  
            SELECT @local_c_errmsg =  
            ': archiving of MBOL failed - (nspArchiveShippingOrder2) ' + ' ( ' +  
            ' sqlsvr message = ' + dbo.fnc_LTrim(dbo.fnc_RTrim(@local_c_errmsg)) + ')'  
         END  
      END  
...
---  
   ...
   BEGIN  
      ...
      END  
      EXECUTE dbo.nsp_logerror @n_err, @c_errmsg, 'nspArchiveShippingOrder2'  
