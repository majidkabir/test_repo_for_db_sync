...
GO
/************************************************************************/  
/* Stored Procedure: nspTTMEvaluatePPKTasks                             */  
/* Creation Date:                                                       */  
/* Copyright: IDS                                                       */  
/* Written by:                                                          */  
/*                                                                      */  
...
/* 28-03-2017   1.0   James      WMS1349.Created                        */  
/************************************************************************/  
  
CREATE PROC    [dbo].[nspTTMEvaluatePPKTasks]  
    ...
    BEGIN  
        ...
        BEGIN  
            ...
            SELECT @c_errmsg = "NSQL"+CONVERT(CHAR(5) ,@n_err)+  
                   ": Execute Of Move Tasks Pick Code Failed. (nspTTMEvaluatePPKTasks)"   
   ...
   BEGIN  
      ...
      BEGIN  
       ...
       BEGIN  
           ...
           END  
       END  
       execute nsp_logerror @n_err, @c_errmsg, 'nspTTMEvaluatePPKTasks'  
