...
/************************************************************************/    
/* Stored Procedure: nspALPVH05                                         */    
/* Creation Date: 28-SEP-2020                                           */    
/* Copyright: LFL                                                       */    
/* Written by: WLChooi                                                  */    
/*                                                                      */    
/* Purpose: WMS-15566 CN_PVH_AllocStrategy(B2C)_New                     */
/*          SkipPreallocation = '1'                                     */
/*                                                                      */
/*                                                                      */
/* Called By: Wave                                                      */    
...
BEGIN    
   ...
   IF @c_UOM NOT IN ('2','6','7')
      GOTO EXIT_SP
   
   IF @c_UOM IN ('2','7')
      SET @c_ExtraCond = 'AND SL.LocationType NOT IN (''PICK'')'
   ELSE
   	SET @c_ExtraCond = 'AND SL.LocationType IN (''PICK'')'
