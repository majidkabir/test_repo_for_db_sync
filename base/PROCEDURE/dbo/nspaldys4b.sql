...
BEGIN    
   ...
   SET @c_SQL = N'   
      ...
      AND LOC.LocationCategory IN (''DYNPPICK'') ' + CHAR(13) + CASE WHEN @c_IsValid = 'Y' THEN @c_Conditions ELSE '' END + CHAR(13) +
   ...
   EXEC sp_ExecuteSQL @c_SQL, @c_SQLParm, @c_Facility, @c_StorerKey, @c_SKU, @n_QtyLeftToFulfill, @n_UOMBase, @c_Lottable01, @c_Lottable02, @c_Lottable03,
                      ...
                      @d_Lottable13, @d_Lottable14, @d_Lottable15, @c_Doctype
