...
BEGIN  
   ...
   BEGIN  
      ...
      SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0))    
                    ...
                    + '. Must Be SEPB2BPTS, SEPB2BNOR or SEPB2CALL (ispSEPCDB2C)'
      GOTO QUIT_SP  
   END  
   ...
   BEGIN  
      IF @b_debug IN ( 1, 9 )  
      BEGIN  
         PRINT 'Main PICKCOde: ispSEPCDB2C'+ CHAR(13) +  
               'SKU: ' + @c_SKU + CHAR(13) +  
      ...
      BEGIN  
         ...
         BEGIN  
            PRINT '-----------------------------------'+ CHAR(13) +  
                  'Main PICKCOde: ispSEPCDB2C'+ CHAR(13) +  
                  'SKU: ' + @c_SKU + CHAR(13) +  
                  '@n_QtyLeftToFullFill: ' + CAST(@n_QtyLeftToFullFill AS VARCHAR) + CHAR(13) +  
...
QUIT_SP:  
   ...
   BEGIN  
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'ispSEPCDB2C'  
