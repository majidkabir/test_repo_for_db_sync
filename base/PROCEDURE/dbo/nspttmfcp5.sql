...
/******************************************************************************/
/* Stored Procedure: nspTTMFCP5                                               */
/* Copyright: LF Logistics                                                    */
/*                                                                            */
/* Date        Author    Ver  Purposes                                        */
/* 2018-03-27  Ung       1.0  WMS-4221 Created                                */
/******************************************************************************/
CREATE PROC [dbo].[nspTTMFCP5]
...
BEGIN
   ...
   SAVE TRAN nspTTMFCP5 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN nspTTMFCP5 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN nspTTMFCP5 -- Only rollback change made here
Fail:
Quit:
