...
/************************************************************************/
/* Store procedure: isp_ImgMgr_Validate_Remy_IN_DMG                     */
/* Creation Date: 04-Aug-2021                                           */
/* Copyright: IDS                                                       */
/* Written by: GuanHaoChan                                              */
/*                                                                      */
/* Purpose: Fields Validation for Image Manager Remy Inbound Damage     */
/*                                                                      */
...
/************************************************************************/
CREATE PROC [dbo].[isp_ImgMgr_Validate_Remy_IN_DMG]
(
    @b_Debug INT = 0,
    @x_xml XML,
    ...
    BEGIN
        ...
        FROM
            ...
            (
                ...
                col3 NVARCHAR(100) 'col3', --Container Number
                col4 NVARCHAR(100) 'col4', --PO Number (ASN#)
                col5 NVARCHAR(100) 'col5', --SKU
                col6 NVARCHAR(100) 'col6', --Lottable
                col7 NVARCHAR(100) 'col7', --DefectCode
        ...
        (
            ...
            WHERE ReceiptKey = @c_col4
        )
        BEGIN
            SET @n_Continue = 3;
            SET @b_Success = 0;
            SET @n_ErrNo = 10001;
            SET @c_ErrMsg += 'PO Number(ASN#) not found!';
        END;
