...
/* 18-05-2010   ChewKP         Created                                  */
/************************************************************************/

CREATE PROC    [dbo].[nspTTMOPK1]
    ...
    BEGIN
        ...
        -- Logical Location 
         ...
         WHERE  TaskManagerUserDetail.UserKey = @c_userid AND
                TaskManagerUserDetail.PermissionType = 'OPK' AND
                TaskManagerUserDetail.Permission = '1' AND
                TaskDetail.TASKTYPE = 'OPK' AND
   ...
   END -- WHILE 1=1
    ...
    BEGIN
        ...
        BEGIN
            ...
            END
        END
        EXECUTE nsp_logerror @n_err, @c_errmsg, 'nspTTMOPK1'
