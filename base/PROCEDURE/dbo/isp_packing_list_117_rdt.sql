...
GO
/************************************************************************/  
/* Stored Proc: isp_packing_list_117_rdt                                */  
/* Creation Date: 25-Nov-2021                                           */  
/* Copyright: LF Logistics                                              */  
/* Written by: Mingle                                                   */  
/*                                                                      */  
/* Purpose: WMS-18351 - [CN] SepCD_B2B_Packing List_CR                  */  
/*        :                                                             */  
/* Called By: r_dw_packing_list_117_rdt                                 */  
/*          :                                                           */  
/* PVCS Version: 1.1                                                    */  
/*                                                                      */  
/* Version: 7.0                                                         */  
...
/************************************************************************/  
CREATE   PROC isp_packing_list_117_rdt  
...
BEGIN  
   ...
   BEGIN    
      INSERT INTO #TMP_PCK(Pickslipno)  
   ...
   JOIN #TMP_PCK (NOLOCK) ON #TMP_PCK.Pickslipno = PackDetail.PickSlipNo  
   ...
   JOIN #TMP_PCK (NOLOCK) ON #TMP_PCK.Pickslipno = PDET.PickSlipNo   
   ...
   AND PDET.CartonNo BETWEEN CAST(@c_CartonNoStart AS INT) AND CAST(@c_CartonNoEnd AS INT)  
   AND OH.DocType = 'N'  
   ...
   IF @n_continue=3  -- Error Occured - Process And Return    
    BEGIN    
       ...
       BEGIN    
          ...
          END    
       END    
       execute nsp_logerror @n_err, @c_errmsg, "isp_packing_list_117_rdt"    
