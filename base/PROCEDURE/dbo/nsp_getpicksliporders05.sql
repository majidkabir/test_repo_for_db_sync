...
GO
/************************************************************************/
/* Store Procedure:  nsp_GetPickSlipOrders05                            */
...
/* Return Status:  None                                                 */
/*                                                                      */
/* Usage:  Used for report dw = r_dw_print_pickorder05                  */
/*                                                                      */
/* Local Variables:                                                     */
/*                                                                      */
/* Called By:                                                           */
...
/* 2007-07-17  ONG01     1.0   Add Lot01, 03, 05                        */
/* 2008-04-15  June      1.1   SOS101659 - Add Grand Total Pallet Cnt   */
/* 2008-11-24  ACM             SOS121799 - Add Addr4, City              */
/* 2010-08-14  TLTING    1.3   InsertPickDet_log (tlting01)             */
/* 15-Aug-2011 YTWan     1.2   SOS#222245 - Standard getting report logo*/
/*                             (Wan01)                                  */
/* 03-Jan-2013 Leong     1.4   SOS#265314 - Prevent Pickslip number not */
/*                                          tally with nCounter table.  */
/* 26-Nov-2013 NJOW01    1.5   295589-format sku code                   */
 ...
 BEGIN
   ...
   SET CONCAT_NULL_YIELDS_NULL OFF
    ...
    CREATE TABLE #TEMP_PICK
       ...
       , CASE WHEN ISNULL(CLR.Code,'') <> '' THEN 'Y' ELSE 'N' END AS ShowBarcode                  --CS01
