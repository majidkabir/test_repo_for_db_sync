...
BEGIN
   ...
   BEGIN  
      ...
      BEGIN    
         ...
         BEGIN    
            SET @n_Continue = 3    
            SET @n_Err = 60000    
            SET @c_errmsg = 'NSQL ' + CONVERT(NCHAR(5),@n_Err) + ': Vat is not a numeric value. (isp_GLBL20)'    
            GOTO QUIT_SP    
         END     
   ...
   BEGIN
      ...
      BEGIN
         ...
         END          
      END
      EXECUTE nsp_logerror @n_err, @c_errmsg, "isp_GLBL20"
