...
GO
/************************************************************************/
/* Stored Procedure: nsp_ReplenishmentRpt_PC04                          */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
...
CREATE PROC  [dbo].[nsp_ReplenishmentRpt_PC04]
                  ...
                  ELSE
                     ...
                     ELSE
                        ...
                        ELSE
                           ...
                           --select @n_SKULOCavailableqty '@n_SKULOCavailableqty', @c_currentSKU '@c_currentSKU', @c_fromLOC '@c_fromLOC', @n_OnHandQty '@n_OnHandQty', @n_RemainingQty '@n_RemainingQty'
                           /* How many do we take? */
