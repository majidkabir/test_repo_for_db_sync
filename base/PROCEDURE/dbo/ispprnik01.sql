...
BEGIN          
   ...
   BEGIN         
      ...
      --              + ': Invalid Wave Piece Pick Task Dispatch Method. Must Be INLINE/ECOM (ispPRNIK01)'      
      GOTO QUIT_SP      
   END                           
   ...
   /***  INSERT IDxLOCxLOT FOR CURRENT SKU       ***/      
      ...
      -- UCC ID without status between '2' and '9'        
    ...
    --BEGIN      
      SET @c_SQL =       
                N'INSERT INTO #IDxLOC (Loc, ID, LogicalLocation, QtyAvailable,channel_id) '         --CS01a      
     ...
     END      
      ...
      BEGIN          
         ...
         BEGIN      
            ...
            WHILE (@@FETCH_STATUS <> -1) AND @n_OrderQty >= @n_QtyAvail    --(Wan01) Fixed >=      
            BEGIN        
               SET @n_PickQty = @n_QtyAvail        
      
               IF @b_Debug = 1      
               BEGIN      
                  PRINT 'Orderkey: ' + @c_Orderkey + ', @n_PickQty: ' + CAST(@n_PickQty AS NVARCHAR)      
                  PRINT '@n_QtyAvail: ' + CAST(@n_QtyAvail AS NVARCHAR)      
                  PRINT 'Lot: ' + @c_Lot      
                  PRINT 'Loc: ' + @c_Loc      
                  PRINT 'ID: ' + @c_ID      
               END         
      ...
      END --CS01a      
                     ...
                     BEGIN      
                        ...
                        BEGIN      
                           ...
                           SET @n_Err = 61020      
                           SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0))       
                                          + ': Insert PickDetail Failed. (ispPRNIK01)'      
                           GOTO QUIT_SP      
                        END      
...
QUIT_SP:      
   ...
   BEGIN        
      ...
      BEGIN        
         ...
         END        
      END        
      EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'ispPRNIK01'        
