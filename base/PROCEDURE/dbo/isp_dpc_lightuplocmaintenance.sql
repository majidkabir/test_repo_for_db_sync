...
/* 2013-07-19 1.0  ChewKP      Created                                        */
/******************************************************************************/        
      
CREATE PROC [dbo].[isp_DPC_LightUpLocMaintenance]       
(      
   @c_StorerKey   NVARCHAR(15)
  ,@c_DeviceID    NVARCHAR(20)
  ,@c_LightModule NVARCHAR(5)
  ,@c_LightMode   NVARCHAR(5)
...
BEGIN
   ...
   --LM_LIGHT_UP	172.23.72.176	0101	2	02345
   SET @c_DSPMessage = 'LM_LIGHT_UP<TAB>' + RTRIM(@c_DeviceIP) +       
                       '<TAB>' + RTRIM(@c_LightModule) +       
                       '<TAB>' + RTRIM(@c_LightMode)  + '<TAB>12345'
...
EXIT_SP:
   ...
   BEGIN  
      ...
      BEGIN  
         ROLLBACK TRAN  
         EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'isp_DPC_LightUpLocMaintenance'  
