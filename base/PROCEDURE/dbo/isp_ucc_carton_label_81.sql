...
/************************************************************************/
/* Store Procedure:  isp_UCC_Carton_Label_81                            */
/* Creation Date: 01-Apr-2019                                           */
/* Copyright: IDS                                                       */
/* Written by: WLCHOOI                                                  */
/*                                                                      */
/* Purpose:  WMS-8451 - [CN] Super Hub Project _                        */ 
/*                      Pandora Carton Label Change (CR)                */
/*                                                                      */
...
/* Usage:                                                               */
/*                                                                      */
/* Called By:  r_dw_ucc_carton_label_81                                 */
/*                                                                      */
/* PVCS Version: 1.1                                                    */
/*                                                                      */
/* Version: 5.4                                                         */
...
/* 29-08-2019   WLChooi  1.1  WMS-10358 - Add Pickdetail.DropID (WL01)  */
/************************************************************************/

CREATE PROC [dbo].[isp_UCC_Carton_Label_81] (
  ...
  BEGIN       
     SELECT PACKHEADER.Loadkey, 
            ...
            LEFT OUTER JOIN Codelkup CLR (NOLOCK) ON (Orders.Storerkey = CLR.Storerkey AND CLR.Code = 'SHOWFIELD'   
					                                       AND CLR.Listname = 'REPORTCFG' AND CLR.Long = 'r_dw_ucc_carton_label_81' AND ISNULL(CLR.Short,'') <> 'N')
