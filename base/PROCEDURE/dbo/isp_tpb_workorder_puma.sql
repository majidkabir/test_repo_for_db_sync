...
GO
/************************************************************************/      
/* Stored Procedure: isp_TPB_WorkOrder_PUMA                             */      
/* Creation Date:                                                       */      
/* Copyright: IDS                                                       */      
/* Written by:                                                          */      
/*                                                                      */      
/* Purpose: TPB billing for PUMA WorkOrder Transaction                  */      
/*                                                                      */      
...
CREATE PROC [dbo].[isp_TPB_WorkOrder_PUMA] 
...
BEGIN
   ...
   SET @c_SQLStatement = 
      ...
      ',UPPER(ISNULL(RTRIM(WorkOrderDetail.SKU),'''')) ' +
      ',WorkOrderDetail.QTY ' +
      ...
      ',ISNULL(RTRIM(SKU.IVAS),'''') ' +
      ',ISNULL(RTRIM(SKU.OVAS),'''') ' +
      ',ISNULL(RTRIM(SKU.HazardousFlag),'''') ' +
      ',ISNULL(RTRIM(SKU.TemperatureFlag),'''') ' +
      ',ISNULL(RTRIM(SKU.ProductModel),'''') ' +
      ',ISNULL(RTRIM(SKU.PrePackIndicator),'''') ' +
