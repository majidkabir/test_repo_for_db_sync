...
/* 2014-12-16  Ung       1.0  SOS327467 FCP task                        */
/* 2015-03-19  Ung       1.1  SOS338354 Support UserKeyOverRide         */
/* 2015-06-12  Ung       1.2  SOS343926 Add GroupKey                    */
/* 2018-02-02  Ung       1.3  WMS-3273 Add TransitLOC                   */
/************************************************************************/
CREATE PROC [dbo].[nspTTMFCP1]
...
BEGIN
   ...
   SAVE TRAN nspTTMFCP1 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN nspTTMFCP1 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN nspTTMFCP1 -- Only rollback change made here
Fail:
Quit:
