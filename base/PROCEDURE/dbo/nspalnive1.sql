...
GO
/************************************************************************/    
/* Stored Procedure: nspALNive1                                         */    
/* Creation Date: 06-MAR-2019                                           */    
/* Copyright: LFL                                                       */    
/* Written by:                                                          */    
/*                                                                      */    
/* Purpose: WMS-8402 CN Nivea Allocation for kitting                    */
/*         	from bulk then pick                                         */
/*                                                                      */
/* Called By: Wave                                                      */    
/*                                                                      */    
...
BEGIN    
   ...
   BEGIN
      ...
      SET @c_key3 = SUBSTRING(@c_OtherParms, 16, 1) --W=Wave  K=Kit   	    
   ...
   BEGIN
      SET @c_SQL = N'   
         ...
         ' ORDER BY CASE WHEN SL.LocationType NOT IN(''PICK'',''CASE'') THEN 1 ELSE 2 END, LA.Lottable04, LA.Lottable05, LOC.LogicalLocation, LOC.LOC '       	
   END
   ELSE
   BEGIN
      SET @c_SQL = N'   
