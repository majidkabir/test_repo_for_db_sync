...
/******************************************************************************/                 
/* Copyright: LFL                                                             */                 
/* Purpose: isp_Bartender_SKULABEL08_GetParm                                  */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
/* Date       Rev  Author     Purposes                                        */                 
/* 2021-03-26 1.0  WLChooi    Created (WMS-16660)                             */                            
/******************************************************************************/                
CREATE PROC [dbo].[isp_Bartender_SKULABEL08_GetParm]                      
(  @parm01            NVARCHAR(250),              
   @parm02            NVARCHAR(250),              
   @parm03            NVARCHAR(250),              
   @parm04            NVARCHAR(250),              
...
BEGIN                      
   ...
   SET @c_SQLJOIN = ' SELECT TOP 1 PARM1=S.Storerkey, ' +
                    ' PARM2=RTRIM(S.SKU),PARM3= '''' ,PARM4= '''',PARM5='''',PARM6='''',PARM7='''', '+
