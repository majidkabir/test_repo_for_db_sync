...
GO
/************************************************************************/                                                                                  
/* Store Procedure: isp_Gen_BuildLoad_Select                            */                                                                                  
/* Creation Date:                                                       */                                                                                  
/* Copyright: IDS                                                       */                                                                                  
/* Written by: SHONG                                                    */                                                                                  
/*                                                                      */                                                                                  
...
/* 03-Nov-2017  Shong   1.1   JOIN OrderInfo Table                      */
...
BEGIN
    ...
    PRINT 'SP-isp_Gen_BuildLoad_Select DEBUG-START...' 
...
DECLARE CUR_BUILD_LOAD_COND CURSOR LOCAL FAST_FORWARD READ_ONLY 
FOR
    SELECT Long,
           ISNULL(Notes, ''),
           UDF01,
...
IF @bDebug = 2
BEGIN
    PRINT 'SP-isp_Gen_BuildLoad_Select DEBUG-STOP...' 
