...
/******************************************************************************/                 
/* Copyright: LFL                                                             */                 
/* Purpose: isp_Bartender_CN_SKULABEL04_01                                    */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
/* Date       Rev  Author     Purposes                                        */                 
/* 2020-11-26 1.0  WLChooi    Created (WMS-15753)                             */                      
/******************************************************************************/                
                  
CREATE PROC [dbo].[isp_Bartender_CN_SKULABEL04_01]                      
...
BEGIN                      
  ...
  DECLARE  @d_Trace_StartTime   DATETIME,   
   ...
   SET @c_SQLJOIN = ' SELECT DISTINCT ' + CHAR(13)
                  + ' CASE WHEN ISNULL(S.Price,'''') = '''' THEN ''0'' ELSE S.Price END, ' + CHAR(13)   --1
                  + ' ISNULL(S.RetailSKU,''''),ISNULL(S.RetailSKU,''''),'''','''','''','''','''','''','''', ' + CHAR(13)
                  + ' '''','''','''','''','''','''','''','''','''','''', ' + CHAR(13)
                  + ' '''','''','''','''','''','''','''','''','''','''', ' + CHAR(13)
                  + ' '''','''','''','''','''','''','''','''','''','''', ' + CHAR(13)
                  + ' '''','''','''','''','''','''','''','''','''','''', ' + CHAR(13)
