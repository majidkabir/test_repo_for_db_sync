...
GO
/*************************************************************************/
/* Stored Procedure: isp_Delivery_Note31_RDT                             */
/* Creation Date: 2018-08-06                                             */
/* Copyright: IDS                                                        */
/* Written by:                                                           */
/*                                                                       */
/* Purpose: WMS-5715 - CN HMCOS Delivery Note Report                     */
/*                                                                       */
/* Called By: r_dw_delivery_note31_rdt                                   */
/*                                                                       */
/* PVCS Version: 1.1                                                     */
/*                                                                       */
/* Version: 5.4                                                          */
...
/* 26-Sep-2018  FayLiu  1.1   WMS-5715 Add 3 new columns. (FayLiu01)     */
/*************************************************************************/

CREATE PROC [dbo].[isp_Delivery_Note31_RDT]
...
BEGIN
   ...
   SET @n_maxLine = 10
      ...
      CREATE TABLE #TMP_HDR31
            ...
            ,  BuyerPO       NVARCHAR(20)  -- FayLiu01
            ,  TmallOrdKey   NVARCHAR(40)  -- FayLiu01
            ,  OrdType       NVARCHAR(10)) -- FayLiu01
      ...
      SELECT DISTINCT
            ...
            ,BuyerPO = OH.BuyerPO
            ,TmallOrdKey = case OH.Userdefine03 when 'TMALLCN' then OH.m_company else OH.BuyerPO END
            ,OrdType = OH.Userdefine03
      FROM #TMP_ORD31 TMP
