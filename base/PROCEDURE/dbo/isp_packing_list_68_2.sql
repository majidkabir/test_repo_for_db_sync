...
GO
/************************************************************************/
/* Trigger: isp_Packing_list_68_2                                       */
/* Creation Date: 25-SEP-2019                                           */
/* Copyright: LF Logistics                                              */
/* Written by: WLChooi                                                  */
/*                                                                      */
/* Purpose: WMS-10695 - Copied from isp_GetPackList07                   */
/*        :                                                             */
/* Called By: r_dw_print_packlist_10_2                                  */
/*          :                                                           */
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 7.0                                                         */
...
/************************************************************************/
CREATE PROC [dbo].[isp_Packing_list_68_2]
...
BEGIN
   ...
   JOIN PICKHEADER PH WITH (NOLOCK) ON PH.Orderkey = ORDERDETAIL.ORDERKEY
   ...
   JOIN SKU         WITH (NOLOCK) ON (ORDERDETAIL.Storerkey = SKU.Storerkey)
                                  AND(ORDERDETAIL.Sku = SKU.Sku)
   JOIN #TMP_BRAND t WITH (NOLOCK) ON t.OrderKey = ORDERDETAIL.Orderkey
