...
/******************************************************************************/    
/* Store Procedure: isp_carton_shipping_label_Amazon_US_223                   */    
/* Creation Date: 01-Apr-2021                                                 */    
/* Copyright: LFL                                                             */    
/* Written by: WLChooi                                                        */    
/*                                                                            */    
/* Purpose: WMS-16728 - [CN] Cartersz new shipping label for AMAZON US        */    
/*                      Type 223                                              */ 
/*                                                                            */    
/* Called By: r_dw_carton_shipping_label_amazon_us_223                        */    
/*                                                                            */    
/* GitLab Version: 1.0                                                        */    
/*                                                                            */    
/* Version: 5.4                                                               */    
...
/******************************************************************************/    
CREATE PROC [dbo].[isp_carton_shipping_label_Amazon_US_223](@c_LabelNo NVARCHAR(20))    
AS    
   SET NOCOUNT ON   
   SET ANSI_NULLS OFF   
   SET QUOTED_IDENTIFIER OFF   
