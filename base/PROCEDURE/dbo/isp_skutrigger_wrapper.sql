...
GO
/************************************************************************/  
/* Stored Procedure: isp_SKUTrigger_Wrapper                             */  
/* Creation Date: 11-Nov-2020                                           */  
/* Copyright: LFL                                                       */  
/* Written by: WLChooi                                                  */  
/*                                                                      */  
/* Purpose: WMS-15671 - Call SKU custom stored proc                     */
/*                                                                      */  
/* Called By: SKU insert/update/delete trigger                          */    
/*            Stored proc naming: ispSKUxx                              */
/*                                                                      */  
/* GitLab Version: 1.0                                                   */  
/*                                                                      */  
/* Version: 5.4                                                         */  
...
CREATE PROCEDURE [dbo].[isp_SKUTrigger_Wrapper]  
...
BEGIN  
   ...
   BEGIN   	  
      ...
      BEGIN        	  
         ...
         EXECUTE dbo.isp_SKUTrigger_Wrapper ----->wrapper for current table trigger
...
QUIT_SP:
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, 'isp_SKUTrigger_Wrapper'
