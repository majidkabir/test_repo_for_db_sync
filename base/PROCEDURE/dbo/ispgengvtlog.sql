...
/* 2019-06-22   TLTING01  ANSI OFF                                      */
/************************************************************************/

CREATE   PROC   [dbo].[ispGenGVTLog]
...
BEGIN
   ...
   BEGIN
      IF NOT EXISTS ( SELECT 1 FROM GVTLog (NOLOCK) 
      ...
      BEGIN
         ...
         BEGIN
            ...
            SET @c_ErrMsg = 'NSQL' + CONVERT(CHAR(5),ISNULL(@n_Err,0)) 
                          + ': Insert into GVTLog Failed (ispGenGVTLog)' 
            GOTO QUIT 
         END
      END
   END
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, "ispGenGVTLog"
