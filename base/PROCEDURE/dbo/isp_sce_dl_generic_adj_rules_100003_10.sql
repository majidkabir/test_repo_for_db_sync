...
GO
/************************************************************************/
/* Store Procedure:  isp_SCE_DL_GENERIC_ADJ_RULES_100003_10             */
...
CREATE PROCEDURE [dbo].[isp_SCE_DL_GENERIC_ADJ_RULES_100003_10] (
   @b_Debug       INT            = 0
 , @n_BatchNo     INT            = 0
 , @n_Flag        INT            = 0
...
BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            SET @c_ErrMsg = 'NSQL' + CONVERT(CHAR(5), ISNULL(@n_ErrNo, 0))
                            + ': Update record fail. (isp_SCE_DL_GENERIC_ADJ_RULES_100003_10)';
            ROLLBACK;
   ...
   IF @b_Debug = 1
   BEGIN
      SELECT '<<SUB-SP-RULES>> - [isp_SCE_DL_GENERIC_ADJ_RULES_100003_10] EXIT... ErrMsg : ' + ISNULL(RTRIM(@c_ErrMsg), '');
   END;
