...
/***************************************************************************/
/* Stored Procedure: isp_RPT_ADJ_ADJSUM_001                                */
...
/***************************************************************************/
CREATE PROC [dbo].[isp_RPT_ADJ_ADJSUM_001] (
...
BEGIN
    ...
    DECLARE @n_continue       INT
         ...
         ,  @c_Type        NVARCHAR(1) = '1'
         ,  @c_DataWindow  NVARCHAR(60) = 'RPT_ADJ_ADJSUM_001'
   ...
   JOIN CODELKUP         CL  WITH (NOLOCK) ON (CL.Listname = 'ADJTYPE')
                                         ...
                                         AND(CL.StorerKey = @c_ClkStorerKey)
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE nsp_logerror @n_err, @c_errmsg, 'isp_RPT_ADJ_ADJSUM_001'
