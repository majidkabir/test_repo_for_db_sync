...
/************************************************************************/  
/* Stored Procedure: isp_Packing_List_21_2                              */  
/* Creation Date: 04-Jan-2016                                           */  
/* Copyright: LF                                                        */  
/* Written by:                                                          */  
/*                                                                      */  
/* Purpose:  SOS#359084 - QKS-Print Delivery Note from Packing Module   */  
/*        :  Rename from isp_Packing_List_21                            */  
/* Called By:  WMS - r_dw_packing_list_21_2                             */  
/*                                                                      */  
/* PVCS Version: 1.0                                                    */  
/*                                                                      */  
/* Version: 5.4                                                         */  
...
/* 15-DEC-2016  Wan01   1.0   WMS-782 - Quiksilver - E-com Packing List */
/* 28-Jan-2019  TLTING_ext 1.1  enlarge externorderkey field length     */
/* 15-Apr-2019  TLTING01 1.1  Drop #temp table when exit                */                                             
/************************************************************************/  
CREATE PROC [dbo].[isp_Packing_List_21_2] (  
...
/*********************************************/ 
   ...
   BEGIN
      ...
      AND   Long = 'r_dw_packing_list_21_2'     --(Wan01)  
   ...
   ORDER BY Orderkey 
         ...
         ,  Sku
-- tlting01
   IF OBJECT_ID('tempdb..#TMP_PACKLIST') IS NOT NULL
      DROP TABLE #TMP_PACKLIST              
END  
