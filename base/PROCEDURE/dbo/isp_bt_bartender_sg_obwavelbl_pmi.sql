...
/********************************************************************************/                     
/* Copyright: LFL                                                               */                     
/* Purpose: isp_BT_Bartender_SG_OBWAVELBL_PMI                                   */                     
/*                                                                              */                     
/* Modifications log:                                                           */                     
/*                                                                              */                     
...
-- SET RowNo = 0                 
   ...
   CREATE TABLE [#Result] (                 
      ...
      SET @c_Sorting = N' ORDER BY OH.Orderkey DESC '    
    
      SET @c_SQLJOIN = + ' SELECT DISTINCT '''', OH.ExternOrderKey, OH.Consigneekey, LTRIM(RTRIM(ISNULL(OH.C_Company,''''))), LTRIM(RTRIM(ISNULL(OH.C_Address1,''''))),' + CHAR(13) --5  
                       ...
                       + ' OH.Route, '''', '''', '''', '''', '''', LTRIM(RTRIM(ISNULL(OH.C_Address3,''''))), '''', '''', '''', '  + CHAR(13) --20           
                       + ' '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', '  + CHAR(13) --30       
                       + ' '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', '  + CHAR(13) --40    
                       + ' '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', '  + CHAR(13) --50          
                       + ' '''', '''', '''', '''', '''', '''', '''', OH.Orderkey, '''', ''SG'' '  --60              
                     ...
                     --  +   @c_JoinStatement    
                       ...
                       + ' WHERE OH.Orderkey = @c_Sparm01 '   + CHAR(13)     
                     --  + ' AND PD.LabelNo =  @c_Sparm02 ' + CHAR(13)  
                       + ' GROUP BY OH.ExternOrderKey, OH.Consigneekey, LTRIM(RTRIM(ISNULL(OH.C_Company,''''))), LTRIM(RTRIM(ISNULL(OH.C_Address1,''''))), ' + CHAR(13)  
                       ...
                       + ' OH.Route, LTRIM(RTRIM(ISNULL(OH.C_Address3,''''))), OH.Orderkey ' + CHAR(13)    
                       + @c_Sorting                  
--PRINT @c_SQLJOIN    
...
EXIT_SP:        
   ...
   --   @c_TraceName = 'isp_BT_Bartender_SG_OBWAVELBL_PMI',      
