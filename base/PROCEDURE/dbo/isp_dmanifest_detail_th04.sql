...
/************************************************************************/
/* Stored Procedure: isp_dmanifest_detail_th04                          */
/* Creation Date: 15-AUG-2023                                           */
/* Copyright: Maersk                                                    */
/* Written by:                                                          */
/*                                                                      */
/* Purpose: WMS-23332  - TH-RC CR Dispatch Report                       */
/*                                                                      */
/* Called By: PB - mbol & Report Modules                                */
/*                                                                      */
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 5.4                                                         */
...
/* 15-AUG-2023  CSCHONG  1.0  Devops Scripts Combine                    */
/* 23-AUG-2023  CSCHONG  1.1  WMS-23332 fix line 4 bugs (CS01)          */
/************************************************************************/

CREATE   PROC [dbo].[isp_dmanifest_detail_th04] (
   ...
   DECLARE @n_continue    int,
    ...
    IF EXISTS (SELECT 1 FROM CODELKUP CL WITH (NOLOCK)
     ...
     WHERE CL.ListName = 'DelText' AND CL.Storerkey = @c_storerkey
            ...
            LEFT JOIN CODELKUP C4 WITH (NOLOCK) ON C4.listname = 'REPORTCFG' and C4.storerkey = OH.storerkey and C4.long = 'r_dw_dmanifest_detail_th_04'
             WHERE OH.MBOLKey=@c_MBOLKey 
