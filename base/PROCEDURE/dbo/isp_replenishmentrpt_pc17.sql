...
/***************************************************************************/
/* Stored Procedure: isp_ReplenishmentRpt_PC17                             */
/* Creation Date:  14-OCT-2013                                             */
/* Copyright: IDS                                                          */
/* Written by: YTWan                                                       */
/*                                                                         */
/* Purpose: SOS#289221-CPPI - Replenishment (Pallet Picking)               */
/*        : modify from nsp_ReplenishmentRpt_PC12                          */
/*                                                                         */
...
/***************************************************************************/
CREATE PROC [dbo].[isp_ReplenishmentRpt_PC17]
...
--(Wan01) - END
   ...
   WHERE R.ReplenishmentGroup = @c_ReplGrp
   AND  (LOC.PickZone = @c_ReplGrp OR @c_ReplGrp = 'ALL')
   AND   LOC.facility = @c_zone01
