...
/*          Copy and modify from nspALBULK3                             */
/*                                                                      */
...
BEGIN
   ...
   SET @c_SQLStatement = N'DECLARE  CURSOR_CANDIDATES CURSOR FAST_FORWARD READ_ONLY FOR'
                       ...
                       + ' JOIN SKU WITH (NOLOCK) ON SKU.StorerKey = s.StorerKey AND SKU.Sku = s.Sku'
