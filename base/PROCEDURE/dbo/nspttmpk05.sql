    ...
    BEGIN      
        ...
        BEGIN      
            ...
            SELECT @c_errmsg = 'NSQL'+CONVERT(CHAR(5) ,@n_err)+      
                   ': Update to TaskDetail table failed. (nspTTMPK05)'+' ( '+      
   ...
   BEGIN      
      ...
      BEGIN       
          ...
          BEGIN      
             ...
             JOIN dbo.PickDetail PD ON (TD.TaskDetailKey = PD.TaskDetailKey)      
             JOIN dbo.OrderDetail OD ON (PD.OrderKey = OD.OrderKey AND PD.OrderLineNumber = OD.OrderLineNumber)      
             JOIN dbo.Orders O ON (OD.OrderKey = O.OrderKey AND TD.WaveKey = O.UserDefine09)      
          ...
          BEGIN      
              ...
              SELECT @c_errmsg = 'NSQL'+CONVERT(CHAR(5) ,@n_err)+      
                     ': Could not Open Cursor_Eval02. (nspTTMPK05)'+' ( '       
                    +' SQLSvr MESSAGE='+RTRIM(@c_errmsg)       
                    +' ) '      
          END      
          ELSE      
        ...
        BEGIN      
            ...
            BEGIN      
                ...
                BEGIN      
                  ...
                  SELECT @c_errmsg = CONVERT(CHAR(250) ,@n_err)      
                          ,@n_err = 81204 -- Should Be Set To The SQL Errmessage but I don't know how to do so.      
                    SELECT @c_errmsg = 'NSQL'+CONVERT(CHAR(5) ,@n_err)+': UPDATE TaskDetail Failed. (nspTTMPK05)'+' ( '       
                          + ' SQLSvr MESSAGE='+RTRIM(@c_errmsg)+' ) '      
                END      
            END      
               ...
               END      
                ...
                BEGIN      
                    ...
                    SELECT @c_errmsg = CONVERT(CHAR(250) ,@n_err)      
                          ,@n_err = 81204 -- Should Be Set To The SQL Errmessage but I don't know how to do so.      
                    SELECT @c_errmsg = 'NSQL'+CONVERT(CHAR(5) ,@n_err)+      
                           ': UPDATE TaskDetail Failed. (nspTTMPK05)'+' ( '       
                          +' SQLSvr MESSAGE='+RTRIM(@c_errmsg)       
                          +' ) '      
                END      
            END      
            ...
            BEGIN      
               ...
               BEGIN      
                  ...
                  SELECT @c_errmsg = CONVERT(CHAR(250) ,@n_err)      
                        ,@n_err = 81204 -- Should Be Set To The SQL Errmessage but I don't know how to do so.      
                  SELECT @c_errmsg = 'NSQL'+CONVERT(CHAR(5) ,@n_err)+      
                   ': Lock TaskDetail Failed. (nspTTMPK05)'+' ( '       
                        +' SQLSvr MESSAGE='+RTRIM(@c_errmsg)       
                        +' ) '      
                  GOTO NOTHINGTOSEND                        
               END                         
     ...
     BEGIN      
         ...
         BEGIN      
             ...
             END      
         END      
         EXECUTE nsp_logerror @n_err, @c_errmsg, 'nspTTMPK05'      
