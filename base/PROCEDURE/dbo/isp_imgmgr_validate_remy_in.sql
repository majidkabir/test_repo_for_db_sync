...
/*                                                                      */
/* Purpose: Fields Validation for Image Manager Remy Inbound            */
/*                                                                      */
...
BEGIN
    ...
    BEGIN
        ...
        --Read data from XML
        SELECT @c_col1 = ISNULL(RTRIM(col1), ''),     --StorerKey
               @c_col2 = ISNULL(RTRIM(col2), ''),     --Type
               @c_col3 = ISNULL(RTRIM(col3), ''),     --Container Number
               @c_col4 = ISNULL(RTRIM(col4), ''),     --PO Number(ASN#)
