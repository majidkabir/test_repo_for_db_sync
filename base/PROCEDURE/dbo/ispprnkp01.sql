...
BEGIN    
   ...
   BEGIN 
      ...
      SET @c_SQL = 
                N'INSERT INTO #IDxLOC (Loc, ID, LogicalLocation, QtyAvailable) '
                  ...
                  BEGIN 
                     ...
                     BEGIN
                        ...
                        SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0)) 
                                       + ': Get PickDetailKey Failed. (ispPRNKP01)'
                        GOTO QUIT_SP
                     END
                     ELSE
                     BEGIN
                        ...
                        BEGIN
                           ...
                           SET @n_Err = 61020
                           SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0)) 
                                          + ': Insert PickDetail Failed. (ispPRNKP01)'
                           GOTO QUIT_SP
                        END
...
QUIT_SP:
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         END  
      END  
      EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'ispPRNKP01'  
