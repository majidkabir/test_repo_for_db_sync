...
GO
/***************************************************************************/
/* Stored Proc : nsp_GetPickSlipOrders08                                   */
/* Creation Date:                                                          */
/* Copyright: IDS                                                          */
/* Written by:                                                             */
/*                                                                         */
...
/* Local Variables:                                                        */
/*                                                                         */
/* Called By: r_dw_print_pickorder08                                       */
/*                                                                         */
/* PVCS Version: 1.4                                                       */
/*                                                                         */
/* Version: 5.4                                                            */
...
/* 20-Aug-2009 NJOW01      1.1   Calculate carton qty include pallet qty   */
/*                               SOS#145310                                */
/* 20-Aug-2009 GTGOH       1.1   Include SKU Group Into Report             */
/*                               SOS#144415                                */
/* 19-Sep-2009 TLTING      1.2   performance tune                          */
/* 13-Jan-2014 TLTING      1.3   Commit transaction                        */
...
BEGIN TRAN
   ...
   ON (Orders.Storerkey = CLR.Storerkey AND CLR.Code = 'showlot06'                                            
   AND CLR.Listname = 'REPORTCFG' AND CLR.Long = 'r_dw_print_pickorder08' AND ISNULL(CLR.Short,'') <> 'N')   
   /*CS01 End*/ 
   /*CS02 Start*/
   LEFT OUTER JOIN Codelkup CLR1 (NOLOCK) 
