...
/************************************************************************/  
/* Stored Procedure: nspTTMCPK2                                         */  
/* Copyright: IDS                                                       */  
/*                                                                      */  
/* Purpose: TM Cluster Pick strategy                                    */  
/*          For task that does not use print label module to assign     */
/*          groupkey to cart before using TM Cluster Pick               */
/*                                                                      */  
/* Modifications log:                                                   */  
/* Date        Author    Ver  Purposes                                  */  
/* 2023-04-20  James     1.0  WMS-22212. Created                         */  
/************************************************************************/  
CREATE   PROC [dbo].[nspTTMCPK2]  
...
BEGIN  
   ...
   SAVE TRAN nspTTMCPK2 -- For rollback or commit only our own transaction  
   ...
   FETCH NEXT FROM Cursor_CPKTaskCandidates INTO @c_TaskDetailKey  
   ...
   COMMIT TRAN nspTTMCPK2 -- Only commit change made here  
   GOTO Quit  
  
RollBackTran:  
   ROLLBACK TRAN nspTTMCPK2 -- Only rollback change made here  
Fail:  
Quit:  
