...
GO
/************************************************************************/    
/* Stored Procedure: ispALNIK05                                         */    
/* Creation Date: 01-AUG-2019                                           */    
/* Copyright: LFL                                                       */    
/* Written by:                                                          */    
/*                                                                      */    
/* Purpose: WMS-10032 CN Nike Robot allocation.                         */          
...
BEGIN    
   ...
   */   
   ...
   SET @c_SQL = N'   
      ...
      ' ORDER BY CASE WHEN LOC.LocLevel > 1 THEN 1  WHEN LOC.LocLevel = 1 THEN 2 ELSE 3 END, LOC.LocLevel, QTYAVAILABLE, LOC.LogicalLocation, LOC.Loc '
