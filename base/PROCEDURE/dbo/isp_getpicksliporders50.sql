...
/***************************************************************************/    
/* Stored Proc : isp_GetPickSlipOrders50                                   */    
/* Creation Date:                                                          */    
/* Copyright: IDS                                                          */    
/* Written by:                                                             */    
/*                                                                         */    
/* Purpose: 257082 - BBRAUN Picking Slip                                   */    
/*                                                                         */    
/*                                                                         */    
/* Usage:                                                                  */    
/*                                                                         */    
/* Local Variables:                                                        */    
/*                                                                         */    
/* Called By: r_dw_print_pickorder50                                       */    
/*                                                                         */    
/* PVCS Version: 1.1                                                       */    
/*                                                                         */    
/* Version: 5.4                                                            */    
...
CREATE PROC [dbo].[isp_GetPickSlipOrders50] (@c_loadkey NVARCHAR(10))     
 AS    
 BEGIN    
   SET NOCOUNT ON     
   SET ANSI_NULLS OFF  
   ...
   @c_skugroup         NVARCHAR(10) -- SOS144415      
    ...
    CREATE TABLE #TEMP_PICK    
       ...
       INSERT INTO #TEMP_PICK    
         ...
         Susr4,           Vat,         OVAS,      SKUGROUP,  ContainerType, Lottable01) -- SOS144415    
    ...
    -- Changed by YokeBeen on 08-Aug-2002 (Ticket # 6692) - from BillToKey to ConsigneeKey.      
      ...
      SUBSTRING(LotAttribute.Lottable01,9,10)  
  ...
  -- update case qty    
  update #temp_pick      set cartons_cal = case packcasecnt    
         when 0 then 0    
