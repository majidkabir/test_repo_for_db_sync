...
/******************************************************************************/                   
/* Copyright: IDS                                                             */                   
/* Purpose: isp_BT_Bartender_TW_711_ship_Label_01                             */                   
/*                                                                            */                   
/* Modifications log:                                                         */                   
/*                                                                            */                   
/* Date       Rev  Author     Purposes                                        */
/* 2020-02-03 1.0  CSCHONG    Created (WMS-11987)                             */                           
/******************************************************************************/                  
                    
CREATE PROC [dbo].[isp_BT_Bartender_TW_711_ship_Label_01]                        
...
BEGIN                        
 ...
 SELECT DISTINCT ISNULL(ORDIF.orderinfo03,'N'),ISNULL(c.long,''),ISNULL(o.C_Contact1,''),ISNULL(o.m_company,''), ISNULL(o.markforkey,''),      --5 
            ...
            FROM PackHeader AS ph WITH (NOLOCK)        
               ...
               LEFT JOIN CODELKUP C1   WITH (NOLOCK) ON C1.listname = 'CarrierInf' and C1.Code='711' and C1.storerkey = O.storerkey  
               LEFT JOIN CODELKUP C2   WITH (NOLOCK) ON C2.listname = 'WebsitInfo' and C2.Code=ORDIF.platform and C2.storerkey = O.storerkey   
...
EXIT_SP:      
   ...
   EXEC isp_InsertTraceInfo     
      ...
      @c_TraceName = 'isp_BT_Bartender_TW_711_ship_Label_01',    
