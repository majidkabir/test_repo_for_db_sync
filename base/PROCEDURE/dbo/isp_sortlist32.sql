...
GO
/************************************************************************/
/* StoredProc: isp_sortlist32                                           */
/* Creation Date: 31-May-2022                                           */
/* Copyright: LF Logistics                                              */
/* Written by: MINGLE                                                   */
/*                                                                      */
/* Purpose: WMS-19696 PH_PNG_LoadingGuide_CR_Zuellig                    */
/*        :                                                             */
/* Called By: r_dw_sortlist32                                           */
/*          :                                                           */
/* PVCS Version: 1.1                                                    */
/*                                                                      */
/* Version: 7.0                                                         */
...
/* 31-May-2022 MINGLE   1.0   Created.(Devops scripts combine )         */
/************************************************************************/
CREATE PROC [dbo].[isp_sortlist32]
...
QUIT_SP:
     SELECT LOADPLAN.loadkey
        ...
        ,  PICKDETAIL.SKU
        ,  SKU.descr
        ,  totalcases = CASE WHEN OD.UOM = 'CS' 
                             THEN SUM(PICKDETAIL.qty) --SUM(OD.ShippedQty+OD.QtyAllocated+OD.QtyPicked)    --CS01
                             ELSE SUM(Pickdetail.Qty/NULLIF(Pack.Casecnt,0)) END   
