...
/************************************************************************/
/* Stored Proc: isp_GetPickSlipWave19_m                                 */  
...
/*        :                                                             */  
/* Called By: r_dw_print_wave_pickslip_19_m                             */ 
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 7.0                                                         */
/*                                                                      */
...
/************************************************************************/
CREATE PROC [dbo].[isp_GetPickSlipWave19_m]  
...
BEGIN  
   ...
   SELECT PH.Wavekey  
         ,PD.AddDate
         ,PH.PickHeaderkey 
         ,'' AS PutawayZone--LOC.PutawayZone                                  
         ,@c_Printedflag    
         ,PD.Storerkey  
         ,PD.Loc  
         ,PD.ID  
   ...
   --AND WD.WaveKey = CASE WHEN @c_PickSlipNo = '' THEN @c_wavekey ELSE WD.wavekey END                       
   AND   PD.Status < '5'  
   GROUP BY PH.Wavekey 
         ,  PD.AddDate 
         ,  PH.PickHeaderkey  
