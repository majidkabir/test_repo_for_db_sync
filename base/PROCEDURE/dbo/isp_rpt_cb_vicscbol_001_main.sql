...
/* 05-Dec-2024 WLChooi  1.4   FCR-1459 Remove Userdefine02 - Not used (WL02)           */ 
/* 16-Dec-2024 WLChooi  1.5   FCR-1359 Show CBOLKey in report (WL03)                   */
/***************************************************************************************/  
CREATE   PROCEDURE [dbo].[isp_RPT_CB_VICSCBOL_001_Main] 
(  
   @n_Cbolkey  BIGINT  
)  
AS  
