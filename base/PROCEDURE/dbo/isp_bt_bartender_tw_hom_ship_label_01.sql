...
/******************************************************************************/                 
/* Copyright: IDS                                                             */                 
/* Purpose: isp_BT_Bartender_TW_HOM_ship_Label_01                             */
/*          Copy from: isp_BT_Bartender_TW_EAT_ship_Label_01                  */                  
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
/* Date       Rev  Author     Purposes                                        */                 
/* 2019-08-30 1.0  WLChooi    Created (WMS-10441)                             */ 
/* 2022-04-15 1.1  MINGLE     WMS-19308 - Add new fields (ML01)               */
/******************************************************************************/                
                  
CREATE PROC [dbo].[isp_BT_Bartender_TW_HOM_ship_Label_01]                      
  ...
  DECLARE @d_Trace_StartTime   DATETIME,   
   ...
   SET @c_Trace_ModuleName = ''  
    ...
    SET @c_SQLJOIN = +' SELECT DISTINCT pd.labelno,o.c_company,'
                     ...
                     + ' '''','''','''','''','''','     --20       
                     + CHAR(13) +      
                     + ' '''','''','''','''','''','''','''','''',ISNULL(o.route,''''),ph.PickSlipNo,'  --30    --CS01    --CS02
                     + ' st.b_company,st.b_phone1,o.c_phone1,'''','''','''','''','''','''','''','   --40    --ML01       
                     + ' '''','''','''','''','''','''','''','''','''','''', '  --50       
                     + ' '''','''','''','''','''','''','''',''1'','''',''O'' '   --60          
                     + CHAR(13) +                 
                     ...
                     + ' JOIN Storer ST WITH (NOLOCK) ON ST.storerkey=o.storerkey '               --(CS01)     
   ...
   BEGIN                 
      ...
      SELECT DISTINCT @c_orderkey,@c_cartonno,PD.sku, SUM(PD.qty),@c_labelno,'N'
      ...
      BEGIN  
       ...
       IF (@n_intFlag%@n_MaxLine) = 2 --AND @n_recgrp = @n_CurrentPage
       BEGIN 
        	--SELECT '2'       
          SET @c_sku02 = @c_sku
       ...
       IF (@n_intFlag%@n_MaxLine) = 3 --AND @n_recgrp = @n_CurrentPage
       BEGIN 
        	--SELECT '3'       
          SET @c_sku03 = @c_sku
       ...
       IF (@n_intFlag%@n_MaxLine) = 4 --AND @n_recgrp = @n_CurrentPage
       BEGIN 
        	--SELECT '4'       
          SET @c_sku04 = @c_sku
       ...
       IF (@n_intFlag%@n_MaxLine) = 5 --AND @n_recgrp = @n_CurrentPage
       BEGIN 
        	--SELECT '5'       
          SET @c_sku05 = @c_sku
       ...
       IF (@n_intFlag%@n_MaxLine) = 6 --AND @n_recgrp = @n_CurrentPage
       BEGIN 
        	--SELECT '6'       
          SET @c_sku06 = @c_sku
       ...
       IF (@n_intFlag%@n_MaxLine) = 7 --AND @n_recgrp = @n_CurrentPage
       BEGIN 
        	--SELECT '7'       
          SET @c_sku07 = @c_sku
       ...
       IF (@n_intFlag%@n_MaxLine) = 0 --AND @n_recgrp = @n_CurrentPage
       BEGIN 
        	--SELECT '8'       
          SET @c_sku08 = @c_sku
...
EXIT_SP:    
   ...
   EXEC isp_InsertTraceInfo   
      ...
      @c_TraceName = 'isp_BT_Bartender_TW_HOM_ship_Label_01',  
