...
/******************************************************************************/               
/* Copyright: LFL                                                             */               
/* Purpose: isp_BT_Bartender_CN_PVHSZLBL1_label                               */      
/*          Copy from isp_BT_Bartender_CN_PVHLBL1_label                       */         
/*                                                                            */               
/* Modifications log:                                                         */               
/*                                                                            */               
...
CREATE PROC [dbo].[isp_BT_Bartender_CN_PVHSZLBL1_label]                     
...
BEGIN                    
   ...
   SET @c_SQLJOIN = +' SELECT DISTINCT @c_Sparm4,SKU.Style,SKU.BUSR1,SKU.Color,SKU.Measurement,'
                    +' SKU.[Size],Right(SKU.class,2) + Right(SKU.Itemclass,3), ' --7 --OD.userdefine08
                    +' ISNULL(C1.Short,''''),'
...
EXIT_SP:  
   ...
   EXEC isp_InsertTraceInfo 
      ...
      @c_TraceName = 'isp_BT_Bartender_CN_PVHSZLBL1_label',
