...
/*                            Phase 1 (ChewKP01)                        */    
/* 12-Jul-2012  Shong         Minus QtyReplen for QtyAvailable          */  
/* 17-Mar-2014  YTWan         SOS#305113 - Wave Allocation (Wan01)      */ 
/************************************************************************/    
CREATE PROC    [dbo].[nspAL10006]    
...
BEGIN    
   ...
   */ 
   ...
   SET @c_SQL = N'    
      ...
      'ORDER BY CASE WHEN ISNULL(RTRIM(CL.Short),''R'') = ''R'' THEN 1 ELSE 99 END,
