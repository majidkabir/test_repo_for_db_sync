...
/* Written by: CSCHONG                                                  */
/*                                                                      */
/* Purpose:WMS-17756 SG - iDSMedû Adjustment Ticket Sheet [CR]          */
/*                                                                      */
...
/* Return Status:  None                                                 */
/*                                                                      */
/* Usage:  Used for report dw = r_dw_adjusment_summary_06               */
/*                                                                      */
/* Local Variables:                                                     */
/*                                                                      */
/* Called By:                                                           */
...
BEGIN
   ...
   CREATE TABLE #TMP_ADJ
      ...
      ,  ADJUOM            NVARCHAR(10)   NULL 
      ,  AdjustmentType    NVARCHAR(3)    NULL 
      ,  Lott06            NVARCHAR(30)   NULL
      ,  Lott07            NVARCHAR(30)   NULL
      ,  Qty               INT            NULL 
      ,  Lott08            NVARCHAR(30)   NULL
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE nsp_logerror @n_err, @c_errmsg, 'isp_adjsumm_06'
