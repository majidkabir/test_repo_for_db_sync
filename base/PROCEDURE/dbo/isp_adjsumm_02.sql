...
/************************************************************************/
/* Store Procedure:  isp_adjsumm_02                                     */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by: YTWan                                                    */
/*                                                                      */
...
/* Return Status:  None                                                 */
/*                                                                      */
/* Usage:  Used for report dw = r_dw_adjusment_summary_02               */
/*                                                                      */
/* Local Variables:                                                     */
/*                                                                      */
/* Called By:                                                           */
...
/************************************************************************/
CREATE PROC [dbo].[isp_adjsumm_02] (
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE nsp_logerror @n_err, @c_errmsg, 'isp_adjsumm_02'
