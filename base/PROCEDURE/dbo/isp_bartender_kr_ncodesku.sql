...
/******************************************************************************/                 
/* Copyright: IDS                                                             */                 
/* Purpose: isp_Bartender_KR_NCODESKU                                         */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
...
CREATE PROC [dbo].[isp_Bartender_KR_NCODESKU]                      
  ...
  DECLARE @d_Trace_StartTime   DATETIME,   
   ...
   SET @c_Trace_ModuleName = ''  
    ...
    SELECT DISTINCT CONVERT(NVARCHAR(10), GETDATE(), 120),S.StorerKey,S.sku,ISNULL(S.DESCR,''),s.SKUGROUP, s.Style,s.Color,s.Size,
              ...
              isnull(s.busr6,'') ,isnull(s.busr7,'') ,isnull(s.busr8,'') ,isnull(s.busr9,'') ,isnull(s.busr10,'') ,  --30  
              '','','','','','','','','','',   --40       
              '','','','','','','','','','',   --50       
              '','','','','','','','','',''   --60        
   ...
   EXIT_SP:    
      ...
      --   @c_TraceName = 'isp_Bartender_KR_NCODESKU',  
