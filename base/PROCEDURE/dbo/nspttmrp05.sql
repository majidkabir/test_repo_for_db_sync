...
/* 08-11-2017  Ung       1.0  WMS-3410 Created                          */
/* 23-08-2023  Ung       1.1  WMS-23369 Add UserKeyOverRide             */
/************************************************************************/
CREATE   PROC [dbo].[nspTTMRP05]
...
BEGIN
   ...
   BEGIN
      ...
      SET @c_errmsg = 'NSQL' + CONVERT( NVARCHAR(5), @n_err) + ': ' + 
                      'Update to TaskDetail table failed. (nspTTMRP05)' + 
   ...
   BEGIN
      ...
      BEGIN
        ...
        BEGIN
          ...
          END
        END
        execute nsp_logerror @n_err, @c_errmsg, 'nspTTMRP05'
