...
/* 30-09-2014  Ung       1.0  SOS322179. Created                        */
/* 15-11-2019  Chermaine 1.1  WMS-11126 Add userkey override (cc01)     */
/************************************************************************/
CREATE PROC [dbo].[nspTTMRP03]
...
BEGIN
   ...
   BEGIN
      ...
      SET @c_errmsg = 'NSQL' + CONVERT( NVARCHAR(5), @n_err) + ': ' + 
                      'Update to TaskDetail table failed. (nspTTMRP03)' + 
   ...
   BEGIN
      ...
      BEGIN
        ...
        BEGIN
          ...
          END
        END
        execute nsp_logerror @n_err, @c_errmsg, 'nspTTMRP03'
