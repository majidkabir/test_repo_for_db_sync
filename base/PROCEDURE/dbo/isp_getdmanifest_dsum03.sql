...
/* 2022-Oct-17  Mingle   2.1  WMS-20990 - Modify logic(ML04)            */  
/************************************************************************/        
...
BEGIN        
 ...
 DECLARE  @n_cntRefno           INT                    --(CS01)           
   ...
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ORDERS.B_COMPANY  
      WHEN  bb.pick_qty=cc.pack_qty THEN ORDERS.ConsigneeKey ELSE '' END , --ML04  
   ...
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ST2.ADDRESS1  
      WHEN  bb.pick_qty=cc.pack_qty THEN ORDERS.C_Address1 ELSE '' END , --ML04  
         --CASE WHEN  bb.pick_qty=cc.pack_qty THEN ORDERS.C_Address2 ELSE '' END ,    
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ST2.ADDRESS2  
      WHEN  bb.pick_qty=cc.pack_qty THEN ORDERS.C_Address2 ELSE '' END , --ML04  
         --CASE WHEN  bb.pick_qty=cc.pack_qty THEN ORDERS.C_Address3 ELSE '' END,  
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ST2.ADDRESS3  
      WHEN  bb.pick_qty=cc.pack_qty THEN ORDERS.C_Address3 ELSE '' END , --ML04        
   ...
   --     WHEN  bb.pick_qty=cc.pack_qty AND ORDERS.type NOT IN ('ZS05','ZS06') THEN Orders.C_Company ELSE '' END, --ML03   
     CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ST2.Company  
        WHEN  bb.pick_qty=cc.pack_qty AND ORDERS.type IN ('ZS05','ZS06') THEN Orders.M_Company  
          WHEN  bb.pick_qty=cc.pack_qty AND ORDERS.type NOT IN ('ZS05','ZS06') THEN Orders.C_Company ELSE '' END, --ML04  
         ETA = CASE WHEN  bb.pick_qty=cc.pack_qty THEN        
              ...
              (               
                CASE WHEN (CLC1.Short IS NULL) AND ORDERS.StorerKey = 'NIKECN' THEN MBOL.EditDate   --WL05      
                     WHEN ISDATE(ORDERS.Userdefine10) = 1 AND (ISNUMERIC(ISNULL(ORDERS.Userdefine01,'0')) = 1 OR ISNUMERIC(ISNULL(CLC1.Short,'0')) = 1) AND ISDATE(ORDERS.DeliveryDate) = 0   --NJOW01   --WL05 --ML01       
                     ...
                     WHEN ISDATE(ORDERS.Userdefine10) = 1 AND (ISNUMERIC(ISNULL(ORDERS.Userdefine01,'0')) = 1 OR ISNUMERIC(ISNULL(CLC1.Short,'0')) = 1) AND ISDATE(ORDERS.DeliveryDate) = 1   --NJOW01   --WL05 --ML01          
                     THEN CASE WHEN DATEADD(DAY, CONVERT(INT, CASE WHEN CLC1.Short IS NULL THEN ISNULL(ORDERS.Userdefine01,'0') ELSE ISNULL(CLC1.Short,'0') END), CONVERT(DATETIME, ORDERS.Userdefine10))   --WL05         
                                    >= CONVERT(DATETIME, ORDERS.DeliveryDate) --ML01       
                               THEN DATEADD(DAY, CONVERT(INT, CASE WHEN CLC1.Short IS NULL THEN ISNULL(ORDERS.Userdefine01,'0') ELSE ISNULL(CLC1.Short,'0') END), CONVERT(DATETIME, ORDERS.Userdefine10))   --WL05           
                               ELSE CONVERT(DATETIME, ORDERS.DeliveryDate) --ML01       
                               END          
                ...
                END        
                   ...
                   ELSE DATEADD(DAY, CONVERT(INT, CASE WHEN CLC1.Short IS NULL THEN ISNULL(ORDERS.Userdefine01,'0') ELSE ISNULL(CLC1.Short,'0') END), CONVERT(DATETIME, ORDERS.Userdefine10))END) ELSE '' END,  /* Added ETA = ETD (MBOL.EditDate) + LeadTime 
...
*/     --ML02             
   ...
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ST2.City  
      WHEN  bb.pick_qty=cc.pack_qty THEN ORDERS.C_City ELSE '' END , --ML04        
         ...
         ShowCRD  = CASE WHEN  bb.pick_qty=cc.pack_qty THEN (CASE WHEN ((ISNULL(STORER.SUSR1,'') = 'CRD' AND ISNULL(ORDERS.userdefine10,'') <> ''        
                    ...
                    CONVERT(INT,CASE WHEN CLC1.Short IS NULL AND ORDERS.StorerKey = 'NIKECN' THEN 0 WHEN CLC1.Short IS NULL THEN ORDERS.Userdefine01 ELSE CLC1.Short END)),121))   --WL05      
                    <  CONVERT(NVARCHAR(10),ORDERS.DeliveryDate,121))) THEN --ML01            
         ...
         LP = CASE WHEN  bb.pick_qty=cc.pack_qty THEN ( CASE WHEN @c_Zone = 'CRW'  THEN CASE WHEN ISNULL(CLR7.Notes,'') <> '' THEN CLR7.Notes ELSE CLR2.NOTES2   END   --WL04      
                                                             WHEN @c_Zone = 'CRWP' THEN CASE WHEN ISNULL(CLR7.Notes,'') <> '' THEN CLR7.Notes ELSE CLR2.NOTES    END   --WL04      
                                                             WHEN @c_Zone = 'ECTR' THEN CASE WHEN ISNULL(CLR7.Notes,'') <> '' THEN CLR7.Notes ELSE CLR2.NOTES2   END   --WL04      
                                                             ELSE CASE WHEN ISNULL(CLR7.Notes,'') <> '' THEN CLR7.Notes ELSE '' END END ) ELSE '' END, --CS01 --WL01   --WL04       
         CT = CASE WHEN  bb.pick_qty=cc.pack_qty THEN ( CASE WHEN @c_Zone = 'CRW'  THEN CASE WHEN ISNULL(CLR8.Notes,'') <> '' THEN CLR8.Notes ELSE CLR1.NOTES2   END   --WL04        
                                                             WHEN @c_Zone = 'CRWP' THEN CASE WHEN ISNULL(CLR8.Notes,'') <> '' THEN CLR8.Notes ELSE CLR1.NOTES    END   --WL04      
                                                             WHEN @c_Zone = 'ECTR' THEN CASE WHEN ISNULL(CLR8.Notes,'') <> '' THEN CLR8.Notes ELSE CLR1.NOTES2   END   --WL04      
                                                             ELSE CASE WHEN ISNULL(CLR8.Notes,'') <> '' THEN CLR8.Notes ELSE '' END END ) ELSE '' END, --CS01 --WL01   --WL04       
         TL = CASE WHEN  bb.pick_qty=cc.pack_qty THEN ( CASE WHEN @c_Zone = 'CRW'  THEN CASE WHEN ISNULL(CLR9.Notes,'') <> '' THEN CLR9.Notes ELSE CLR3.NOTES2   END   --WL04      
                                                             WHEN @c_Zone = 'CRWP' THEN CASE WHEN ISNULL(CLR9.Notes,'') <> '' THEN CLR9.Notes ELSE CLR3.NOTES    END   --WL04      
                                                             WHEN @c_Zone = 'ECTR' THEN CASE WHEN ISNULL(CLR9.Notes,'') <> '' THEN CLR9.Notes ELSE CLR3.NOTES2   END   --WL04      
                                                             ELSE CASE WHEN ISNULL(CLR9.Notes,'') <> '' THEN CLR9.Notes ELSE '' END END ) ELSE '' END,  --WL01         --WL04      
         FX = CASE WHEN  bb.pick_qty=cc.pack_qty THEN ( CASE WHEN @c_Zone = 'CRW'  THEN CASE WHEN ISNULL(CLR10.Notes,'') <> '' THEN CLR10.Notes ELSE CLR4.NOTES2 END   --WL04        
                                                             WHEN @c_Zone = 'CRWP' THEN CASE WHEN ISNULL(CLR10.Notes,'') <> '' THEN CLR10.Notes ELSE CLR4.NOTES  END   --WL04      
                                                             WHEN @c_Zone = 'ECTR' THEN CASE WHEN ISNULL(CLR10.Notes,'') <> '' THEN CLR10.Notes ELSE CLR4.NOTES2 END   --WL04      
                                                             ELSE CASE WHEN ISNULL(CLR10.Notes,'') <> '' THEN CLR10.Notes ELSE '' END END ) ELSE '' END,  --WL01   --WL04      
         [SITE] = @c_Zone,                                         --CS01         
         --WL03 S      
...
LEFT OUTER JOIN STORER (NOLOCK) ON (STORER.StorerKey = ORDERS.ConsigneeKey)     
  LEFT OUTER JOIN STORER ST2 (NOLOCK) ON ST2.type ='4' AND ST2.Notes1 ='RSC' AND st2.storerkey = orders.b_company --ML04  
      ...
      LEFT OUTER JOIN CODELKUP CLR5 (NOLOCK) ON (ORDERS.Storerkey = CLR5.Storerkey AND CLR5.Listname = 'REPORTCFG'          
                                             AND CLR5.Long = 'r_dw_dmanifest_sum03' AND CLR5.Code = 'ShowStorerCols' AND ISNULL(CLR5.Short,'') <> 'N')       
      ...
      LEFT OUTER JOIN CODELKUP CLR6 (NOLOCK) ON (ORDERS.Storerkey = CLR6.Storerkey AND CLR6.Listname = 'REPORTCFG'          
                                             AND CLR6.Long = 'r_dw_dmanifest_sum03' AND CLR6.Code = 'ShowNewETA' AND ISNULL(CLR6.Short,'') <> 'N')        
  ...
  LEFT OUTER JOIN STORER ST2 (NOLOCK) ON ST2.type ='4' AND ST2.Notes1 ='RSC' AND st2.storerkey = orders.b_company --ML04   
   ...
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN MAX(ORDERS.B_COMPANY)  
      WHEN  bb.pick_qty=cc.pack_qty THEN MAX(ORDERS.ConsigneeKey) ELSE '' END , --ML04  
         '' AS ExternOrderKey,          
         --CASE WHEN  bb.pick_qty=cc.pack_qty THEN ORDERS.C_Address1 ELSE ''  END,   
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ST2.ADDRESS1  
      WHEN  bb.pick_qty=cc.pack_qty THEN ORDERS.C_Address1 ELSE '' END , --ML04  
  ...
  LEFT OUTER JOIN STORER ST2 (NOLOCK) ON ST2.type ='4' AND ST2.Notes1 ='RSC' AND st2.storerkey = orders.b_company --ML04  
      ...
      GROUP BY PackHeader.Storerkey, PackHeader.Pickslipno,        
               ...
               --ORDERS.C_City,         
     CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ST2.City ELSE ORDERS.C_City END , --ML04        
               ...
               CASE WHEN  bb.pick_qty=cc.pack_qty THEN ( CASE WHEN @c_Zone = 'CRW'  THEN CASE WHEN ISNULL(CLR7.Notes,'') <> '' THEN CLR7.Notes ELSE CLR2.NOTES2   END   --WL04      
                                                              WHEN @c_Zone = 'CRWP' THEN CASE WHEN ISNULL(CLR7.Notes,'') <> '' THEN CLR7.Notes ELSE CLR2.NOTES    END   --WL04      
                                                              WHEN @c_Zone = 'ECTR' THEN CASE WHEN ISNULL(CLR7.Notes,'') <> '' THEN CLR7.Notes ELSE CLR2.NOTES2   END   --WL04      
               ELSE CASE WHEN ISNULL(CLR7.Notes,'') <> '' THEN CLR7.Notes ELSE '' END END ) ELSE '' END, --CS01 --WL01   --WL04      
               CASE WHEN  bb.pick_qty=cc.pack_qty THEN ( CASE WHEN @c_Zone = 'CRW'  THEN CASE WHEN ISNULL(CLR8.Notes,'') <> '' THEN CLR8.Notes ELSE CLR1.NOTES2   END   --WL04      
                                                              WHEN @c_Zone = 'CRWP' THEN CASE WHEN ISNULL(CLR8.Notes,'') <> '' THEN CLR8.Notes ELSE CLR1.NOTES    END   --WL04      
                                                              WHEN @c_Zone = 'ECTR' THEN CASE WHEN ISNULL(CLR8.Notes,'') <> '' THEN CLR8.Notes ELSE CLR1.NOTES2   END   --WL04      
                                                              ELSE CASE WHEN ISNULL(CLR8.Notes,'') <> '' THEN CLR8.Notes ELSE '' END END ) ELSE '' END, --CS01 --WL01   --WL04      
               CASE WHEN  bb.pick_qty=cc.pack_qty THEN ( CASE WHEN @c_Zone = 'CRW'  THEN CASE WHEN ISNULL(CLR9.Notes,'') <> '' THEN CLR9.Notes ELSE CLR3.NOTES2   END   --WL04      
                                                              WHEN @c_Zone = 'CRWP' THEN CASE WHEN ISNULL(CLR9.Notes,'') <> '' THEN CLR9.Notes ELSE CLR3.NOTES    END   --WL04      
                  WHEN @c_Zone = 'ECTR' THEN CASE WHEN ISNULL(CLR9.Notes,'') <> '' THEN CLR9.Notes ELSE CLR3.NOTES2   END   --WL04      
                                                              ELSE CASE WHEN ISNULL(CLR9.Notes,'') <> '' THEN CLR9.Notes ELSE '' END END ) ELSE '' END,  --WL01         --WL04      
               CASE WHEN  bb.pick_qty=cc.pack_qty THEN ( CASE WHEN @c_Zone = 'CRW'  THEN CASE WHEN ISNULL(CLR10.Notes,'') <> '' THEN CLR10.Notes ELSE CLR4.NOTES2 END   --WL04      
                                                              WHEN @c_Zone = 'CRWP' THEN CASE WHEN ISNULL(CLR10.Notes,'') <> '' THEN CLR10.Notes ELSE CLR4.NOTES  END   --WL04      
                                                              WHEN @c_Zone = 'ECTR' THEN CASE WHEN ISNULL(CLR10.Notes,'') <> '' THEN CLR10.Notes ELSE CLR4.NOTES2 END   --WL04      
                                                              ELSE CASE WHEN ISNULL(CLR10.Notes,'') <> '' THEN CLR10.Notes ELSE '' END END ) ELSE '' END,  --WL01   --WL04       
               /*CS01 End*/        
    ...
    ST2.StorerKey, --ML04  
    ORDERS.B_Company, --ML04  
    ST2.Company, --ML04  
    ST2.Address1, --ML04  
    ORDERS.C_Address1, --ML04  
    ST2.Address2, --ML04  
    ORDERS.C_Address2, --ML04  
    ST2.Address3, --ML04  
    ORDERS.C_Address3, --ML04  
    ST2.Address4, --ML04  
    ORDERS.C_Address4, --ML04  
    ST2.City, --ML04  
    ORDERS.C_City --ML04  
    ,tbl.cntRefno  
   END        
   ...
   BEGIN        
      SELECT DISTINCT MBOL.AddWho,           
         ...
         MBOL.Editdate,          
         --ORDERS.ConsigneeKey,   
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ORDERS.B_COMPANY ELSE ORDERS.ConsigneeKey END , --ML04   
         ORDERS.ExternOrderKey,          
         --ORDERS.C_Address1,    
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ST2.ADDRESS1 ELSE ORDERS.C_Address1 END , --ML04  
         --ORDERS.C_Address2,      
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ST2.ADDRESS2 ELSE ORDERS.C_Address2 END , --ML04  
         --ORDERS.C_Address3,  
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ST2.ADDRESS3 ELSE ORDERS.C_Address3 END , --ML04        
         ORDERS.C_Address4,        
         ORDERS.C_Contact1,        
         ORDERS.C_Contact2,        
         ORDERS.C_Phone1,        
   ...
   --CASE WHEN  ORDERS.type in ('ZS05','ZS06') THEN Orders.M_Company ELSE Orders.C_Company END, --ML03  
     CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN ST2.Company  
      WHEN  ORDERS.type in ('ZS05','ZS06') THEN Orders.M_Company ELSE Orders.C_Company END, --ML04  
         ...
         ELSE DATEADD(DAY, CONVERT(INT, CASE WHEN CLC1.Short IS NULL THEN ISNULL(ORDERS.Userdefine01,'0') ELSE ISNULL(CLC1.Short,'0') END), CONVERT(DATETIME, ORDERS.Userdefine10))END,     --ML02        
  ...
  LEFT OUTER JOIN STORER ST2 (NOLOCK) ON ST2.type ='4' AND ST2.Notes1 ='RSC' AND st2.storerkey = orders.b_company --ML04   
      ...
      LEFT OUTER JOIN CODELKUP CLR6 (NOLOCK) ON (ORDERS.Storerkey = CLR6.Storerkey AND CLR6.Listname = 'REPORTCFG'          
                                             ...
                                             AND CLR6.Code2 = ORDERS.Facility    
      --WL03 E      
  --LEFT JOIN #tmp_byload TBL ON orders.LoadKey=TBL.loadkey --ML04  
      WHERE ( MBOL.MbolKey = @c_mbolKey)        
      AND   PICKHEADER.Pickheaderkey IS NULL        
      UNION ALL        
  ...
  --LEFT JOIN #tmp_byload TBL ON orders.LoadKey=TBL.loadkey --ML04  
   ...
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN MAX(ORDERS.B_COMPANY) ELSE MAX(ORDERS.ConsigneeKey) END , --ML04  
         '' AS ExternOrderKey,          
         --MAX(ORDERS.C_Address1),     
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN MAX(ST2.ADDRESS1) ELSE MAX(ORDERS.C_Address1) END,  
         --MAX(ORDERS.C_Address2),   
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN MAX(ST2.ADDRESS2) ELSE MAX(ORDERS.C_Address2) END,  
         --MAX(ORDERS.C_Address3),    
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN MAX(ST2.ADDRESS3) ELSE MAX(ORDERS.C_Address3) END,        
   ...
   CASE WHEN  ST2.STORERKEY = ORDERS.B_COMPANY THEN MAX(ST2.Company)  
        WHEN  ORDERS.type in ('ZS05','ZS06') THEN MAX(Orders.M_Company) ELSE MAX(Orders.C_Company) END, --ML04    
         ETA = CASE WHEN ISNULL(STORER.SUSR1,'') = 'CRD' THEN     --ML02      
         (      
               CASE WHEN (CLC1.Short IS NULL) AND ORDERS.StorerKey = 'NIKECN' THEN MBOL.EditDate   --WL05      
                    WHEN ISDATE(ORDERS.Userdefine10) = 1 AND (ISNUMERIC(ISNULL(ORDERS.Userdefine01,'0')) = 1 OR ISNUMERIC(ISNULL(CLC1.Short,'0')) = 1) AND ISDATE(ORDERS.DeliveryDate) = 0   --NJOW01   --WL05 --ML01      
