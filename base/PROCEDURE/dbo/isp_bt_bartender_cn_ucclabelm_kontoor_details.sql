...
/******************************************************************************/                   
/* Copyright: LFL                                                             */                   
/* Purpose: isp_BT_Bartender_CN_UCCLabelM_Kontoor_Details                    */                   
/*                                                                            */                   
/* Modifications log:                                                         */                   
/*                                                                            */                   
...
CREATE PROC [dbo].[isp_BT_Bartender_CN_UCCLabelM_Kontoor_Details]                        
...
DECLARE                    
      ...
      @c_Qty09           NVARCHAR(80), 
      @c_Style10         NVARCHAR(80), 
      @c_Qty10           NVARCHAR(80), 
      @c_Style11         NVARCHAR(80), 
      @c_Qty11           NVARCHAR(80), 
      @c_Style12         NVARCHAR(80), 
      @c_Qty12           NVARCHAR(80), 
      @c_Style13         NVARCHAR(80), 
      @c_Qty13           NVARCHAR(80), 
      @c_Style14         NVARCHAR(80), 
      @c_Qty14           NVARCHAR(80), 
      @c_Style15         NVARCHAR(80), 
      @c_Qty15           NVARCHAR(80), 
      @c_Style16         NVARCHAR(80), 
      @c_Qty16           NVARCHAR(80), 
      @c_Style17         NVARCHAR(80), 
      @c_Qty17           NVARCHAR(80), 
...
-- SET RowNo = 0               
   ...
   SET @c_SQLJOIN = + ' SELECT DISTINCT PD.LabelNo, OH.ExternOrderkey, PD.Pickslipno, PD.CartonNo, '''' ,  '+ CHAR(13)    --5 
                    + ' '''', '''', '''', ' --8
                    + ' '''', '''', '  --10 
                    + ' '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', ' + CHAR(13)    --20 
                    + ' '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', ' + CHAR(13)    --30 
   ...
   BEGIN  
      ...
      SELECT @c_Pickslipno, @c_LabelNo, @c_CartonNo, PD.LabelLine, PD.SKU, SUM(PD.Qty), 'N'  
      ...
      SET @n_TTLpage =  FLOOR(@n_CntRec / @n_MaxLine ) + CASE WHEN @n_CntRec % @n_MaxLine > 0 THEN 1 ELSE 0 END + 1
      ...
      BEGIN  
         ...
         SELECT   @c_Style      = Style     
          ...
          SET   Col05 = @c_Style01     
              ...
              , Col37 = @c_Style17
              , Col38 = @c_Qty17
              , Col60 = CAST(@n_CurrentPage + 1 AS NVARCHAR(10)) + '/' + CAST(@n_TTLpage AS NVARCHAR(10))  
...
EXIT_SP:      
   ...
   EXEC isp_InsertTraceInfo     
      ...
      @c_TraceName = 'isp_BT_Bartender_CN_UCCLabelM_Kontoor_Details',    
