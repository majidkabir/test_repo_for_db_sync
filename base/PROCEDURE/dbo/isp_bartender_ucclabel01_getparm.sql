...
/******************************************************************************/                 
/* Copyright: IDS                                                             */                 
/* Purpose: isp_Bartender_UCCLABEL01_GetParm                                  */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
/* Date       Rev  Author     Purposes                                        */                 
/* 2017-09-18 1.0  CSCHONG    WMS-2863                                        */                           
/******************************************************************************/                
                  
CREATE PROC [dbo].[isp_Bartender_UCCLABEL01_GetParm]                      
(  @parm01            NVARCHAR(250),              
   @parm02            NVARCHAR(250),              
   @parm03            NVARCHAR(250),              
   @parm04            NVARCHAR(250),              
  ...
  DECLARE @d_Trace_StartTime   DATETIME,   
   ...
   SET @c_Trace_ModuleName = ''  
    ...
    SET @c_SQLJOIN = 'SELECT DISTINCT PARM1= PD.Pickslipno,PARM2=PD.labelNo,PARM3= '''' ,PARM4= '''',PARM5='''',PARM6='''',PARM7='''', '+
						   'PARM8='''',PARM9='''',PARM10='''',Key1=PH.storerkey,Key2=ISNULL(O.type,''''),Key3=ISNULL(O.shipperkey,''''),' +
						   ' Key4=CASE WHEN ISNULL(ph.orderkey,'''') = '''' THEN ''CONSO'' ELSE ''Normal'' END,'+
							' Key5= suser_name() '  +  
