...
GO
/************************************************************************/
/* Stored Procedure: isp_CartonManifestLabel08    								*/
...
/* Purpose: SOS#253509                                                  */
/*                                                                      */
/* Called By: r_dw_carton_manifest_Label_08                             */
/*                                                                      */
/* PVCS Version: 1.2                                                    */
/*                                                                      */
/* Version: 5.4                                                         */
...
/* 02-Apr-2013  NJOW01  1.0   273932-add divisions from sku.class       */
/* 04-Dec-2014  CSCHONG 2.0   327440-a new Division 'MJNS' (CS01)       */
/* 25-Aug-2016  CSCHONG 3.0   375864 - Change division logic (CS02)     */
/* 28-Aug-2016  CSCHONG 3.1   Change the field name (CS03)              */
/************************************************************************/

CREATE PROC [dbo].[isp_CartonManifestLabel08] (
