...
/*************************************************************************/  
/* Stored Procedure: isp_QCmd_TransmitLogInsertAlert_EG_PUMA             */  
...
/* 07-Aug-2019  GHChan   1.0  Initial Development                        */  
/*************************************************************************/  
  
CREATE PROCEDURE [dbo].[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]  
...
BEGIN  
   ...
   BEGIN      
      IF @b_debug = 1                                                           
      BEGIN                                                                                                                    
         PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: Nothing to Process (#QCmd_Transmitlog3_Seq)..'                                                                       
      END       
   ...
   BEGIN      
      ...
      IF @b_Debug = 1      
      BEGIN      
         PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: *** @c_TableName=' + @c_TableName      
         PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @c_StorerKey=' + @c_StorerKey  
         PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @c_MbolKey=' + @c_MbolKey      
         PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @c_TransmitLogKey=' + @c_TransmitLogKey      
      END      
      ...
      BEGIN      
         IF @b_Debug = 1      
         BEGIN      
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @c_APP_DB_Name=' + @c_APP_DB_Name      
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @c_ExecStatements=' + @c_ExecStatements      
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @c_DataStream=' + @c_DataStream      
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @n_ThreadPerAcct=' + CAST(CAST(@n_ThreadPerAcct AS INT)AS NVARCHAR)      
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @n_ThreadPerStream=' + CAST(CAST(@n_ThreadPerStream AS INT)AS NVARCHAR)      
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @n_MilisecondDelay=' + CAST(CAST(@n_MilisecondDelay AS INT)AS NVARCHAR)      
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @c_Port=' + @c_Port       
         END      
         ...
         --   IF @b_Debug = 1      
         --   BEGIN      
         --      PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: Exceeed Port Limit. Port : ' + @c_Port      
         --   END      
         --   BREAK      
         --END      
         ...
         BEGIN      
            IF @b_Debug = 1      
            BEGIN      
               PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: Record exists in TCPSOCKET_QueueTask, @c_TransmitLogKey=' + @c_TransmitLogKey      
            END      
         ...
         BEGIN  
            SET @c_ExecStatements = 'EXEC [dbo].[isp_EXG_Construct_FileName] @c_Username=''QCmdUser'',@n_EXG_Hdr_ID=1,@b_Debug=0,@b_Success=0,@n_Err=0,@c_ErrMsg='''',@c_ParamVal1=''PUMA'''  
         END  
         ...
         IF @b_Debug = 1      
   BEGIN      
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @c_CmdType=' + @c_CmdType      
            PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @c_ExecStatements=' + @c_ExecStatements      
         END      
         ...
         BEGIN CATCH      
            ...
            IF @b_Debug = 1      
            BEGIN      
               PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: @c_ErrMsg=' + @c_ErrMsg      
            END       
         END CATCH         
         ...
         --   IF @b_Debug = 1      
         --   BEGIN      
         --      PRINT '[isp_QCmd_TransmitLogInsertAlert_EG_PUMA]: BREAK For RecCount exceeed Port Limit. Port : ' + @c_Port      
         --   END      
         --   BREAK      
         --END      
