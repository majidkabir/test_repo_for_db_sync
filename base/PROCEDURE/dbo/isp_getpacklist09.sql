...
GO
/************************************************************************/
/* Store Procedure:  isp_GetPackList09                                  */
/* Creation Date: 20-Sep-2019                                           */
/* Copyright: LFL                                                       */
/* Written by: WLChooi                                                  */
/*                                                                      */
/* Purpose:  WMS-10614 - [TW] CNK RCM_PackSummary Report (NEW)          */
/*           (modified from isp_GetPackList05)                          */
/*                                                                      */
/* Usage:  Used for report dw = r_dw_print_packlist_09                  */
/*                                                                      */
/* Called By: Exceed                                                    */
/*                                                                      */
/* PVCS Version: 1.0                                                    */
...
/* 06-Nov-2019  Leong   1.1   INC0915220 - Bug Fix.                     */
/************************************************************************/

CREATE PROC [dbo].[isp_GetPackList09] (@c_LoadKey NVARCHAR(10))
AS
BEGIN
   SET NOCOUNT ON
   SET ANSI_NULLS OFF
   ...
   DECLARE @c_OrderKey        NVARCHAR(10),
           ...
           @c_Style           NVARCHAR(30),-- INC0915220
           @c_Color           NVARCHAR(10),
           @c_PrevStyle       NVARCHAR(30),-- INC0915220
