...
/************************************************************************/
/* Stored Procedure: nsp_GetPickSlipWave_08r                            */
/* Creation Date: 01-Apr-2009                                           */
/* Copyright: IDS                                                       */
/* Written by: Shong                                                    */
/*                                                                      */
/* Purpose: SOS#149851 - SSL HK - Descrete Picking Slip                 */
/*          - Printed together with Move Ticket & Pickslip in a         */
/*            composite report                                          */
/*          - copy from nsp_GetPickSlipWave_08                          */
/*                                                                      */
/* Called By: Report module (r_dw_print_wave_pickslip_08r)              */
/*                                                                      */
/* PVCS Version: 1.2                                                    */
/*                                                                      */
/* Version: 5.4                                                         */
...
/* 11-Nov-2009  NJOW01  1.0   SOS#149851 - Duplicate report of          */
/*                            nsp_GetPickSlipWave_08. Can retrieve pick */
/*                            detail in all status                      */
/* 28-Jan-2019  TLTING_ext 1.1 enlarge externorderkey field length      */
/************************************************************************/

CREATE PROC [dbo].[nsp_GetPickSlipWave_08r] (
               ...
               BEGIN
                  ...
                  BEGIN
                     ...
                     BEGIN
                        ...
                        Select @c_errmsg= 'NSQL'+CONVERT(char(5), @n_err)+':Insert failed on TransmitLog2. (nsp_GetPickSlipWave_08r)'+'('+'SQLSvr MESSAGE='+LTrim(RTrim(@c_errmsg))+')'
                        ROLLBACK TRAN 
                        GOTO QUIT 
                     END
                     ELSE
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN  
            ...
            SELECT @n_continue=3
            SELECT @n_err = @@ERROR
            SELECT @c_errMsg = 'Insert into TransmitLog Failed (nsp_GetPickSlipWave_08r)'                     
            GOTO QUIT 
         END  
         ELSE 
         BEGIN
...
QUIT:
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         END  
      END  
      EXECUTE nsp_logerror @n_err, @c_errmsg, 'nsp_GetPickSlipWave_08r'  
