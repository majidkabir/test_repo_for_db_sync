...
/*          Copy and modify from isp_BT_Bartender_Shipper_Label_UA            */             
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
...
--                   +' AND PD.Dropid = CASE WHEN ISNULL(RTRIM(''' + @c_Sparm3+ '''),'''') <> '''' THEN ''' + @c_Sparm3+ ''' ELSE PD.Dropid END'         --(CS02)   
  ...
  SET @c_SQL='INSERT INTO #Result (Col01,Col02,Col03,Col04,Col05, Col06,Col07,Col08,Col09'  + CHAR(13) +           
   ...
   UPDATE #Result  
   SET Col32 = CASE WHEN @n_CntLabel <> 0 --AND @c_PStatus ='9' --WL01(Removed due to Bartender faster than WMS Pack confirm)
               THEN CONVERT(NVARCHAR(5),@n_CntLabel) ELSE '' END  
   ...
   --                               AND S.StorerKey = OD.StorerKey       
    ...
    --group by L.lottable03,PD.SKU,s.descr      
     ...
     IF( (@n_SumPick = @n_SumPack) AND (@n_MaxCtnNo = @c_CntNo) )
     BEGIN
        UPDATE #Result
        SET COL41 = '1'
        WHERE Col31 = @c_CntNo
...
EXIT_SP:    
   ...
   EXEC isp_InsertTraceInfo   
      ...
      @c_TraceName = 'isp_BT_Bartender_CN_Shipper_Label_UA',  
