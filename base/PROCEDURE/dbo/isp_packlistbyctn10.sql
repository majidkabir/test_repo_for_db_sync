...
/******************************************************************************/  
/* Store Procedure: isp_PackListByCtn10                                       */  
/* Creation Date:02-JUNE-2017                                                 */  
/* Copyright: IDS                                                             */  
/* Written by: CSCHONG                                                        */  
/*                                                                            */  
/* Purpose: WMS-1887-CN-PANDORA Exceed Packing List                           */  
/*        :                                                                   */  
/* Called By:  r_dw_packing_list_by_ctn10                                     */  
/*                                                                            */  
/* PVCS Version: 1.0                                                          */  
/*                                                                            */  
/* Version: 1.0                                                               */  
...
CREATE PROC [dbo].[isp_PackListByCtn10] (
...
BEGIN  
   ...
   CREATE Table #TempPackListByCtn10 (
   ...
   INSERT INTO #TempPackListByCtn10 (
   	         OrderKey 		      
               , ExternOrderkey 	   
               , ORD_Contact1  		
               , ORD_Address1  	   
...
GROUP BY ORDERS.OrderKey,   
   ...
   SELECT *
   FROM #TempPackListByCtn10            
   ORDER BY busr1,CASE WHEN sortbypackqty = 'Y' THEN PackQty ELSE '' END desc
                 ,LabelNo, SKU      
          

   DROP TABLE #TempPackListByCtn10
END  
