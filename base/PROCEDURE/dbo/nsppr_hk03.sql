...
ELSE
   BEGIN
      ...
      BEGIN
         ...
         -- Added By SHONG
         -- Shouldn't check lottable04 even with shelf life
         -- Date: 01 Jul 2002
         IF dbo.fnc_RTrim(@c_Lottable04Label) IS NOT NULL AND  @c_Lottable04Label <> ''
         BEGIN
            IF LEFT(@c_lot,1) = '*'
            BEGIN
