...
/* Return Status:  None                                                 */
/*                                                                      */
/* Usage:  Used for report dw = r_dw_print_wave_pickslip_21             */
/*                                                                      */
/* Local Variables:                                                     */
/*                                                                      */
/* Called By:                                                           */
...
CREATE   PROC [dbo].[isp_GetPickSlipWave21] (@c_wavekey NVARCHAR(10))
AS
BEGIN
   SET NOCOUNT ON
   SET ANSI_NULLS OFF
...
-- AND (PICKDETAIL.PickMethod = '8' OR PICKDETAIL.PickMethod = '')      -- ONG01
 ...
 SUCCESS:
   ...
   BEGIN
      ...
      EXECUTE dbo.nsp_logerror @n_err, @c_errmsg, 'isp_GetPickSlipWave21'
