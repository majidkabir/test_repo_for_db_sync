...
BEGIN
   ...
   SAVE TRAN nspTTMFCP10 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN nspTTMFCP10 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN nspTTMFCP10 -- Only rollback change made here
Fail:
Quit:
