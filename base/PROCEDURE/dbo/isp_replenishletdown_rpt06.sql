...
/************************************************************************/
/* Store Procedure: isp_ReplenishLetdown_rpt06                          */
/* Creation Date: 13-MAR-2012                                          */
/* Copyright: IDS                                                       */
/* Written by: YTWan                                                    */
/*                                                                      */
/* Purpose: SOS#238071 - Generate Replenishment Let Down report for WE  */  
/*          (Duplicate from nsp_ReplenishLetdown_rpt04)                 */
/*                                                                      */
...
/* Local Variables:                                                     */
/*                                                                      */
/* Called By: r_dw_replenishletdown_rpt06                               */
/*                                                                      */
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 5.4                                                         */
...
CREATE PROC [dbo].[isp_ReplenishLetdown_rpt06] (@c_facility     NVARCHAR(5)
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE nsp_logerror @n_err, @c_errmsg, 'isp_ReplenishLetdown_rpt06'
