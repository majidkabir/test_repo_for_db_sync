...
GO
/************************************************************************/    
/* Stored Procedure: ispALEC06                                          */    
/* Creation Date: 02-JUNE-2014                                          */    
/* Copyright: LF                                                        */    
/* Written by:                                                          */    
/*                                                                      */    
/* Purpose: 336160 - ECOM Allocate Case from BULK                       */
/*          SkipPreAllocation='1'                                       */
/*        : Copy and Modify from  ispALEC02                             */
/* Called By:                                                           */    
/*                                                                      */    
/* PVCS Version: 1.0                                                    */    
/*                                                                      */    
...
/* 10-Oct-2016  Shong01 1.1   Fixing Overallocation Issues              */
/* 18-Oct-2016  Shong   1.2   Change Sorting Order                      */
/* 24-Jul-2017  TLTING  1.3   Dynamic SQL review, impact SQL cache log  */
/* 31-Jul-2018  SHONG   1.4   Change for ROBOT Project (SWT01)          */
/* 20-Mar-2019  NJOW01  1.5   Fix to exclude qtyreplen                  */
/************************************************************************/    
CREATE PROC [dbo].[ispALEC06]        
...
BEGIN    
   ...
   SELECT @c_SQL =   
             ' DECLARE CURSOR_CANDIDATES SCROLL CURSOR FOR '   
            +' SELECT LOT.Lot, LOTxLOCxID.Loc, LOTxLOCxID.Id, '
            +' CASE WHEN (LOT.Qty - LOT.QtyAllocated - LOT.QtyPicked - LOT.QtyPreAllocated) <  (LOTxLOCxID.Qty - LOTxLOCxID.QtyAllocated - LOTxLOCxID.QtyPicked - LOTxLOCxID.QtyReplen) '
            ...
            +' AND LOC.LocationType NOT IN (''DYNPPICK'') '   -- SWT01
