...
GO
/************************************************************************/
/* Stored Proc: isp_RPT_RP_DespLBL01                                    */
/* Creation Date: 2022-03-04                                            */
/* Copyright: LF Logistics                                              */
/* Written by: Wan                                                      */
/*                                                                      */
/* Purpose: LFWM-3391 - MY-Convert Despatch Label to SCE                */
/*        : Convert to SCE - original Dw- r_dw_dispatch_label02         */
/* Called By: r_dw_rpt_rp_despllbl01                                    */
/*          :                                                           */
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 7.0                                                         */
...
/************************************************************************/
CREATE   PROC [dbo].[isp_RPT_RP_DespLBL01]
...
BEGIN
   ...
   CREATE TABLE #TMP_DESPLBL
      ...
      ,  Orderkey             NVARCHAR(30) NOT NULL DEFAULT('')      
