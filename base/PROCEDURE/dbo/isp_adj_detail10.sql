...
/************************************************************************/
/* Store Procedure:  isp_adj_detail10                                   */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by: Mingle                                                   */
/*                                                                      */
/* Purpose:  WMS-18176 PH_IDSMED AdjustmentReport                       */
/*                                                                      */
...
/* Return Status:  None                                                 */
/*                                                                      */
/* Usage:  Used for report dw = r_adjusment_detail_10                   */
/*                                                                      */
/* Local Variables:                                                     */
/*                                                                      */
/* Called By:                                                           */
...
/* 15-Nov-2021  Mingle        DevOps Combine Script                     */
/************************************************************************/
CREATE PROC [dbo].[isp_adj_detail10] (
...
BEGIN
   ...
   --JOIN CODELKUP         CL  WITH (NOLOCK) ON (CL.Listname = 'ADJREASON')
   --                                        AND(AD.ReasonCode = CL.Code )
   JOIN SKU              S   WITH (NOLOCK) ON S.StorerKey = AD.StorerKey AND S.Sku = AD.Sku
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         END  
      END  
      EXECUTE nsp_logerror @n_err, @c_errmsg, 'isp_adj_detail10'  
