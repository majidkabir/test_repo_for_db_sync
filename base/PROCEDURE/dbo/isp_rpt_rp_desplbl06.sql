...
GO
/************************************************************************/
/* Stored Proc: isp_RPT_RP_DespLBL06                                    */
/* Creation Date: 2022-03-10                                            */
/* Copyright: LF Logistics                                              */
/* Written by: Wan                                                      */
/*                                                                      */
/* Purpose: LFWM-3391 - MY-Convert Despatch Label to SCE                */
/*        : Convert to SCE - original Dw- r_dw_dispatch_label15         */
/* Called By: r_dw_rpt_rp_despllbl06                                    */
/*          :                                                           */
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 7.0                                                         */
...
/************************************************************************/
CREATE   PROC [dbo].[isp_RPT_RP_DespLBL06]
...
BEGIN
   ...
   CREATE TABLE #TMP_DESPLBL
      ...
      ,  BilledContainerQty   INT            NOT NULL DEFAULT(0)
   ...
   SELECT o.Orderkey 
       ...
       ,  BilledContainerQty  = ISNULL(o.BilledContainerQty  ,0)            
       ,  InvoiceNo           = ISNULL(o.InvoiceNo     ,'')
       ,  OrderGroup          = ISNULL(o.OrderGroup    ,'')
