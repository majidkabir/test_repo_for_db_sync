...
GO
/*************************************************************************/
/* Stored Procedure: nspALCONE1                                          */
/* Creation Date: 07-FEB-2023                                            */
/* Copyright: LFL                                                        */
/* Written by:                                                           */
/*                                                                       */
/* Purpose: WMS-21653/21789 - CN Converse ECOM Allocation from priority  */
/*                      distribution area                                */
/*                                                                       */
/* Called By:                                                            */
/*                                                                       */
...
/* 07-FEB-2023  NJOW    1.0   DEVOPS combine script                      */
/*************************************************************************/
CREATE   PROC [dbo].[nspALCONE1]
...
BEGIN    
   ...
   SET @c_SortBy = 'ORDER BY CL.Short, LOC.LogicalLocation, LOC.Loc, LA.Lottable05, LOTxLOCxID.Lot'
   ...
   SET @c_SQL = N'      
      ...
      JOIN CODELKUP CL (NOLOCK) ON LOTXLOCXID.Storerkey = CL.Storerkey AND CL.ListName = ''CONVSALE'' AND LOC.Loc = CL.Code
      ...
      'GROUP BY LOTxLOCxID.LOT, LOTxLOCxID.LOC, LOTxLOCxID.ID, LOC.LogicalLocation, LOC.LOC, LA.Lottable05, CL.Short ' +    
      @c_SortBy
