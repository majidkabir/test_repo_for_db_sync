...
GO
/************************************************************************/  
/* Store Procedure:  isp_archiveDataRecord                              */  
...
/* 18Mar2011    TLTING    Increase Variable field length (tlting01)     */
/*                                                                      */  
/************************************************************************/  
  
CREATE PROC [dbo].[isp_archiveDataRecord]    
...
BEGIN  
   ...
   BEGIN    
      ...
      BEGIN    
         ...
         END    
      END    
      EXECUTE dbo.nsp_logerror @n_err, @c_errmsg, 'isp_archiveDataRecord'    
