...
BEGIN
   ...
   SAVE TRAN nspTTMFPK2 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN nspTTMFPK2 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN nspTTMFPK2 -- Only rollback change made here
Fail:
Quit:
