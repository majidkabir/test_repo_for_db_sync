...
BEGIN
   ...
   BEGIN
      ...
      SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0))  
                    ...
                    + '. Must Be SEPB2BPTS, SEPB2CAGV or SEPB2CPTS (ispSEPB2B)'
      GOTO QUIT_SP
   END

   IF @c_WaveType NOT IN ('SEPB2BPTS')
   BEGIN
      GOTO QUIT_SP
   END
   ...
   BEGIN
      ...
      SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0))  
                    ...
                    + '. Allocation is not allowed (ispSEPB2B)'
      GOTO QUIT_SP
   END
   ...
   SET @c_SQLParms  = N' @c_Facility           NVARCHAR(5)'  
    ...
    EXEC sp_ExecuteSQL  @c_SQL
      ...
      BEGIN
         ...
         BEGIN
            PRINT '-----------------------------------'+ CHAR(13) +
                  'Main PICKCOde: ispSEPB2B'+ CHAR(13) +
                  'SKU: ' + @c_SKU + CHAR(13) +
         ...
         EXEC ispSEPLoadFP2   --//Pallet @Pallet LOC
           @c_WaveKey          = @c_WaveKey         
         ...
         END
          ...
          EXEC ispSEPLoadFC2   --//CASE @Case & @Pallet Loc, UOM = '2'
           @c_WaveKey          = @c_WaveKey         
         , @c_WaveType         = @c_WaveType  
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
         ...
         EXEC ispSEPConsoFP6  --//Pallet @Pallet LOC
           @c_WaveKey          = @c_WaveKey         
         , @c_WaveType         = @c_WaveType   
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
         ...
         EXEC ispSEPConsoFC6  --//CASE @Case & @Pallet Loc, UOM = '6'
           @c_WaveKey          = @c_WaveKey         
         , @c_WaveType         = @c_WaveType   
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
         ...
         EXEC ispSEPConsoFQ7  --//Loose Qty @DPP Loc, UOM = '7', Get DPP <= @n_QtyLeftToFullfill   --(Wan01)
           @c_WaveKey          = @c_WaveKey 
         , @c_WaveType         = @c_WaveType                      
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
         ...
         EXEC ispSEPConsoLC7  --//Loose Qty @Case & @Pallet Loc, UOM = '7'
           @c_WaveKey          = @c_WaveKey 
         , @c_WaveType         = @c_WaveType                    
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
         ...
         EXEC ispSEPConsoLQ7  --//Loose Qty @DPP Loc, UOM = '7', Get DPP >= 0 
           @c_WaveKey          = @c_WaveKey 
         , @c_WaveType         = @c_WaveType                      
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
      ...
      IF @n_QtyLeftToFullfill > 0
      BEGIN
         EXEC ispSEPConsoLQ7  --//Loose Qty @AVG Loc, UOM = '7'
           @c_WaveKey          = @c_WaveKey 
         , @c_WaveType         = 'SEPB2B_AGV'  -- to get from AVG                       
         , @c_Facility         = @c_Facility         
         , @c_Storerkey        = @c_Storerkey        
         , @c_Sku              = @c_Sku              
         , @c_Lottable01       = @c_Lottable01       
...
QUIT_SP:
   ...
   BEGIN
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'ispSEPB2B'
