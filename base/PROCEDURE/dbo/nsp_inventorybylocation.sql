...
/************************************************************************/
/* Store Procedure:  nsp_InventoryByLocation                            */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:   LFL                                                    */
/*                                                                      */
/* Purpose:  Inventory by Loc                                           */
/*                                                                      */
/* Input Parameters:                                                    */
/*                                                                      */
/* Output Parameters:                                                   */
...
CREATE PROC [dbo].[nsp_InventoryByLocation] ( -- nsp_InventoryByLocation 'A','B','1','3','U'
 @c_facility NVARCHAR(5),
 @c_start_aisle NVARCHAR(10),
 @c_end_aisle NVARCHAR(10),
 @n_start_level NVARCHAR(5),
 @n_end_level NVARCHAR(5)
 )
 AS
 BEGIN
   SET NOCOUNT ON 
   ...
   SET CONCAT_NULL_YIELDS_NULL OFF
 	...
 	BEGIN
        ...
        AND LOTxLOCxID.storerkey = SKU.storerkey	
 		...
 		IF @@ROWCOUNT = 0
 			INSERT #RESULT (facility, putawayzone, loc, lottable04, qtyavail, casecnt) 
 				VALUES (@c_facility, @c_zone, @c_loc, '00/00/00', 0, 0)
