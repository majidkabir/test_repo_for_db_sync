...
GO
/************************************************************************/
/* Store Procedure:  isp_GetPickSlipOrders26                        	   */
...
/* Return Status:  None                                                 */
/*                                                                      */
/* Usage:  Used for report dw = r_dw_print_pickorder26       				*/
/*                                                                      */
/* Local Variables:                                                     */
/*                                                                      */
...
CREATE PROC [dbo].[isp_GetPickSlipOrders26] (@c_loadkey NVARCHAR(10)) 
AS
BEGIN
	SET NOCOUNT ON			
   SET QUOTED_IDENTIFIER OFF	
	...
	DECLARE @c_pickheaderkey NVARCHAR(10),
		...
		INSERT INTO #TEMP_PICK
			(  PickSlipNo,          LoadKey,         OrderKey,			ConsigneeKey,
				...
				DischargePlace ,     InvoiceNo,       Pltcnt ) 
		SELECT
