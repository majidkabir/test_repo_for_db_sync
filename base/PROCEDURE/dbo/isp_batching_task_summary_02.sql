...
GO
/************************************************************************/
/* Store Procedure:  isp_batching_task_summary_02                       */
/* Creation Date:  31-MAY-2019                                          */
/* Copyright: LF                                                        */
/* Written by:                                                          */
/*                                                                      */
/* Purpose: WMS-9127-[TW] Exceed RCM Report CR                          */
/*                                                                      */
/* Input Parameters:                                                    */
/*                                                                      */
...
/* Local Variables:                                                     */
/*                                                                      */
/* Called By: r_dw_batching_task_summary_02                             */
/*                                                                      */
/* PVCS Version: 1.2                                                    */
/*                                                                      */
/* Version: 5.4                                                         */
...
CREATE PROC [dbo].[isp_batching_task_summary_02] (
 ...
 BEGIN
    ...
    BEGIN 
       SELECT @n_Continue = 3  
       SELECT @n_Err = 63200  
       SELECT @c_ErrMsg='NSQL'+CONVERT(NVARCHAR(5),@n_Err)+': Invalid Mode. The value must be 1,4,5,9 (isp_batching_task_summary_02)' 
       GOTO Quit
    END
