...
/******************************************************************************/                 
/* Copyright: IDS                                                             */                 
/* Purpose: isp_BT_Bartender_TH_PRICERTLBL_1                                  */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
/* Date       Rev  Author     Purposes                                        */                 
/* 2020-04-29 1.0  CSCHONG    Created (WMS-13157)                              */             
/******************************************************************************/                
                  
CREATE PROC [dbo].[isp_BT_Bartender_TH_PRICERTLBL_1]                      
...
SET @c_SQLJOIN = +' SELECT DISTINCT s.busr8,s.busr6,S.busr9,S.busr7,s.notes2,'    
             + CHAR(13) +   
             +'S.COUNTRYOFORIGIN,S.BUSR5,'''','''','''','  
             + CHAR(13) +  
             +' '''','''','''','''','
				 + ' '''','''','''','''','''','''', '   
             + CHAR(13) +  
