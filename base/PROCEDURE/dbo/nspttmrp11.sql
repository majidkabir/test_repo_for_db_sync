...
BEGIN
   ...
   DECLARE 
      ...
      ,@c_EquipmentProfileKey NVARCHAR(10) 
   ...
   SELECT @c_EquipmentProfileKey = EquipmentProfileKey
   ...
   BEGIN
      ...
      SET @c_errmsg = 'NSQL' + CONVERT( NVARCHAR(5), @n_err) + ': ' + 
                      'Update to TaskDetail table failed. (nspTTMRP11)' + 
   ...
   BEGIN
      ...
      BEGIN
        ...
        BEGIN
          ...
          END
        END
        execute nsp_logerror @n_err, @c_errmsg, 'nspTTMRP11'
