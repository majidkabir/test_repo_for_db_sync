...
/*          Copy from isp_BT_Bartender_Shipper_Label_ECCOKR                   */                
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
/* Date       Rev  Author     Purposes                                        */      
/* 2021-02-24 1.0  WLChooi    Check in GitLab (Unable to find related ticket) */             
/******************************************************************************/                
                  
CREATE PROC [dbo].[isp_BT_Bartender_Shipper_Label_SLKR]                       
...
BEGIN                      
  ...
  DECLARE @d_Trace_StartTime   DATETIME,   
   ...
   SET @c_SQLJOIN = +' SELECT DISTINCT F.DESCR,F.Address1,F.Address2,F.Address3,F.Address4,'   --5  
                    ...
                    +' JOIN CartonTrack CT WITH (NOLOCK) ON PD.labelno = CT.labelno and CT.carriername = ''SLKR'' and CT.keyname = ORD.Storerkey '   
...
EXIT_SP:    
   ...
   EXEC isp_InsertTraceInfo   
      ...
      @c_TraceName = 'isp_BT_Bartender_Shipper_Label_SLKR',  
