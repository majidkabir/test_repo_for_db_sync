...
/******************************************************************************/
/* Copyright: LFL                                                             */
/* Purpose: isp_BT_Bartender_VN_PRICERTLBL_1                                  */
/*        : Copy from isp_BT_Bartender_TH_PRICERTLBL_1 and modify             */
/*                                                                            */
/* Modifications log:                                                         */
/*                                                                            */
...
/* 2021-03-26 1.5  WLChooi    WMS-16121 - Change Col01 & Col03 (WL05)         */
/* 2022-08-22 1.6  CSCHONG    Devops Scripts Combine & WMS-20557(CS01)        */
/******************************************************************************/
...
BEGIN
   ...
   SET @c_SQLJOIN = +N'SELECT DISTINCT S.SKUGroup, S.SKU, SUBSTRING(ISNULL(S.DESCR,''''),1,80), S.COUNTRYOFORIGIN, SUBSTRING(ISNULL(S.Notes1,''''), 1, 80),'   --5   --WL01   --WL04   --WL05
                    + CHAR(13) +
                    +N'S.AltSKU, ISNULL(S.BUSR5,''''), SUBSTRING(ISNULL(S.Notes2,''''),1,80),CAST(S.ShelfLife as NVARCHAR(10)),'''','   --WL02   --CS01
                    + CHAR(13) +
                    +' '''','''','''','''','
                    + ' '''','''','''','''','''','''', '
                    + CHAR(13) +
...
EXIT_SP:
   ...
   --   @c_TraceName = 'isp_BT_Bartender_TH_PRICERTLBL_1',
