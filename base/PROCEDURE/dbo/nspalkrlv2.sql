...
/* 15-DEC-2022  NJOW01  1.0   WMS-21344 allocate prime pick zone first  */
/************************************************************************/      
CREATE   PROC [dbo].[nspALKRLV2]          
...
BEGIN      
   ...
   SET @c_SortingCondition = ' ORDER BY CASE WHEN LOC.LocationGroup = ''PRIME'' THEN 1 ELSE 2 END, LA.Lottable05, LOC.LogicalLocation, LOC.Loc '  --NJOW01
