...
/************************************************************************/  
/* Stored Procedure: isp_GetKIOSKASRSPKCIPRevTask_a                     */  
...
/*                                                                      */  
/* Called By: r_dw_kiosk_asrspk_cip_rev_a_form                          */  
/*                                                                      */  
/* PVCS Version: 1.1                                                    */  
/*                                                                      */  
/* Version: 7.0                                                         */  
...
CREATE PROC [dbo].[isp_GetKIOSKASRSPKCIPRevTask_a]   
...
,    Remarks             NVARCHAR(80)  NOT NULL DEFAULT ('')      --(Wan02)
   ...
   INSERT INTO #Result (TaskDetailKey,RefTaskKey,FROMID,TOID,PalletID,OrderKey,OrderStatus,OrderLineNumber
