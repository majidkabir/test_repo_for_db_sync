...
/* 16-Mar-2011  Audrey    SOS204962 - Remove p.uom. It will not accurate*/
/*                        when case pick from bulk              (ang01) */    
/************************************************************************/  
CREATE PROC  [dbo].[nspPR_UHPC]    
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            IF @c_Facility NOT IN ('PR','JB') AND @c_uom <> '1'
            BEGIN
               GOTO SKIPREALLOC
            END
