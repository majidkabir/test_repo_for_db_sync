...
/* 2022-02-14 1.0  MINGLE     Created(WMS-18915) DevOps Combine Script        */
/******************************************************************************/

CREATE PROC [dbo].[isp_BT_Bartender_KR_Shipper_Content_Label_UA_02]
...
DECLARE
   ...
   FETCH NEXT FROM CUR_StartRecLoop INTO @c_ExternORDKey,@c_ExternPOKey,@c_BuyerPO,@c_OrderKey,@c_OrdType,@c_CartonType,@c_LabelNo,@c_CartonNo,@c_Notes 
   ...
   BEGIN
      ...
      BEGIN
         ...
         INSERT INTO #CartonContent (OrderKey,ORDSku,SDESCR,SDIV,TTLPICKQTY)    
         ...
         JOIN #OrderDetail OD ON OH.OrderKey = OD.OrderKey AND PD.StorerKey = OD.StorerKey AND PD.SKU = OD.SKU    
         ...
         --SET @c_ColPDQty11         =''
            ...
            BEGIN
               ...
               SET @c_ColSDIV1       = @c_Colcontentsdiv    
            ...
            BEGIN
               ...
               SET @c_ColSDIV2       = @c_Colcontentsdiv    
            ...
            BEGIN
               ...
               SET @c_ColSDIV3       = @c_Colcontentsdiv    
            ...
            BEGIN
               ...
               SET @c_ColSDIV4       = @c_Colcontentsdiv    
            ...
            BEGIN
               ...
               SET @c_ColSDIV5       = @c_Colcontentsdiv    
            ...
            BEGIN
               ...
               SET @c_ColSDIV6       = @c_Colcontentsdiv    
            ...
            BEGIN
               ...
               SET @c_ColSDIV7       = @c_Colcontentsdiv    
            ...
            --   SET @c_ColSDIV8       = @c_Colcontentsdiv    
            ...
            --   SET @c_ColSDIV9       = @c_Colcontentsdiv    
            ...
            --   SET @c_ColSDIV10       = @c_Colcontentsdiv    
            ...
            --   SET @c_ColSDIV11       = @c_Colcontentsdiv    
   ...
   EXEC isp_InsertTraceInfo
      ...
      @c_TraceName = 'isp_BT_Bartender_KR_Shipper_Content_Label_UA_02',
