...
/******************************************************************************/                   
/* Copyright: IDS                                                             */                   
/* Purpose: isp_Bartender_PALLETLBL3_GetParm                                  */                   
/*                                                                            */                   
/* Modifications log:                                                         */                   
/*                                                                            */                   
...
CREATE PROC [dbo].[isp_Bartender_PALLETLBL3_GetParm]                        
(  @parm01            NVARCHAR(250),                
   @parm02            NVARCHAR(250),                
   @parm03            NVARCHAR(250),                
   @parm04            NVARCHAR(250),                
  ...
  DECLARE @d_Trace_StartTime   DATETIME,     
   ...
   SET @c_Trace_ModuleName = ''    
    ...
    SET @c_SQLJOIN = 'SELECT TOP 1 PARM1=S2.storerkey, ' +  
                     ...
                     ' JOIN SKU S2 WITH (NOLOCK) ON S2.Storerkey = S.storerkey and ' +   
                     ' (S2.sku = S.busr1 OR  S2.sku = S.MANUFACTURERSKU)' +  
                     ' where Rec.receiptkey =@parm01 ' +  
