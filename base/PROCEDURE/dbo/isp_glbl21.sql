...
GO
/************************************************************************/
/* Store Procedure: isp_GLBL21                                          */
/* Creation Date: 11-Jun-2020                                           */
/* Copyright: IDS                                                       */
/* Written by: CSCHONG                                                  */
/*                                                                      */
/* Purpose: WMS-13607 - [JP] Desigual - SSCC Barcode Generate SP        */ 
/*                                                                      */
...
--   END 
   ...
   BEGIN
      ...
      BEGIN
         ...
         END          
      END
      EXECUTE nsp_logerror @n_err, @c_errmsg, "isp_GLBL21"
