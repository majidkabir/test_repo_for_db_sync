...
/******************************************************************************/                   
/* Copyright: IDS                                                             */                   
/* Purpose: isp_BT_Bartender_CN_SKU_Label_01_UA                               */                   
/*                                                                            */                   
/* Modifications log:                                                         */                   
/*                                                                            */                   
...
BEGIN                        
 ...
 --  SET ANSI_WARNINGS OFF                    --CS01             
  ...
  SET @c_SQLJOIN = +' SELECT DISTINCT sc.[Data],lli.id,lli.sku,sum(lli.qty) AS qty,'''','+ CHAR(13)      --5        
             ...
             + 'JOIN SKUConfig AS sc WITH (NOLOCK) ON sc.SKU=lli.Sku AND sc.StorerKey=lli.StorerKey'  
             + ' WHERE LLI.ID = @c_Sparm01 AND'      
             + ' LLI.Storerkey= @c_Sparm02 '     
             + ' GROUP BY sc.[Data],lli.id,lli.sku '  
...
EXIT_SP:      
   ...
   EXEC isp_InsertTraceInfo     
      ...
      @c_TraceName = 'isp_BT_Bartender_CN_SKU_Label_01_UA',    
