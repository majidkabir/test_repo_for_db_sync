...
/* 21Jun2017    TLTING    recompile                                     */
/************************************************************************/

CREATE  PROC   [dbo].[ispGenOTMLog]
...
BEGIN
   ...
   BEGIN
      IF NOT EXISTS ( SELECT 1 FROM OTMLOG (NOLOCK) 
      ...
      BEGIN
         ...
         BEGIN
            ...
            SET @c_ErrMsg = 'NSQL' + CONVERT(CHAR(5),ISNULL(@n_Err,0)) 
                          + ': Insert into OTMLOG Failed (ispGenOTMLog)' 
            GOTO QUIT 
         END
      END
   END
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, "ispGenOTMLog"
