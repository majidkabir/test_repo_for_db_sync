...
/************************************************************************/
/* Store Procedure:  isp_adj_detail08                                  */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by: YTWan                                                    */
/*                                                                      */
...
/* Return Status:  None                                                 */
/*                                                                      */
/* Usage:  Used for report dw = r_adjusment_detail_08                   */
/*                                                                      */
/* Local Variables:                                                     */
/*                                                                      */
/* Called By:                                                           */
...
/*                            by storerkey                              */
/************************************************************************/
CREATE PROC [dbo].[isp_adj_detail08] (
...
BEGIN
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         END  
      END  
      EXECUTE nsp_logerror @n_err, @c_errmsg, 'isp_adj_detail08'  
