...
GO
/************************************************************************/
/* Store Procedure:  isp_SCE_DL_GENERIC_ORDDETREF_RULES_200001_10       */
/* Creation Date: 10-May-2022                                           */
/* Copyright: LFL                                                       */
/* Written by: GHChan                                                   */
/*                                                                      */
/* Purpose:  Perform insert into OrderDetailRef target table            */
/*                                                                      */
/*                                                                      */
...
CREATE   PROCEDURE [dbo].[isp_SCE_DL_GENERIC_ORDDETREF_RULES_200001_10] (
   @b_Debug       INT            = 0
 , @n_BatchNo     INT            = 0
 , @n_Flag        INT            = 0
...
BEGIN
   ...
   IF @b_Debug = 1
   BEGIN
      SELECT '<<SUB-SP-RULES>> - [isp_SCE_DL_GENERIC_ORDDETREF_RULES_200001_10] EXIT... ErrMsg : ' + ISNULL(RTRIM(@c_ErrMsg), '');
   END;
