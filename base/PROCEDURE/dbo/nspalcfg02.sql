...
/*
   ...
   11. For LISTNAME. Only need to provide storerkey and UDF01. This option only can apply to listname 'nspALCFG02'
...
*/
  ...
  --NJOW06 S
   ...
   WHERE CODELKUP.Listname = 'nspALCFG02'
