...
/* 2019-04-15   kelvinongcy   1.1 Count sum for Carton(s) https://jira.lfapps.net/browse/WMS-8555       */    
/********************************************************************************************************/    
CREATE PROC  [dbo].[isp_MailQBuildAdidas]        
   @Qid   int         
  ,@Debug   bit   = 0        
AS        
BEGIN        
...
ELSE IF @C02Name<>''  SET @TotalCol= 2     
   ...
   -- Start: count total     
    ...
    BEGIN    
      ...
      IF       @C02Agg<> ''  SET @C01AggLabel = 'Grant Total'    
      ELSE IF  @C03Agg<> ''  SET @C02AggLabel = 'Grant Total'    
      ELSE IF  @C04Agg<> ''  SET @C03AggLabel = 'Grant Total'    
      ELSE IF  @C05Agg<> ''  SET @C04AggLabel = 'Grant Total'    
      ELSE IF  @C06Agg<> ''  SET @C05AggLabel = 'Grant Total'    
      ELSE IF  @C07Agg<> ''  SET @C06AggLabel = 'Grant Total'    
      ELSE IF  @C08Agg<> ''  SET @C07AggLabel = 'Grant Total'    
      ELSE IF  @C09Agg<> ''  SET @C08AggLabel = 'Grant Total'    
      ELSE IF  @C10Agg<> ''  SET @C09AggLabel = 'Grant Total'    
      ELSE IF  @C11Agg<> ''  SET @C10AggLabel = 'Grant Total'    
      ELSE IF  @C12Agg<> ''  SET @C11AggLabel = 'Grant Total'    
      ELSE IF  @C13Agg<> ''  SET @C12AggLabel = 'Grant Total'    
      ELSE IF  @C14Agg<> ''  SET @C13AggLabel = 'Grant Total'    
      ELSE IF  @C15Agg<> ''  SET @C14AggLabel = 'Grant Total'    
