...
GO
/************************************************************************/    
/* Stored Procedure: isp_PODTrigger_Wrapper                             */    
/* Creation Date: 2021-11-18                                            */    
/* Copyright: LF                                                        */    
/* Written by:                                                          */    
/*                                                                      */    
/* Purpose: WMS-18336 - MYS–SBUXM–Default value in POD Entry column upon*/  
/*        : update POD Status                                           */  
/*                                                                      */    
/* Called By: Orders insert/update/delete trigger                       */      
/*            Stored proc naming: ispPODxx                              */  
/*                                                                      */    
/* PVCS Version: 1.0                                                    */    
/*                                                                      */    
/* Version: 5.4                                                         */    
...
CREATE PROCEDURE [dbo].[isp_PODTrigger_Wrapper]    
...
BEGIN    
   ...
   FETCH NEXT FROM Cur_SPCode INTO   @c_StorerKey  
                        , @c_SPCode  
                                   , @c_option5_splist   
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         END  
      END  
      execute nsp_logerror @n_err, @c_errmsg, 'isp_PODTrigger_Wrapper'  
