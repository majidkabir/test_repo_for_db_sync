...
CREATE PROC  [dbo].[nsp_TransferDetailInterface_ALL]
...
BEGIN
   ...
   BEGIN
      ...
      SELECT @c_errmsg="NSQL"+CONVERT(char(5),@n_err)+": Unable to obtain transmitlogkey (nsp_TransferDetailInterface_ALL)" + " ( " + " SQLSvr MESSAGE=" + dbo.fnc_LTrim(dbo.fnc_RTrim(@c_errmsg)) + " ) "
   END
ELSE
   BEGIN
   ...
   ELSE
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, "nsp_TransferDetailInterface_ALL"
