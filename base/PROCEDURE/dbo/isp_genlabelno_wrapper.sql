...
GO
/************************************************************************/  
/* Stored Procedure: isp_GenLabelNo_Wrapper                             */  
...
/* 06-JUN-2017  Wan02   1.1   WMS-1816 - CN_DYSON_Exceed_ECOM PACKING   */
/* 21-DEC-2017  Wan03   1.2   WMS-3486 - CR_Nike Korea ECOM Exceed      */
/*                            Packing Module                            */
/* 26-JUL-2017  SWT01   1.3   Performance Tuning                        */
/* 26-NOV-2017  NJOW01  1.4   WMS-7060 add dropid optional param.       */
/************************************************************************/   
CREATE PROCEDURE [dbo].[isp_GenLabelNo_Wrapper]  
...
BEGIN  
   ...
   BEGIN
      ...
      BEGIN
         SET @n_continue = 3
         SET @n_err = 31201
         SET @c_errmsg='NSQL'+CONVERT(char(5),@n_err)+': Error Executing ' + @c_CTNTrackNo_SP + '. (isp_UnpackReversal)' 
