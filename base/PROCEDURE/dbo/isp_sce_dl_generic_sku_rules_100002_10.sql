...
GO
/************************************************************************/
/* Store Procedure:  isp_SCE_DL_GENERIC_SKU_RULES_100002_10             */
...
CREATE PROCEDURE [dbo].[isp_SCE_DL_GENERIC_SKU_RULES_100002_10] (
   @b_Debug       INT            = 0
 , @n_BatchNo     INT            = 0
 , @n_Flag        INT            = 0
...
BEGIN
   ...
   IF @b_Debug = 1
   BEGIN
      SELECT '<<SUB-SP-RULES>> - [isp_SCE_DL_GENERIC_SKU_RULES_100002_10] EXIT... ErrMsg : ' + ISNULL(RTRIM(@c_ErrMsg), '');
   END;
