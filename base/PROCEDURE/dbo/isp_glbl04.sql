...
--   END
   ...
   SET @c_SSCC_LabelNo  = RTRIM(@c_Label_SeqNo) --+ @c_Label_CheckDigit
   
   IF @b_debug = 1   
   BEGIN
      SELECT @c_Label_CheckDigit '@c_Label_CheckDigit', @c_Label_SeqNo '@c_Label_SeqNo' 
   END
...
--   END 
   ...
   BEGIN
      ...
      BEGIN
         ...
         END          
      END
      EXECUTE nsp_logerror @n_err, @c_errmsg, "isp_GLBL04"
