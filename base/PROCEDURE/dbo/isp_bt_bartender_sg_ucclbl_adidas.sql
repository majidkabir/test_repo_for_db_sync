...
/********************************************************************************/                   
/* Copyright: LFL                                                               */                   
/* Purpose: isp_BT_Bartender_SG_UCCLBL_ADIDAS                                   */                   
/*                                                                              */                   
/* Modifications log:                                                           */                   
/*                                                                              */                   
/* Date       Rev  Author     Purposes                                          */                   
/* 2021-10-29 1.0  WLChooi    Created (WMS-18269)                               */ 
/* 2021-10-29 1.0  WLChooi    DevOps Combine Script                             */
/********************************************************************************/                  
                    
CREATE PROC [dbo].[isp_BT_Bartender_SG_UCCLBL_ADIDAS]                        
...
BEGIN                        
  ...
  DECLARE  @d_Trace_StartTime   DATETIME,     
   ...
   SET @c_SQLJOIN = + ' SELECT DISTINCT PH.Pickslipno, ISNULL(CL.UDF04,''''), OH.Orderkey, OH.ExternOrderkey, ISNULL(OH.XDockPOKey,''''), ' + CHAR(13) --5
                    + ' LEFT(TRIM(OH.C_Company),80), LEFT(TRIM(OH.C_Contact1),80), ' + CHAR(13) --7  
                    + ' CONVERT(NVARCHAR(10), PH.EditDate, 111), CONVERT(NVARCHAR(8), PH.EditDate, 108), ' + CHAR(13) --9 
                    + ' CONVERT(NVARCHAR(10), OH.AddDate, 111), CONVERT(NVARCHAR(8), OH.AddDate, 108), ' + CHAR(13) --11
                    ...
                    + ' LEFT JOIN CODELKUP CL (NOLOCK) ON CL.Listname = ''COURIERLBL'' AND CL.Storerkey = PH.Storerkey '  + CHAR(13)
                    + '                               AND CL.Code = OH.Salesman '  + CHAR(13)
