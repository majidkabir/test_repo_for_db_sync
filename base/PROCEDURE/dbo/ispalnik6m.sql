...
GO
/************************************************************************/      
/* Stored Procedure: ispALNIK6M                                         */      
/* Creation Date: 14-OCT-2019                                           */      
/* Copyright: LFL                                                       */      
/* Written by:                                                          */      
/*                                                                      */      
/* Purpose: WMS-10908 CN Nike Robot auto allocation.                    */            
/*          multi Order from level > 1 first then level 1               */    
/*          SkipPreallocation = '1'                                     */  
/*                                                                      */  
/* Called By: Wave                                                      */      
/*                                                                      */      
...
BEGIN      
   ...
   */     
   ...
   SET @c_SQL = N'     
      ...
      ' ORDER BY CASE WHEN LOC.LocLevel > 1 THEN 1  WHEN LOC.LocLevel = 1 THEN 2 ELSE 3 END, LOC.LocLevel, SL.QTY - SL.QTYALLOCATED - SL.QTYPICKED, LOC.LogicalLocation, LOC.Loc '  
