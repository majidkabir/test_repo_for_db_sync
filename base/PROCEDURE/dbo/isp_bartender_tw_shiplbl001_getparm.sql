...
/******************************************************************************/                       
/* Copyright: IDS                                                             */                       
/* Purpose: isp_Bartender_TW_SHIPLBL001_GetParm                               */                       
/*                                                                            */                       
/* Modifications log:                                                         */                       
/*                                                                            */                       
/* Date         Rev  Author     Purposes                                      */     
/* 09-Apr-2019  1.0  CSCHONG    Created (WMS-8086-WMS-8567)                   */     
/* 17-Jun-2019  1.1  CSCHONG    WMS-8567-revised report logic (CS01)          */                                           
/******************************************************************************/                      
                        
CREATE PROC [dbo].[isp_Bartender_TW_SHIPLBL001_GetParm]                            
(  @parm01            NVARCHAR(250),                    
   @parm02            NVARCHAR(250),                    
   @parm03            NVARCHAR(250),                    
   @parm04            NVARCHAR(250),                    
...
BEGIN                            
  ...
  DECLARE  @d_Trace_StartTime   DATETIME,         
   ...
   BEGIN  
    ...
    END  
    print '1'  
       SET @c_SQLJOIN = 'SELECT DISTINCT PARM1=OH.Storerkey,PARM2=OH.orderkey,PARM3= '''' ,PARM4= '''',PARM5='''',PARM6='''',PARM7='''', '+    --CS01  
