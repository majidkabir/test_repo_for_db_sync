...
/***************************************************************************/    
/* Stored Procedure: isp_ReplenishmentRpt_PC20                             */    
/* Creation Date: 28-Dec-2010                                              */    
/* Copyright: IDS                                                          */    
/* Written by: NJOW                                                        */    
/*                                                                         */    
/* Purpose: SOS#342565 - Taiwan JTI Replenishment Report.                  */    
/*                       Amend From nsp_ReplenishmentRpt_PC14              */    
/*                                                                         */    
/* Called By: Replenishment Report r_replenishment_report_pc20             */    
/*                                                                         */    
/* PVCS Version: 1.2                                                       */    
/*                                                                         */    
/* Version: 5.4                                                            */    
...
/* 16-Jul-2015  NJOW01  1.0   342565-fix sorting by zone                   */
/* 17-Apr-2017  SPChin  1.1   IN00318574 - Bug Fixed                       */
/* 05-MAR-2018 Wan01    1.2   WM - Add Functype                            */
/***************************************************************************/    
CREATE PROC [dbo].[isp_ReplenishmentRpt_PC20]    
         ...
         BEGIN     
            ...
            DECLARE LOC_CUR CURSOR LOCAL FAST_FORWARD READ_ONLY FOR     
               ...
               ORDER BY CASE WHEN PACK.Pallet > 0 THEN 
                           CASE WHEN FLOOR(SUM(LOTxLOCxID.Qty - LOTxLOCxID.QtyPicked - LOTxLOCxID.QtyAllocated) / PACK.Pallet) >= 1 THEN  --NJOW01
                                1 ELSE 0 END
                        ELSE 0 END,                  
                        ISNULL(CL.Short,'ZZ'),       
