...
/******************************************************************************/    
/* Copyright: LFL                                                             */    
/* Purpose: isp_BT_Bartender_AU_VASXDLBL01_DJ                                 */    
/*                                                                            */    
/* Modifications log:                                                         */    
/*                                                                            */    
/* Date        Rev  Author     Purposes                                       */    
/* 27-Mar-2023 1.0  WLChooi    Created (WMS-21984)                            */    
/* 27-Mar-2023 1.0  WLChooi    DevOps Combine Script                          */    
/******************************************************************************/    
    
CREATE   PROC [dbo].[isp_BT_Bartender_AU_VASXDLBL01_DJ]
(
...
BEGIN    
   ...
   SET @c_SQLJOIN = N' SELECT DISTINCT ' + CHAR(13)
                  ...
                  + N'        OH.Userdefine04, TRIM(ISNULL(OH.UserDefine01,'''')), TRIM(ISNULL(OH.BuyerPO,'''')), TRIM(PD.LottableValue), ' + CHAR(13)   --14
                  + N'        RIGHT(TRIM(PD.LottableValue), 18), ' + CHAR(13)   --15
                  + N'        OH.Shipperkey, OH.TrackingNo, '''', '''', '''', '   --20
                  + N'        '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', ' + CHAR(13) --30
                  + N'        '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', ' + CHAR(13) --40
                  + N'        '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', ' + CHAR(13) --50
