...
BEGIN                        
  ...
  DECLARE   @d_Trace_StartTime   DATETIME,     
   ...
   SET @n_noofcopy = 1 --CAST(@c_Sparm04 AS int)  
  ...
  SET @c_SQLJOIN = +' SELECT DISTINCT ORD.Orderkey,PD.loc,PD.sku,ORD.trackingno,PT.Taskbatchno,'+ CHAR(13)      --5   --CS01     
    ...
    +'  LEFT JOIN PACKTASK PT WITH (Nolock) ON ORD.Orderkey=PT.Orderkey'  
       +'  LEFT JOIN PICKDETAIL PD WITH (Nolock) ON ORD.Orderkey=PD.Orderkey and ORD.Storerkey=PD.Storerkey'  
    + ' LEFT JOIN LOC L WITH (Nolock) ON PD.Loc=L.Loc'  
...
EXIT_SP:      
   ...
   EXEC isp_InsertTraceInfo     
      ...
      @c_TraceName = 'isp_BT_Bartender_CN_SKESHIPLBL',    
