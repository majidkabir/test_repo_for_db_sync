...
/************************************************************************/
/* Stored Procedure: nspInventoryHoldStatusRpt                          */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
...
CREATE PROCEDURE [dbo].[nspInventoryHoldStatusRpt] (
 ...
 DECLARE CUR1 CURSOR  FAST_FORWARD READ_ONLY FOR
    ...
    AND    Hold = '1'
    -- Added By SHONG, 14-Nov-2003, Should Filter hold by lottables
    ...
    BEGIN
       INSERT INTO #RESULT 
             ( Holdkey, LOT, ID, SKU, DESCR, Qty, Reason, Expirydate, ReceiptDate,   Location,
               addwho,   adddate,   holdby,   holddate, Facility, StorerKey )
       VALUES
             ( @c_HoldKey, @c_LOT, @c_ID, @c_SKU, @c_DESCR, @n_Qty, @c_Reason, @d_Expirydate, @d_ReceiptDate,  @c_LOC,
               @c_WhoOn,   @d_DateOn,   @c_WhoOn,   @d_DateOn, @c_Facility, @c_StorerKey )
       FETCH NEXT FROM CUR2 INTO
          @c_StorerKey,
          @c_Id,
          @c_loc,
