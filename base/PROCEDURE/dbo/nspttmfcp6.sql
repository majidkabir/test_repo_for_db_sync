...
BEGIN
   ...
   SAVE TRAN nspTTMFCP6 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN nspTTMFCP6 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN nspTTMFCP6 -- Only rollback change made here
Fail:
Quit:
