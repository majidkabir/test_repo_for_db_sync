...
/************************************************************************/
/* Store procedure: ispHNMLabelNoDecode                                 */
/* Copyright      : IDS                                                 */
/*                                                                      */
...
/* 01-12-2014  1.1  Ung         Performance tuning                      */
/* 02-01-2018  1.2  James       WMS3666 - Add config to control the     */
/*                              decoding method (james01)               */
/* 25-06-2018  1.3  James       WMS5311-Add function id, step (james02) */
/************************************************************************/

CREATE PROCEDURE [dbo].[ispHNMLabelNoDecode]
