...
/************************************************************************/
/* Stored Procedure: nsp_GetPickSlipOrders25                            */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by: (Copy from nsp_GetPickSlipOrders04)                      */
/*                                                                      */
/* Purpose:                                                             */
/*                                                                      */
/* Called By:                                                           */
...
/*                            LogicalLocation                           */
/* 29-Jun-2007  James         SOS79354 - Add Packuom2 & Inner Pack      */
/*                            into SELECT                               */ 
/* 26-Nov-2013  TLTING     Change user_name() to SUSER_SNAME()          */
/* 18-Sep-2015  CSCHONG       SOS#352276 (CS01)                         */
/************************************************************************/
 
CREATE PROC [dbo].[nsp_GetPickSlipOrders25] (@c_loadkey NVARCHAR(10))
AS
BEGIN
   SET NOCOUNT ON 
   SET QUOTED_IDENTIFIER OFF 
