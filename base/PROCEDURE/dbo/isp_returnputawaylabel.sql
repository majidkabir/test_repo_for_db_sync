...
/************************************************************************/
/* Stored Procedure: isp_ReturnPutawayLabel                             */
/* Creation Date: 19-May-2016                                           */
/* Copyright: LFL                                                       */
/* Written by:                                                          */
/*                                                                      */
/* Purpose: 369889-CN-Trade Return Putaway Label                        */
/*                                                                      */
/* Called By:                                                           */
/*                                                                      */
/* Parameters:                                                          */
...
CREATE PROCEDURE [dbo].[isp_ReturnPutawayLabel]
    ...
    ELSE
       BEGIN
         ...
         BEGIN
          ...
          END
       END
     execute nsp_logerror @n_err, @c_errmsg, 'isp_ReturnPutawayLabel'
