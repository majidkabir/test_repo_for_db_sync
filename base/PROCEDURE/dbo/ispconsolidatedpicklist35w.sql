...
GO
/************************************************************************/
/* Stored Procedure: ispConsolidatedPickList35w                         */
/* Creation Date:                                                       */
/* Copyright: LF                                                        */
/* Written by:                                                          */
/*                                                                      */
/* Purpose:  315650 - PH - GSK Consolidated Picklist (wave)             */
/*                                                                      */
/* Called By:                                                           */
/*                                                                      */
/* PVCS Version: 1.1                                                    */
...
CREATE PROC [dbo].[ispConsolidatedPickList35w](@c_WaveKey NVARCHAR(10))
AS
BEGIN
   SET NOCOUNT ON 
   SET ANSI_NULLS OFF 
