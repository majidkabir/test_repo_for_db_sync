...
GO
/************************************************************************/  
/* Stored Procedure: isp_ReceiptDetailTrigger_Wrapper                   */  
/* Creation Date: 07-APR-2016                                           */  
/* Copyright: LF                                                        */  
/* Written by: NJOW                                                     */  
/*                                                                      */  
/* Purpose: WMS-1798 Call Receiptdetail custom stored proc              */
/*                                                                      */  
/* Called By: Receiptdetail insert/update/delete trigger                */    
/*            Stored proc naming: ispRECDxx                             */
/*                                                                      */  
/* PVCS Version: 1.0                                                    */  
/*                                                                      */  
/* Version: 5.4                                                         */  
...
BEGIN  
   ...
   */
   ...
   SET @c_SQL        = ''
   SET @c_Storerkey  = ''
   SET @c_configkey = 'ReceiptDetailTrigger_SP'
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, 'isp_ReceiptDetailTrigger_Wrapper'
