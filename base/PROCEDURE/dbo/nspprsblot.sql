...
/* Get Storer Minimum Shelf Life */
   ...
   IF @n_StorerMinShelfLife IS NULL
	...
	-- Purpose: At receiving stage, the Batch no(lottable01) for SB can be 20010101a, 
   ...
   BEGIN
      SELECT @c_Condition = " AND LOTATTRIBUTE.LOTTABLE01 LIKE N'" + dbo.fnc_RTrim(dbo.fnc_LTrim(@c_Lottable01)) + "_' "
   END
