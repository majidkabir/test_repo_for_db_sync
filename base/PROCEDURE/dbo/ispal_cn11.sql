...
/*          SkipPreallocation = '1'                                     */
/*          Full UCC Control                                            */
/*          Cater for if remaining qty > (AGV) Qty                      */
...
BEGIN    
   ...
   --Check RemainingQty > (AGV), if not, skip to next pickcode
   SET @c_SQL = N'   
   ...
   BEGIN
      ...
      --Since no more AGV loc have available Qty, allocate on Bulk
      IF @n_ContinueAllocation = 0
