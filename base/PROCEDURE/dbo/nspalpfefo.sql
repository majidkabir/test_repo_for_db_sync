...
/* 27-APR-2016  NJOW01  1.1   Remove locationtype='OTHER' filter        */
/* 13-May-2016  NJOW02  1.2   Fix to check transferdetail.status for    */
/*                            calculate qtyavailable                    */
/************************************************************************/    
CREATE PROC [dbo].[nspALPFEFO]        
