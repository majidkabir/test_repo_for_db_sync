...
/************************************************************************/
/* Stored Proc: ispDesigualLoadFC2                                      */
...
/*          Pick FULL CASE from CASE & PALLET Location                  */
/*                                                                      */
/* Called By:                                                           */
/*          :                                                           */
/* GitLab Version: 1.0                                                  */
...
/************************************************************************/
CREATE   PROC [dbo].[ispDesigualLoadFC2]
...
BEGIN
   ...
   BEGIN
      PRINT '---------------------------------------'+ CHAR(13) +
            'Sub PICKCOde: ispDesigualLoadFC2'+ CHAR(13) +
            ...
            '@dt_Lottable13_2: ' + CASE WHEN @dt_Lottable13_2 IS NULL THEN 'NULL' ELSE CONVERT(VARCHAR(20),@dt_Lottable13_2, 106) END
   END
         ...
         BEGIN
            ...
            BEGIN
               ...
               SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0)) 
                              + ': Get PickDetailKey Failed. (ispDesigualLoadFC2)'
               GOTO QUIT_SP
            END
            ...
            BEGIN
               ...
               SET @n_Err = 81220
               SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0)) 
                              + ': Insert PickDetail Failed. (ispDesigualLoadFC2)'
               GOTO QUIT_SP
            END
...
QUIT_SP:
   ...
   BEGIN
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'ispDesigualLoadFC2'
