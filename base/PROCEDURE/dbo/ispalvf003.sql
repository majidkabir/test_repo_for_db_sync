...
GO
/************************************************************************/    
/* Stored Procedure: ispALVF003                                         */    
/* Creation Date: 30-Sep-2012                                           */    
/* Copyright: IDS                                                       */    
/* Written by: Chee Jun Yan                                             */    
/*                                                                      */    
/* Purpose: Step 3 - Pick loose from DPP (For Wholesale & Retail Only)  */
/*                   UOM:7                                              */
/*                                                                      */    
/* Called By:                                                           */    
/*                                                                      */    
...
BEGIN    
   ...
   ELSE
   BEGIN
      -- SKIP THIS STEP FOR LAUNCH WAVE
      DECLARE  CURSOR_CANDIDATES CURSOR FAST_FORWARD READ_ONLY FOR 
