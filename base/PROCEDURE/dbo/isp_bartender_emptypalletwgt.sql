...
/* 2024-06-11 1.0.0  PYU015     UWP-21098 Created                               */
/********************************************************************************/

CREATE     PROC [dbo].[isp_Bartender_EmptyPalletWgt]
...
BEGIN
   ...
   SET @c_ExecStatements = N'SELECT ISNULL(TRIM(PalletKey),'''')'
                          + '     , GrossWgt'
                          + '     , '''','''','''','''','''','''','''',''''           ' + CHAR(13) --10
                          + '     , '''','''','''','''','''','''','''','''','''','''' ' + CHAR(13) --20
                          + '     , '''','''','''','''','''','''','''','''','''','''' ' + CHAR(13) --30
