...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         DECLARE Cursor_RPTTaskCandidates CURSOR FAST_FORWARD READ_ONLY FOR --Note: global cursor
   ...
   BEGIN
      ...
      END
   END
   -- Start of Process EvaluateRPT Equivalent
   OPEN Cursor_RPTTaskCandidates
   
   -- Get a task
   SET @c_TaskDetailKey = ''
   FETCH NEXT FROM Cursor_RPTTaskCandidates INTO @c_TaskDetailKey
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF @c_TaskType = 'RPT' AND @cPickMethod = 'FP'
         BEGIN
   ...
   BEGIN
      ...
      BEGIN
        ...
        BEGIN
          ...
          END
        END
        execute nsp_logerror @n_err, @c_errmsg, 'nspTTMRT04'
