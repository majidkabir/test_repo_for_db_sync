...
/*                            Strategy CR                               */    
/* 25-JAN-2018 Wan02    1.2   Fixed. Partial allocate UCC from Pallet   */    
 ...
 AND ISNULL(RTRIM(OD.Lottable01),'') <> ''        
   ...
   BEGIN     
      ...
      EXEC sp_ExecuteSQL @c_SQL, @c_SQLParm, @c_Facility, @c_StorerKey, @c_SKU    
                        ...
                        ,@c_LocationTypeOverride,@c_channel                   --(Wan01)  --CS01a    
       ...
       --(Wan02) - START    
         ...
         BEGIN    
            ...
            SELECT Lot    
                  ...
                  ,QtyAvailable     
            FROM #IDxLOCxLOT    
            WHERE Loc = @c_Loc                                             --(Wan02)    
            AND   ID  = @c_ID                                              --(Wan02)    
            --WHERE IDQty <= @n_OrderQty                                   --(Wan02)    
            AND QtyAvailable > 0    
            ORDER BY SeqNo    
                    ...
                    END --CS01a    
                     ...
                     BEGIN    
                        ...
                        SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0))     
                                       + ': Get PickDetailKey Failed. (ispPRNIK07)'    
                        GOTO QUIT_SP    
                     END    
                     ELSE    
                     BEGIN    
                        ...
                        BEGIN    
                           ...
                           SET @n_Err = 61020    
                           SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0))     
                                          + ': Insert PickDetail Failed. (ispPRNIK07)'    
                           GOTO QUIT_SP    
                        END    
         ...
         END -- END WHILE @n_OrderQty > 0                            --Wan02    
         FETCH NEXT FROM CUR_ORDERLINE_SKU INTO  @c_Orderkey, @n_OrderQty    
...
QUIT_SP:    
   ...
   BEGIN      
      ...
      BEGIN      
         ...
         END      
      END      
      EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'ispPRNIK07'      
