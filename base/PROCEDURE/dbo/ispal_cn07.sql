...
/* 2021-09-30   WLChooi 1.3   WMS-17878 Load Conso for UOM 2 only (WL02) */
/*************************************************************************/            
CREATE PROC [dbo].[ispAL_CN07]
   @c_DocNo      NVARCHAR(10),  
...
BEGIN   
   ...
   SELECT @c_SQL = ' DECLARE CURSOR_COACH_AVAILABLE CURSOR FAST_FORWARD READ_ONLY FOR ' +
                   ...
                   ' GROUP BY LOT.STORERKEY, LOT.SKU, LOT.LOT, LOTxLOCxID.LOC, LOTxLOCxID.ID, LOC.Loc, LOC.LogicalLocation, LOTATTRIBUTE.Lottable05, LOC.LocLevel, SKUxLOC.LocationType ' +
