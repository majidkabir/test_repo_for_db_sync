...
/* 2017-08-21 1.1  JihHaur    IN00437443 Courier label qty double issue (JH01)*/  
/* 2017-08-28 1.1  CSCHONG    Enchance for Dynamic SQL (CS01)                 */   
/* 2019-07-28 1.3  WLCHOOI    WMS-9999 - Add ReportCFG to encrypt phone       */
/*                                       number (WL01)                        */        
/******************************************************************************/                
                  
CREATE PROC [dbo].[isp_BT_Bartender_Shipper_Label_4]                       
...
BEGIN       
   ...
   AND Storerkey = @c_StorerKey AND CODE2 = @c_GetShipperKey --(CODE2 = @c_Sparm1 OR CODE2 = @c_Sparm5)
   --WL01 End
...
EXIT_SP:    
   ...
   EXEC isp_InsertTraceInfo   
      ...
      @c_TraceName = 'isp_BT_Bartender_Shipper_Label_4',  
