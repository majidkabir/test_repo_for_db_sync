...
BEGIN
   ...
   BEGIN
     ...
     SELECT @c_SQLStatement =  " DECLARE  PREALLOCATE_CURSOR_CANDIDATES CURSOR FAST_FORWARD READ_ONLY FOR " +
            ...
            "       WHERE PreAllocatePickCode = 'nspPRLEVQ1' AND Storerkey = @c_storerkey  " +
...
GRANT EXECUTE on nspPRLEVQ1 to nSQL
