...
GO
/************************************************************************/
/* Stored Procedure: nspPRUKD05                                         */
/* Creation Date: 29-Sep-2015                                           */
/* Copyright: LF                                                        */
/* Written by:                                                          */
/*                                                                      */
/* Purpose: 345748-UK JackW-prellocate clear bulk if fulfill demand     */   
/*                 For Store Order Only. UOM 7(BULK)                    */
/*                                                                      */
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 6.0                                                         */
...
BEGIN  
   ...
   BEGIN
      ...
      /*SELECT @c_SQL = ' SELECT @n_QTYAVAILABLE = SUM(CASE WHEN LOC.Locationflag="HOLD" AND LOC.LOC <> "WS01" THEN 0 ELSE LOTxLOCxID.QTY END) ' +                                     
                      ...
                      ' AND LOC.LocationType NOT IN ("PICK","CASE","DynPickP", "DYNPICKR") ' + 
