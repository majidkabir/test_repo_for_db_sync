...
GO
/************************************************************************/  
/* Stored Procedure: isp_ReceiptTrigger_Wrapper                         */  
/* Creation Date: 07-APR-2016                                           */  
/* Copyright: LF                                                        */  
/* Written by: NJOW                                                     */  
/*                                                                      */  
/* Purpose:  Call Receipt custom stored proc                            */
/*                                                                      */  
/* Called By: Receipt insert/update/delete trigger                      */    
/*            Stored proc naming: ispRECxx                              */
/*                                                                      */  
/* PVCS Version: 1.0                                                    */  
/*                                                                      */  
/* Version: 5.4                                                         */  
...
CREATE PROCEDURE [dbo].[isp_ReceiptTrigger_Wrapper]  
...
BEGIN  
   ...
   */
   ...
   SET @c_SQL        = ''
   SET @c_Storerkey  = ''
   SET @c_configkey = 'ReceiptTrigger_SP'
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, 'isp_ReceiptTrigger_Wrapper'
