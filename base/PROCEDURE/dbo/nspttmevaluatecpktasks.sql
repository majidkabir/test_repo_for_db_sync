...
GO
/************************************************************************/
/* Stored Procedure: nspTTMEvaluateCPKTasks                             */
/* Purpose:                                                             */
/*                                                                      */
/* Modification log:                                                    */
/* Date        Ver.  Author     Purposes                                */
/* 2020-06-20  1.0   James      WMS-12055 Created                       */  
/************************************************************************/

CREATE PROC [dbo].[nspTTMEvaluateCPKTasks]  
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         BEGIN  
             ...
             END  
         END  
         EXECUTE nsp_logerror @n_err, @c_errmsg, 'nspTTMEvaluateCPKTasks'  
