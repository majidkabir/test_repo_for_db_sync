...
/*           Decanting                                                  */
/*           Allocate Loose Qty with Exact Orderdetail.Qty. UOM 6.      */
              ...
              BEGIN
                 ...
                 BEGIN
                    ...
                    BEGIN
                       ...
                       SET @c_errmsg='NSQL'+CONVERT(NVARCHAR(5),@n_err)+': Insert Pickdetail Failed. (ispPRJCB07)'
...
QUIT:
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'ispPRJCB07'
