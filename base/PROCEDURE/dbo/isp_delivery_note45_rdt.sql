...
/* Written by:                                                           */    
/*                                                                       */    
/* Purpose: WMS-14952 - AU_H&M_DN Report                                 */    
/*                                                                       */    
/* Called By: r_dw_delivery_Note45_rdt                                   */    
...
--ORDER BY SeqNo    
         ...
         SET @c_ExecStatements2 =  ' FROM #TMP_ORDH TMP '+    
            ...
            'LEFT JOIN CODELKUP CL1 WITH (NOLOCK) ON ( CL1.ListName= ''HMDN'' AND CL1.Storerkey = OH.Storerkey ) ' +    
            '                                         AND CL1.code = ''Oriental''  ' +    
            ' WHERE ' + @c_ExecWhere +    
...
BEGIN    
   ...
   VALUES ('isp_Delivery_Note45_RDT', getdate(), @c_DWCategory, @c_Loadkey, @c_orderkey, @c_Type, suser_name())    
END    
