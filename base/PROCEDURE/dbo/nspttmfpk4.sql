...
BEGIN
   ...
   SAVE TRAN nspTTMFPK4 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN nspTTMFPK4 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN nspTTMFPK4 -- Only rollback change made here
Fail:
Quit:
