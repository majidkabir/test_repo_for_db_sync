...
GO
/************************************************************************/
 /* Store Procedure:  isp_TCP_VC_prTaskLUTPtsValidRegions                */
 /* Creation Date: 26-Feb-2013                                           */
 /* Copyright: IDS                                                       */
 /* Written by: Shong                                                    */
 /*                                                                      */
 /* Purposes: returns the regions where the operator is allowed to       */
 /*           perform put to store.                                      */
 /*                                                                      */
 /* Updates:                                                             */
 /* Date         Author    Purposes                                      */
 /************************************************************************/
CREATE PROC [dbo].[isp_TCP_VC_prTaskLUTPtsValidRegions] (
