...
/************************************************************************/    
/* Store Procedure: isp_PackListBySKU16                                 */    
/* Creation Date:16/07/2020                                             */    
/* Copyright: LFL                                                       */    
/* Written by: WLChooi                                                  */    
/*                                                                      */    
/* Purpose: WMS-14227 - [TW-KSW] Delivery Note                          */    
/*                                                                      */    
...
BEGIN    
  ...
  -- SELECT @c_TempFloor = '', @c_TempOrderKey = '',     
   ...
   SELECT DISTINCT ORDERS.OrderKey, ORDERS.Loadkey    
   INTO #TempOrder    
   ...
   OPEN C_orderkey    
   FETCH NEXT FROM C_orderkey INTO @c_TempOrderKey, @c_LoadKey    
     ...
     -- INTO #TempSKU            
      ...
      BEGIN        
         ...
         GROUP BY  STO.Company,    
                   ...
                   PH.PickHeaderKey, ORD.Deliverydate
...
QUIT:  
   ...
   IF OBJECT_ID('tempdb..#TempPacklist16') IS NOT NULL
      DROP TABLE #TempPacklist16  
