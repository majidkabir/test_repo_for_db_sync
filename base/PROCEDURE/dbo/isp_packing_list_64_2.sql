...
/************************************************************************/  
/* Stored Proc: isp_Packing_List_64_2                                   */  
...
/*        :                                                             */  
/* Called By:r_dw_packing_list_64_2    (<> ECOM)                        */  
/*          :                                                           */  
/* PVCS Version: 1.0                                                    */  
/*                                                                      */  
/* Version: 7.0                                                         */  
...
/* 16-Jul-2019  WLChooi   1.1 WMS-9305 - Copy SP from WMS-8102          */
/*                                       (isp_packing_list_60)          */
/* 03-Sep-2020  WLChooi   1.2 WMS-15002 - Add new column (WL02)         */
/************************************************************************/  
  
CREATE PROC [dbo].[isp_Packing_List_64_2] 
...
*/
   ...
   SELECT @c_DataWidnow = 'r_dw_Packing_List_64'
   ...
   BEGIN
      ...
      AND CL.Short = 'Y'
      AND CL.Long = 'r_dw_packing_list_64_2'
      --WL02 END
