...
/************************************************************************/
/* Store Procedure: isp_ReplenishLetdown_rpt04                          */
/* Creation Date: 05-Aug-2011                                           */
/* Copyright: IDS                                                       */
/* Written by: YTWan                                                    */
/*                                                                      */
/* Purpose: SOS#222522 - Generate Replenishment Let Down report for     */  
/*          Converse (Duplicate from nsp_ReplenishLetdown_rpt)          */
/*                                                                      */
...
/* Local Variables:                                                     */
/*                                                                      */
/* Called By: r_dw_replenishletdown_rpt04                               */
/*                                                                      */
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 5.4                                                         */
...
CREATE PROC [dbo].[isp_ReplenishLetdown_rpt04] (@c_facility     NVARCHAR(5)
