...
/************************************************************************/
/* Stored Procedure: isp_RCM_MB_Kewill_CCI                              */
...
CREATE PROCEDURE [dbo].[isp_RCM_MB_Kewill_CCI]
...
BEGIN 
   ...
   IF @b_success = 0
       SELECT @n_continue = 3, @n_err = 60098, @c_errmsg = 'isp_RCM_MB_Kewill_CCI: ' + rtrim(@c_errmsg)
   ...
   IF @n_continue=3  -- Error Occured - Process And Return
	 ...
	 ELSE
	    BEGIN
	       ...
	       END
	    END
  	  execute nsp_logerror @n_err, @c_errmsg, 'isp_RCM_MB_Kewill_CCI'
