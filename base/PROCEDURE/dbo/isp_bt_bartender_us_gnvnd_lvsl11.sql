...
/******************************************************************************/    
/* Copyright: LFL                                                             */    
/* Purpose: isp_BT_Bartender_US_GNVND_LVSL11                                 */    
/*                                                                            */    
/* Modifications log:                                                         */    
/*                                                                            */    
...
CREATE  PROC [dbo].[isp_BT_Bartender_US_GNVND_LVSL11]
(
...
BEGIN    
   ...
   SET @c_SQLJOIN = N'SELECT DISTINCT ' + CHAR(13)
	+N'F.DESCR,' + CHAR(13)
	+N'F.ADDRESS1,' + CHAR(13)
	+N'F.CITY,' + CHAR(13)
	+N'F.STATE,' + CHAR(13)
	+N'F.ZIP,' + CHAR(13)
	+N'O.C_Company,' + CHAR(13)
	+N'O.C_Address1, ' + CHAR(13)
	+N'O.C_Address2, ' + CHAR(13)
	+N'O.C_Address3, ' + CHAR(13)
	+N'O.C_Address4, ' + CHAR(13)
	+N'O.C_City,' + CHAR(13)
	+N'O.C_State,' + CHAR(13)
	+N'O.C_Zip,' + CHAR(13)
	+N'CONCAT(''(420) '',O.C_Zip),' + CHAR(13)
	+N'M.CARRIERKEY,' + CHAR(13)
	+N'M.CARRIERAGENT,' + CHAR(13)
	+N'M.MBOLKEY,' + CHAR(13)
	+N'S.SKUGROUP,' + CHAR(13)
	+N'O.BuyerPO,' + CHAR(13)
	+N'POD.CARTONNO ,' + CHAR(13)
	+N'MAX(POD.CARTONNO) ,' + CHAR(13)
	+N'O.ExternOrderKey,' + CHAR(13)
	+N'CONCAT(''(91)0'',(SUBSTRING(O.CONSIGNEEKEY,LEN(O.CONSIGNEEKEY)-3,3)) )    ,' + CHAR(13)
	+N'CASE WHEN (O.M_CONTACT1 IS  NULL) THEN  SUBSTRING(O.CONSIGNEEKEY,LEN(O.CONSIGNEEKEY)-3,3) ELSE O.M_CONTACT1 END AS FOR1,' + CHAR(13)
	+N'CASE WHEN (O.M_CONTACT2 IS  NULL) THEN O.C_CONTACT2  ELSE O.M_CONTACT2 END AS FOR2,' + CHAR(13)
	+N'CONCAT(''000'',PD.CASEID),' + CHAR(13)
	+N''''', '''', '''', '''',  --30' + CHAR(13)
    +N''''', '''', '''', '''', '''', '''', '''', '''', '''', '''',  --40' + CHAR(13)
    +N''''', '''', '''', '''', '''', '''', '''', '''', '''', '''',  --50' + CHAR(13)
    +N''''', '''', '''', '''', '''', '''', '''', '''', '''', ''''   --60' + CHAR(13)
	+N'--''0000016294'''+CHAR(13)
	...
	--+N'WHERE O.STORERKEY =@c_Sparm1  AND O.ORDERKEY=@c_Sparm2' + CHAR(13)
