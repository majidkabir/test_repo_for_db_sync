...
/************************************************************************/  
/* Trigger: isp_EPackRVCtnTrack04                                       */  
/* Creation Date: 01-Apr-2018                                           */  
/* Copyright: LF Logistics                                              */  
/* Written by: CSCHONG                                                  */  
/*                                                                      */  
/* Purpose: WMS-8292-CN_Ecom-Packing_For JD_CR                          */  
/*        :                                                             */  
...
/* 2021-04-12  Wan01    1.1   WMS-16026 - PB-Standardize TrackingNo -Dup*/
/************************************************************************/  
CREATE PROC [dbo].[isp_EPackRVCtnTrack04]  
...
BEGIN  
   ...
   --END                 
   SELECT 
         @c_TrackingNo_ORD = CASE WHEN ISNULL(RTRIM(TrackingNo),'') <> ''        --(Wan01)     
                                  THEN TrackingNo     
   ...
   BEGIN  
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'isp_EPackRVCtnTrack04'  
