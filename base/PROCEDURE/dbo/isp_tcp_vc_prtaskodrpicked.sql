...
GO
/************************************************************************/    
/* Store Procedure:  isp_TCP_VC_prTaskODRPicked                         */    
...
/* 07-05-2015   Shong     Added nsp_LogError                            */
/* 17-03-2017   ChewKP    Fix TaskDetail and VoiceAssignmentDetail Qty  */
/*                        Update issues (ChewKP02)                      */
/* 22-Mar-2017  JayLim    SQL2014 compatibility (Jay01)			*/
/************************************************************************/    
CREATE PROC [dbo].[isp_TCP_VC_prTaskODRPicked] (    
...
BEGIN    
   ...
   -- Sample prTaskODRPicked('03-12-13 15:29:59.990','572517045','shong','0000038538','0000038538','A1AH009A5','4','1','','1','','','')    
   SET @c_StorerKey = ''  
   SET @c_Facility = ''  
   SET @n_Func = 0   
   SET @n_Mobile = 0   
   ...
   BEGIN
      SET @c_Message = 'TaskDetailKey Not Found in VoiceAssignmentDetail AssignmentID=' + @c_AssignmentID + ' SeqNo=' + @c_Sequence 
      SET @c_ErrorCode = 'E'
      SET @n_Error = 81001
   ...
   BEGIN  
      SET @c_Message = 'TaskDetailKey Not Found in TaskDetail TaskDetailKey=' + @c_TaskDetailKey   
      SET @c_ErrorCode = 'E'
      SET @n_Error = 81002
   ...
   SET @n_MQty      = ISNULL(rdt.rdtConvUOMQTY( @c_StorerKey, @c_SKU, @n_QtyPicked, @c_UOM, '6'), 0) -- Convert to QTY in master UOM  
   SET @n_QtyRemain = @n_MQty
   ...
   BEGIN    
      ...
      BEGIN    
         ...
         BEGIN    
            ...
            BEGIN    
               SET @n_Continue = 3    
               SET @c_ErrMsg = 'Get PickDetail Key Failed (isp_TCP_VC_prTaskODRPicked).'    
               
               SET @c_Message = 'Get PickDetail Key Failed. AssignmentID=' + @c_AssignmentID + ' SeqNo=' + @c_Sequence   
               SET @c_ErrorCode = 'E'
               SET @n_Error = 81003
            ...
            BEGIN    
               SET @n_Continue = 3    
               SET @c_ErrMsg = 'Insert PickDetail Failed (isp_TCP_VC_prTaskODRPicked).'

               SET @c_Message = 'Insert PickDetail Failed. AssignmentID=' + @c_AssignmentID + ' SeqNo=' + @c_Sequence   
               SET @c_ErrorCode = 'E'
               SET @n_Error = 81004
            ...
            BEGIN    
               ...
               SET @c_Message = 'Update PickDetail Failed. AssignmentID=' + @c_AssignmentID + ' SeqNo=' + @c_Sequence   
               SET @c_ErrorCode = 'E'
               SET @n_Error = 81005
   ...
   VALUES ( 'isp_TCP_VC_prTaskODRPicked' , Getdate() , @c_TaskDetailKey, @n_TaskQty, @n_MQty  ) 
   
   UPDATE TASKDETAIL     
      SET [Status] = '9'   
         ,Trafficcop = NULL  
         ,DropID = @c_DropID  
         ,Qty = CASE WHEN @n_TaskQty > @n_MQty THEN @n_MQty ELSE Qty END   
         ,ReasonKey = @c_ReasonCode  
         ,EndTime = GetDate() -- (ChewKP01)
   ...
   BEGIN    
      ...
      SET @c_Message = 'Update TASKDETAIL Failed. AssignmentID=' + @c_AssignmentID + ' SeqNo=' + @c_Sequence   
      SET @c_ErrorCode = 'E'
      SET @n_Error = 81007
   ...
   BEGIN    
      ...
      SET @c_Message = 'Update Voice Assignment Detail Failed. AssignmentID=' + @c_AssignmentID + ' SeqNo=' + @c_Sequence   
      SET @c_ErrorCode = 'E'
      SET @n_Error = 81008
   ...
   BEGIN  
      ...
      BEGIN    
         ...
         SET @c_Message = 'Update Voice Assignment Failed. AssignmentID=' + @c_AssignmentID + ' SeqNo=' + @c_Sequence   
         SET @c_ErrorCode = 'E'
         SET @n_Error = 81009
...
QUIT_SP:       
   ...
   BEGIN
      UPDATE VoiceAssignmentDetail  
      SET [Status] = 'E', EditDate = GETDATE(), EditWho = @c_OperatorID
      WHERE AssignmentID = @c_AssignmentID   
      AND   SeqNo = @c_Sequence   
      ...
      EXEC nsp_logerror
         @n_err = @n_Error,
         @c_errmsg = @c_Message,
         @c_module = 'isp_TCP_VC_prTaskODRPicked'     
   END
