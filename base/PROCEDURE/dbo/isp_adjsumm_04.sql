...
/************************************************************************/
/* Store Procedure:  isp_adjsumm_04                                     */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by: CSCHONG                                                  */
/*                                                                      */
...
/* Return Status:  None                                                 */
/*                                                                      */
/* Usage:  Used for report dw = r_dw_adjusment_summary_04               */
/*                                                                      */
/* Local Variables:                                                     */
/*                                                                      */
/* Called By:                                                           */
...
/************************************************************************/
CREATE PROC [dbo].[isp_adjsumm_04] (
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE nsp_logerror @n_err, @c_errmsg, 'isp_adjsumm_04'
