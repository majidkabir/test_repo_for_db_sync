...
GO
/************************************************************************/
/* Stored Procedure: nspTTMEvaluateOPKTasks                              */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
...
CREATE PROC    [dbo].[nspTTMEvaluateOPKTasks]
    ...
    BEGIN
        ...
        BEGIN
            ...
            SELECT @c_errmsg = "NSQL"+CONVERT(CHAR(5) ,@n_err)+
                   ": Execute Of Move Tasks Pick Code Failed. (nspTTMEvaluateOPKTasks)" 
   ...
   BEGIN
      ...
      BEGIN
       ...
       BEGIN
           ...
           END
       END
       execute nsp_logerror @n_err, @c_errmsg, 'nspTTMEvaluateOPKTasks'
