...
/************************************************************************/
/* Stored Procedure: nsp_GetPickSlipNike                                */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
...
CREATE PROC [dbo].[nsp_GetPickSlipNike] (@c_LoadKey NVARCHAR(10))
AS
BEGIN
   SET NOCOUNT ON 
   SET ANSI_NULLS OFF 
   ...
   --SUBSTRING(PICKDETAIL.Sku, 1, 9) StyleColour,  -- 07/17/2001 CS
   SUBSTRING(PICKDETAIL.Sku, 1, 13) StyleColour,
...
--SUBSTRING(PICKDETAIL.Sku, 1, 9),  07/17/2001 CS
SUBSTRING(PICKDETAIL.Sku, 1, 13),
PICKDETAIL.UOM,
