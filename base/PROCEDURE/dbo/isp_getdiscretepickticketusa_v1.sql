...
/************************************************************************/
/* Stored Procedure: isp_GetDiscretePickTicketUSA_V1                    */
...
/* 15-Sep-2007  Shong     Missing ExternOrderKey = @c_LoadKey (Shong001)*/
/* 11-Oct-2007  June		  June01 - Change Sorting Sequence					*/
/* 12-Oct-2007  Vicky     Vicky01 - Modified to cater Matrix style for  */
/*                        non Prepack as well                           */
...
CREATE PROC [dbo].[isp_GetDiscretePickTicketUSA_V1] (
...
--	JOIN LOC WITH (NOLOCK) ON (LOC.LOC = PICKDETAIL.LOC) -- June01 -- Commented Vicky01
	...
	AND PICKDETAIL.Status < '9' -- KHLim1
