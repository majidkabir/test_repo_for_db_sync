...
GO
/************************************************************************/  
/* Stored Procedure: isp_WaveTrigger_Wrapper                            */  
/* Creation Date: 20-OCT-2022                                           */  
/* Copyright: LFL                                                       */  
/* Written by:                                                          */  
/*                                                                      */  
/* Purpose:  WMS-21042-Call wave custom stored proc                     */
/*                                                                      */  
/* Called By: Wave insert/update/delete trigger                         */    
/*            Stored proc naming: ispWVHxx                              */
/*                                                                      */  
/* PVCS Version: 1.0                                                    */  
/*                                                                      */  
/* Version: 7.0                                                         */  
...
CREATE PROCEDURE [dbo].[isp_WaveTrigger_Wrapper]  
...
BEGIN  
   ...
   BEGIN   	  
      ...
      BEGIN        	  
         ...
         EXECUTE dbo.isp_WaveTrigger_Wrapper ----->wrapper for current table trigger
   ...
   */
   ...
   SET @c_SQL        = ''
   SET @c_Storerkey  = ''
   SET @c_configkey = 'WaveTrigger_SP'
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, 'isp_WaveTrigger_Wrapper'
