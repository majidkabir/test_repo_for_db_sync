...
/* 2020-04-20 1.0  WLChooi    WMS-13033 (Created)                             */           
/******************************************************************************/              
                
CREATE PROC [dbo].[isp_BT_Bartender_Shipper_Label_ECCOKR]                     
...
BEGIN                    
  ...
  DECLARE @d_Trace_StartTime   DATETIME, 
   ...
   SET @c_SQLJOIN = +' SELECT DISTINCT F.DESCR,F.Address1,F.Address2,F.Address3,F.Address4,'   --5
                    ...
                    +' '''','''',PD.DropID,ORD.loadkey,'''',ORD.Userdefine03,ISNULL(ST.SUSR5,''''),'''','''','''', '  --50    
                    +' '''','''','''','''','''','''','''','''','''','''' '   --60      
...
EXIT_SP:  
   ...
   EXEC isp_InsertTraceInfo 
      ...
      @c_TraceName = 'isp_BT_Bartender_Shipper_Label_ECCOKR',
