...
GO
/************************************************************************/    
/* Stored Procedure: nspAL_SG07                                         */    
/* Creation Date: 03-NOV-2020                                           */    
/* Copyright: LFL                                                       */    
/* Written by:                                                          */    
/*                                                                      */    
/* Purpose: WMS-15609 - SG-Allocate Full pallet by loc/id balance for   */
/*          UOM 1 FIFO. Other UOM as normal                             */
/*          SkipPreallocation = '1'. Copy from nspALPFIFO               */
/*                                                                      */
/* Called By:                                                           */    
/*                                                                      */    
/* PVCS Version: 1.0                                                    */    
...
BEGIN    
   ...
   SET @c_SQL = N'   
      ...
      CASE WHEN @c_UOM = '1' THEN ' AND (LOTxLOCxID.QTY - LOTxLOCxID.QTYALLOCATED - LOTxLOCxID.QTYPICKED - LOTxLOCxID.QtyReplen - ISNULL(TRFLLI.FromQty,0)) >= ISNULL(PACK.CaseCnt,0) ' ELSE ' ' END +
