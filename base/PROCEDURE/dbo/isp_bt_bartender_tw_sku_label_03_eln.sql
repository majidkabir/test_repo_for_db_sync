...
/******************************************************************************/                 
/* Copyright: IDS                                                             */                 
/* Purpose: isp_BT_Bartender_TW_SKU_Label_03                                  */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
...
CREATE PROC [dbo].[isp_BT_Bartender_TW_SKU_Label_03_ELN]                      
...
SET @c_SQL = @c_SQL + @c_SQLJOIN        
  ...
  SELECT DISTINCT col01,col59     
   ...
   BEGIN                 
      ...
      INSERT INTO [#TEMPLLISKU03] (Storerkey,SKU,LLI_id,Qty,Retrieve)
...
EXIT_SP:    
   ...
   EXEC isp_InsertTraceInfo   
      ...
      @c_TraceName = 'isp_BT_Bartender_TW_SKU_Label_03_ELN',  
