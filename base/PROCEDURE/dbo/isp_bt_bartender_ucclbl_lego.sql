...
/*****************************************************************************/                 
/* Copyright: IDS                                                            */                 
/* Purpose: isp_BT_Bartender_UCCLBL_LEGO                                     */                 
/*                                                                           */                 
/* Modifications log:                                                        */                 
/*                                                                           */                 
...
/* 26-APR-2022  1.4    MINGLE    Add new mappings (ML02)                     */  
/*****************************************************************************/                
...
/*****************CCH*********************/    
  ...
  SET @c_SQLJOIN = +' SELECT O.ExternOrderkey,O.C_Company,ISNULL(O.C_Address1,''''),ISNULL(O.C_Address2,''''),ISNULL(O.C_Address3,''''),'+ CHAR(13)    --5              
     ...
     + ' ISNULL(O.B_VAT,''''),PD.CartonNo,O.Orderdate,FORMAT (O.deliverydate, ''dd/MM/yyyy'') as date,O.Effectivedate,O.Type,O.Consigneekey,'''','''','   --40    --ML01 --ML02         
     + ' '''','''','''','''','''','''','''','''','''','''', '  --50             
     + ' '''','''','''','''','''','''','''','''',PH.Pickslipno,''O'' ' --60               
     + CHAR(13) +               
     ...
     + ' ELSE ISNULL(STC.susr3,'''') END, ISNULL(O.B_VAT,''''),PD.CartonNo,O.Orderdate,O.Deliverydate,O.Effectivedate,O.Type,PH.Pickslipno,O.Consigneekey    '  --ML01 --ML02        
