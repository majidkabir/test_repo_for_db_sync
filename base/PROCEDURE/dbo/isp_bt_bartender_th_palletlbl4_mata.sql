...
BEGIN                      
  ...
  SET @c_SQLJOIN = N' SELECT DISTINCT RECDET.SKU, SUBSTRING(ISNULL(S.Descr,''''),1,80), ISNULL(RECDET.Lottable07,''''), ' + CHAR(13) --3
                  ...
                  + ' AND RECDET.Lottable02 = CASE WHEN ISNULL(@c_Sparm02,'''') = '''' THEN RECDET.Lottable02 ELSE @c_Sparm02 END ' 
  ...
  SET @c_SQL='INSERT INTO #Result (Col01,Col02,Col03,Col04,Col05, Col06,Col07,Col08,Col09'  + CHAR(13) +           
   ...
   EXIT_SP:    
      ...
      EXEC isp_InsertTraceInfo   
         ...
         @c_TraceName = 'isp_BT_Bartender_TH_PALLETLBL4_MATA',  
