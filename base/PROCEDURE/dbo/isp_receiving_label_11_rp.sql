...
/*********************************************************************************/
/* Store procedure: isp_Receiving_Label_11_RP                                    */
/* Purpose: SKU label                                                            */
/*                                                                               */
/* Modifications log:                                                            */
/*                                                                               */
/* Date       Rev  Author   Purposes                                             */
/* 2015-11-25 1.0  Ung      SOS357817 Created base on isp_Receiving_Label_10_RP  */
/*********************************************************************************/

CREATE PROC [dbo].[isp_Receiving_Label_11_RP] (
   @nMobile     INT, 
   @nFunc       INT, 
...
AS
   ...
   BEGIN
      ...
      SAVE TRAN isp_Receiving_Label_11_RP -- For rollback or commit only our own transaction
      ...
      COMMIT TRAN isp_Receiving_Label_11_RP
   END
...
RollBackTran:
   ROLLBACK TRAN isp_Receiving_Label_11_RP -- Only rollback change made here
Quit:
