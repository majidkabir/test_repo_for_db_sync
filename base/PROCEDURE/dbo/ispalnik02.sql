...
BEGIN    
   ...
   SET @c_SQL = N'DECLARE CURSOR_CANDIDATES CURSOR FAST_FORWARD READ_ONLY FOR '
              ...
              +     ', CASE WHEN (LOTXLOCXID.Qty - LOTXLOCXID.QtyAllocated - LOTXLOCXID.QtyPicked - LOTXLOCXID.QtyReplen) >= @n_QtyLeftToFulfill THEN 0 ELSE 1 END '
              +     ', LOC.LogicalLocation '
              +     ', LOC.Loc'                             
      ...
      SET @c_SQLParm =  N'@c_Facility   NVARCHAR(5),  @c_StorerKey  NVARCHAR(15), @c_SKU NVARCHAR(20) '      
                     ...
                     +  ',@c_Lottable12 NVARCHAR(30), @n_QtyLeftToFulfill INT' 
