...
/************************************************************************/    
/* Stored Procedure: nspPRCMC5G                                         */    
/* Creation Date: 24-Mar-2008                                           */    
/* Copyright: IDS                                                       */    
/* Written by: June                                                     */    
/*                                                                      */    
/* Purpose: ULP Allocation which use Acceptance Age Per customer        */    
/*     Per SKU in validating stocks. Similar to nspPRCMC04 except       */    
/*    it allocate from pickface.                                        */    
/*                                                                      */    
/* Called By:                                                           */    
/*                                                                      */    
/* PVCS Version: 1.3                                                    */    
...
BEGIN -- main    
 ...
 DECLARE @c_Consigneekey   NVARCHAR(18)    
   ...
   BEGIN    
      ...
      BEGIN    
         SET @c_Consigneekey = RIGHT(RTrim(LTrim(@c_Consigneekey)), 10)    
      END    
