...
/************************************************************************/
/* Stored Procedure: ispGenLottable02pre                                */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
...
CREATE PROCEDURE [dbo].[ispGenLottable02pre]
...
--     SELECT @dt_Lottable04 = CONVERT(DATETIME, '2007-12-31')
--     SELECT @dt_Lottable05 = CONVERT(DATETIME, '2007-12-31')
