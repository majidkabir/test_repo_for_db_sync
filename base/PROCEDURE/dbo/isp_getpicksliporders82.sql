...
GO
/************************************************************************/
/* Stored Proc: isp_GetPickSlipOrders82                                 */
/* Creation Date: 04-OCT-2017                                           */
/* Copyright: LF Logistics                                              */
/* Written by: YTWan                                                    */
/*                                                                      */
/* Purpose:WMS-5567- [TW] VFEC- EC PickSlip_RCMReport                   */
/*        :                                                             */
/* Called By:r_dw_print_pickorder82                                     */
/*          :                                                           */
/* PVCS Version: 1.0                                                    */
/*                                                                      */
/* Version: 7.0                                                         */
...
/* 30-AUG-2018  CHEEMUN	  1.0 INC0355882 - Order by Loc, Sku            */
/* 31-AUG-2018  LZG       1.1 Fix report shows blank space (ZG01)       */
/************************************************************************/

CREATE PROC [dbo].[isp_GetPickSlipOrders82]
...
BEGIN
   ...
   BEGIN
      ...
      AND C4.Code =  @c_Logo AND C4.long='r_dw_print_pickorder82'
...
/*  WHILE @n_ReqLine >= 1
  ...
  SELECT * FROM #TMP_PCK82 AS tp
  ORDER BY pickslipno, loc, sku,  --INC0355882
