...
/* Copyright: IDS                                                       */
/* Purpose: Default Lottable04 from ReceiptDetail                       */
/*                                                                      */
/* Modifications log:                                                   */
/*                                                                      */
...
CREATE   PROCEDURE [dbo].[ispDefLot4FrRcptDtlPMI]
...
BEGIN
   ...
   SET @nCount = 0
   SET @cUserDefine04 = ''
   SET @dt_Lottable04Value = ''

   -- Get code lookup info
   SELECT @cUserDefine04 = UDF04
   ...
   IF @cUserDefine04 <> ''
      SET @dt_Lottable04 = @cUserDefine04
   ELSE
   BEGIN
      -- Get receipt detail info
      SELECT 
         @nCount = COUNT( DISTINCT Lottable04), 
         @dt_Lottable04Value = MAX(Lottable04)
