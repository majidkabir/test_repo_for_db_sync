...
/* Purpose: POD                                                         */    
/*                                                                      */    
/* Called By: r_dw_pod_03  SOS#168331                                   */     
/*                                                                      */    
...
/* 15-Aug-2017 Wan10      2.2  WMS-2549 - CN BROOKS POD                 */    
/* 04-Jan-2018 Wan11      2.3  WMS-3708 - CN-WMS-3708- UA_POD_CR        */    
/* 15-Dec-2018 TLTING01   2.4  Missing nolock                          */    
/* 08-Jan-2019 WLCHOOI    2.5  WMS-7428 Add codelkup to enlarge fontsize*/   
/* 28-Jan-2019 TLTING_ext 2.6  enlarge externorderkey field length      */   
/* 11-Jul-2019 WLCHOOI    2.7  Add ReportCFG to show pageno (WL02)      */  
/************************************************************************/    
CREATE PROCEDURE [dbo].[isp_pod_03]    
 ...
 --WL01 END    
   ...
   WHERE ORDERS.Mbolkey = @c_Mbolkey    
    ...
    ( mbolkey,        MbolLineNumber ,    ExternOrderKey,        Orderkey,        type,    
      ...
      Domain,ConsigneeKey --GOH01   --CS01    
      )        
    SELECT     
