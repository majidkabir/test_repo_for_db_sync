...
/************************************************************************/  
/* Stored Procedure: nspAL_PH06                                         */  
/* Creation Date: 10-Jun-2021                                           */  
/* Copyright: LFL                                                       */  
/* Written by:                                                          */  
/*                                                                      */  
/* Purpose: WMS-17043 PH Young Living allocation                        */  
/*                                                                      */                                                    
/* Called By:                                                           */  
/*                                                                      */  
/* PVCS Version: 1.0                                                    */  
...
BEGIN  
  ...
  DECLARE @c_OrderKey        VARCHAR(10),  
   ...
   BEGIN   
      ...
      AND LOC.Status <> 'HOLD'  
      AND ID.Status = 'OK'  
      AND (LOC.LocationType IN('PICK','CASE') OR @c_AllowMonkeyPick = 'Y')  
      AND (LOTxLOCxID.QTY - LOTxLOCxID.QTYALLOCATED - LOTxLOCxID.QTYPICKED - LOTxLOCxID.QtyReplen) > 0   
