...
/******************************************************************************/                 
/* Copyright: IDS                                                             */                 
/* Purpose: isp_Bartender_CustomLabel_KR_01                                   */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
  ...
  DECLARE @d_Trace_StartTime   DATETIME,   
   ...
   BEGIN         
    ...
    SET @c_SQLJOIN = +' SELECT DISTINCT U.Uccno,'''',s.putawayzone,'+ CHAR(13)--SUM(RECDET.qtyreceived),RECDET.SKU,'+ CHAR(13)+ --5
            ...
            -- + ' JOIN PODETAIL PODET WITH (NOLOCK) ON pokey= SUBSTRING(u.sourcekey,1,10) AND PODET.POLineNumber =SUBSTRING(u.sourcekey,11,5)'           
             ...
             + ' LEFT JOIN CODELKUP C WITH (NOLOCK) ON C.listname = ''ADSKUDIV'' and C.code = s.skugroup'
   ...
   EXIT_SP:    
      ...
      EXEC isp_InsertTraceInfo   
         ...
         @c_TraceName = 'isp_Bartender_CustomLabel_KR_01',  
