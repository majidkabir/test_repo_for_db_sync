...
GO
/***************************************************************************/
/* Stored Proc : nsp_GetPickSlipOrders60                                   */
/* Creation Date:                                                          */
/* Copyright: IDS                                                          */
/* Written by: CHONGCS                                                     */
/*                                                                         */
/* Purpose: SG - IDSMED Pick List CR (Migration) (SOS#368216)              */
...
CREATE PROC [dbo].[nsp_GetPickSlipOrders60]
(
...
BEGIN TRAN
   ...
   SELECT *
   FROM #TEMP_PICK
   ORDER BY Orderkey, Putawayzone,  
   substring(loc,1,4),substring(loc,9,2),substring(loc,5,3)
