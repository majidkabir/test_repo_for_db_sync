...
/***************************************************************************/
/* Stored Procedure: isp_ReplenishmentRpt_PC28                             */
/* Creation Date:  14-May-2020                                             */
/* Copyright: LFL                                                          */
/* Written by:                                                             */
/*                                                                         */
/* Purpose: WMS-13197 CN Sephora replenishment report                      */
/*                                                                         */
/*                                                                         */
...
CREATE PROC [dbo].[isp_ReplenishmentRpt_PC28]
...
BEGIN
      ...
      BEGIN		
         ...
         SET @n_RemainingQty = @n_ReplenQty
			   ...
			   BEGIN         
                ...
                JOIN UCC WITH (NOLOCK) ON LLI.Lot = UCC.Lot AND LLI.Loc = UCC.Loc AND LLI.ID = UCC.ID AND UCC.Status < 3                                                 
                ...
                ORDER BY LOC.LocationHandling DESC, LOC.LogicalLocation, LOC.Loc, UCC.Qty
   ...
   BEGIN
      ...
      SELECT R.FromLoc ,R.Id ,R.ToLoc ,R.Sku ,SUM(R.Qty) ,R.StorerKey
            ,R.Lot, R.PackKey, R.Priority, R.UOM, COUNT(DISTINCT R.DropID)
