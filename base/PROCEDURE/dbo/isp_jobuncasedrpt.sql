...
/******************************************************************************/    
CREATE PROC [dbo].[isp_JobUncasedRpt]
...
BEGIN
   ...
   BEGIN
      ...
      SELECT @c_o_Storerkey= SKU.Storerkey
            ...
            ,@c_InterimSku    = WORKORDERREQUESTOUTPUTS.PrimarySku
