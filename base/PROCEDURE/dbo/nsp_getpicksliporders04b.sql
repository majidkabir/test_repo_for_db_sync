...
GO
/************************************************************************/
/* Stored Procedure: nsp_GetPickSlipOrders04b                           */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
/* Purpose:                                                             */
/*                                                                      */
/* Called By: r_dw_print_pickorder04b                                   */
/*                                                                      */
/* PVCS Version:                                                        */
/*                                                                      */
/* Version:                                                             */
...
/* 09-Aug-2006  Loon	      	 Create new Datawindow                    */
/* 01-Jul-2009  NJOW     1.0   Add altsku column SOS#140677             */
/* 26-Nov-2013  TLTING         Change user_name() to SUSER_SNAME()      */
/* 18-Sep-2015  CSCHONG        SOS#352276 (CS01)                        */
/* 09-Aug-2016  MTTEY          IN#00115219 (MT02) link with storerkey   */
/************************************************************************/

CREATE PROC [dbo].[nsp_GetPickSlipOrders04b] (@c_loadkey NVARCHAR(10))
AS
BEGIN
   SET NOCOUNT ON
   SET QUOTED_IDENTIFIER OFF
   ...
   LEFT OUTER JOIN CODELKUP (nolock)
      ON codelkup.listname = 'PRINCIPAL' and
         codelkup.storerkey = sku.storerkey and      --(MT02)
