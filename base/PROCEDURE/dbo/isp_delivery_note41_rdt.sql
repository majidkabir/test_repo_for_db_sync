...
/*************************************************************************/  
/* Stored Procedure: isp_delivery_note41_rdt                             */  
/* Creation Date: 2019-12-31                                             */  
/* Copyright: LFL                                                        */  
/* Written by: WLChooi                                                   */  
/*                                                                       */  
/* Purpose: WMS-11602 - [CN] HM ARKET Delivery Note Report               */  
/*                                                                       */  
/* Called By: r_dw_delivery_note41_rdt                                   */  
/*            Copy from isp_delivery_note34_rdt                          */  
/*                                                                       */ 
/* PVCS Version: 1.0                                                     */  
/*                                                                       */  
/* Version: 5.4                                                          */  
...
CREATE PROC [dbo].[isp_delivery_note41_rdt]   
...
BEGIN  
   ...
   ORDER BY   PD.Orderkey ,PD.sku  
    ...
    DROP TABLE #TMP_ORD41  
    DROP TABLE #TMP_HDR41  
    GOTO QUIT_SP  
