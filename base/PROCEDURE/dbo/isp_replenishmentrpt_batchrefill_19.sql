...
/****************************************************************************/
/* Stored Procedure: isp_ReplenishmentRpt_BatchRefill_19                    */
/* Creation Date: 10-APR-2019                                               */
/* Copyright: IDS                                                           */
/* Written by: CSCHONG                                                      */
/*                                                                          */
/* Purpose: WMS-8656 - [CR]Pandora_replenishment_report_CR                  */
/*        : modify from isp_ReplenishmentRpt_BatchRefill_16                 */ 
/*                                                                          */  
/* Called By: r_replenishment_report19                                      */  
/*                                                                          */  
/* PVCS Version: 1.7                                                        */  
/*                                                                          */  
/* Version: 5.4                                                             */  
...
--            END    
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         SET @c_errmsg= 'NSQL'+CONVERT(char(5),@n_err)+': Fail to get REPLENISHKEY. (isp_ReplenishmentRpt_BatchRefill_19)'  
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         SET @c_errmsg = 'NSQL'+CONVERT(char(5),@n_err)  
                       + ': Insert into Replenishment table failed. (isp_ReplenishmentRpt_BatchRefill_19)'  
       + ' ( ' + ' SQLSvr MESSAGE=' + RTRIM(@c_errmsg) + ' ) '  
         GOTO QUIT  
      END  
      COMMIT TRAN  
...
--         ,  QtyAvailableEA       FLOAT          NULL  DEFAULT (0)  
  ...
  END                                                                                  --(Wan04)
   ...
   AND   CODELKUP.Long = 'r_replenishment_report19'  
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         END  
      END  
      EXECUTE nsp_logerror @n_err, @c_errmsg, 'isp_ReplenishmentRpt_BatchRefill_19'  
