...
/******************************************************************************/  
/* Store Procedure: isp_PackListBySku06                                       */  
/* Creation Date: 29-Aug-2013                                                 */  
/* Copyright: IDS                                                             */  
/* Written by: NJOW (Copy from nsp_PackListBySku03_chs)                       */  
/*                                                                            */  
/* Purpose:  288003-CN Lisalisa packing list                                  */  
/*                                                                            */  
...
CREATE PROC [dbo].[isp_PackListBySku06] (@c_PickSlipNo NVARCHAR(30))  
AS  
SET NOCOUNT ON
...
BEGIN
  ...
  INTO #TMP_STYLECOLOR	              
	...
	SELECT Orderkey, ExternOrderKey, Storerkey, ST_Company, ReprintFlag, PickSlipNo, Company,
	       Address1, Address2, Address3, Address4, City, STATE, Country, Contact1, Phone1,  
	       BuyerPO, CartonNo, Style, Color, MAX(Descr), MAX(Price)
	FROM #TMP_STYLECOLOR
	GROUP BY Orderkey, ExternOrderKey, Storerkey, ST_Company, ReprintFlag, PickSlipNo, Company,
	         Address1, Address2, Address3, Address4, City, STATE, Country, Contact1, Phone1,  
	         BuyerPO, CartonNo, Style, Color
