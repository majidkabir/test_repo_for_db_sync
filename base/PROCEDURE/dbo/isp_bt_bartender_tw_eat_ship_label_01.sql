...
/******************************************************************************/                 
/* Copyright: IDS                                                             */                 
/* Purpose: isp_BT_Bartender_TW_EAT_ship_Label_01                             */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
/* Date       Rev  Author     Purposes                                        */                 
/* 2017-11-27 1.0  CSCHONG    Created (WMS-3495)                              */  
/* 2018-02-01 1.1  CSCHONG    WMS-3947 - Add new field (CS01)                 */  
/* 2018-03-20 1.2  CSCHONG    WMS-4286 - addnew field (CS02)                  */
/* 2020-01-31 1.3  LZG        INC1024700 - Fixed doubled Qty issue (ZG01)     */
/******************************************************************************/                
                  
CREATE PROC [dbo].[isp_BT_Bartender_TW_EAT_ship_Label_01]                      
 ...
 SET @c_ExecArguments = N'     @c_Sparm01          NVARCHAR(80)'    
  ...
  SELECT DISTINCT col01,col09,col11     
   ...
   BEGIN                 
      ...
      SELECT DISTINCT @c_orderkey,@c_cartonno,OD.sku, SUM(pd.qty),@c_labelno,'N'
      FROM ORDERS AS o WITH (NOLOCK) 
      JOIN ORDERDETAIL OD WITH (NOLOCK) ON OD.orderkey = o.orderkey
      JOIN PackDetail AS pd WITH (NOLOCK) ON pd.storerkey = OD.storerkey AND pd.sku = od.sku          -- ZG01
...
EXIT_SP:    
   ...
   EXEC isp_InsertTraceInfo   
      ...
      @c_TraceName = 'isp_BT_Bartender_TW_EAT_ship_Label_01',  
