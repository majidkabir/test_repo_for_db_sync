...
/************************************************************************/
/* Stored Procedure: ispGenLottable0XpreNick                            */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
...
CREATE PROCEDURE [dbo].[ispGenLottable0XpreNick]
...
BEGIN
   ...
   SELECT @c_Lottable01  = 'CHINA';
   SELECT @c_Lottable02  = 'GREEN';
   SELECT @c_Lottable03  = '20241010';
   SELECT @dt_Lottable04  = GETDATE();
   --SELECT @dt_Lottable05  = DATEADD(dd, 20, GETDATE());
