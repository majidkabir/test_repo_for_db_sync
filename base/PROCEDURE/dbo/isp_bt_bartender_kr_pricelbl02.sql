...
/******************************************************************************/                   
/* Copyright: IDS                                                             */                   
/* Purpose: isp_BT_Bartender_KR_PRICELBL02                                    */                   
/*                                                                            */                   
/* Modifications log:                                                         */                   
/*                                                                            */                   
...
CREATE    PROC [dbo].[isp_BT_Bartender_KR_PRICELBL02]                        
  ...
  DECLARE @d_Trace_StartTime   DATETIME,     
   ...
   SET @c_Trace_ModuleName = ''    
    ...
    SELECT DISTINCT S.sku,s.style,SUBSTRING(ISNULL(s.NOTES1,''),1,80), @c_Sparm03,ISNULL(s.susr1,''), --5     
              ...
              S.busr1,S.busr2,S.size,'','',         --20 --ML01        
              '','','','','','','','','','',  --30    
              '','','','','','','','','','',   --40         
              '','','','','','','','','','',   --50         
              '','','','','','','','','',''   --60          
   ...
   EXIT_SP:      
      ...
      --   @c_TraceName = 'isp_BT_Bartender_KR_PRICELBL02',    
