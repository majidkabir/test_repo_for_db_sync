...
CREATE   PROC [dbo].[isp_RPT_WV_PLIST_WAVE_037]
(
...
BEGIN
   ...
   CREATE TABLE #temp_isp_RPT_WV_PLIST_WAVE_037
   (
      wavekey        NVARCHAR(10)
   ...
   BEGIN --While
      ...
      SELECT @c_Lottable02 = Lottable02
           , @c_Lottable04 = CONVERT(NVARCHAR(10), [dbo].[fnc_ConvSFTimeZone](@c_StorerKey, @c_Facility, Lottable04), 23)
     ...
     IF @n_ShowPDUOM = 1
      ...
      VALUES (@c_Wavekey, CONVERT(CHAR(16), dbo.fnc_ConvSFTimeZone(@c_StorerKey, @c_Facility, GETDATE()), 120), @c_pickheaderkey, @c_PickMethod, @c_PrintedFlag
   ...
   BEGIN
      SELECT *
      FROM #temp_isp_RPT_WV_PLIST_WAVE_037
      ORDER BY PickSlipNo
             , OrderKey
             , SKU
   END
   ...
   QUIT:
   IF OBJECT_ID('tempdb..#temp_isp_RPT_WV_PLIST_WAVE_037') IS NOT NULL
      DROP TABLE #temp_isp_RPT_WV_PLIST_WAVE_037
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE nsp_logerror @n_err, @c_errmsg, 'isp_RPT_WV_PLIST_WAVE_037'
