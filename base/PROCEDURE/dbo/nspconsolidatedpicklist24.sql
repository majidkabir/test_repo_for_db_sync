...
GO
/************************************************************************/
/* Store Procedure:  nspConsolidatedPickList24                      		*/
/* Creation Date: 29/04/2015                            					   */
/* Copyright: IDS                                                       */
/* Written by:                                           				  	*/
/*                                                                      */
/* Purpose:  Create Consolidated PickSlip (24)- copy from 11       	   */
/*                                                                      */
...
/* Return Status:  None                                                 */
/*                                                                      */
/* Usage:  Used for report dw = r_dw_consolidated_pick24         		  	*/
/*                                                                      */
/* Local Variables:                                                     */
/*                                                                      */
/* Called By:                                       						  	*/
...
CREATE PROC [dbo].[nspConsolidatedPickList24] (
...
--SOS#152092 
 ...
 DECLARE @c_OrderKey 		NVARCHAR(10),
   ...
   /*CS01 END*/ 
    ...
    SET @c_LRoute = ''              --(CS01)
    SET @c_LEXTLoadKey= ''          --(CS01)
    SET @c_LPriority = ''            --(CS01) 
    SET @c_LUdef01 = ''            --(CS01) 
 ...
 BEGIN
   ...
   /*    SELECT ORDERKEY, GroupNo, GroupSeq, GroupSeqsub, SKUUOM, LOT
    ...
    INSERT INTO #CONSOLIDATED VALUES (
          ...
          ISNULL(@c_LRoute,""),              --(CS01)
          ISNULL(@c_LEXTLoadKey,""),         --(CS01)
          ISNULL(@c_LPriority,""),           --(CS01)  
          ISNULL(@c_LUdef01,"")              --(CS01) 
          )
    SELECT @n_Qty1=0
    SELECT @n_Qty2=0
    SELECT @n_Qty3=0
