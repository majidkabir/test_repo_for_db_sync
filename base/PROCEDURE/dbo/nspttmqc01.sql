...
BEGIN
   ...
   ELSE
      ...
      BEGIN
         ...
         SELECT @c_errmsg="NSQL"+CONVERT(char(5),@n_err)+": Execute Of QC Tasks Pick Code Failed. (nspTTMQC01)" + " ( " + " SQLSvr MESSAGE=" + dbo.fnc_LTrim(dbo.fnc_RTrim(@c_errmsg)) + " ) "
      END
   END
   /* #INCLUDE <SPTMQC01_2.SQL> */
   ...
   ELSE
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, "nspTTMQC01"
