...
/******************************************************************************/                 
/* Copyright: IDS                                                             */                 
/* Purpose: isp_Bartender_SKUVASLBL_GetParm                                   */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
/* Date       Rev  Author     Purposes                                        */                 
/* 2021-11-11 1.0  CSCHONG    Devops scripts combine - Created(WMS-18297)     */                             
/******************************************************************************/                
                  
CREATE PROC [dbo].[isp_Bartender_SKUVASLBL_GetParm]                      
(  @parm01            NVARCHAR(250),              
   @parm02            NVARCHAR(250),              
   @parm03            NVARCHAR(250),              
   @parm04            NVARCHAR(250),              
...
BEGIN                      
  ...
  DECLARE @d_Trace_StartTime   DATETIME,   
   ...
   SELECT @c_stsusr1 = st.susr1
   FROM ORDERS OH WITH (NOLOCK)
   JOIN dbo.STORER ST WITH (NOLOCK) ON st.StorerKey=oh.ConsigneeKey
   ...
   BEGIN
            ...
            INSERT INTO #TEMPSKUVASLBL (PARM01,PARM02,PARM03,PARM04,PARM05,PARM06,PARM07,PARM08,PARM09,PARM10,
                                         key01,key02,key03,key04,key05)
            SELECT TOP 1 PARM1=S.storerkey,PARM2=S.SKU,PARM3= '' ,PARM4= @parm05,PARM5='',PARM6='',PARM7='',
   ...
   WHILE @n_Copy > 1
   BEGIN
      INSERT INTO #TEMPSKUVASLBL (PARM01,PARM02,PARM03,PARM04,PARM05,PARM06,PARM07,PARM08,PARM09,PARM10,key01,key02,key03,key04,key05)
