...
GO
/************************************************************************/
/* Stored Proc: isp_GetPickSlipOrders68                                 */
/* Creation Date: 06-FEB-2016                                           */
/* Copyright: LF Logistics                                              */
/* Written by: YTWan                                                    */
/*                                                                      */
/* Purpose: WMS - 1001 - GCI Consolidated PickList Format               */
/*        :                                                             */
/* Called By:r_dw_print_pickorder68                                     */
/*          :                                                           */
/* PVCS Version: 1.1                                                    */
/*                                                                      */
/* Version: 7.0                                                         */
...
/* 11-07-2019  KarHoe     1.1 INC0761176 - Revise qty                   */
/* 08-08-2019  WLChooi    1.2 WMS-10092 - Add ReportCFG (WL01)          */
/* 05-09-2019  WLChooi    1.3 Fix totalcases qty, fix Pickslipno        */
/*                            missing due to different UOM (Use         */
/*                            ReportCFG to control) and fix duplicated  */
/*                            records (WL02)                            */
/* 12-11-2019  WLChooi    1.4 Group similar detail lines together if    */
/*                            @n_LinkPickdetailkey = 1, doesn't affect  */
/*                            if @n_LinkPickdetailkey <> 1 (WL03)       */
/************************************************************************/
CREATE PROC [dbo].[isp_GetPickSlipOrders68]
...
BEGIN
 ...
 CREATE TABLE #TMP_PAGING
   ...
   AND   Long = 'r_dw_print_pickorder68'  
   AND   ISNULL(Short,'') <> 'N'  
   --WL01 End
