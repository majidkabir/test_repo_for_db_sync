...
/******************************************************************************/
/* Store Procedure: isp_Packing_List_40_rdt                                   */
/* Creation Date: 20-JUL-2017                                                 */
/* Copyright: IDS                                                             */
/* Written by: CSCHONG                                                        */
/*                                                                            */
/* Purpose: WMS-2380 - CN Newlook Ecom Packlist                               */
/*                                                                            */
/*                                                                            */
/* Called By:  r_dw_packing_list_40_rdt                                       */
/*                                                                            */
/* PVCS Version: 1.0                                                          */
/*                                                                            */
/* Version: 1.0                                                               */
...
/* 31-Oct-2017  Leong     1.1   Sum Pickdetail Qty (L01)                      */
/******************************************************************************/

CREATE PROC [dbo].[isp_Packing_List_40_rdt]
...
BEGIN
 ...
 CREATE TABLE #PACKLIST40RDT
   ...
   ISNULL(OH.M_Company,''),OH.ExternOrderKey,PD.LOC,ISNULL(OH.C_Address3,''),
   ISNULL(OH.Userdefine01,''),PD.SKU,PD.qty,OH.OrderKey,
   OH.LoadKey,ISNULL(OH.C_Address4,''),OH.Invoiceamount,ORDDET.UnitPrice,s.descr,
