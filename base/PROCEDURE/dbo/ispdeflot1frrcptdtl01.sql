...
/***************************************************************************/
/* Store procedure: ispDefLot1FrRcptDtl01                                  */
/* Copyright: IDS                                                          */
...
/* 2021-04-12   Chermaine 1.0   WMS-16334 Created (dup ispDefLot1FrRcptDtl)*/
/***************************************************************************/

CREATE PROCEDURE [dbo].[ispDefLot1FrRcptDtl01]
...
BEGIN
   ...
   BEGIN
      ...
      SELECT 
         @c_Lottable01Value = ExternReceiptKey
