...
/*************************************************************************/  
/* Stored Procedure: isp_Print_SSCC_CartonLabel06_02_01_dmart            */  
...
/*          datamart                                                     */  
/* Called By: r_dw_sscc_cartonlabel06_02_01_dmart                        */
/*                                                                       */  
/* PVCS Version: 1.0                                                     */  
/*                                                                       */  
/* Version: 5.4                                                          */  
...
/*************************************************************************/  
CREATE PROC [dbo].[isp_Print_SSCC_CartonLabel06_02_01_dmart]
...
BEGIN
   ...
   SET @sql = ' SELECT ORDERS.BuyerPO ' + char(10)
            + '			,  ORDERS.ExternOrderkey ' + char(10)
            + '			,  ORDERS.MarkForKey ' + char(10)
            ...
            + '			,  SKU.Busr4 ' + char(10)
            + '			,  SKU.Size ' + char(10)
            + '			,  SKU.Measurement ' + char(10)
            + '			,  SKU.StdGrossWgt ' + char(10)
