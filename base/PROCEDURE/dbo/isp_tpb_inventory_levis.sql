...
GO
/************************************************************************/        
/* Stored Procedure: isp_TPB_Inventory_Levis                            */        
/* Creation Date:                                                       */        
/* Copyright: IDS                                                       */        
/* Written by:                                                          */        
/*                                                                      */        
/* Purpose: TPB billing for Levis DailyInventory Transaction            */        
/*                                                                      */        
...
CREATE PROC [dbo].[isp_TPB_Inventory_Levis]  
...
BEGIN  
   ...
   SET @c_SQLStatement =   
      ...
      JOIN DBO.DailyInventory DailyInventory1 (NOLOCK) ON DailyInventory1.Facility=CD.Code 
      ...
      JOIN DBO.DailyInventory DailyInventory1 (NOLOCK) ON DailyInventory1.Storerkey=CD.Storerkey 
      ...
      'JOIN DBO.PACK (NOLOCK) ON PACK.Packkey = SKU.Packkey ' +
      'JOIN DBO.Loc (NOLOCK) on Loc.Loc = DI.Loc ' +
