...
GO
/************************************************************************/      
/* Store Procedure:  isp_Transfer_Ticket_07                             */      
/* Creation Date:                                                       */      
/* Copyright: IDS                                                       */      
/* Written by: Mingle(copy from isp_Transfer_Ticket)                    */      
/*                                                                      */      
...
/* Return Status:  None                                                 */      
/*                                                                      */      
/* Usage:  Used for report dw = r_dw_transfer_ticket_07                 */      
/*                                                                      */      
/* Local Variables:                                                     */      
/*                                                                      */      
/* Called By:                                                           */      
...
/* 22-Aug-2021  Mingle  1.1   WMS-17755 - Add transfer.Remarks(ML01)    */           
/************************************************************************/      
CREATE PROC [dbo].[isp_Transfer_Ticket_07] (@c_TransferKey NVARCHAR(10))      
 AS      
BEGIN      
    SET NOCOUNT ON      
    SET QUOTED_IDENTIFIER OFF      
 ...
 END      
   ...
   CREATE TABLE #TMP_TRFTICKET      
      ...
      ,  Remarks           NVARCHAR(200)  NULL     --ML01  
      )      
   ...
   BEGIN      
      ...
      BEGIN      
         ...
         END      
      END      
      EXECUTE nsp_logerror @n_err, @c_errmsg, 'isp_Transfer_Ticket_07'      
