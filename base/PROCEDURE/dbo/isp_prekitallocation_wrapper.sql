...
/* Written by:                                                          */
/*                                                                      */
/* Purpose: WMS-10084 Pre-Kit Allocation process                        */
/*          ispPREALKIT??                                               */
/*                                                                      */
...
/************************************************************************/
CREATE   PROC [dbo].[isp_PreKitAllocation_Wrapper]
...
BEGIN
   ...
   EXEC nspGetRight      
      ...
      ,  @c_sku       = NULL      
      ,  @c_ConfigKey = 'PreKitAllocation_SP'      
   ...
   BEGIN
      ...
      SET @c_ErrMsg = 'NSQL' + CONVERT(CHAR(5), @n_Err)  
                  + ': Error Executing nspGetRight. (isp_PreKitAllocation_Wrapper)'  
      GOTO QUIT_SP
   END
...
QUIT_SP:
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         END  
      END  
      execute nsp_logerror @n_err, @c_errmsg, "isp_PreKitAllocation_Wrapper"  
