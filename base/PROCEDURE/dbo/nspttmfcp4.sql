...
BEGIN
   ...
   SAVE TRAN nspTTMFCP4 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN nspTTMFCP4 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN nspTTMFCP4 -- Only rollback change made here
Fail:
Quit:
