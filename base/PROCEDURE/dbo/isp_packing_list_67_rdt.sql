...
/******************************************************************************/                
/* Store Procedure: isp_Packing_List_67_rdt                                   */                
/* Creation Date: 16-Jul-2019                                                 */                
/* Copyright: LFL                                                             */                
/* Written by: WLCHOOI                                                        */                
/*                                                                            */                
/* Purpose: WMS-9848 - CN Lululemon Ecompacking module packinglist            */    
/*                                                                            */                
/*                                                                            */                
/* Called By:  r_dw_packing_list_67_rdt                                       */                
/*                                                                            */                
/* PVCS Version: 1.0                                                          */                
/*                                                                            */                
/* Version: 1.0                                                               */                
...
CREATE PROC [dbo].[isp_Packing_List_67_rdt]               
...
BEGIN              
   ...
   SELECT Facility         = ISNULL(RTRIM(FACILITY.Descr),'')
         ...
         ,CurrentCtn         = PACKDETAIL.CartonNo
	   ...
	   LEFT JOIN CODELKUP CL	WITH (NOLOCK) ON (CL.LISTNAME = 'REPORTCFG' AND CL.CODE = 'SHOWTITLE' AND CL.STORERKEY = ORDERS.Storerkey
	   											AND CL.LONG = 'r_dw_packing_list_67_rdt')
	   LEFT JOIN CODELKUP CLR WITH (NOLOCK) ON (CLR.LISTNAME = 'REPORTCFG' AND CLR.CODE = 'HIDECOLUMNS' AND CLR.STORERKEY = ORDERS.Storerkey
	   											AND CLR.LONG = 'r_dw_packing_list_67_rdt')						
	   WHERE PACKDETAIL.PickSlipNo = @c_Pickslipno --'P078285441'
