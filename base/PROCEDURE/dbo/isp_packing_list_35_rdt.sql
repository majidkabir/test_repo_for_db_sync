...
/******************************************************************************/              
/* Store Procedure: isp_Packing_List_35_rdt                                   */              
/* Creation Date: 12-APR-2017                                                 */              
/* Copyright: IDS                                                             */              
/* Written by: CSCHONG                                                        */              
/*                                                                            */              
/* Purpose: WMS-1622-CN-Victoria_Secret ECOM - Packing List                   */  
/*                                                                            */              
/*                                                                            */              
/* Called By:  r_dw_packing_list_35_rdt                                       */              
/*                                                                            */              
/* PVCS Version: 1.0                                                          */              
/*                                                                            */              
/* Version: 1.0                                                               */              
...
CREATE PROC [dbo].[isp_Packing_List_35_rdt]             
...
BEGIN            
 ...
 CREATE TABLE #PACKLIST35 
   ...
   SELECT ISNULL(OH.c_Contact1,''),
         (ISNULL(OH.C_address2,'') + ISNULL(OH.C_address3,'') + ISNULL(OH.C_address4,'')), --+',' + ISNULL(OH.C_address1,'')),
          ISNULL(OH.C_state,''),ISNULL(OH.C_City,'') ,ISNULL(OH.C_zip,''),
          ISNULL(OH.M_Company,''),OH.OrderDate,s.size,
          s.color,s.sku,PD.qty,OH.OrderKey,
          '','',--RTRIM(ORDDET.UserDefine01),RTRIM(ORDDET.UserDefine02),   --CS01
   ...
   --ORDER BY orderkey,
   --         CASE WHEN PASKU <> '' THEN 0 ELSE 1 END
   --         ,SColor,SKUSize  
   --CS02 END
