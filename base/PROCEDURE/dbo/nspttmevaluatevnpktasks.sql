...
GO
/************************************************************************/  
/* Stored Procedure: nspTTMEvaluateVNPKTasks                            */  
/* Creation Date:                                                       */  
/* Copyright: IDS                                                       */  
/* Written by:                                                          */  
/*                                                                      */  
...
/* 27-05-2010   1.1   ChewKP     Created                                */  
/************************************************************************/  
  
CREATE PROC    [dbo].[nspTTMEvaluateVNPKTasks]  
    ...
    BEGIN  
        ...
        BEGIN  
            ...
            SELECT @c_errmsg = "NSQL"+CONVERT(NVARCHAR(5) ,@n_err)+  
                   ": Execute Of Move Tasks Pick Code Failed. (nspTTMEvaluateVNPKTasks)"   
...
--              +RTrim(CONVERT(NVARCHAR(10) ,@n_qty))+@c_senddelimiter  
   ...
   BEGIN  
      ...
      BEGIN  
       ...
       BEGIN  
           ...
           END  
       END  
       execute nsp_logerror @n_err, @c_errmsg, 'nspTTMEvaluateVNPKTasks'  
