...
/************************************************************************/
/* Stored Procedure:  ispPRJCB03                                        */
/* Creation Date: 06-MAY-2024                                           */
/* Copyright: MAERSK                                                    */
/* Written by:                                                          */
/*                                                                      */
/* Purpose:  UWP-18748 UK Demeter - JCB Allocation                      */
/*           Allocate full pallet of single sku from bulk. UOM 1.       */
/*           Without top up order qty                                   */
/*           Order type = '1' Consignment Order                         */
/*                                                                      */
      	    ...
      	    BEGIN                      	 	           
                  ...
                  BEGIN
                     ...
                     BEGIN
                        ...
                        SET @c_errmsg='NSQL'+CONVERT(NVARCHAR(5),@n_err)+': Insert Pickdetail Failed. (ispPRJCB03)'
                                    + ' ( ' + ' SQLSvr MESSAGE=' + RTRIM(@c_errmsg) + ' ) '
                     END
                  END  
...
QUIT:
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'ispPRJCB03'
