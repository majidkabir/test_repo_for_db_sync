...
/************************************************************************/
/* Trigger: isp_GetPickSlipOrders04d                             	      */
/* Creation Date: 24-Sep-2014                                           */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
/* Purpose: 319111-PH Loreal - Picklist Revision (EAN)                  */
/*          Notes: Duplicate from nsp_GetPickSlipOrders04c and modified */
/*                                                                      */
...
/* 18-Sep-2015  CSCHONG   1.0   SOS#352276 (CS01)                       */
/************************************************************************/

CREATE PROC [dbo].[isp_GetPickSlipOrders04d] (@c_loadkey NVARCHAR(10))
AS
BEGIN
   SET NOCOUNT ON 
   SET QUOTED_IDENTIFIER OFF 
