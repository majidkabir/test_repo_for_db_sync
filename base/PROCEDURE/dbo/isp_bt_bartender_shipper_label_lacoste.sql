...
/******************************************************************************/
/* Copyright: IDS                                                             */
/* Purpose: isp_BT_Bartender_Shipper_Label_Lacoste                            */
/*                                                                            */
/* Modifications log:                                                         */
/*                                                                            */
/* Date       Rev  Author     Purposes                                        */
/*11-SEP-2020 1.0  CSCHONG   Created (WMS-15015)                              */
/*24-SEP-2020 1.1  CSCHONG   WMS-15015 revised field mapping (CS01)           */
/*11-OCT-2020 1.2  CSCHONG   Fix col32 and col34 bugs (CS02)                  */
/*26-OCT-2020 1.3  WLChooi   WMS-15583 - Add Col43 & Col44 (WL01)             */
/*19-Apr-2021 1.4  WLChooi   WMS-16840 - Add Col45 (WL02)                     */
/*14-Jun-2023 1.5  CSCHONG   Devops Scripts Combine & WMS-22764 (CS03)        */
/******************************************************************************/

CREATE   PROC [dbo].[isp_BT_Bartender_Shipper_Label_Lacoste]
   ...
   DECLARE @d_Trace_StartTime  DATETIME,
    ...
    CREATE TABLE [#Result] (
      ...
      [PQty]        INT)
       ...
       SET @c_SQLJOIN = +' SELECT DISTINCT ORD.Orderkey, ORD.ExternOrderkey+''-'' + ORD.pokey,CASE WHEN ORD.ordergroup=''VIP'' THEN ST.company else ORD.C_Company END, '  --3
                        ...
                        +' PD.CartonNo , SUBSTRING(ORD.notes,1,80), '+ CHAR(13)      --10
                        +'  '''', '''', '''', '''', '''', '''', '''', '''', '''', '''', '+ CHAR(13)  --20
                        +' '''','''','''','''','''','''','''','''','''','''', ' + CHAR(13) --30
                        +' '''','''','''','''','''','''','''','''','''','''', ' + CHAR(13) --40
                        +' '''','''',ISNULL(ORD.Userdefine03,''''),ISNULL(ORD.OrderGroup,''''),PD.LabelNo,'''','''','''','''','''', ' + CHAR(13) --50   --WL01   --WL02
                        +' '''','''','''','''','''','''', '''','''', ' + CHAR(13) --58
 ...
 SET @c_ExecArguments = N'     @c_Sparm01          NVARCHAR(80)'
   ...
   BEGIN
      ...
      SELECT DISTINCT PD.CartonNo
                    , PH.PICKSLIPNO
                    , LTRIM(RTRIM(ISNULL(Sku.sku,'')))             --CS01
                    , sku.altsku
                    , PD.Qty
      FROM PACKDETAIL PD (NOLOCK)
  ...
  SET Col12 = @c_SSTYLE01, Col11 = @c_altsku01, Col13 = @c_SKUQty01,
      ...
      Col33 = @c_SSTYLE08, Col32 = @c_altsku08, Col34 = @c_SKUQty08,                --(CS02)
...
EXIT_SP:
   ...
   EXEC isp_InsertTraceInfo
      ...
      @c_TraceName = 'isp_BT_Bartender_Shipper_Label_Lacoste',
