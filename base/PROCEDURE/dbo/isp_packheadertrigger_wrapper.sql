...
GO
/************************************************************************/  
/* Stored Procedure: isp_PackHeaderTrigger_Wrapper                      */  
/* Creation Date: 16-May-2017                                           */  
/* Copyright: LFL                                                       */  
/* Written by:                                                          */  
/*                                                                      */  
/* Purpose:  Call Packheader custom trigger stored proc                 */
/*                                                                      */  
/* Called By: Packheader insert/update/delete trigger                   */    
/*            Stored proc naming: ispPCKHxx                             */
/*                                                                      */  
/* PVCS Version: 1.0                                                    */  
/*                                                                      */  
/* Version: 5.4                                                         */  
...
CREATE PROCEDURE [dbo].[isp_PackHeaderTrigger_Wrapper]  
...
BEGIN  
   ...
   */
   ...
   SET @c_SQL        = ''
   SET @c_Storerkey  = ''
   SET @c_configkey = 'PackHeaderTrigger_SP'
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, 'isp_PackHeaderTrigger_Wrapper'
