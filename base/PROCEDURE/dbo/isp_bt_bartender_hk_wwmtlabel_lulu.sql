...
/* 2016-11-18 1.0  CSCHONG    Created(WMS-599)                                */   
/* 2020-04-30 1.1  CSCHONG    WMS-13150 - add col58 (CS01)                    */  
/* 2020-08-27 1.2  CSCHONG    unitprice by orderkey and sku (CS01a)           */  
/******************************************************************************/                
                  
CREATE PROC [dbo].[isp_BT_Bartender_HK_WWMTLabel_LULU]                       
...
--CS01 END  
 ...
 VALUES (@c_field02,@c_field03,@c_field04,@c_field06,@c_field07,@c_field08,@c_field09,@c_field10,@c_field11,@c_field12    --10  
        ...
        ,@c_field53,@c_field54,@c_style,@c_Sparm1,@c_SCData,@c_altsku,@c_sku,@n_Unitprice,'','')         --(CS01)  
...
END       
   ...
   EXEC isp_InsertTraceInfo   
      ...
      @c_TraceName = 'isp_BT_Bartender_HK_WWMTLabel_LULU',  
