...
/* 2018-04-20 1.0  CSCHONG    Created (WMS-4647)                              */                 
/******************************************************************************/                
                  
CREATE PROC [dbo].[isp_Bartender_HK_PVHLBL1_GetParm]                      
(  @parm01            NVARCHAR(250),              
   @parm02            NVARCHAR(250),              
   @parm03            NVARCHAR(250),              
   @parm04            NVARCHAR(250),              
...
BEGIN                      
  ...
  DECLARE @d_Trace_StartTime   DATETIME,   
   ...
   IF ISNULL(@parm04,'') = ''
   BEGIN
   	 SET @c_SQLJOIN = ' SELECT DISTINCT PARM1=PD.storerkey,PARM2=PD.labelno,PARM3=PD.SKU,PARM4=CAST(SUM(PD.Qty) as NVARCHAR(10)),PARM5='''',' + CHAR(13) +
