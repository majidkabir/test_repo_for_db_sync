...
/************************************************************************/
/* Stored Procedure: ispSKUDC13                                         */
/* Creation Date: 22/05/2023                                            */
/* Copyright: Maersk                                                    */
/* Written by:                                                          */
/*                                                                      */
/* Purpose: WMS-22631 CN Fabrique decode sku from scanned EPC           */
/*                                                                      */
/*                                                                      */
...
/* 22-MAY-2023 NJOW     1.0   DEVOPS combine scirpt                     */
/************************************************************************/

CREATE   PROCEDURE [dbo].[ispSKUDC13]
...
QUIT_SP:
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE dbo.nsp_LogError @n_Err, @c_Errmsg, 'ispSKUDC13'
