...
GO
/************************************************************************/  
/* Stored Procedure: isp_PackdetailTrigger_Wrapper                      */  
/* Creation Date: 31-AUG-2020                                           */  
/* Copyright: LFL                                                       */  
/* Written by: NJOW                                                     */  
/*                                                                      */  
/* Purpose:  WMS-15009-Call Orders custom stored proc                   */
/*                                                                      */  
/* Called By: Orders insert/update/delete trigger                       */    
/*            Stored proc naming: ispPCKDxx                             */
/*                                                                      */  
/* PVCS Version: 1.0                                                    */  
/*                                                                      */  
/* Version: 7.0                                                         */  
...
CREATE PROCEDURE [dbo].[isp_PackdetailTrigger_Wrapper]  
...
BEGIN  
   ...
   BEGIN   	  
      ...
      BEGIN        	  
         ...
         EXECUTE dbo.isp_PackdetailTrigger_Wrapper ----->wrapper for current table trigger
   ...
   */
   ...
   SET @c_SQL        = ''
   SET @c_Storerkey  = ''
   SET @c_configkey = 'PackdetailTrigger_SP'
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, 'isp_PackdetailTrigger_Wrapper'
