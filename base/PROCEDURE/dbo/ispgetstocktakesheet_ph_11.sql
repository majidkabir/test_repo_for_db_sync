...
/************************************************************************/  
/* Stored Procedure: ispGetStockTakeSheet_ph_11                         */  
/* Creation Date: 1-DEC-2021                                            */  
/* Copyright: IDS                                                       */  
/* Written by: MINGLE                                                   */  
/*                                                                      */  
/* Purpose: WMS-18474 [PH] - PH YLEO CYCLE COUNT REPORT CR              */  
/*                                                                      */ 
...
/* Local Variables:                                                     */
/*                                                                      */ 
/* Called By: r_dw_stocktake_ph_11                                      */  
/*                                                                      */  
/* PVCS Version: 1.0                                                    */  
/*                                                                      */  
/* Version: 5.4                                                         */  
...
CREATE PROC [dbo].[ispGetStockTakeSheet_ph_11] 
...
BEGIN
   ...
   CREATE TABLE #Var_STSPH_08 ( 
         ...
         , Lottable04   NVARCHAR(11)    NULL
         , CaseCnt      FLOAT           NULL
         , CCLogicalloc NVARCHAR(20)    NULL )
   ...
   SELECT  CCDetail.CCKey,                    -- (JSM-87068)
         ...
         LOT.Lottable02,
         LOT.Lottable03,
         CONVERT(NVARCHAR(11),LOT.Lottable04,101) AS lottable04,
         PACK.CaseCnt,
         LOC.cclogicalloc        
    FROM CCDetail (NOLOCK) --ON CCDetail.cckey = CC.CCKey   
         ...
         JOIN LOTATTRIBUTE LOT WITH (NOLOCK) ON LOT.StorerKey = SKU.StorerKey AND LOT.Sku = SKU.Sku AND LOT.Lot = CCDetail.Lot
