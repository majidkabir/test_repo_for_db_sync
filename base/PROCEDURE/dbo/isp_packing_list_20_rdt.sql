...
/******************************************************************************/                  
/* Store Procedure: isp_Packing_List_20_rdt                                   */                  
/* Creation Date: 17-JUN-2015                                                 */                  
/* Copyright: IDS                                                             */                  
/* Written by: CSCHONG                                                        */                  
/*                                                                            */                  
/* Purpose: SOS#344925 - Under Armour ECOM packing list report                */      
/*                                                                            */                  
/*                                                                            */                  
/* Called By:  r_dw_packing_list_20_rdt                                       */                  
/*                                                                            */                  
/* PVCS Version: 2.1                                                          */                  
/*                                                                            */                  
/* Version: 1.0                                                               */                  
...
/* 20-02-2017   CSCHONG   1.3   increase orderdetail.userdefine03 lenght (CS04)*/        
/* 07-06-2017   CSCHONG   1.4   WMS-1641-revise report logic (CS05)           */    
/* 18-09-2017   CHEEMUN   1.5   IN00467807 - Remove Select Distinct Data      */    
/* 13-12-2017   WLCHOOI   1.6   WMS-3600-Add QR Code (WL01)                   */    
/* 20-12-2018   SPChin    1.7   INC0511705 - Cater for Ecom Packing Printing  */    
/* 28-Jan-2019  TLTING_ext 1.8  enlarge externorderkey field length           */  
/* 2nd-Apr-2019 WLCHOOI   1.9   WMS-7761 Revise logic (WL02)                  */
/* 03-Apr-2019  NJOW01    2.0   Fix - only print if have packheader           */  
/* 12-May-2021  WLChooi   2.1   WMS-17035 - Add new logic for QRCode (WL03)   */
/******************************************************************************/         
      
CREATE PROC [dbo].[isp_Packing_List_20_rdt]                 
...
--         , SPhone1         NVARCHAR(18)  NULL        --(CS01)    
         , OrdDate   DATETIME --WL01    
         , Cudf05   NVARCHAR(400) NULL --WL01    
         , OriString  NVARCHAR(4000) NULL --WL01    
         , QRCODE   NVARCHAR(4000) NULL --WL01    
   )      
