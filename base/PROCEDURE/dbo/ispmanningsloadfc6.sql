...
/************************************************************************/
/* Stored Proc: ispManningsLoadFC6                                      */
...
/*                            (WL01)                                    */
/************************************************************************/
CREATE PROC [dbo].[ispManningsLoadFC6]
...
BEGIN
   ...
   BEGIN
      PRINT '---------------------------------------'+ CHAR(13) +
            'Sub PICKCOde: ispManningsLoadFC6'+ CHAR(13) +
  ...
  ;WITH UCC AS
   ...
   BEGIN
      ...
      BEGIN CATCH  
         ...
         SELECT @n_continue = 3  
         SET @c_ErrMsg = RTRIM(@c_ErrMsg) + '. (ispManningsLoadFC6)'   
      END CATCH
         ...
         BEGIN
            ...
            BEGIN
               ...
               SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0)) 
                              + ': Get PickDetailKey Failed. (ispManningsLoadFC6)'
               GOTO QUIT_SP
            END
            ...
            BEGIN
               ...
               SET @n_Err = 81220
               SET @c_ErrMsg = 'NSQL' + CONVERT(NVARCHAR(5),ISNULL(@n_Err,0)) 
                              + ': Insert PickDetail Failed. (ispManningsLoadFC6)'
               GOTO QUIT_SP
            END
...
QUIT_SP:
   ...
   BEGIN
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'ispManningsLoadFC6'
