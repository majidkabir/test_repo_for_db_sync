...
/************************************************************************/
/* Stored Procedure: nspTTMEvaluateFCPTasks                             */
/* Purpose:                                                             */
/*                                                                      */
/* Modification log:                                                    */
/* Date        Ver.  Author     Purposes                                */
/* 2014-12-18  1.0   Ung        Created. SOS327467                      */
/************************************************************************/

CREATE PROC [dbo].[nspTTMEvaluateFCPTasks]
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
             ...
             END
         END
         EXECUTE nsp_logerror @n_err, @c_errmsg, 'nspTTMEvaluateFCPTasks'
