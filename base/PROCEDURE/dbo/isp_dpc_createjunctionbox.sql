...
CREATE PROC [dbo].[isp_DPC_CreateJunctionBox]
(
...
BEGIN
   ...
   SELECT @c_DeviceIP = ISNULL(ll.IPAddress,''), 
          ...
          @c_DeviceType = ISNULL(ll.DeviceType,'')
   ...
   SET @c_DSPMessage = 'CREATE_JUNCTION_BOX<TAB>' + RTRIM(@c_DeviceIP) + '<TAB>' + RTRIM(@c_DevicePort) + '<TAB>10<TAB>10<TAB>YES<TAB>YES<TAB>NO'
...
EXIT_SP:
   ...
   BEGIN  
      ...
      BEGIN  
         ROLLBACK TRAN  
         EXECUTE nsp_logerror @n_Err, @c_ErrMsg, 'isp_DPC_CreateJunctionBox'  
