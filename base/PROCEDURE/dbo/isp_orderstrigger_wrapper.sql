...
GO
/************************************************************************/  
/* Stored Procedure: isp_OrdersTrigger_Wrapper                          */  
/* Creation Date: 02-OCT-2015                                           */  
/* Copyright: LF                                                        */  
/* Written by: NJOW                                                     */  
/*                                                                      */  
/* Purpose:  354034-Call Orders custom stored proc                      */
/*                                                                      */  
/* Called By: Orders insert/update/delete trigger                       */    
/*            Stored proc naming: ispORDxx                              */
/*                                                                      */  
/* PVCS Version: 1.0                                                    */  
/*                                                                      */  
/* Version: 5.4                                                         */  
...
/*2019-03-04    WLCHOOI  1.0  Use local cur instead of global cur (WL01)*/
/*2019-09-26    NJOW01   1.1  WMS-10731 Support configure multiple sp   */
/************************************************************************/  

CREATE PROCEDURE [dbo].[isp_OrdersTrigger_Wrapper]  
...
BEGIN  
   ...
   BEGIN   	  
      ...
      BEGIN        	  
         ...
         EXECUTE dbo.isp_OrdersTrigger_Wrapper ----->wrapper for current table trigger
   ...
   */
   ...
   SET @c_SQL        = ''
   SET @c_Storerkey  = ''
   SET @c_configkey = 'OrdersTrigger_SP'
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      execute nsp_logerror @n_err, @c_errmsg, 'isp_OrdersTrigger_Wrapper'
