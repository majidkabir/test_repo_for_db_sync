...
/* 2017-06-15  Ung       1.0  WMS-2256 Created                                */
/******************************************************************************/
CREATE PROC [dbo].[nspTTMFCP3]
...
BEGIN
   ...
   SAVE TRAN nspTTMFCP3 -- For rollback or commit only our own transaction
   ...
   COMMIT TRAN nspTTMFCP3 -- Only commit change made here
   GOTO Quit

RollBackTran:
   ROLLBACK TRAN nspTTMFCP3 -- Only rollback change made here
Fail:
Quit:
