...
/******************************************************************************/                 
/* Copyright: IDS                                                             */                 
/* Purpose: isp_Bartender_TH_PLTRCVLBL_GetParm                                */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
...
CREATE PROC [dbo].[isp_Bartender_TH_PLTRCVLBL_GetParm]                      
(  @parm01            NVARCHAR(250),              
   @parm02            NVARCHAR(250),              
   @parm03            NVARCHAR(250),              
   @parm04            NVARCHAR(250),              
...
BEGIN                      
  ...
  DECLARE @d_Trace_StartTime   DATETIME,   
   ...
   SET @c_Trace_ModuleName = ''  
    ...
    SET @c_SQLJOIN = ' SELECT DISTINCT PARM1 = RH.RECEIPTKEY ,PARM2 = RD.TOID,PARM3='''',PARM4='''',PARM5='''',' + CHAR(13) +
                     ' PARM6= '''',PARM7='''',PARM8='''',PARM9='''',PARM10='''',Key1=''Receiptkey'',Key2=''Recline'',Key3=RH.facility,Key4='''',Key5='''' ' + CHAR(13) +
