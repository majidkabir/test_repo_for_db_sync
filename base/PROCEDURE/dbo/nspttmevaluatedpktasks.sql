...
/************************************************************************/
/* Stored Procedure: nspTTMEvaluateDPKTasks                             */
    ...
    BEGIN
        ...
        BEGIN
            ...
            SELECT @c_errmsg = "NSQL"+CONVERT(CHAR(5) ,@n_err)+
                   ": Execute Of Move Tasks Pick Code Failed. (nspTTMEvaluateDPKTasks)" 
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                ...
                END
            END
            EXECUTE nsp_logerror @n_err, @c_errmsg, 'nspTTMEvaluateDPKTasks'
