...
GO
/************************************************************************/      
/* Stored Procedure: isp_TPB_MBOL_Carters                               */      
/* Creation Date:                                                       */      
/* Copyright: IDS                                                       */      
/* Written by:                                                          */      
/*                                                                      */      
/* Purpose: TPB billing for CHN Carter MBOL Transaction                 */      
/*                                                                      */      
...
CREATE PROC [dbo].[isp_TPB_MBOL_Carters]
...
BEGIN
   ...
   -- Dynamic SQL
           ...
           SET @c_SQLGroup =
                  ...
                  ',RTRIM(MBOLDETAIL.MbolLineNumber) ' +  
                  ...
                  ',RTRIM(LOADPLAN.TrfRoom) ' +  
                  ',RTRIM(LOADPLAN.DELIVERY_ZONE) ' +  
                  ',MBOL.ShipDate '
         ...
         SET @c_SQLStatement = N'SELECT @n_WMS_BatchNo '+
                  ...
                  ',MBOL.ShipDate ' +  
                  ',PACKDETAIL.Qty ' +   
                  ',Count(distinct PackDetail.LabelNo) ' +  
                  ',MBOL.NoofContainer ' +  
                  ',RTRIM(MBOL.Vessel) ' +  
                  ',RTRIM(MBOL.VoyageNumber) ' +  
                  ',RTRIM(ORDERS.ContainerType) ' +  
        ...
        SET @c_SQLStatement =  @c_SQLStatement +
                  ...
                  'JOIN dbo.MBOLDETAIL (NOLOCK) ON MBOLDETAIL.MbolKey = MBOL.MbolKey   ' +  
                  'JOIN dbo.Orders (NOLOCK) ON ORDERS.OrderKey = MBOLDETAIL.OrderKey ' +  
                  ...
                  'JOIN dbo.LOADPLAN (NOLOCK) ON LOADPLAN.LoadKey = MBOLDETAIL.LoadKey  ' +  
