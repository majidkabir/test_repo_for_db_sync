...
/* 2022-02-21 1.0  CSCHONG    Devops Scripts combine and Created(WMS-18967)   */
/* 2023-01-12 1.1  WLChooi    WMS-21551 - Modify Col02-Col05 (WL01)           */
/******************************************************************************/

CREATE PROC [dbo].[isp_bartender_GIFTCARDLB]
(
...
BEGIN
   ...
   DECLARE @d_Trace_StartTime  DATETIME
         ...
         , @c_col03            NVARCHAR(80) = N''
         , @c_col04            NVARCHAR(80) = N''
   ...
   SELECT ISNULL(OH.B_Company, '')
        , SUBSTRING(ISNULL(OH.Notes2, ''), 1, 80)
        , SUBSTRING(ISNULL(OH.Notes2, ''), 81, 80)    --WL01
        , SUBSTRING(ISNULL(OH.Notes2, ''), 161, 80)   --WL01
        , ISNULL(OH.BillToKey, '')   --5   --WL01
        , ''
        , ''
        , ''
        , ''
   ...
   WHERE OH.StorerKey = @c_Sparm02 AND OH.OrderKey = @c_Sparm01
