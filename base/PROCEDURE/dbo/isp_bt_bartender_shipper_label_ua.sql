...
/* 2015-06-03 1.0  CSCHONG    Created (SOS343415)                             */ 
/* 2015-07-28 1.1  CSCHONG    change input by pickslipno & CartonNo (CS02)    */
/* 2015-08-24 1.2  CSCHONG    New column (CS03)                               */
/* 2017-08-30 1.3  CSCHONG    Enhance Dynamic SQL (CS04)                      */
/* 2019-03-20 1.4  CSCHONG    WMS-8310 - new column Col45 &col46 (CS05)       */
/* 2019-03-29 1.5  CSCHONG    WMS-8310 - revised col46 logic (CS06)           */
/******************************************************************************/              
                
CREATE PROC [dbo].[isp_BT_Bartender_Shipper_Label_UA]                     
...
BEGIN                    
   ...
   DECLARE                
	  ...
	  @c_GetCol45        NVARCHAR(80), --CS05
	  @c_getlabelno      NVARCHAR(50), --CS05
	  @c_CCode           NVARCHAR(20), --CS05
	  @c_CCode1          NVARCHAR(20), --CS05
	  @c_CCode2          NVARCHAR(20), --CS05
	  @c_CCode3          NVARCHAR(20), --CS05
	  @c_CCode4          NVARCHAR(20), --CS05
	  @c_CCode5          NVARCHAR(20), --CS05
	  @c_CCode6          NVARCHAR(20), --CS05
	  @c_Col46           NVARCHAR(80), --CS05
	  @c_dropid          NVARCHAR(80) --CS06
...
--                   +' AND PD.Dropid = CASE WHEN ISNULL(RTRIM(''' + @c_Sparm3+ '''),'''') <> '''' THEN ''' + @c_Sparm3+ ''' ELSE PD.Dropid END'         --(CS02) 
                   + ' WHERE PD.Pickslipno =  @c_Sparm1'                                            --(CS02)
                   + ' AND PD.Cartonno >= CONVERT(INT,  @c_Sparm2)'                                 --(CS02)
  ...
  SET @c_SQL='INSERT INTO #Result (Col01,Col02,Col03,Col04,Col05, Col06,Col07,Col08,Col09'  + CHAR(13) +         
   ...
   SELECT DISTINCT col29,col31,Col33,col43             --CS06
   FROM #Result        
     
   OPEN CUR_RowNoLoop          
     
   FETCH NEXT FROM CUR_RowNoLoop INTO @c_orderkey,@c_CntNo,@c_labelno ,@c_dropid        --CS06  
...
EXIT_SP:  
   ...
   EXEC isp_InsertTraceInfo 
      ...
      @c_TraceName = 'isp_BT_Bartender_Shipper_Label_UA',
