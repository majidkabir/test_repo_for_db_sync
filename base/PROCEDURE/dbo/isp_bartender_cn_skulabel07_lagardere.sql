...
/******************************************************************************/                 
/* Copyright: LFL                                                             */                 
/* Purpose: Bartender SKU Label - isp_Bartender_CN_SKULABEL07_Lagardere       */                 
/*                                                                            */                 
/* Modifications log:                                                         */                 
/*                                                                            */                 
...
BEGIN                      
  ...
  DECLARE  @d_Trace_StartTime  DATETIME,   
   ...
   SET @c_SQLJOIN = + ' SELECT TOP 1 ISNULL(S.BUSR6,''''), RTRIM(S.SKU), ISNULL(SI.ExtendedField02,''''), ISNULL(SI.ExtendedField03,''''),'   + CHAR(13) +   --4    
                    ...
                    + ' LEFT JOIN SKUINFO SI WITH (NOLOCK) ON SI.Storerkey = S.Storerkey AND SI.SKU = S.Sku '   + CHAR(13)
                    + ' JOIN Storer ST WITH (NOLOCK) ON ST.Storerkey = S.Storerkey '   + CHAR(13)
                    + ' OUTER APPLY (SELECT TOP 1 UPC.UPC FROM UPC (NOLOCK) WHERE UPC.Storerkey = S.Storerkey AND UPC.SKU = S.Sku) AS U ' + CHAR(13)
   ...
   IF EXISTS (SELECT 1 FROM #Result)
      SET @c_Sparm03 = CAST(@c_Sparm03 AS INT) - 1

   WHILE @c_Sparm03 > 0
   BEGIN
      INSERT INTO #Result(Col01, Col02, Col03, Col04, Col05, Col06, Col07, Col08, Col09, Col10, Col11, Col12, Col13, Col14
      ...
      SELECT TOP 1 Col01, Col02, Col03, Col04, Col05, Col06, Col07, Col08, Col09, Col10, Col11, Col12, Col13, Col14
                 , Col15, Col16, Col17, Col18, Col19, Col20, Col21, Col22, Col23, Col24, Col25, Col26, Col27, Col28
                 , Col29, Col30, Col31, Col32, Col33, Col34, Col35, Col36, Col37, Col38, Col39, Col40, Col41, Col42
                 , Col43, Col44, Col45, Col46, Col47, Col48, Col49, Col50, Col51, Col52, Col53, Col54, Col55, Col56
                 , Col57, Col58, Col59, Col60
...
EXIT_SP:    
   ...
   EXEC isp_InsertTraceInfo   
      ...
      @c_TraceName = 'isp_Bartender_CN_SKULABEL07_Lagardere',  
