...
/************************************************************************/
/* Store Procedure:  isp_adjsumm_05                                     */
/* Creation Date: 2020-01-13                                            */
/* Copyright: LFL                                                       */
/* Written by: WLChooi                                                  */
/*                                                                      */
/* Purpose: WMS-16007 - [PH] - Adidas Ecom - Adjustment Report          */
/*          Copy from isp_adjsumm_02                                    */
/*                                                                      */
/* Input Parameters:  @c_Adjustmentkey  - Adjustment Key                */
/*                 ,  @c_UserID                                         */
/*                                                                      */
...
/* Return Status:  None                                                 */
/*                                                                      */
/* Usage:  Used for report dw = r_dw_adjusment_summary_05               */
/*                                                                      */
/* Local Variables:                                                     */
/*                                                                      */
/* Called By:                                                           */
...
/* 31-10-2014   SPChin        SOS324756 - Add Storerkey Filter          */
/************************************************************************/
CREATE PROC [dbo].[isp_adjsumm_05] (
...
BEGIN
   ...
   JOIN SKU              SKU WITH (NOLOCK) ON (AD.Storerkey = SKU.Storerkey)
                                         AND(AD.SKU = SKU.SKU)
   JOIN CODELKUP         CL  WITH (NOLOCK) ON (CL.Listname = 'ADJTYPE')
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE nsp_logerror @n_err, @c_errmsg, 'isp_adjsumm_05'
