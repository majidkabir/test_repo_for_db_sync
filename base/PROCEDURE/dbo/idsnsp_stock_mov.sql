...
/*****************************************************************/
CREATE PROC [dbo].[IDSnsp_stock_mov] (
     ...
     @LotMin         NVARCHAR(10),
     @LotMax         NVARCHAR(10),
     @DateStringMin  datetime,
     @DateStringMax  datetime
   ...
   SET CONCAT_NULL_YIELDS_NULL OFF
     ...
     BEGIN
          ...
          SELECT @n_num_recs = -100 /* initialize */
               ...
               , EffectiveDate = convert(datetime,convert(char(20), a.EffectiveDate,106))
               , a.itrnkey
               , a.sourcekey
               , a.sourcetype
               , 0 as distinct_sku
...
-- 	select * from       #ITRN_CUT_BY_SKU
     ...
     BEGIN
          ...
          BEGIN
               ...
               , ExternNum = "                              "
               , BuyerPO = "                    "
               , convert(datetime,convert(char(20), a.ArchiveDate,106))  
               , picked = 0
...
, ExceedNum = "          "
   ...
   , Sku
     ...
     SELECT
        ...
        , Sku
        , Qty
        , EffectiveDate = convert(datetime,CONVERT(char(20), EffectiveDate,106)) 
        , Flag = "  "
        , TranType        
        , ExceedNum
        , ExternNum
 ...
 SELECT @prev_Sku =  @Sku
     ...
     BEGIN
        ...
        , #BF2.picked
        , "INV94" -- report id
        , "From " + CONVERT(char(10), @DateStringMin, 103) + " To "+ CONVERT( NVARCHAR(10), @DateStringMax, 103)
          FROM #BF2,
          STORER,
          SKU
     ...
     BEGIN
        ...
        , #BF2.Sku
        , #BF2.Qty
        , EffDate = convert(char(20),#BF2.EffectiveDate,106)
        , #BF2.Flag
        , #BF2.TranType
        , #BF2.ExceedNum
        , #BF2.ExternNum
