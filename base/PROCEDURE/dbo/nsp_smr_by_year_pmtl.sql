...
/************************************************************************/
/* Stored Procedure: nsp_smr_by_year_pmtl                               */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
...
CREATE PROC [dbo].[nsp_smr_by_year_pmtl] (
...
AND	a.Sku = c.Sku
group by a.storerkey, a.SKU, a.TrxDate, a.TranType, a.Sourcetype, a.Sourcekey, c.BUSR1, record_number
, c.RetailSKU -- SOS15891
...
GROUP BY Storerkey, tr.Sku, o_qty, EFYear, EFMonth, BUSR1, tr.Label, tr.sorting
, tr.RetailSKU  -- SOS15891
