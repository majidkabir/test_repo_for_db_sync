...
GO
/************************************************************************/
/* Stored Procedure: nsp_ReplenishmentRpt_PC02                          */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
...
/* 12-Sep-2005  June       SOS40633:Prevent replen fr other facility    */
/* 15-Sep-2005  June       SOS40770:Sort by Lot04, lot02 & lot05        */
/* 05-Oct-2005  Shong      SOS41555 Bug Fix - Changed to cursor while   */
/*                         getting available Lot for replenish          */
/* 05-MAR-2018 Wan01 1.6   WM - Add Functype                            */
/************************************************************************/
 
CREATE PROC    [dbo].[nsp_ReplenishmentRpt_PC02]
                 ...
                 SET ROWCOUNT 0
                     ...
                     BEGIN
                          ...
                          BEGIN
                               ...
                               -- Modified by Shong on 05-Oct-2005 (SOS41555) 
                               -- Change to cursor to get Lot (for qtyexpected=0) due to sorting of lottables
                               DECLARE C_LOT_Replen CURSOR LOCAL FAST_FORWARD READ_ONLY FOR                                               
                               SELECT LOTxLOCxID.LOT 
                                    ...
                                    ORDER BY LOTTABLE04, LOTTABLE02, LOTTABLE05
                               ...
                               BEGIN
                                    ...
                                    BEGIN                        
                                       ...
                                       -- SOS41555      
                                       FETCH NEXT FROM C_LOT_Replen INTO @c_fromlot 
                                    ...
                                    BEGIN
                                         ...
                                         BEGIN
                                              ...
                                              SELECT @c_fromLOC = LOTxLOCxID.LOC
                                                   ...
                                                   AND LOTxLOCxID.qtyexpected = 0 -- make sure we aren't going to try to pull from a LOCation that needs stuff to satisfy existing demAND 
                                                   AND LOTxLOCxID.LOC <> @c_currentLOC
                                                   AND LOC.Facility = @c_Zone01 -- SOS40633
                                         ...
                                         BEGIN
                                             ...
                                             if @b_debug = 1
                                             begin
                                                select @c_currentSKU '@c_currentSKU', @n_fromqty '@n_fromqty', @n_remainingqty '@n_remainingqty'
                                             end
                                    ...
                                    CLOSE C_LOT_Replen      -- SOS41555
                                    DEALLOCATE C_LOT_Replen -- SOS41555
                                    SET ROWCOUNT 0
                                 END -- FOR SKU
                                 SET ROWCOUNT 0                         
                              END -- FOR STORER
