...
GO
/************************************************************************/  
/* Store Procedure: nsp_UCC_CartonLabel_07                              */  
...
/* 07-08-2008  HFLiew   Added Orders.Consigneekey in SELECT statement   */  
/*                      (HFLiew01)                                      */  
/* 15-Oct-2015 Audrey SOS354865 - fixed cartonno & storerkey length */  
/*               (ang01)        
/* 28-Jan-2019  TLTING_ext 1.1 enlarge externorderkey field length      */                                   */  
/* 10-May-2019 WLChooi  WMS-8455 - Add new barcode (WL01)               */  
/************************************************************************/  
CREATE PROC [dbo].[nsp_UCC_CartonLabel_07] (  
