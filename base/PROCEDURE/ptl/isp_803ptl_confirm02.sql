...
/************************************************************************/
/* Store procedure: isp_803PTL_Confirm02                                */
/* Copyright      : LF Logistics                                        */
/*                                                                      */
/* Purpose: Accept QTY in CS-PCS, format 9-999                          */
/*                                                                      */
/* Date       Rev  Author   Purposes                                    */
/* 16-03-2016 1.0  Ung      SOS370123 Created                           */
/* 12-04-2017 1.1  Ung      WMS-1603 Auto light up after assign tote    */
/************************************************************************/

CREATE PROC [PTL].[isp_803PTL_Confirm02] (
...
*/      
      ...
      SAVE TRAN isp_803PTL_Confirm02 -- For rollback or commit only our own transaction   
      ...
      COMMIT TRAN isp_803PTL_Confirm02
      GOTO Quit
   END
...
RollBackTran:
   ROLLBACK TRAN isp_803PTL_Confirm02 -- Only rollback change made here
Quit:
