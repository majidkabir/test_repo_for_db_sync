...
/***************************************************************************/  
/* Trigger: [API].[isp_ECOMP_QueryRules]                                   */  
...
/***************************************************************************/  
CREATE   PROC [API].[isp_ECOMP_QueryRules]   
      ...
      BEGIN  
         ...
         BEGIN  
            ...
            BEGIN  
               SET @n_Continue = 3  
               SET @n_err = 60010  
               SET @c_errmsg='NSQL'+CONVERT(char(5),@n_err)+': Error Update PACKTASKDETAIL Table. (isp_ECOMP_QueryRules)'   
