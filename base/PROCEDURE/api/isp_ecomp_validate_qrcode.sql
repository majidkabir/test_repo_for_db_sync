...
GO
/************************************************************************/  
/* Stored Proc: [API].[isp_ECOMP_Validate_QRCode]                       */  
...
/* 05 MAY 2023    Alex     1.0      Clone from WMS                      */
/************************************************************************/  
CREATE   PROC [API].[isp_ECOMP_Validate_QRCode]
...
QUIT_SP:  
   ...
   BEGIN  
      ...
      EXECUTE nsp_logerror @n_err, @c_ErrMsg, 'isp_ECOMP_Validate_QRCode'  
      RAISERROR (@c_errmsg, 16, 1) WITH SETERROR    -- SQL2012      
   END  
   ELSE  
   BEGIN        SET @b_Success = 1  
      WHILE @@TRANCOUNT > @n_StartTCnt  
      BEGIN  
         COMMIT TRAN  
      END  
