CREATE TABLE [dbo].[sce_dl_po_stg]
(
    ...
    [AddWho] nvarchar(128) NULL DEFAULT (suser_name()),
    ...
    CONSTRAINT [PK_SCE_DL_PO_STG] PRIMARY KEY ([RowRefNo])
);
GO

CREATE INDEX [SCE_DL_PO_STG_Idx01] ON [dbo].[sce_dl_po_stg] ([STG_BatchNo]);
GO
CREATE INDEX [SCE_DL_PO_STG_Idx02] ON [dbo].[sce_dl_po_stg] ([STG_BatchNo], [STG_SeqNo]);
GO