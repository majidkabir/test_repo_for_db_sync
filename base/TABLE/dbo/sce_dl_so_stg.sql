CREATE TABLE [dbo].[sce_dl_so_stg]
(
    ...
    CONSTRAINT [PK_SCE_DL_SO_STG] PRIMARY KEY ([RowRefNo])
);
GO

CREATE INDEX [SCE_DL_SO_STG_Idx01] ON [dbo].[sce_dl_so_stg] ([STG_BatchNo]);
GO
CREATE INDEX [SCE_DL_SO_STG_Idx02] ON [dbo].[sce_dl_so_stg] ([STG_BatchNo], [STG_SeqNo]);
GO