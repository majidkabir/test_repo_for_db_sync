CREATE TABLE [dbo].[sce_dl_storer_stg]
(
    ...
    CONSTRAINT [PK_SCE_DL_STORER_STG] PRIMARY KEY ([RowRefNo])
);
GO

CREATE INDEX [SCE_DL_STORER_STG_Idx01] ON [dbo].[sce_dl_storer_stg] ([STG_BatchNo]);
GO
CREATE INDEX [SCE_DL_STORER_STG_Idx02] ON [dbo].[sce_dl_storer_stg] ([STG_BatchNo], [STG_SeqNo]);
GO