...
(
    ...
    CONSTRAINT [PKORDERDETAIL_CANCLOG] PRIMARY KEY ([LogId])
);
GO

CREATE INDEX [IX_ORDERDETAIL_CANCLOG_ConsoOrderKey] ON [dbo].[orderdetail_canclog] ([ConsoOrderKey], [ConsoOrderLineNo]);
GO
CREATE INDEX [IX_ORDERDETAIL_CANCLOG_ExtOrdKey] ON [dbo].[orderdetail_canclog] ([ExternOrderKey], [ExternLineNo]);
GO
CREATE INDEX [IX_ORDERDETAIL_CANCLOG_MbolKey] ON [dbo].[orderdetail_canclog] ([MBOLKey]);
GO
CREATE INDEX [IX_ORDERDETAIL_CANCLOG_SKU] ON [dbo].[orderdetail_canclog] ([StorerKey], [Sku]);
GO
CREATE INDEX [ORDERDETAIL_CANCLOG6] ON [dbo].[orderdetail_canclog] ([LoadKey], [Status]);
GO