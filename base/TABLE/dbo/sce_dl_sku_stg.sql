CREATE TABLE [dbo].[sce_dl_sku_stg]
(
    ...
    CONSTRAINT [PK_SCE_DL_SKU_STG] PRIMARY KEY ([RowRefNo])
);
GO

CREATE INDEX [SCE_DL_SKU_STG_Idx01] ON [dbo].[sce_dl_sku_stg] ([STG_BatchNo], [STG_Status], [STG_SeqNo]);
GO