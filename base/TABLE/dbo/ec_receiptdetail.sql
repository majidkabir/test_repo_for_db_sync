CREATE TABLE [dbo].[ec_receiptdetail]
(
    ...
    CONSTRAINT [PKECRECEIPTDETAIL] PRIMARY KEY ([ReceiptKey], [ReceiptLineNumber]),
    CONSTRAINT [FK_EC_RECEIPTDETAIL_SKU_01] FOREIGN KEY ([StorerKey], [Sku]) REFERENCES [dbo].[SKU] ([StorerKey], [Sku])
);
GO

CREATE INDEX [EC_RECEIPTDETAIL3] ON [dbo].[ec_receiptdetail] ([ReceiptKey], [ReceiptLineNumber], [QtyReceived], [BeforeReceivedQty]);
GO
CREATE INDEX [IX_EC_RECEIPTDETAIL_ExternReceiptKey] ON [dbo].[ec_receiptdetail] ([ExternReceiptKey]);
GO
CREATE INDEX [IX_EC_RECEIPTDETAIL_PO] ON [dbo].[ec_receiptdetail] ([POKey], [POLineNumber]);
GO
CREATE INDEX [IX_EC_RECEIPTDETAIL_STSKLot02XRecKey] ON [dbo].[ec_receiptdetail] ([StorerKey], [Sku], [Lottable02], [ExternPoKey]);
GO