CREATE TABLE [dbo].[sce_dl_transfer_stg]
(
    ...
    CONSTRAINT [PK_SCE_DL_TRANSFER_STG] PRIMARY KEY ([RowRefNo])
);
GO

CREATE INDEX [SCE_DL_TRANSFER_STG_Idx01] ON [dbo].[sce_dl_transfer_stg] ([STG_BatchNo]);
GO
CREATE INDEX [SCE_DL_TRANSFER_STG_Idx02] ON [dbo].[sce_dl_transfer_stg] ([STG_BatchNo], [STG_SeqNo]);
GO