...
(
    ...
    [DataPopulated] nvarchar(1) NOT NULL DEFAULT ('0'),
    CONSTRAINT [PK_rdtPTLStationLogQueue] PRIMARY KEY ([RowRef])
);
GO

CREATE INDEX [IDX_rdtPTLStationLog_Loc] ON [rdt].[rdtptlstationlogqueue] ([LOC]);
GO