...
/************************************************************************/
/* Stored Procedure: rdtConvertToDate2   		                           */
/* Creation Date:                                                       */
/* Copyright: IDS                                                       */
/* Written by:                                                          */
/*                                                                      */
...
/* 2021-04-22   Chermaine     Created                                   */
/*                             (dup rdtIsValidDate,rdtConvertToDate)    */
/* 2023-12-23   YeeKung       Change add date (yeekung01)               */ 
/************************************************************************/

CREATE   FUNCTION RDT.rdtConvertToDate2 (
   @cDate         NVARCHAR( 10),
...
BEGIN
   ...
   ELSE
   BEGIN
   	SET @cUserDateFormat = @cDateFormat
   END
