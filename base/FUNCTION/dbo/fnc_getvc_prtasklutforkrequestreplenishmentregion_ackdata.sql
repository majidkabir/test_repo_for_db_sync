...
GO
CREATE FUNCTION [dbo].[fnc_GetVC_prTaskLUTForkRequestReplenishmentRegion_AckData]
(
   @nSerialNo INT
)
RETURNS @tReplenishmentRegionTask TABLE 
        (
...
BEGIN
   ...
   BEGIN
       ...
       FETCH NEXT FROM CUR1 INTO @n_SeqNo, @c_ColValue
   END
   INSERT INTO @tReplenishmentRegionTask
     (
       ErrorCode
      ,ErrorMessage
     )
