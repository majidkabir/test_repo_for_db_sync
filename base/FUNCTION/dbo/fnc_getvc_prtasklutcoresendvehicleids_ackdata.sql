...
GO
CREATE FUNCTION [dbo].[fnc_GetVC_prTaskLUTCoreSendVehicleIDs_AckData]
(
   @nSerialNo INT
)
RETURNS @tCoreSendVehicleID TABLE 
        (   [SafetyCheck] NVARCHAR(50)
...
BEGIN
   ...
   BEGIN
       ...
       FETCH NEXT FROM CUR1 INTO @n_SeqNo, @c_ColValue
   END
   INSERT INTO @tCoreSendVehicleID
     ( SafetyCheck
      ,ErrorCode
      ,ErrorMessage
     )
