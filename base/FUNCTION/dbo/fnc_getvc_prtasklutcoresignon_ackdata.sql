...
GO
CREATE FUNCTION [dbo].[fnc_GetVC_prTaskLUTCoreSignOn_AckData]
(
   @nSerialNo INT
)
RETURNS @tCoreSignOn TABLE 
        (   [Interleave] NVARCHAR(1)
