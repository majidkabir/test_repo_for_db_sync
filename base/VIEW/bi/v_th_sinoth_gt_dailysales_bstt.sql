...
/******************************************************************************************/
CREATE   VIEW [BI].[V_TH_SINOTH_GT_DailySales_BSTT]
AS
...
JOIN dbo.V_LOTATTRIBUTE AL4 WITH (NOLOCK) ON AL3.Sku=AL4.Sku AND AL3.Storerkey=AL4.StorerKey AND AL3.Lot=AL4.Lot
RIGHT OUTER JOIN dbo.V_ORDERDETAIL AL6 WITH (NOLOCK) ON AL6.Sku=AL3.Sku AND AL6.OrderKey=AL3.OrderKey AND AL3.Storerkey=AL6.StorerKey AND AL6.OrderLineNumber=AL3.OrderLineNumber
JOIN dbo.V_ORDERS AL5 WITH (NOLOCK) ON AL5.OrderKey=AL6.OrderKey AND AL5.StorerKey=AL6.StorerKey AND AL5.ExternOrderKey=AL6.ExternOrderKey
...
WHERE
 ...
 AND AL5.Status <> 'CANC'
 AND AL5.Type NOT  IN ('COPACK', 'PM', 'TRF')
 ...
 AND AL8.ConsigneeFor IN ('SINOTH', 'SINOXD')
