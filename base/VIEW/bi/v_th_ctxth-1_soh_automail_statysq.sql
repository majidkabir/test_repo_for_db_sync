...
/******************************************************************************************/
CREATE   VIEW [BI].[V_TH_CTXTH-1_SOH_AUTOmail_statysQ]
AS
SELECT DISTINCT
   AL3.Lottable01 + '-' +
   Case
      ...
      Else
         ...
         End
   End as 'catalog'
, AL1.BUSR5, AL4.StorerKey, AL5.Facility, AL4.Id, AL4.Sku, AL1.DESCR, sum(AL4.Qty) as 'QTY', AL4.QtyAllocated, AL4.QtyPicked,
UPPER(AL2.PackUOM3) as 'UOM', UPPER(AL3.Lottable01) as 'Lottable01', AL3.Lottable02, AL3.Lottable03, AL3.Lottable05, AL2.Pallet,
AL1.BUSR4, Upper(AL5.Loc) as 'Loc', AL1.BUSR10, AL1.ShelfLife,
   Case
      When
         (
            AL1.ShelfLife
