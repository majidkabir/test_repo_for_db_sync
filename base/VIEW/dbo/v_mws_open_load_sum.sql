...
CREATE   VIEW [dbo].[V_MWS_OPEN_LOAD_SUM] AS (
select o.storerkey Storerkey , o.loadkey LoadKey,o.type OrdType, o.ordergroup OrdGrp,
CONVERT(VARCHAR(16),min(o.adddate),120) OrdDate, count(distinct(o.orderkey)) NumOrd,
count(*) NumOrdLines, count(distinct(od.sku)) NumSkus, min(o.status) GrpStatus,
...
group by o.storerkey , o.loadkey, o.type, o.ordergroup
