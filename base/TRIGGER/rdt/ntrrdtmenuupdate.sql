...
BEGIN  
 ...
 SET CONCAT_NULL_YIELDS_NULL OFF  
   ...
   BEGIN    
         ...
         SELECT @c_errmsg="NSQL"+CONVERT(char(5),@n_err)+": Update Failed On Table RDT.RDTMenu. Batch Update not allow! (RDT.ntrRDTMenuUpdate)" + " ( " + " SQLSvr MESSAGE=" + LTRIM(RTRIM(@c_errmsg)) + " ) "    
   ...
   BEGIN    
      ...
      BEGIN    
         ...
         END    
      END    
      execute nsp_logerror @n_err, @c_errmsg, "RDT.ntrRDTMenuUpdate"    
