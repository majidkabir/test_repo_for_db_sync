...
/***************************************************************************/  
/* Trigger: ntrBartenderLabelCfgUpdate                                     */  
/* Creation Date:                                                          */  
/* Copyright: IDS                                                          */  
/* Written by:                                                             */  
/*                                                                         */  
/* Purpose:  https://jiralfl.atlassian.net/browse/WMS-10229                */  
...
BEGIN
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         SELECT @c_errmsg='NSQL'+CONVERT(char(5),@n_err)+': Update Failed On Table BartenderLabelCfg. (ntrBartenderLabelCfgUpdate)' + ' ( ' + ' SQLSvr MESSAGE=' + dbo.fnc_LTrim(dbo.fnc_RTrim(@c_errmsg)) + ' ) '  
      END
   END
 ...
 --  IF UPDATE(TrafficCop)
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         END  
      END  
      execute nsp_logerror @n_err, @c_errmsg, 'ntrBartenderLabelCfgUpdate'  
