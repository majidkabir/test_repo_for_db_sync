...
CREATE   TRIGGER [dbo].[ntrTTMStrategyDetailDelete]
 ...
 BEGIN
   ...
   BEGIN
      ...
      BEGIN
         SELECT @n_continue = 3
               ,@c_errmsg = 'ntrTTMStrategyDetailDelete' + dbo.fnc_RTrim(@c_errmsg)
      END
      ELSE 
   ...
   BEGIN
      ...
      BEGIN
         ...
         END
      END
      EXECUTE nsp_logerror @n_err, @c_errmsg, "ntrTTMStrategyDetailDelete"
