...
/********************************************************************************/ 
/* Trigger: ntrOrderDetailRefUpdate                                             */ 
/* Creation Date:                                                               */ 
/* Copyright: IDS                                                               */ 
/* Written by: kelvinongcy                                                      */ 
/*                                                                              */ 
/* Purpose:  OrderDetailRef Update                                              */ 
...
BEGIN  
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         SELECT @c_errmsg='NSQL'+CONVERT(char(5),@n_err)+': Update Failed On Table OrderDetailRef. (ntrOrderDetailRefUpdate)' + ' ( ' + ' SQLSvr MESSAGE=' + dbo.fnc_LTrim(dbo.fnc_RTrim(@c_errmsg)) + ' ) '  
      END  
   END 
   ...
   BEGIN  
      ...
      BEGIN  
         ...
         END  
      END  
      execute nsp_logerror @n_err, @c_errmsg, 'ntrOrderDetailRefUpdate'  
