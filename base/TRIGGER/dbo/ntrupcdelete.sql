...
GO
/***************************************************************************************/
/* Trigger:  ntrUPCDelete                                                        		*/
/* Creation Date:                                                                		*/
/* Copyright: IDS                                                                		*/
/* Written by:                                                                   		*/
/*                                                                               		*/
/* Purpose:  Trigger point upon any Delete on the UPC                            		*/
/*                                                                               		*/
/* Return Status:  None                                                          		*/
/*                                                                               		*/
/* Usage:                                                                        		*/
...
-- END
   ...
   BEGIN
      ...
      BEGIN
         ...
         SELECT UPC, StorerKey, SKU FROM DELETED WITH (NOLOCK)
   ...
   BEGIN      
         ...
         SELECT @c_errmsg="NSQL"+CONVERT(char(5),@n_err)+": Delete Failed On Table UPC. Batch Delete not allow! (ntrUPCDelete)" + " ( " + " SQLSvr MESSAGE=" + LTRIM(RTRIM(@c_errmsg)) + " ) "
   END
